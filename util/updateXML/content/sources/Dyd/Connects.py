...
class Connects:
    ...
    def get_connects_with_var(self, var, idx):
        ...
        connect_xpath = './dyn:' + self.__connect_type.name + '[@id' + idx + '="' + self.__model_id + \
                        '" and @var' + idx + '="' + var + '"]'
        connects.extend(self.__parent_xml_tree.xpath(connect_xpath, namespaces=NAMESPACE_URI))
        ...
        for macro_connect in macro_connects:
            ...
            connects.extend(self.__parent_xml_tree.xpath(macro_connector_connect_xpath, namespaces=NAMESPACE_URI))
    ...
    def change_var_name(self, current_var, new_var):
        ...
        """
        for idx in ["1", "2"]:
            connects = self.get_connects_with_var(current_var,idx)
