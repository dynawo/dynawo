<!--  This xsl works with connects inside macroConnector and:
...
<xsl:template match="dyn:connect">
  <xsl:choose>
    <xsl:when test="@var1='generator_switchOffSignal1' and parent::dyn:macroConnector">
    ...
    <xsl:when test="@var2='generator_switchOffSignal1' and parent::dyn:macroConnector">
      <xsl:element name="dyn:connect">
    ...
    <xsl:when test="@var1='load_switchOffSignal1' and parent::dyn:macroConnector">
      <xsl:element name="dyn:connect">
        <xsl:attribute name="var1">switchOff_switchOffSignal1</xsl:attribute>
        <xsl:attribute name="var2"><xsl:value-of select="@var2"/></xsl:attribute>
      </xsl:element>
    </xsl:when>
    <xsl:when test="@var2='load_switchOffSignal1' and parent::dyn:macroConnector">
      <xsl:element name="dyn:connect">
        <xsl:attribute name="var1"><xsl:value-of select="@var1"/></xsl:attribute>
        <xsl:attribute name="var2">switchOff_switchOffSignal1</xsl:attribute>
      </xsl:element>
...
<xsl:template match="connect">
  <xsl:choose>
    <xsl:when test="@var1='generator_switchOffSignal1' and parent::macroConnector">
      <xsl:element name="connect">
        <xsl:attribute name="var1">switchOff_switchOffSignal1</xsl:attribute>
        <xsl:attribute name="var2"><xsl:value-of select="@var2"/></xsl:attribute>
      </xsl:element>
    </xsl:when>
    <xsl:when test="@var2='generator_switchOffSignal1' and parent::macroConnector">
      <xsl:element name="connect">
        <xsl:attribute name="var1"><xsl:value-of select="@var1"/></xsl:attribute>
        <xsl:attribute name="var2">switchOff_switchOffSignal1</xsl:attribute>
      </xsl:element>
    </xsl:when>
    <xsl:when test="@var1='load_switchOffSignal1' and parent::macroConnector">
      <xsl:element name="connect">
        <xsl:attribute name="var1">switchOff_switchOffSignal1</xsl:attribute>
        <xsl:attribute name="var2"><xsl:value-of select="@var2"/></xsl:attribute>
      </xsl:element>
    </xsl:when>
    <xsl:when test="@var2='load_switchOffSignal1' and parent::macroConnector">
      <xsl:element name="connect">
        <xsl:attribute name="var1"><xsl:value-of select="@var1"/></xsl:attribute>
        <xsl:attribute name="var2">switchOff_switchOffSignal1</xsl:attribute>
      </xsl:element>
