...
static boost::shared_ptr<SubModel> initModelUpdatableDiscrete() {
  ...
  parametersSet->createParameter(DYN::UPDATABLE_INPUT_VALUE_NAME, 1.2);
...
TEST(ModelsModelUpdatableDiscrete, ModelUpdatableDiscreteDefineMethods) {
  ...
  std::shared_ptr<parameters::ParametersSet> parametersSet = parameters::ParametersSetFactory::newParametersSet("Parameterset");
  parametersSet->createParameter(DYN::UPDATABLE_INPUT_VALUE_NAME, 2.);
  ...
  ASSERT_EQ(variableModelUpdatableDiscrete->getName(), DYN::UPDATABLE_VARIABLE_NAME);
...
TEST(ModelsModelUpdatableDiscrete, ModelUpdatableDiscreteTypeMethods) {
  ...
  ASSERT_EQ(modelUpdatableDiscrete->sizeZ(), 1);
...
TEST(ModelsModelUpdatableDiscrete, ModelUpdatableDiscreteUpdate) {
  ...
  modelUpdatableDiscrete->setParameterValue(DYN::UPDATABLE_INPUT_VALUE_NAME, DYN::FINAL, 2.5, false);
  modelUpdatableDiscrete->setSubModelParameters();
  modelUpdatableDiscrete->evalG(0);
  mode = modelUpdatableDiscrete->evalMode(0);
  ASSERT_EQ(modelUpdatableDiscrete->findParameter(DYN::UPDATABLE_INPUT_VALUE_NAME, false).getDoubleValue(), 2.5);
  ASSERT_EQ(mode, NO_MODE);
  ...
  modelUpdatableDiscrete->setParameterValue(DYN::UPDATABLE_INPUT_VALUE_NAME, DYN::FINAL, 3.1, false);
  modelUpdatableDiscrete->setSubModelParameters();
  modelUpdatableDiscrete->evalG(0);
  mode = modelUpdatableDiscrete->evalMode(0);
  ASSERT_EQ(modelUpdatableDiscrete->findParameter(DYN::UPDATABLE_INPUT_VALUE_NAME, false).getDoubleValue(), 3.1);
  ASSERT_EQ(mode, NO_MODE);
  ...
  modelUpdatableDiscrete->setParameterValue(DYN::UPDATABLE_INPUT_MULTIPLIER_NAME, DYN::FINAL, 2., false);
  modelUpdatableDiscrete->setSubModelParameters();
  modelUpdatableDiscrete->evalG(0);
  mode = modelUpdatableDiscrete->evalMode(0);
  ASSERT_EQ(modelUpdatableDiscrete->findParameter(DYN::UPDATABLE_INPUT_VALUE_NAME, false).getDoubleValue(), 6.2);
  ASSERT_EQ(mode, NO_MODE);
