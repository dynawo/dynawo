...
ModelTwoWindingsTransformer::evalState(const double& /*time*/) {
  ...
  // external automaton
  if (z_[1] != getCurrentStepIndex() && (disableInternalTapChanger_ > 0.)) {
...
void
ModelTwoWindingsTransformer::setSubModelParameters(const std::tr1::unordered_map<std::string, ParameterModeler>& params) {
