...
class ModelTwoWindingsTransformer : public NetworkComponent::Impl {
 public:
  ...
  /**
   * @brief getgetDefJCalculatedVarI get the index of variables used to define the jacobian associated to a calculated variable
   * @param numCalculatedVar iCalculatedVar index of the calculated variable
