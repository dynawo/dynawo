...
TEST(ModelsModelNetwork, ModelNetworkBusDiscreteVariables) {
  ...
  g[0] = ROOT_UP;
  g[1] = ROOT_UP;
  bus->evalZ(0., deactivateZeroCrossingFunctions);
  ...
  g[0] = ROOT_DOWN;
  g[1] = ROOT_DOWN;
  bus->evalZ(10., deactivateZeroCrossingFunctions);
...
TEST(ModelsModelNetwork, ModelNetworkBusNodeBreakerDiscreteVariables) {
  ...
  g[0] = ROOT_UP;
  g[1] = ROOT_UP;
  ASSERT_THROW_DYNAWO(bus->evalZ(0., deactivateZeroCrossingFunctions), Error::MODELER, KeyError_t::CalculatedBusNoSwitchStateChange);
}
