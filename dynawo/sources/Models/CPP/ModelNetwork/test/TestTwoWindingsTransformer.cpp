...
TEST(ModelsModelNetwork, ModelNetworkTwoWindingsTransformerCalculatedVariables) {
  ...
  ASSERT_NO_THROW(t2w->getIndexesOfVariablesUsedForCalculatedVarI(ModelTwoWindingsTransformer::i1Num_, numVars, numVarsExternal));
  ...
  numVars.clear();
  ASSERT_NO_THROW(t2w->getIndexesOfVariablesUsedForCalculatedVarI(ModelTwoWindingsTransformer::i2Num_, numVars, numVarsExternal));
  ASSERT_EQ(numVars.size(), 4);
  ASSERT_EQ(numVars[0], 0);
  ASSERT_EQ(numVars[1], 1);
  ASSERT_EQ(numVars[2], 2);
  ASSERT_EQ(numVars[3], 3);
  numVars.clear();
  ASSERT_NO_THROW(t2w->getIndexesOfVariablesUsedForCalculatedVarI(ModelTwoWindingsTransformer::p1Num_, numVars, numVarsExternal));
  ASSERT_EQ(numVars.size(), 4);
  ASSERT_EQ(numVars[0], 0);
  ASSERT_EQ(numVars[1], 1);
  ASSERT_EQ(numVars[2], 2);
  ASSERT_EQ(numVars[3], 3);
  numVars.clear();
  ASSERT_NO_THROW(t2w->getIndexesOfVariablesUsedForCalculatedVarI(ModelTwoWindingsTransformer::p2Num_, numVars, numVarsExternal));
  ASSERT_EQ(numVars.size(), 4);
  ASSERT_EQ(numVars[0], 0);
  ASSERT_EQ(numVars[1], 1);
  ASSERT_EQ(numVars[2], 2);
  ASSERT_EQ(numVars[3], 3);
  numVars.clear();
  ASSERT_NO_THROW(t2w->getIndexesOfVariablesUsedForCalculatedVarI(ModelTwoWindingsTransformer::q1Num_, numVars, numVarsExternal));
  ASSERT_EQ(numVars.size(), 4);
  ASSERT_EQ(numVars[0], 0);
  ASSERT_EQ(numVars[1], 1);
  ASSERT_EQ(numVars[2], 2);
  ASSERT_EQ(numVars[3], 3);
  numVars.clear();
  ASSERT_NO_THROW(t2w->getIndexesOfVariablesUsedForCalculatedVarI(ModelTwoWindingsTransformer::q2Num_, numVars, numVarsExternal));
  ASSERT_EQ(numVars.size(), 4);
  ASSERT_EQ(numVars[0], 0);
  ASSERT_EQ(numVars[1], 1);
  ASSERT_EQ(numVars[2], 2);
  ASSERT_EQ(numVars[3], 3);
  numVars.clear();
  ASSERT_NO_THROW(t2w->getIndexesOfVariablesUsedForCalculatedVarI(ModelTwoWindingsTransformer::iS1ToS2Side1Num_, numVars, numVarsExternal));
  ASSERT_EQ(numVars.size(), 4);
  ASSERT_EQ(numVars[0], 0);
  ASSERT_EQ(numVars[1], 1);
  ASSERT_EQ(numVars[2], 2);
  ASSERT_EQ(numVars[3], 3);
  numVars.clear();
  ASSERT_NO_THROW(t2w->getIndexesOfVariablesUsedForCalculatedVarI(ModelTwoWindingsTransformer::iS2ToS1Side1Num_, numVars, numVarsExternal));
  ASSERT_EQ(numVars.size(), 4);
  ASSERT_EQ(numVars[0], 0);
  ASSERT_EQ(numVars[1], 1);
  ASSERT_EQ(numVars[2], 2);
  ASSERT_EQ(numVars[3], 3);
  numVars.clear();
  ASSERT_NO_THROW(t2w->getIndexesOfVariablesUsedForCalculatedVarI(ModelTwoWindingsTransformer::iS1ToS2Side2Num_, numVars, numVarsExternal));
  ASSERT_EQ(numVars.size(), 4);
  ASSERT_EQ(numVars[0], 0);
  ASSERT_EQ(numVars[1], 1);
  ASSERT_EQ(numVars[2], 2);
  ASSERT_EQ(numVars[3], 3);
  numVars.clear();
  ASSERT_NO_THROW(t2w->getIndexesOfVariablesUsedForCalculatedVarI(ModelTwoWindingsTransformer::iS2ToS1Side2Num_, numVars, numVarsExternal));
  ASSERT_EQ(numVars.size(), 4);
  ASSERT_EQ(numVars[0], 0);
  ASSERT_EQ(numVars[1], 1);
  ASSERT_EQ(numVars[2], 2);
  ASSERT_EQ(numVars[3], 3);
  numVars.clear();
  ASSERT_NO_THROW(t2w->getIndexesOfVariablesUsedForCalculatedVarI(ModelTwoWindingsTransformer::iSide1Num_, numVars, numVarsExternal));
  ASSERT_EQ(numVars.size(), 4);
  ASSERT_EQ(numVars[0], 0);
  ASSERT_EQ(numVars[1], 1);
  ASSERT_EQ(numVars[2], 2);
  ASSERT_EQ(numVars[3], 3);
  numVars.clear();
  ASSERT_NO_THROW(t2w->getIndexesOfVariablesUsedForCalculatedVarI(ModelTwoWindingsTransformer::iSide2Num_, numVars, numVarsExternal));
  ASSERT_EQ(numVars.size(), 4);
  ASSERT_EQ(numVars[0], 0);
  ASSERT_EQ(numVars[1], 1);
  ASSERT_EQ(numVars[2], 2);
  ASSERT_EQ(numVars[3], 3);
  numVars.clear();
  ASSERT_NO_THROW(t2w->getIndexesOfVariablesUsedForCalculatedVarI(ModelTwoWindingsTransformer::twtStateNum_, numVars, numVarsExternal));
