 ...
 *
 * All measurements of the network are connected to this model
 * but only the generators with a trure "running" are taken into account for the computations.
 *
 */
...
bool
ModelVoltageMeasurementsUtilities::isConnected(unsigned int iInputIdx) const {
  bool out = false;
