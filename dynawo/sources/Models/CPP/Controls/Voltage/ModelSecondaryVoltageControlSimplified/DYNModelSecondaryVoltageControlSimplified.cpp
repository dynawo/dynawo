...
constexpr double ModelSecondaryVoltageControlSimplified::LEVEL_MIN;  ///< Minimal admissible level
  ...
  void
  ModelSecondaryVoltageControlSimplified::evalJt(const double /*t*/, const double /*cj*/, SparseMatrix& /*jt*/, const int /*rowOffset*/) {
    /* not need */
  }
  ...
  void
  ModelSecondaryVoltageControlSimplified::evalJtPrim(const double /*t*/, const double /*cj*/, SparseMatrix& /*jt*/, const int /*rowOffset*/) {
    /* not need */
  }
