...
model YgYg "YgYg three phase transformer"
...
equation
  connect(Nonideal_Unit_A.Pin_i, Ph_a.pin_p) annotation (
    Line(points = {{-10, 66}, {-70, 66}, {-70, 66}, {-70, 66}}, color = {255, 0, 0}));
  ...
  connect(Nonideal_Unit_C.Pin_j, ground1.p) annotation (
    Line(points = {{-10, -80}, {-40, -80}, {-40, -86}}));
  connect(Nonideal_Unit_B.Pin_j, ground1.p) annotation (
    Line(points = {{-10, -20}, {-40, -20}, {-40, -86}}));
  connect(Nonideal_Unit_A.Pin_j, ground1.p) annotation (
    Line(points = {{-10, 46}, {-40, 46}, {-40, -86}}));
  connect(Nonideal_Unit_A.Pin_k, Ph_A.pin_p) annotation (
    Line(points = {{10, 66}, {58, 66}, {58, 66}, {58, 66}}, color = {238, 46, 47}, thickness = 0.5));
  ...
  connect(Nonideal_Unit_A.Pin_m, ground.p) annotation (
    Line(points = {{10, 46}, {40, 46}, {40, -86}, {40, -86}}, thickness = 0.5));
  connect(Nonideal_Unit_B.Pin_m, ground.p) annotation (
    Line(points = {{10, -20}, {40, -20}, {40, -86}, {40, -86}}, thickness = 0.5));
  connect(Nonideal_Unit_C.Pin_m, ground.p) annotation (
    Line(points = {{10, -80}, {40, -80}, {40, -86}, {40, -86}}, thickness = 0.5));
  annotation (
...
</body></html>"),defaultComponentName = "YgYg", Icon(graphics = {Text(origin = {-91, -25}, extent = {{-9, 9}, {9, -9}}, textString = "k"), Text(origin = {91, -23}, extent = {{-9, 9}, {9, -9}}, textString = "m"), Ellipse(origin = {42, 7}, lineColor = {0, 0, 255}, extent = {{-48, -49}, {32, 35}}, endAngle = 360), Line(origin = {65.86, 0}, points = {{8.1422, 0}, {26.1422, 0}}, color = {0, 0, 255}), Line(origin = {-4.78261, -1.30435}, points = {{-32, 0}, {-32, 10}}, color = {0, 0, 255}, thickness = 1), Line(origin = {-4.78261, -1.30435}, points = {{-32, 0}, {-40, -8}}, color = {0, 140, 72}, thickness = 1), Line(origin = {-4.78261, -1.30435}, points = {{-32, 0}, {-24, -8}}, color = {238, 46, 47}, thickness = 1), Ellipse(origin = {-24, 9}, lineColor = {0, 0, 255}, extent = {{-48, -49}, {32, 35}}, endAngle = 360), Line(origin = {-85, 0}, points = {{13, 0}, {-5, 0}, {-5, 0}}), Line(origin = {-4.78261, -1.30435}, points = {{-32, 0}, {-40, -8}}, color = {0, 140, 72}, thickness = 1), Line(origin = {-4.78261, -1.30435}, points = {{-32, 0}, {-24, -8}}, color = {238, 46, 47}, thickness = 1), Line(origin = {-4.78261, -1.30435}, points = {{-32, 0}, {-32, 10}}, color = {0, 0, 255}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-24, -8}}, color = {238, 46, 47}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-40, -8}}, color = {0, 140, 72}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-32, 10}}, color = {0, 0, 255}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-40, -8}}, color = {0, 140, 72}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-24, -8}}, color = {238, 46, 47}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-32, 10}}, color = {0, 0, 255}, thickness = 1), Text(origin = {-2, 8}, lineColor = {0, 0, 255}, extent = {{-150, 90}, {150, 50}}, textString = "%name"), Text(origin = {-31, -25}, extent = {{-9, 9}, {9, -9}}, textString = "1"), Text(origin = {37, -25}, extent = {{-9, 9}, {9, -9}}, textString = "2")}, coordinateSystem(initialScale = 0.1)),
    uses(Modelica(version = "3.2.3")),
    Diagram(graphics = {Text(origin = {-12, 92}, extent = {{-10, 8}, {36, -8}}, textString = "YgYg")}, coordinateSystem(initialScale = 0.1)));
end YgYg;
