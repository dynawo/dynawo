...
model YD01 "YD01/YD-30 three phase transformer"
...
equation
  ...
  connect(Nonideal_Unit_C.Pin_m, Nonideal_Unit_A.Pin_k) annotation (
    Line(points = {{10, -80}, {40, -80}, {40, 66}, {9, 66}, {9, 66}}, color = {238, 46, 47}, thickness = 0.5));
  connect(Nonideal_Unit_A.Pin_m, Nonideal_Unit_B.Pin_k) annotation (
    Line(points = {{10, 46}, {20, 46}, {20, 0}, {10, 0}, {10, 0}}, color = {0, 0, 255}, thickness = 0.5));
  ...
  connect(Nonideal_Unit_B.Pin_m, Nonideal_Unit_C.Pin_k) annotation (
    Line(points = {{10, -20}, {20, -20}, {20, -60}, {10, -60}, {10, -60}}, color = {0, 140, 72}, thickness = 0.5));
  ...
  connect(Nonideal_Unit_C.Pin_j, Nonideal_Unit_B.Pin_j) annotation (
    Line(points = {{-10, -80}, {-40, -80}, {-40, -20}, {-10, -20}, {-10, -20}}));
  annotation (
...
</body></html>"),defaultComponentName = "YD01",Icon(graphics = {Text(origin = {-91, -25}, extent = {{-9, 9}, {9, -9}}, textString = "k"), Text(origin = {91, -23}, extent = {{-9, 9}, {9, -9}}, textString = "m"), Ellipse(origin = {42, 9}, lineColor = {0, 0, 255}, extent = {{-48, -49}, {32, 35}}, endAngle = 360), Line(origin = {65.86, 0}, points = {{8.1422, 0}, {26.1422, 0}}, color = {0, 0, 255}), Line(points = {{-32, 0}, {-32, 10}}, color = {0, 0, 255}, thickness = 1), Line(points = {{-32, 0}, {-40, -8}}, color = {0, 140, 72}, thickness = 1), Line(points = {{-32, 0}, {-24, -8}}, color = {238, 46, 47}, thickness = 1), Line(origin = {-7.70642, -0.321101}, points = {{28, 8}, {28, -6}}, color = {28, 108, 200}, thickness = 1), Line(origin = {-1.92661, 0.642202}, points = {{22, 8}, {36, 0}}, color = {238, 46, 47}, thickness = 1), Line(origin = {-2.24771, -0.321101}, points = {{24, -6}, {36, 0}}, color = {0, 140, 72}, thickness = 1), Ellipse(origin = {-24, 9}, lineColor = {0, 0, 255}, extent = {{-48, -49}, {32, 35}}, endAngle = 360), Line(origin = {-85, 0}, points = {{13, 0}, {-5, 0}, {-5, 0}}, color = {0, 0, 255}), Text(origin = {-2, 8}, lineColor = {0, 0, 255}, extent = {{-150, 90}, {150, 50}}, textString = "%name"), Text(origin = {-31, -25}, extent = {{-9, 9}, {9, -9}}, textString = "1"), Text(origin = {37, -25}, extent = {{-9, 9}, {9, -9}}, textString = "2")}, coordinateSystem(initialScale = 0.1)),
    uses(Modelica(version = "3.2.3")),
    Diagram(graphics = {Text(origin = {-12, 92}, extent = {{-10, 8}, {36, -8}}, textString = "YD-30 or YD01")}, coordinateSystem(initialScale = 0.1)),
  Documentation);
end YD01;
