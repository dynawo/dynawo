...
model YgDD "3-phase 3-Winding transformer YgDD"
...
// base parameters
  ...
  final parameter Real R2 = (3/2) * (R[1]/S[1] - R[2]/S[2] + R[3]/S[3]) * S[1] * Z_b2 "Resistance on side 2";
  ...
  final parameter Real L2 = (3/2) * (X[1]/S[1] - X[2]/S[2] + X[3]/S[3]) * S[1] * Z_b2 / (2*pi*f) "Inductance on side 2";
  final parameter Real L3 = (3/2) * (-X[1]/S[1]+ X[2]/S[2] + X[3]/S[3]) * S[1] * Z_b3 / (2*pi*f) "Inductance on side 3";
  final parameter Real Ratio21 = (sqrt(3)* v[2]) / v[1] "winding 2:winding1";
  final parameter Real Ratio31 = (sqrt(3)* v[3]) / v[1] "winding 3:winding1";
  ...
  OpenEMTP.Electrical.Transformers.IdealUnit transformer1_a(g = Ratio21)  annotation (
    Placement(visible = true, transformation(origin = {0, 72}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  OpenEMTP.Electrical.Transformers.IdealUnit transformer2_a(g = Ratio31)  annotation (
  ...
  OpenEMTP.Electrical.Nonlinear.L_Nonlinear Lmag_a(T = MDD)  annotation (
  ...
  OpenEMTP.Electrical.Transformers.IdealUnit transformer2_b(g = Ratio31)  annotation (
    Placement(visible = true, transformation(origin = {12, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  OpenEMTP.Electrical.Transformers.IdealUnit transformer1_b(g = Ratio21)  annotation (
    Placement(visible = true, transformation(origin = {0, -18}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  OpenEMTP.Electrical.Nonlinear.L_Nonlinear Lmag_b(T = MDD)  annotation (
    Placement(visible = true, transformation(origin = {-26, -18}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  OpenEMTP.Electrical.RLC_Branches.R Rmag_b(R = Rm)  annotation (
  ...
  OpenEMTP.Electrical.Transformers.IdealUnit transforme1_c(g = Ratio21)  annotation (
    Placement(visible = true, transformation(origin = {0, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  OpenEMTP.Electrical.Transformers.IdealUnit transformer2_c(g = Ratio31)  annotation (
    Placement(visible = true, transformation(origin = {12, -130}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  OpenEMTP.Electrical.Nonlinear.L_Nonlinear Lmag_c(T = MDD)  annotation (
    Placement(visible = true, transformation(origin = {-24, -100}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  OpenEMTP.Electrical.RLC_Branches.R Rmag_c(R = Rm)  annotation (
  ...
  OpenEMTP.Electrical.RLC_Branches.RL RL3_c(L = L3, R = R3)  annotation (
  ...
  Modelica.Electrical.MultiPhase.Basic.PlugToPin_p Ph_2c(k = 3, m = 3) annotation (
...
equation
  connect(Ph_1b.plug_p, k) annotation (
    Line(points = {{-86, 0}, {-100, 0}, {-100, 0}, {-100, 0}}, color = {0, 0, 255}));
  connect(Ph_1a.plug_p, k) annotation (
    Line(points = {{-92, 92}, {-100, 92}, {-100, 0}, {-100, 0}}, color = {238, 46, 47}));
  connect(Ph_2a.plug_p, m) annotation (
    Line(points = {{114, 92}, {122, 92}, {122, 0}}, color = {238, 46, 47}, thickness = 0.5));
  ...
  connect(RL2_a.n, Ph_2a.pin_p) annotation (
    Line(points = {{60, 92}, {110, 92}}, color = {238, 46, 47}, thickness = 0.5));
  ...
  connect(Ph_1b.pin_p, RL1_b.p) annotation (
    Line(points = {{-82, 0}, {-70, 0}, {-70, 0}, {-70, 0}}, color = {0, 0, 255}));
  ...
  connect(transformer1_a.n2, Ph_2b.pin_p) annotation (
    Line(points = {{10, 62}, {86, 62}, {86, 0}, {86, 0}}, color = {0, 0, 255}, thickness = 0.5));
  connect(transformer1_b.n2, Ph_2c.pin_p) annotation (
    Line(points = {{10, -28}, {92, -28}, {92, -80}, {92, -80}}, color = {0, 140, 72}, thickness = 0.5));
  connect(transforme1_c.n2, Ph_2a.pin_p) annotation (
    Line(points = {{10, -110}, {110, -110}, {110, 92}, {110, 92}}, color = {238, 46, 47}, thickness = 0.5));
  annotation (
...
</body></html>"),defaultComponentName = "YgDD", Icon(graphics = {Text(origin = {-91, -25}, extent = {{-9, 9}, {9, -9}}, textString = "1"), Ellipse(origin = {44, 31}, lineColor = {0, 0, 255}, extent = {{-48, -49}, {32, 35}}, endAngle = 360), Line(origin = {68.449, 27.6164}, points = {{8.1422, 0}, {26.1422, 0}}, color = {0, 0, 255}), Line(origin = {-4.78261, -1.30435}, points = {{-32, 0}, {-32, 10}}, color = {0, 0, 255}, thickness = 1), Line(origin = {-4.78261, -1.30435}, points = {{-32, 0}, {-40, -8}}, color = {0, 140, 72}, thickness = 1), Line(origin = {-4.78261, -1.30435}, points = {{-32, 0}, {-24, -8}}, color = {238, 46, 47}, thickness = 1), Ellipse(origin = {-24, 9}, lineColor = {0, 0, 255}, extent = {{-48, -49}, {32, 35}}, endAngle = 360), Line(origin = {-85, 0}, points = {{13, 0}, {-5, 0}, {-5, 0}}, color = {0, 0, 255}), Line(origin = {-4.78261, -1.30435}, points = {{-32, 0}, {-40, -8}}, color = {0, 140, 72}, thickness = 1), Line(origin = {-4.78261, -1.30435}, points = {{-32, 0}, {-24, -8}}, color = {238, 46, 47}, thickness = 1), Line(origin = {-4.78261, -1.30435}, points = {{-32, 0}, {-32, 10}}, color = {0, 0, 255}, thickness = 1), Text(origin = {-4, 16}, lineColor = {0, 0, 255}, extent = {{-150, 90}, {150, 50}}, textString = "%name"), Ellipse(origin = {44, -29}, lineColor = {0, 0, 255}, extent = {{-48, -49}, {32, 35}}, endAngle = 360), Text(origin = {97, 11}, extent = {{-9, 9}, {9, -9}}, textString = "2"), Text(origin = {99, -59}, extent = {{-9, 9}, {9, -9}}, textString = "3"), Line(origin = {-0.844396, 33.6559}, points = {{22, 8}, {36, 0}}, color = {238, 46, 47}, thickness = 1), Line(origin = {-1.1655, 32.6926}, points = {{24, -6}, {36, 0}}, color = {0, 140, 72}, thickness = 1), Line(origin = {-6.6242, 32.6926}, points = {{28, 8}, {28, -6}}, color = {28, 108, 200}, thickness = 1), Line(origin = {68.3805, -40.9178}, points = {{8.1422, 0}, {26.1422, 0}}, color = {0, 0, 255}), Line(origin = {-2.09701, -49.6499}, points = {{24, -6}, {36, 0}}, color = {0, 140, 72}, thickness = 1), Line(origin = {-1.7759, -48.6866}, points = {{22, 8}, {36, 0}}, color = {238, 46, 47}, thickness = 1), Line(origin = {-7.55571, -49.6499}, points = {{28, 8}, {28, -6}}, color = {28, 108, 200}, thickness = 1)}, coordinateSystem(initialScale = 0.1)),
    uses(Modelica(version = "3.2.3")),
    Diagram(graphics = {Text(origin = {-12, 118}, extent = {{-10, 8}, {36, -8}}, textString = "YgDD")}, coordinateSystem(initialScale = 0.1)));
end YgDD;
