...
model DY11 "DY11/DY+30 three phase transformer"
...
</body></html>"),defaultComponentName = "DY11", Icon(graphics = {Text(origin = {-91, -25}, extent = {{-9, 9}, {9, -9}}, textString = "k"), Text(origin = {91, -23}, extent = {{-9, 9}, {9, -9}}, textString = "m"), Text(origin = {-2, 8}, lineColor = {0, 0, 255}, extent = {{-150, 90}, {150, 50}}, textString = "%name"), Ellipse(origin = {42, 9}, lineColor = {0, 0, 255}, extent = {{-48, -49}, {32, 35}}, endAngle = 360), Ellipse(origin = {-24, 9}, lineColor = {0, 0, 255}, extent = {{-48, -49}, {32, 35}}, endAngle = 360), Line(origin = {65.86, 0}, points = {{8.1422, 0}, {26.1422, 0}}, color = {0, 0, 255}), Line(origin = {-84.863, -0.287671}, points = {{13, 0}, {-5, 0}, {-5, 0}}, color = {0, 0, 255}), Line(origin = {-63.8444, -0.0016336}, points = {{22, 8}, {36, 0}}, color = {238, 46, 47}, thickness = 1), Line(origin = {-64.1655, -0.964937}, points = {{24, -6}, {36, 0}}, color = {0, 140, 72}, thickness = 1), Line(origin = {-69.6242, -0.964937}, points = {{28, 8}, {28, -6}}, color = {28, 108, 200}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-40, -8}}, color = {0, 140, 72}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-24, -8}}, color = {238, 46, 47}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-32, 10}}, color = {0, 0, 255}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-40, -8}}, color = {0, 140, 72}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-32, 10}}, color = {0, 0, 255}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-24, -8}}, color = {238, 46, 47}, thickness = 1), Text(origin = {-31, -25}, extent = {{-9, 9}, {9, -9}}, textString = "1"), Text(origin = {37, -25}, extent = {{-9, 9}, {9, -9}}, textString = "2")}, coordinateSystem(initialScale = 0.1)),
    uses(Modelica(version = "3.2.3")),
    Diagram(graphics = {Text(origin = {8, 94}, extent = {{-54, 4}, {36, -8}}, textString = "Delta-Y transformer, +30 on secondary
Dy11 connection"), Text(origin = {-14, 80}, extent = {{-10, 8}, {36, -8}}, textString = "3 identical non-ideal units")}, coordinateSystem(initialScale = 0.1)));
end DY11;
