...
model DYg01 "DYg01/DYg-30 three phase transformer"
...
equation
  connect(Ph_a.plug_p, k) annotation (
    Line(points = {{-74, 66}, {-100, 66}, {-100, 0}, {-100, 0}}, color = {255, 0, 0}, thickness = 0.5));
  connect(Ph_b.plug_p, k) annotation (
    Line(points = {{-72, 0}, {-98, 0}, {-98, 0}, {-100, 0}}, color = {0, 0, 255}, thickness = 0.5));
  connect(Ph_c.plug_p, k) annotation (
    Line(points = {{-72, -60}, {-100, -60}, {-100, -2}, {-100, -2}, {-100, 0}}, color = {0, 140, 72}, thickness = 0.5));
  connect(Nonideal_Unit_A.Pin_k, Ph_A.pin_p) annotation (
    Line(points = {{10, 66}, {58, 66}}, color = {238, 46, 47}));
  connect(Ph_A.plug_p, m) annotation (
    Line(points = {{62, 66}, {100, 66}, {100, 0}, {100, 0}}, color = {238, 46, 47}));
  connect(m, Ph_B.plug_p) annotation (
    Line(points = {{100, 0}, {62, 0}, {62, 0}, {62, 0}}, color = {0, 0, 255}));
  connect(Ph_C.plug_p, m) annotation (
    Line(points = {{62, -60}, {100, -60}, {100, 0}, {100, 0}}, color = {0, 140, 72}));
  connect(Nonideal_Unit_A.Pin_i, Ph_a.pin_p) annotation (
    Line(points = {{-10, 66}, {-70, 66}}, color = {238, 46, 47}, thickness = 0.5));
  connect(Ph_b.pin_p, Nonideal_Unit_B.Pin_i) annotation (
    Line(points = {{-68, 0}, {-10, 0}}, color = {0, 0, 255}, thickness = 0.5));
  connect(Ph_c.pin_p, Nonideal_Unit_C.Pin_i) annotation (
    Line(points = {{-68, -60}, {-10, -60}}, color = {0, 140, 72}, thickness = 0.5));
  ...
  connect(Ph_C.pin_p, Nonideal_Unit_C.Pin_k) annotation (
    Line(points = {{58, -60}, {10, -60}}, color = {0, 140, 72}));
  connect(Nonideal_Unit_A.Pin_m, Nonideal_Unit_C.Pin_m) annotation (
    Line(points = {{10, 46}, {40, 46}, {40, -80}, {10, -80}}));
  connect(Nonideal_Unit_B.Pin_m, Nonideal_Unit_C.Pin_m) annotation (
    Line(points = {{10, -20}, {40, -20}, {40, -80}, {10, -80}}));
  connect(Nonideal_Unit_A.Pin_j, Nonideal_Unit_C.Pin_i) annotation (
    Line(points = {{-10, 46}, {-20, 46}, {-20, -60}, {-10, -60}}, color = {0, 140, 72}, thickness = 0.5));
  connect(Nonideal_Unit_C.Pin_j, Ph_b.pin_p) annotation (
    Line(points = {{-10, -80}, {-36, -80}, {-36, 0}, {-68, 0}, {-68, 0}}, color = {0, 0, 255}, thickness = 0.5));
  connect(Nonideal_Unit_B.Pin_j, Nonideal_Unit_A.Pin_i) annotation (
    Line(points = {{-10, -20}, {-52, -20}, {-52, 66}, {-10, 66}, {-10, 66}}, color = {255, 0, 0}, thickness = 0.5));
  connect(ground.p, Nonideal_Unit_C.Pin_m) annotation (
    Line(points = {{40, -86}, {40, -86}, {40, -80}, {10, -80}, {10, -80}}));
  annotation (
...
</body></html>"),defaultComponentName = "DYg01", Icon(graphics = {Text(origin = {-91, -25}, extent = {{-9, 9}, {9, -9}}, textString = "k"), Text(origin = {91, -23}, extent = {{-9, 9}, {9, -9}}, textString = "m"), Text(origin = {-2, 8}, lineColor = {0, 0, 255}, extent = {{-150, 90}, {150, 50}}, textString = "%name"), Ellipse(origin = {42, 9}, lineColor = {0, 0, 255}, extent = {{-48, -49}, {32, 35}}, endAngle = 360), Ellipse(origin = {-24, 9}, lineColor = {0, 0, 255}, extent = {{-48, -49}, {32, 35}}, endAngle = 360), Line(origin = {65.86, 0}, points = {{8.1422, 0}, {26.1422, 0}}, color = {0, 0, 255}), Line(origin = {-84.863, -0.287671}, points = {{13, 0}, {-5, 0}, {-5, 0}}, color = {0, 0, 255}), Line(origin = {-63.8444, -0.0016336}, points = {{22, 8}, {36, 0}}, color = {238, 46, 47}, thickness = 1), Line(origin = {-64.1655, -0.964937}, points = {{24, -6}, {36, 0}}, color = {0, 140, 72}, thickness = 1), Line(origin = {-69.6242, -0.964937}, points = {{28, 8}, {28, -6}}, color = {28, 108, 200}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-40, -8}}, color = {0, 140, 72}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-24, -8}}, color = {238, 46, 47}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-32, 10}}, color = {0, 0, 255}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-40, -8}}, color = {0, 140, 72}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-32, 10}}, color = {0, 0, 255}, thickness = 1), Line(origin = {69.5652, 0.869563}, points = {{-32, 0}, {-24, -8}}, color = {238, 46, 47}, thickness = 1), Text(origin = {-31, -25}, extent = {{-9, 9}, {9, -9}}, textString = "1"), Text(origin = {37, -25}, extent = {{-9, 9}, {9, -9}}, textString = "2")}, coordinateSystem(initialScale = 0.1)),
    uses(Modelica(version = "3.2.3")),
    Diagram(graphics = {Text(origin = {8, 94}, extent = {{-54, 4}, {36, -8}}, textString = "Delta-Y transformer, -30 on secondary
Dyg1"), Text(origin = {-14, 80}, extent = {{-10, 8}, {36, -8}}, textString = "3 identical non-ideal units")}, coordinateSystem(initialScale = 0.1)));
end DYg01;
