...
model ParallelLines
  ...
  OpenEMTP.Electrical.Switches.IdealSwitch idealSwitch(Tclosing = 0, Topening = 50e-3) annotation(
  ...
  OpenEMTP.Electrical.Lines.CPmodel.SP_TLM TLM2(Zc = 295.4, d = 200000, r = 3.151e-2, tau = 6.806e-4) annotation(
    Placement(visible = true, transformation(origin = {-2, -20}, extent = {{-15, -11}, {15, 11}}, rotation = 0)));
  OpenEMTP.Electrical.Switches.IdealSwitch idealSwitch1(Tclosing = 400e-3, Topening = 2) annotation(
    Placement(visible = true, transformation(origin = {-44, 46}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  OpenEMTP.Electrical.Switches.IdealSwitch SW1(Tclosing = 400e-3, Topening = 2) annotation(
...
equation
  ...
  connect(idealSwitch.pin_n, L.p) annotation(
    Line(points = {{128, 0}, {138, 0}, {138, -14}, {138, -14}}, color = {0, 0, 255}));
  ...
  connect(idealSwitch1.pin_p, BRk1.pin_p) annotation(
    Line(points = {{-54, 46}, {-60, 46}, {-60, 20}, {-54, 20}, {-54, 20}}, color = {0, 0, 255}));
  connect(idealSwitch1.pin_n, BRk1.pin_n) annotation(
    Line(points = {{-32, 46}, {-24, 46}, {-24, 20}, {-32, 20}, {-32, 20}}, color = {0, 0, 255}));
  connect(SW1.pin_p, BRm1.pin_p) annotation(
    Line(points = {{32, 46}, {26, 46}, {26, 20}, {32, 20}, {32, 20}}, color = {0, 0, 255}));
  connect(SW1.pin_n, BRm1.pin_n) annotation(
    Line(points = {{54, 46}, {60, 46}, {60, 20}, {54, 20}, {54, 20}}, color = {0, 0, 255}));
  ...
  connect(SW2.pin_p, SW1.pin_p) annotation(
    Line(points = {{18, 74}, {16, 74}, {16, 46}, {32, 46}}, color = {0, 0, 255}));
  ...
  connect(idealSwitch.pin_p, BRm1.pin_n) annotation(
    Line(points = {{106, 0}, {60, 0}, {60, 20}, {54, 20}, {54, 20}, {54, 20}}, color = {0, 0, 255}));
  connect(TLM2.pin_k, SW.pin_n) annotation(
    Line(points = {{-16, -20}, {-60, -20}, {-60, 0}, {-72, 0}, {-72, 0}}, color = {0, 0, 255}));
  connect(SW3.pin_p, idealSwitch.pin_p) annotation(
    Line(points = {{84, -6}, {84, -6}, {84, 0}, {106, 0}, {106, 0}}, color = {0, 0, 255}));
