...
model PlugToPlug
  ...
  parameter Integer n[k]={1, 3} "Selecte the index phases";
  Integer rangeo[m] = kofm(m, k, n);
...
positivePlugIn.pin[1].i = -positivePlugOut.pin[n[1]].i;
positivePlugIn.pin[3].i = -positivePlugOut.pin[n[3]].i;
