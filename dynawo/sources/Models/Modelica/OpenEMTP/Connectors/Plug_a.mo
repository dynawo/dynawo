...
equation
  pin_p.v = plug_p.pin[1].v;
  for j in 1:3 loop
    plug_p.pin[j].i = if j == 1 then -pin_p.i else 0;
  end for;

  annotation (defaultComponentName="Plug_a", Icon(coordinateSystem(preserveAspectRatio=false, initialScale = 0.1), graphics={Line(points = {{-20, 20}, {40, 20}, {40, -20}, {-20, -20}}), Rectangle(lineColor = {0, 0, 255}, fillColor = {238, 46, 47}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-20, 20}, {40, -20}}), Ellipse(fillColor = {238, 46, 47}, fillPattern = FillPattern.Solid, extent = {{-40, 20}, {0, -20}}, endAngle = 360), Line(points = {{-20, 20}, {40, 20}, {40, -20}, {-20, -20}}), Text(lineColor = {0, 0, 255}, extent = {{-150, 40}, {150, 80}}, textString = "%name")}),
