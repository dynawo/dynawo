...
package Types "Standard types for electrical variables"
  ...
  // Voltage
  record Voltage = Complex(redeclare VoltageComponent re "Real part of complex voltage", redeclare VoltageComponent im "Imaginary part of complex voltage") "Complex voltage";
  ...
  // Current
  record Current = Complex(redeclare CurrentComponent re "Real part of complex current", redeclare CurrentComponent im "Imaginary part of complex current") "Complex current";
  ...
  // Power
  record ApparentPower = Complex(redeclare ActivePower re "Real part of complex apparent power", redeclare ReactivePower im "Imaginary part of complex apparent power") "Complex apparent power";
  ...
  // PerUnit
  record ComplexPerUnit = Complex(redeclare PerUnit re "Real part of complex per unit quantity", redeclare PerUnit im "Imaginary part of complex per unit quantity") "Complex per unit";
