...
connector ACPower "Connector for AC power (described using complex V and i variables)"
  ...
  annotation(preferredView = "text", Icon(graphics = {Rectangle(lineColor = {0, 0, 255}, fillColor = {0, 170, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 98}, {100, -102}})}, coordinateSystem(initialScale = 0.1)));
end ACPower;
