...
block Power "Outputs a power of the input"
  ...
  final parameter Boolean IsInteger = (n == floor(n));
...
<p>If n is not an integer number, then:</p><p>&nbsp; y = abs(u) ^ n</p><p>The output is thus always calculable.</p>
