...
annotation(
  ...
  Documentation(info = "<html><head></head><body><p>This block computes the output <strong>y</strong> as the <strong>u2</strong>th power&nbsp;of&nbsp;<strong>u1</strong>:</p><pre>  y = u1 ^ u2</pre><p>It is necessary to have either u2 integer or u1 strictly positive.</p></body></html>"));
