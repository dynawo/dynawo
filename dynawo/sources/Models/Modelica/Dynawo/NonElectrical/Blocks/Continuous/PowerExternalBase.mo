...
block PowerExternalBase "Outputs a power of the input"
  /*
  ...
  */
  ...
  RealInput n "Exponent of the power function" annotation (Placement(
        visible = true, transformation(origin = {0, 36}, extent = {{-140, -20}, {-100, 20}}, rotation = 0)));
