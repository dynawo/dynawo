...
block AntiWindupIntegratorNoRateLimit "Integrator with absolute and rate limits, anti windup and anti winddown"
  /*
...
equation
  ...
  annotation(
    ...
    Diagram(coordinateSystem(extent = {{-240, 140}, {220, -140}})));
end AntiWindupIntegratorNoRateLimit;
