...
block MultiSwitchFive
  ...
  Modelica.Blocks.Interfaces.RealInput u3 "Connector of fourth Real input signal" annotation(
    Placement(visible = true, transformation(origin = {-120, -40}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-110, -42}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput u4 "Connector of fifth Real input signal" annotation(
...
equation
  ...
  y = if M==4 then u4 elseif M==3 then u3 elseif M==2 then u2 elseif M==1 then u1 else u0;
...
u1, else it is set equal to u3.</p>
    ...
    Icon(coordinateSystem(
        initialScale = 0.1), graphics={Rectangle(fillColor = {186, 189, 182}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {-83, -41}, extent = {{-13, 13}, {13, -13}}, textString = "3"), Text(origin = {-83, 77}, extent = {{-13, 13}, {13, -13}}, textString = "0"), Text(origin = {-83, -79}, extent = {{-13, 13}, {13, -13}}, textString = "4"), Text(origin = {-83, 39}, extent = {{-13, 13}, {13, -13}}, textString = "1"), Text(origin = {-83, -1}, extent = {{-13, 13}, {13, -13}}, textString = "2")}));
