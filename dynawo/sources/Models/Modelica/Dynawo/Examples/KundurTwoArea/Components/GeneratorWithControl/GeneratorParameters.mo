...
record GeneratorParameters "Parameter sets for the generators of the Nordic 32 test system"
  ...
  */
  ...
  final constant Real[genFramePreset, genParams] genParamValues = {{800.0, 760.0, 0.002, 0.15, 1.10, 0.70, 0.25, 1.0, 0.20, 0.20, 5.0, 1.0, 0.05, 0.10, 3.0, 6.0257, 6.0257, 0.1, 0.1}, // g01, Hydro
  ...
  // KSigma, Kp, Ki, PNom
  final constant Real[genFramePreset, govParams] govParamValues = {{0.04, 2, 0.4, 760.0}, // g01 Hydro power plant, with speed governor
  ...
  final constant Real[genFramePreset, vrParams] vrParamValues = {{1.8991, 0, -11.0, 70.0, 10.0, 20.0, 4.0, 75.0, 15.0, 0.20, 0.010}, // g01
