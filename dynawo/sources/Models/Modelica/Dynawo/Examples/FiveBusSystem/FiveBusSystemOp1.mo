...
model FiveBusSystemOp1 "Five-bus system operating point 1"
  ...
  Dynawo.Electrical.Loads.LoadAlphaBetaTwoMotorSimplified load(ActiveMotorShare = ActiveMotorShare, Alpha = Alpha, Beta = Beta, H = H, PLoad0Pu(fixed = false), QLoad0Pu(fixed = false), RrPu = RrPu, RsPu = RsPu, XmPu = XmPu, XrPu = XrPu, XsPu = XsPu, ce0Pu(fixed = false), i0Pu(re(fixed = false), im(fixed = false)), im0Pu(each re(fixed = false), each im(fixed = false)), ir0Pu(each re(fixed = false), each im(fixed = false)), is0Pu(each re(fixed = false), each im(fixed = false)), motori0Pu(each re(fixed = false), each im(fixed = false)), motors0Pu(each re(fixed = false), each im(fixed = false)), omegaR0Pu(fixed = false), s0(fixed = false), s0Pu(re(fixed = false), im(fixed = false)), torqueExponent = torqueExponent, u0Pu(re(fixed = false), im(fixed = false))) annotation(
