...
model FiveBusSystem "Five-bus system"
  ...
  //Dynawo.Electrical.Buses.InfiniteBusBis grid(UPhase = 0, UNom = 225) annotation(
  //Placement(visible = true, transformation(origin = {-140, 60}, extent = {{-16, -16}, {16, 16}}, rotation = 90)));

  Dynawo.Electrical.Buses.InfiniteBus grid(UPhase = 0, UNom = 225, UPu = 1.02) annotation(
    Placement(visible = true, transformation(origin = {-140, 60}, extent = {{-16, -16}, {16, 16}}, rotation = 90)));
...
equation
  ...
  //if time < faultEnd then false else true;
