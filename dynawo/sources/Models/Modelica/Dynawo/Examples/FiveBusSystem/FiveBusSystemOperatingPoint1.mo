...
Dynawo.Electrical.Controls.Basics.SetPoint Omega0Pu(Value0 = 1);
  ...
  // Governor
  Dynawo.Electrical.Controls.Machines.Governors.Standard.Steam.GovSteam govSteam(FHp = 0.4, FMp = 0.3, PNomTurb = 460, Pm0Pu = gen.Pm0Pu, Sigma = 0.04, ZMaxPu = 1, ZMinPu = 0, dZMaxPu = 0.05, dZMinPu = -0.05, Ivo = 1, tHp = 0.3, tLp = 0.3, tMeas = 0.1, tR = 5, tSm = 0.4)  annotation(
    Placement(visible = true, transformation(origin = {86, -32}, extent = {{-22, -16}, {22, 16}}, rotation = 0)));
...
equation
  ...
  connect(PRef.y, govSteam.PRefPu) annotation(
    Line(points = {{47, -14}, {60.5, -14}, {60.5, -22}, {60, -22}}, color = {0, 0, 127}));
  ...
  connect(voltageRegulatorPssOel.EfdPu, gen.efdPu_in) annotation(
    Line(points = {{132, -72}, {148, -72}, {148, -54}, {114, -54}, {114, -48}}, color = {0, 0, 127}));
  connect(govSteam.PmPu, gen.PmPu_in) annotation(
    Line(points = {{110, -32}, {108, -32}, {108, -56}, {126, -56}, {126, -48}}, color = {0, 0, 127}));
  connect(gen.IRotorPu_out, voltageRegulatorPssOel.ifPu) annotation(
    Line(points = {{124, -30}, {122, -30}, {122, 2}, {24, 2}, {24, -96}, {64, -96}, {64, -80}, {72, -80}}, color = {0, 0, 127}));
  connect(gen.omegaPu_out, govSteam.omegaPu) annotation(
    Line(points = {{130, -42}, {158, -42}, {158, -52}, {34, -52}, {34, -42}, {60, -42}}, color = {0, 0, 127}));
  connect(gen.omegaPu_out, voltageRegulatorPssOel.omegaPu) annotation(
    Line(points = {{130, -42}, {66, -42}, {66, -66}, {72, -66}}, color = {0, 0, 127}));
  connect(gen.UsPu_out, voltageRegulatorPssOel.UsPu) annotation(
    Line(points = {{130, -30}, {138, -30}, {138, -58}, {52, -58}, {52, -70}, {72, -70}}, color = {0, 0, 127}));
