...
import Modelica.Constants.pi;
  ...
  Dynawo.Electrical.Buses.InfiniteBusWithVariations BusInfinite(U0Pu = 0.98, UEvtPu = 1.01, UPhase = 0, omega0Pu = 1, omegaEvtPu = -1.8, tOmegaEvtEnd = tOmegaEvtEnd, tOmegaEvtStart = tOmegaEvtStart, tUEvtEnd = tMagnitudeEvtEnd, tUEvtStart = tMagnitudeEvtstart) annotation(
  ...
  Modelica.Blocks.Sources.BooleanExpression booleanExpression2(y = true) annotation(
    Placement(visible = true, transformation(origin = {-22850, 5645}, extent = {{-984, 509}, {984, -509}}, rotation = 0)));
  Modelica.Blocks.Sources.BooleanExpression SiteActivation(y = false)  annotation(
