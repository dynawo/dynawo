within Dynawo.Examples.GFM_Rfgv2Tests.FaultThreePhaseSymetric;

model VSM_CurrentLimiting
  ...
  parameter Types.Time tOmegaEvtEnd = 20.0001;
  parameter Types.Time tMagnitudeEvtstart = 100;
  parameter Types.Time tMagnitudeEvtEnd = 100 + 0.5;
  ...
  Types.PerUnit IpccModule;
  Types.PerUnit IpccAngle;
  Types.PerUnit IQ;
  Types.PerUnit IP;
  Types.PerUnit Upcc;
  ...
  Dynawo.Electrical.Buses.InfiniteBusWithVariations BusInfinite(U0Pu = 0.99, UEvtPu = 0.94, UPhase = 0, omega0Pu = 1, omegaEvtPu = 20, tOmegaEvtEnd = tOmegaEvtEnd, tOmegaEvtStart = tOmegaEvtStart, tUEvtEnd = tMagnitudeEvtEnd, tUEvtStart = tMagnitudeEvtstart) annotation(
    Placement(visible = true, transformation(origin = {-6, -52}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Controls.Converters.GFM_VSM_cc_v3Prope_ForRLFilter gFM_VSM_cc(ActiveAngleBloc = true, AmortisementVSM = 0.7, CFilter = 0.00001, CurrentAngle0 = CurrentAngle0, CurrentModule0 = CurrentModule0, DeltaVVId0 = DeltaVVId0, DeltaVVIq0 = DeltaVVIq0, FDampingLC = 60, Fsw = 5000, Gffv = 0.8, H = 3, Imax = 1.2, Imax_XVI = 1.4, Ith_XVI = 1, LFilter = 0.15, LTransformer = 0.06, Lv_QSEM = 0, Mq = 0, PFilter0Pu = PFilter0Pu, PGen0Pu = PGen0Pu, PMesure0Pu = PMesure0Pu, PRef0Pu = PRef0Pu, QFilter0Pu = QFilter0Pu, QGen0Pu = QGen0Pu, QMesure0Pu = QMesure0Pu, QRef0Pu = QRef0Pu, RVI0 = RVI0, R_LCL = 0, Rv = 0, SNom = Sbase1, SigmaXR = 5, SwitchOffSignal10 = false, UFilterRef0Pu = UFilterRef0Pu, UPolar0Pu = UPolar0Pu, UPolarPhase0 = UPolarPhase0, WPLL = 100, W_CurrentLimit = 10000, Wnc = 1000, Wqsem = 100, Wref_FromPLL = true, XVI0 = XVI0, XVInduct = 0, i0Pu = i0Pu, idConv0Pu = idConv0Pu, idConvRef0Pu = idConvRef0Pu, idConvSatRef0Pu = idConvSatRef0Pu, idPcc0Pu = idPcc0Pu, iqConv0Pu = iqConv0Pu, iqConvRef0Pu = iqConvRef0Pu, iqConvSatRef0Pu = iqConvSatRef0Pu, iqPcc0Pu = iqPcc0Pu, omega0Pu = omega0Pu, omegaPLL0Pu = omegaPLL0Pu, omegaRef0Pu = omegaRef0Pu, omegaSetSelected0Pu = omegaSetSelected0Pu, theta0 = theta0, u0Pu = u0Pu, udConv0Pu = udConv0Pu, udConvRef0Pu = udConvRef0Pu, udFilter0Pu = udFilter0Pu, udFilterRef0Pu = udFilterRef0Pu, udPcc0Pu = udPcc0Pu, uqConv0Pu = uqConv0Pu, uqConvRef0Pu = uqConvRef0Pu, uqFilter0Pu = uqFilter0Pu, uqFilterRef0Pu = uqFilterRef0Pu, uqPcc0Pu = uqPcc0Pu) annotation(
    Placement(visible = true, transformation(origin = {-2, 36}, extent = {{-36, -36}, {36, 36}}, rotation = 0)));
  Dynawo.Electrical.Events.NodeFault nodeFault(RPu = RFault, XPu = XFault, tBegin = 10, tEnd = 11) annotation(
...
/*Current calculs in dq */
  IpccModule = sqrt(gFM_VSM_cc.VSC.idPccPu ^ 2 + gFM_VSM_cc.VSC.iqPccPu ^ 2);
  IpccAngle = atan2(gFM_VSM_cc.VSC.iqPccPu, gFM_VSM_cc.VSC.idPccPu);
/*Active and Reactive Current*/
  IQ = gFM_VSM_cc.measurementPcc.QGenPu / Upcc;
  IP = gFM_VSM_cc.measurementPcc.PGenPu / Upcc;
