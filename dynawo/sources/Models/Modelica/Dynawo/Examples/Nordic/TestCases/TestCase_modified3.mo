...
model TestCase_modified3 "Nordic test system case with variable reference frequency"
  extends Examples.Nordic.Grid.FullDynamicModel_modified3(
    Alpha = 1,
    Beta = 2,
    P0Pu_g01 = -6,
    P0Pu_g02 = -3,
