...
<<<<<<< HEAD:dynawo/sources/Models/Modelica/Dynawo/Examples/Nordic/TestCases/TestCase.mo
...
=======
    Documentation(info = "<html><head></head><body><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">This test case is meant to investigate the long term dynamic response of the Nordic 32 test system, operating point A, regarding a contingency. This particular test case corresponds to the setup presented in Chapter 3.1 of the IEEE Technical Report \"Test Systems for Voltage Stability Analysis and Security Assessment\" from August, 2015.</span><div><font face=\"MS Shell Dlg 2\">OmegaRef of the generators is set to the center of inertia of the whole system.</font></div><div><font face=\"MS Shell Dlg 2\">The simulation runs in DAEmode, starts at t = 0 s, ends at t = 166.8 s (just before crashing) and uses the euler solver with a step size of 0.01 s and a tolerance of 0.005.<br></font><div><font face=\"MS Shell Dlg 2\">At t = 1 s, a node fault occurs at bus 4032, which is cleared by tripping line 4032-4044&nbsp;</font><span style=\"font-family: 'MS Shell Dlg 2';\">after 0.1 s</span>.</div><div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">While voltage remains more or less stable at buses 4012 and 4062, voltage keeps dropping at buses 1041 and 1042, until the voltage collapses ~160 s later.</div></div></div></body></html>"));
end TestCaseA;
>>>>>>> #2616 Adding operating point B, which is stable:dynawo/sources/Models/Modelica/Dynawo/Examples/Nordic/TestCases/TestCaseA.mo
