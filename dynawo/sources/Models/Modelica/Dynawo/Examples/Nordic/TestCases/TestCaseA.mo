...
equation
  omegaCOI = omegaCOINum / omegaCOIDen;

  annotation(
    preferredView = "diagram",
    experiment(StartTime = 0, StopTime = 168.4, Tolerance = 0.005, Interval = 0.01),
