...
model TestCase10InjectorsWith1Condenser "Nordic test system case with variable reference frequency"
  extends Grid.FullDynamicModel10InjectorsWith1Condenser(
    Alpha = 1,
    Beta = 2,
    P0Pu_g01 = -6,
    P0Pu_g02 = -3,
...
end TestCase10InjectorsWith1Condenser;
