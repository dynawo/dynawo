...
model TestCaseB "Nordic test system case with variable reference frequency (operating point B)"
  ...
  Dynawo.Electrical.Events.NodeFault nodeFault(RPu = 40 / 400 ^ 2 * SystemBase.SnRef, XPu = 40 / 400 ^ 2 * SystemBase.SnRef, tBegin = 1000, tEnd = 1000.1);
  Dynawo.Electrical.Events.Event.SingleBooleanEvent disconnection(stateEvent1 = true, tEvent = 1000.1);
  ...
  GeneratorWithControl.GeneratorSynchronousFourWindingsWithControl g16b(P0Pu = 0, Q0Pu = -0.498946, U0Pu = 1.0531, UPhase0 = -0.320135, gen = GeneratorWithControl.GeneratorParameters.genFramePreset.g16) annotation(
...
equation
  ...
  annotation(preferredView = "diagram",
    experiment(StartTime = 0, StopTime = 200, Tolerance = 0.005, Interval = 0.01),
