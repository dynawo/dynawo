...
model TestCaseB "Nordic test system case with variable reference frequency (operating point B)"
  ...
  extends Dynawo.Examples.Nordic.Grid.FullDynamicModelB;
  ...
  Dynawo.Electrical.Events.NodeFault nodeFault(RPu =  40 / 400 ^ 2 * SystemBase.SnRef, XPu =  40 / 400 ^ 2 * SystemBase.SnRef, tBegin = 1000, tEnd = 1001.1);
  Dynawo.Electrical.Events.Event.SingleBooleanEvent disconnection(stateEvent1 = true, tEvent = 1001.1);
...
equation
  ...
  annotation(preferredView = "diagram",
    experiment(StartTime = 0, StopTime = 1000, Tolerance = 0.005, Interval = 0.01),
