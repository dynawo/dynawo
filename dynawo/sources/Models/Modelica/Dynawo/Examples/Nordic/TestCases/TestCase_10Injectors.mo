...
model TestCase_10Injectors "Nordic test system case with variable reference frequency"
  extends Grid.FullDynamicModel_10Injectors(
    Alpha = 1,
    Beta = 2,
    P0Pu_g01 = -6,
    P0Pu_g02 = -3,
