...
model FullDynamicModelB "Nordic test grid with buses, lines, shunts, voltage-dependent loads, transformers and generators (operating point B)"
  ...
  Dynawo.Examples.Nordic.Components.GeneratorWithControl.GeneratorSynchronousFourWindingsWithControl g16b(P0Pu = P0Pu_g16, Q0Pu = Q0Pu_g16b, U0Pu = U0Pu_g16, UPhase0 = UPhase0_g16, gen = Data.GeneratorParameters.genFramePreset.g16) annotation(
