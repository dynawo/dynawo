...
protected
  ...
  final parameter Types.ReactivePowerPu Q0Pu_g01b = -0.20841;
  final parameter Types.Angle UPhase0_g01b = 0.33648;
  // Generator g02 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g02b = -0.198489;
  final parameter Types.Angle UPhase0_g02b = 0.384177;
  // Generator g03 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g03b = -0.0897223;
  final parameter Types.Angle UPhase0_g03b = 0.472476;
  // Generator g04 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g04b = -0.162969;
  final parameter Types.Angle UPhase0_g04b = 0.51642;
  // Generator g05 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g05b = -0.27873;
  final parameter Types.Angle UPhase0_g05b = 0.172729;
  // Generator g06 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g06b = 0.8899;
  final parameter Types.Angle UPhase0_g06b = -0.364191;
  // Generator g07 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g07b = -0.140849;
  final parameter Types.Angle UPhase0_g07b = -0.523565;
  // Generator g08 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g08b = 1.26953;
  final parameter Types.Angle UPhase0_g08b = 0.205415;
  // Generator g09 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g09b = 0.356058;
  final parameter Types.Angle UPhase0_g09b = 0.26949;
  // Generator g10 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g10b = 1.52318;
  final parameter Types.Angle UPhase0_g10b = 0.308662;
  // Generator g11 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g11b = -0.767623;
  final parameter Types.Angle UPhase0_g11b = -0.022193;
  // Generator g12 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g12b = -0.595041;
  final parameter Types.Angle UPhase0_g12b = -0.0474042;
  // Generator g13 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g13b = -1.24859;
  final parameter Types.Angle UPhase0_g13b = -0.357367;
  // Generator g14 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g14b = 0.259356;
  final parameter Types.Angle UPhase0_g14b = -0.263414;
  // Generator g15 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g15b = 1.33093;
  final parameter Types.Angle UPhase0_g15b = -0.277906;
  // Generator g16 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g16b = 0.498946;
  final parameter Types.Angle UPhase0_g16b = -0.320135;
  // Generator g17 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g17b = -0.271439;
  final parameter Types.Angle UPhase0_g17b = -0.182998;
  // Generator g18 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g18b = 2.16394;
  final parameter Types.Angle UPhase0_g18b = -0.120982;
  // Generator g19 init values:
  // Q0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_g19b = 1.17235;
  final parameter Types.Angle UPhase0_g19b = 0.129745;
  // Generator g20 init values:
  // P0Pu, Q0Pu in SnRef, receptor convention
  final parameter Types.ActivePowerPu P0Pu_g20b = -1.5374;
  final parameter Types.ReactivePowerPu Q0Pu_g20b = -3.76498;
  final parameter Types.Angle UPhase0_g20b = 0;

  // load_01 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_01b = 1.482;
  final parameter Types.Angle UPhase0_load_01b = -0.768272;
  ...
  // load_02 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_02b = 0.71;
  final parameter Types.Angle UPhase0_load_02b = -0.552757;
  ...
  // load_03 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_03b = 0.838;
  final parameter Types.Angle UPhase0_load_03b = -0.70266;
  ...
  // load_04 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_04b = 2.52;
  final parameter Types.Angle UPhase0_load_04b = -0.569653;
  ...
  // load_05 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_05b = 1.904;
  final parameter Types.Angle UPhase0_load_05b = -0.594378;
  ...
  // load_11 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_11b = 0.688;
  final parameter Types.Angle UPhase0_load_11b = 0.136679;
  ...
  // load_12 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_12b = 0.838;
  final parameter Types.Angle UPhase0_load_12b = 0.190344;
  ...
  // load_13 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_13b = 0.344;
  final parameter Types.Angle UPhase0_load_13b = 0.26868;
  ...
  // load_22 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_22b = 0.799;
  final parameter Types.Angle UPhase0_load_22b = 0.0167541;
  ...
  // load_31 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_31b = 0.247;
  final parameter Types.Angle UPhase0_load_31b = -0.171672;
  ...
  // load_32 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_32b = 0.396;
  final parameter Types.Angle UPhase0_load_32b = 0.0354461;
  ...
  // load_41 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_41b = 1.314;
  final parameter Types.Angle UPhase0_load_41b = -0.401732;
  ...
  // load_42 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_42b = 1.274;
  final parameter Types.Angle UPhase0_load_42b = -0.431432;
  ...
  // load_43 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_43b = 2.546;
  final parameter Types.Angle UPhase0_load_43b = -0.513156;
  ...
  // load_46 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_46b = 2.118;
  final parameter Types.Angle UPhase0_load_46b = -0.522753;
  ...
  // load_47 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_47b = 0.44;
  final parameter Types.Angle UPhase0_load_47b = -0.449247;
  ...
  // load_51 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_51b = 2.582;
  final parameter Types.Angle UPhase0_load_51b = -0.482062;
  ...
  // load_61 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_61b = 1.225;
  final parameter Types.Angle UPhase0_load_61b = -0.431346;
  ...
  // load_62 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_62b = 0.838;
  final parameter Types.Angle UPhase0_load_62b = -0.358965;
  ...
  // load_63 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_63b = 2.646;
  final parameter Types.Angle UPhase0_load_63b = -0.296299;
  ...
  // load_71 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_71b = 0.838;
  final parameter Types.Angle UPhase0_load_71b = -0.00666291;
  ...
  // load_72 init values:
  //s0Pu, i0Pu in SnRef, receptor convention
  final parameter Types.ReactivePowerPu Q0Pu_load_72b = 3.961;
  final parameter Types.Angle UPhase0_load_72b = -0.0944849;
  ...
  final parameter Types.Angle UPhase0_shunt_1022b = 0.0617031;
  ...
  // negative values for capacitors, positive values for inductors (reversed in PESTR)
  final parameter Types.Angle UPhase0_shunt_1041b = -0.724707;
  ...
  // negative values for capacitors, positive values for inductors (reversed in PESTR)
  final parameter Types.Angle UPhase0_shunt_1043b = -0.652779;
  ...
  // negative values for capacitors, positive values for inductors (reversed in PESTR)
  final parameter Types.Angle UPhase0_shunt_1044b = -0.523876;
  ...
  // negative values for capacitors, positive values for inductors (reversed in PESTR)
  final parameter Types.Angle UPhase0_shunt_1045b = -0.548682;
  ...
  // negative values for capacitors, positive values for inductors (reversed in PESTR)
  final parameter Types.Angle UPhase0_shunt_4012b = 0.196975;
  ...
  // negative values for capacitors, positive values for inductors (reversed in PESTR)
  final parameter Types.Angle UPhase0_shunt_4041b = -0.357367;
  ...
  // negative values for capacitors, positive values for inductors (reversed in PESTR)
  final parameter Types.Angle UPhase0_shunt_4043b = -0.468773;
  ...
  // negative values for capacitors, positive values for inductors (reversed in PESTR)
  final parameter Types.Angle UPhase0_shunt_4046b = -0.477581;
  ...
  // negative values for capacitors, positive values for inductors (reversed in PESTR)
  final parameter Types.Angle UPhase0_shunt_4051b = -0.436666;
  ...
  // negative values for capacitors, positive values for inductors (reversed in PESTR)
  final parameter Types.Angle UPhase0_shunt_4071b = 0.0422263;
