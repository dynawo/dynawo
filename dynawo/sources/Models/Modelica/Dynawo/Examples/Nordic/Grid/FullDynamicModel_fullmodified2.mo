...
model FullDynamicModel_fullmodified2
  ...
  Components.GeneratorWithControl.InjectorIDQWithControl Inj01(P0Pu = P0Pu_g01, Q0Pu = Q0Pu_g01, U0Pu = U0Pu_g01, UPhase0 = UPhase0_g01, i0Pu = ComplexMath.conj(Complex(P0Pu_g01, Q0Pu_g01)/ComplexMath.fromPolar(U0Pu_g01, UPhase0_g01)), Id0Pu = (ComplexMath.real(Inj01.i0Pu)*cos(UPhase0_g01) + ComplexMath.imag(Inj01.i0Pu)*sin(UPhase0_g01))*(SystemBase.SnRef/Inj01.Snom), Iq0Pu = -(ComplexMath.real(Inj01.i0Pu)*sin(UPhase0_g01) - ComplexMath.imag(Inj01.i0Pu)*cos(UPhase0_g01))*(SystemBase.SnRef/Inj01.Snom), s0Pu = Complex(P0Pu_g01, Q0Pu_g01), u0Pu = ComplexMath.fromPolar(U0Pu_g01, UPhase0_g01), Imax = 1, Snom = 800)  annotation(
    Placement(transformation(origin = {25, 77}, extent = {{-3, -3}, {3, 3}})));
  Components.GeneratorWithControl.InjectorIDQWithControl Inj02(P0Pu = P0Pu_g02, Q0Pu = Q0Pu_g02, U0Pu = U0Pu_g02, UPhase0 = UPhase0_g02, i0Pu = ComplexMath.conj(Complex(P0Pu_g02, Q0Pu_g02)/ComplexMath.fromPolar(U0Pu_g02, UPhase0_g02)), Id0Pu = (ComplexMath.real(Inj02.i0Pu)*cos(UPhase0_g02) + ComplexMath.imag(Inj02.i0Pu)*sin(UPhase0_g02))*(SystemBase.SnRef/Inj02.Snom), Iq0Pu = -(ComplexMath.real(Inj02.i0Pu)*sin(UPhase0_g02) - ComplexMath.imag(Inj02.i0Pu)*cos(UPhase0_g02))*(SystemBase.SnRef/Inj02.Snom), s0Pu = Complex(P0Pu_g02, Q0Pu_g02), u0Pu = ComplexMath.fromPolar(U0Pu_g02, UPhase0_g02), Imax = 1, Snom = 600)  annotation(
    Placement(transformation(origin = {75, 159}, extent = {{-3, -3}, {3, 3}})));
  Components.GeneratorWithControl.InjectorIDQWithControl Inj03(P0Pu = P0Pu_g03, Q0Pu = Q0Pu_g03, U0Pu = U0Pu_g03, UPhase0 = UPhase0_g03, i0Pu = ComplexMath.conj(Complex(P0Pu_g03, Q0Pu_g03)/ComplexMath.fromPolar(U0Pu_g03, UPhase0_g03)), Id0Pu = (ComplexMath.real(Inj03.i0Pu)*cos(UPhase0_g03) + ComplexMath.imag(Inj03.i0Pu)*sin(UPhase0_g03))*(SystemBase.SnRef/Inj03.Snom), Iq0Pu = -(ComplexMath.real(Inj03.i0Pu)*sin(UPhase0_g03) - ComplexMath.imag(Inj03.i0Pu)*cos(UPhase0_g03))*(SystemBase.SnRef/Inj03.Snom), s0Pu = Complex(P0Pu_g03, Q0Pu_g03), u0Pu = ComplexMath.fromPolar(U0Pu_g03, UPhase0_g03), Imax = 1, Snom = 700)  annotation(
    Placement(transformation(origin = {85, 77}, extent = {{-3, -3}, {3, 3}})));
  Components.GeneratorWithControl.InjectorIDQWithControl Inj05(P0Pu = P0Pu_g05, Q0Pu = Q0Pu_g05, U0Pu = U0Pu_g05, UPhase0 = UPhase0_g05, i0Pu = ComplexMath.conj(Complex(P0Pu_g05, Q0Pu_g05)/ComplexMath.fromPolar(U0Pu_g05, UPhase0_g05)), Id0Pu = (ComplexMath.real(Inj05.i0Pu)*cos(UPhase0_g05) + ComplexMath.imag(Inj05.i0Pu)*sin(UPhase0_g05))*(SystemBase.SnRef/Inj05.Snom), Iq0Pu = -(ComplexMath.real(Inj05.i0Pu)*sin(UPhase0_g05) - ComplexMath.imag(Inj05.i0Pu)*cos(UPhase0_g05))*(SystemBase.SnRef/Inj05.Snom), s0Pu = Complex(P0Pu_g05, Q0Pu_g05), u0Pu = ComplexMath.fromPolar(U0Pu_g05, UPhase0_g05), Imax = 1, Snom = 250)  annotation(
    Placement(transformation(origin = {-45, 73}, extent = {{-3, -3}, {3, 3}})));
  Components.GeneratorWithControl.InjectorIDQWithControl Inj06(P0Pu = P0Pu_g06, Q0Pu = Q0Pu_g06, U0Pu = U0Pu_g06, UPhase0 = UPhase0_g06, i0Pu = ComplexMath.conj(Complex(P0Pu_g06, Q0Pu_g06)/ComplexMath.fromPolar(U0Pu_g06, UPhase0_g06)), Id0Pu = (ComplexMath.real(Inj06.i0Pu)*cos(UPhase0_g06) + ComplexMath.imag(Inj06.i0Pu)*sin(UPhase0_g06))*(SystemBase.SnRef/Inj06.Snom), Iq0Pu = -(ComplexMath.real(Inj06.i0Pu)*sin(UPhase0_g06) - ComplexMath.imag(Inj06.i0Pu)*cos(UPhase0_g06))*(SystemBase.SnRef/Inj06.Snom), s0Pu = Complex(P0Pu_g06, Q0Pu_g06), u0Pu = ComplexMath.fromPolar(U0Pu_g06, UPhase0_g06), Imax = 1, Snom = 400)  annotation(
    Placement(transformation(origin = {35, -57}, extent = {{-3, -3}, {3, 3}})));
  ...
  Components.GeneratorWithControl.InjectorIDQWithControl Inj10(P0Pu = P0Pu_g10, Q0Pu = Q0Pu_g10, U0Pu = U0Pu_g10, UPhase0 = UPhase0_g10, i0Pu = ComplexMath.conj(Complex(P0Pu_g10, Q0Pu_g10)/ComplexMath.fromPolar(U0Pu_g10, UPhase0_g10)), Id0Pu = (ComplexMath.real(Inj10.i0Pu)*cos(UPhase0_g10) + ComplexMath.imag(Inj10.i0Pu)*sin(UPhase0_g10))*(SystemBase.SnRef/Inj10.Snom), Iq0Pu = -(ComplexMath.real(Inj10.i0Pu)*sin(UPhase0_g10) - ComplexMath.imag(Inj10.i0Pu)*cos(UPhase0_g10))*(SystemBase.SnRef/Inj10.Snom), s0Pu = Complex(P0Pu_g10, Q0Pu_g10), u0Pu = ComplexMath.fromPolar(U0Pu_g10, UPhase0_g10), Imax = 1, Snom = 800)  annotation(
    Placement(transformation(origin = {-35, 79}, extent = {{-3, 3}, {3, -3}}, rotation = -0)));
  Components.GeneratorWithControl.InjectorIDQWithControl Inj11(P0Pu = P0Pu_g11, Q0Pu = Q0Pu_g11, U0Pu = U0Pu_g11, UPhase0 = UPhase0_g11, i0Pu = ComplexMath.conj(Complex(P0Pu_g11, Q0Pu_g11)/ComplexMath.fromPolar(U0Pu_g11, UPhase0_g11)), Id0Pu = (ComplexMath.real(Inj11.i0Pu)*cos(UPhase0_g11) + ComplexMath.imag(Inj11.i0Pu)*sin(UPhase0_g11))*(SystemBase.SnRef/Inj11.Snom), Iq0Pu = -(ComplexMath.real(Inj11.i0Pu)*sin(UPhase0_g11) - ComplexMath.imag(Inj11.i0Pu)*cos(UPhase0_g11))*(SystemBase.SnRef/Inj11.Snom), s0Pu = Complex(P0Pu_g11, Q0Pu_g11), u0Pu = ComplexMath.fromPolar(U0Pu_g11, UPhase0_g11), Imax = 1, Snom = 300)  annotation(
    Placement(transformation(origin = {35, 73}, extent = {{-3, -3}, {3, 3}})));
  Components.GeneratorWithControl.InjectorIDQWithControl Inj12(P0Pu = P0Pu_g12, Q0Pu = Q0Pu_g12, U0Pu = U0Pu_g12, UPhase0 = UPhase0_g12, i0Pu = ComplexMath.conj(Complex(P0Pu_g12, Q0Pu_g12)/ComplexMath.fromPolar(U0Pu_g12, UPhase0_g12)), Id0Pu = (ComplexMath.real(Inj12.i0Pu)*cos(UPhase0_g12) + ComplexMath.imag(Inj12.i0Pu)*sin(UPhase0_g12))*(SystemBase.SnRef/Inj12.Snom), Iq0Pu = -(ComplexMath.real(Inj12.i0Pu)*sin(UPhase0_g12) - ComplexMath.imag(Inj12.i0Pu)*cos(UPhase0_g12))*(SystemBase.SnRef/Inj12.Snom), s0Pu = Complex(P0Pu_g12, Q0Pu_g12), u0Pu = ComplexMath.fromPolar(U0Pu_g12, UPhase0_g12), Imax = 1, Snom = 350)  annotation(
    Placement(transformation(origin = {-3, 43}, extent = {{-3, -3}, {3, 3}})));
  Dynawo.Electrical.Buses.Bus bus_BSC1042 annotation(
    Placement(transformation(origin = {24, -95}, extent = {{-5, -5}, {5, 5}})));
  Dynawo.Electrical.Transformers.TransformersFixedTap.TransformerFixedRatio trafo_SC1042_40411(BPu = 0, GPu = 0, RPu = 0, XPu = 0.10*1.05^2*(100/300.0), rTfoPu = 1.05) annotation(
  ...
  Dynawo.Examples.Nordic.Components.GeneratorWithControl.GeneratorSynchronousThreeWindingsWithControl SC1042(P0Pu = P0Pu_g13, Q0Pu = Q0Pu_g13, U0Pu = U0Pu_g06, UPhase0 = UPhase0_g06, gen = GeneratorWithControl.GeneratorParameters.genFramePreset.g13) annotation(
    Placement(transformation(origin = {24, -99}, extent = {{-3, -3}, {3, 3}})));
equation
  Inj01.VReg = ComplexMath.abs(bus_1012.terminal.V);
  Inj02.VReg = ComplexMath.abs(bus_1013.terminal.V);
  Inj03.VReg = ComplexMath.abs(bus_1014.terminal.V);
  Inj05.VReg = ComplexMath.abs(bus_1022.terminal.V);
  Inj06.VReg = ComplexMath.abs(bus_1042.terminal.V);
  Inj07.VReg = ComplexMath.abs(bus_1043.terminal.V);
  Inj09.VReg = ComplexMath.abs(bus_4011.terminal.V);
  Inj10.VReg = ComplexMath.abs(bus_4012.terminal.V);
  Inj11.VReg = ComplexMath.abs(bus_4021.terminal.V);
  Inj12.VReg = ComplexMath.abs(bus_4031.terminal.V);
  ...
  trafo_SC1042_40411.switchOffSignal1.value = false;
  trafo_SC1042_40411.switchOffSignal2.value = false;
  ...
  connect(Inj01.terminal, bus_BG01.terminal) annotation(
    Line(points = {{25, 77}, {25, 85}}, color = {0, 0, 255}));
  connect(Inj02.terminal, bus_BG02.terminal) annotation(
    Line(points = {{75, 159}, {75, 145}}, color = {0, 0, 255}));
  connect(Inj03.terminal, bus_BG03.terminal) annotation(
    Line(points = {{85, 77}, {85, 85}}, color = {0, 0, 255}));
  connect(bus_BG05.terminal, Inj05.terminal) annotation(
    Line(points = {{-45, 65}, {-45, 73}}, color = {0, 0, 255}));
  connect(bus_BG06.terminal, Inj06.terminal) annotation(
    Line(points = {{35, -65}, {35, -57}}, color = {0, 0, 255}));
  connect(bus_BG07.terminal, Inj07.terminal) annotation(
    Line(points = {{-53, -45}, {-53, -37}}, color = {0, 0, 255}));
  ...
  connect(bus_BG11.terminal, Inj11.terminal) annotation(
    Line(points = {{35, 65}, {35, 73}}, color = {0, 0, 255}));
  connect(bus_BG12.terminal, Inj12.terminal) annotation(
    Line(points={{-4,35},{-4,39},{-3,39},{-3,43}},          color = {0, 0, 255}));
  connect(trafo_SC1042_40411.terminal2, bus_1042.terminal) annotation(
    Line(points = {{24, -82}, {24, -80}, {30, -80}}, color = {0, 0, 255}));
  connect(bus_BSC1042.terminal, trafo_SC1042_40411.terminal1) annotation(
    Line(points={{24,-95},{24,-92}},      color = {0, 0, 255}));
  connect(SC1042.terminal, bus_BSC1042.terminal) annotation(
    Line(points={{24,-99},{24,-95}},      color = {0, 0, 255}));
  connect(g13.terminal, bus_BG13.terminal) annotation(
    Line(points = {{-70, -28}, {-70, -24}}, color = {0, 0, 255}));
  annotation(
...
end FullDynamicModel_fullmodified2;
