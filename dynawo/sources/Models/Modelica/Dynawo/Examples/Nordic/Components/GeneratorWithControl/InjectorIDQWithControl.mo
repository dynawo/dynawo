...
model InjectorIDQWithControl
  ...
  ElectricalControlNordic electricalControlNordic(t1 = 1, t2 = 1, t3 = 1, t4 = 1, t5 = 1, t6 = 1, Kp = 5, Ki = 0.1, Imax = Imax, Vt0 = U0Pu, Q0Pu = Q0Pu, P0Pu = P0Pu, U0Pu = U0Pu, baseratio = 100/Snom, Iq0Pu = Iq0Pu) annotation(
