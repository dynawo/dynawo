...
model InjectorIDQWithControl
  ...
  Types.AngularVelocityPu omegaCOI;
  Types.VoltageModulePu VtPu(start = U0Pu);
  ...
  ElectricalControlNordic electricalControlNordic(t1 = 1, t2 = 1, t3 = 1, t4 = 1, t5 = 1, t6 = 1, Kp = 5, Ki = 0.1, IMaxPu = IMaxPu, Vt0Pu = U0Pu, Q0Pu = Q0Pu, P0Pu = P0Pu, U0Pu = U0Pu, BaseRatio = 100 / SNom, Iq0Pu = Iq0Pu) annotation(
  ...
  Modelica.Blocks.Sources.RealExpression realExpression3(y = omegaCOI) annotation(
...
equation
  ...
  connect(realExpression2.y, electricalControlNordic.VtRefPu) annotation(
  ...
  connect(realExpression4.y, electricalControlNordic.PRefPu) annotation(
