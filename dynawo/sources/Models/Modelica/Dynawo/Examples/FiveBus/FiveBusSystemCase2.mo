...
model FiveBusSystemCase2
  ...
  */
  ...
  Dynawo.Electrical.Controls.Transformers.TapChanger tap_changer(regulating0 = true, t1st = 25., tNext = 10., tapMax = 32, tapMin = 0, UDeadBand = 0.015, UTarget = 1.0038, U0 = 1.0038, tap0 = 14, state0 = Dynawo.Electrical.Controls.Transformers.BaseClasses.TapChangerPhaseShifterParams.State.Standard, increaseTapToIncreaseValue = true);
  // Load
  // init values:
  ...
  Modelica.Blocks.Sources.Ramp UsRefPu(duration = 2, height = 0.05, offset = voltageRegulatorPssOel.UsRef0Pu, startTime = 61)  annotation(
...
// Plot
  ...
  connect(UsRefPu.y, voltageRegulatorPssOel.UsRefPu) annotation(
    Line(points = {{54, -78}, {72, -78}, {72, -76}}, color = {0, 0, 127}));
  annotation(
