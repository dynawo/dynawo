...
model FiveBusSystemCase4
  ...
  */
  ...
  Dynawo.Electrical.Lines.Line line1_3(BPu = 0.000195 * ZBASE225, GPu = 0. * ZBASE225, RPu = 4.16 / ZBASE225, XPu = 41.6 / ZBASE225) annotation(
    Placement(visible = true, transformation(origin = {-28, 60}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
...
// Line
  ...
  line1_3.switchOffSignal2.value = if time < 61.08 then false else true;
...
// Plot
  ...
  connect(line1_3.terminal1, bus_1.terminal) annotation(
    Line(points = {{-44, 60}, {-60, 60}, {-60, 40}, {-80, 40}}, color = {0, 0, 255}));
  ...
  connect(line1_3.terminal2, bus_3.terminal) annotation(
    Line(points = {{-12, 60}, {-5, 60}, {-5, 40}, {4, 40}}, color = {0, 0, 255}));
