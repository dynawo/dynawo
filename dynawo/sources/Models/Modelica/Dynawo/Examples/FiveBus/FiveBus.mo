...
model FiveBus
  ...
  // Generator
  Dynawo.Examples.BaseClasses.InitializedGeneratorSynchronousThreeWindings gen(ExcitationPu = Dynawo.Electrical.Machines.OmegaRef.BaseClasses.GeneratorSynchronousParameters.ExcitationPuType.Kundur, md = 0.1, mq = 0.1, nd = 6.0257, nq = 6.0257, DPu = 0., H = 4., RaPu = 0., XlPu = 0.15, XdPu = 2.2, XpdPu = 0.3, XppdPu = 0.2, Tpd0 = 7., Tppd0 = 0.05, XqPu = 2.0, XpqPu = 0.4, Tpq0 = 1.5, Tppq0 = 0.05, UNom = 15., SNom = 500., PNomTurb = 460., PNomAlt = 460., SnTfo = 500., UNomHV = 231.75, UNomLV = 15., UBaseHV = 225, UBaseLV = 15., RTfPu = 0., XTfPu = 0.15, P0Pu = -4.5, Q0Pu = -0.06, U0Pu = 1.0184, UPhase0 = 0.1466076571675237) annotation(
  ...
  parameter Dynawo.Types.VoltageModulePu U0PuLoad1 = 1.0038; //1.2??
  parameter Dynawo.Types.Angle UPhase0Load1 = 0.03141592653;//0.31??
  ...
  Dynawo.Electrical.Transformers.TransformerRatioTapChanger tfo(BPu = 0., GPu = 0., NbTap = 33, P10Pu = 1.52, Q10Pu = 0.05, RPu = 0., RatioTfoMaxPu = 1.2, RatioTfoMinPu = 0.88, Tap0 = 15, U10Pu = 1.0154, XPu = 0.15) annotation(
    Placement(visible = true, transformation(origin = {18, -6}, extent = {{-14, -14}, {14, 14}}, rotation = -90)));
...
equation
  ...
  connect(tfo.terminal1, bus_3.terminal) annotation(
    Line(points = {{18, 8}, {4, 8}, {4, 42}}, color = {0, 0, 255}));
