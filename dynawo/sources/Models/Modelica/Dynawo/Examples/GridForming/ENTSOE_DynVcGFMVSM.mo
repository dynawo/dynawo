...
model ENTSOE_DynVcGFMVSM
 ...
 Electrical.Lines.Line line(BPu = 0, GPu = 0, RPu = 0.000166667, XPu = 0.1)  annotation(
  ...
  Modelica.Blocks.Sources.Step PRefPu(height = 0, offset = 0.5, startTime = 5)  annotation(
    Placement(visible = true, transformation(origin = {-112, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
 Dynawo.Electrical.PEIR.Converters.General.Average.GridForming.DynVcGFMVSM dynVcGFMVSM(CFilterPu = 1e-5, H = 3, IMaxVI = 1.2, Kff = 0, KpVI = 0.21, LFilterPu = 0.15, LTransformerPu = 0.06, Mq = 0, OmegaSetPu = 1, P0Pu = -7.4663, Q0Pu = 0.4119, RFilterPu = 0.015, RTransformerPu = 0.006, SNom = 100, U0Pu = 1, UPhase0 = 0.0374, Wf = 31.4159, Wff = 60, XRratio = 10, kVSM = 80, tVSC = 0.0004) annotation(
