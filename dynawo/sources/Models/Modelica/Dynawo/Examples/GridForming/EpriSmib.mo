...
model EpriSmib "Single machine infinite bus test case for EPRI Grid Forming model"
  ...
  Dynawo.Electrical.Controls.Converters.EpriGFM.EpriGFM epriGfm(BPu = 0, DD = 0.11, DeltaOmegaMaxPu = 75 / 314.15, DeltaOmegaMinPu = -75 / 314.15, GPu = 0, IMaxPu = 1.05, IdConv0Pu = 0.660022, IqConv0Pu = -0.0229981, K1 = 0.05, K2 = 0.2, K2Dvoc = 1e-9, KD = 0.033 * 0.11 * 0, KIPll = 700, KIi = 5, KIp = 10, KIv = 10, KPPll = 20, KPi = 0.5, KPp = 2, KPv = 2, LFilterPu = 0.15, MF = 0.15, OmegaDroopPu = 0.05, OmegaFlag = 1, OmegaMaxPu = 1.5, OmegaMinPu = 0.5, PFilter0Pu = 0.657, PQflag = true, PRef0Pu = 0.657, Pref0Pu = 0.657, QDroopPu = 0.2, QFilter0Pu = 0.0228928, QRef0Pu = 0.0228928, RFilterPu = 0.00015, RPu = 0.00015, SNom = 100, Theta0 = 0.188732, UDipPu = 0.8, UFilterRef0Pu = 0.995421, UdConv0Pu = 0.99897, UdFilter0Pu = 0.995421, UqConv0Pu = 0.0989998, UqFilter0Pu = 0, XPu = 0.15, i0Pu = Complex(0, 0), tE = 0.01, tF = 0.15 * 0.033 * 1e-9, tR = 0.005, tV = 1e-9, u0Pu = Complex(1.0, 0)) annotation(
