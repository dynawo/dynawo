...
model EpriSmib
  ...
  Dynawo.Electrical.Buses.InfiniteBusWithVariations infiniteBus(U0Pu = 1, UEvtPu = 0.5, UPhase = 0, omega0Pu = 1, omegaEvtPu = 0.999, tOmegaEvtEnd = 20, tOmegaEvtStart = 10, tUEvtEnd = 12, tUEvtStart = 10) annotation(
