...
model DynGFMCCVSMSmib "Single machine infinite bus test case for Grid Forming VSM model with dynamic filter and transformer"
  ...
  Electrical.PEIR.Converters.General.Average.GridForming.DynGFMCCVSM DynGFMCCVSM(CFilterPu = 1e-05, H = 5, IMaxVI = 2.0, Kfd = 0.8, Kff = 0, Kfq = 0, KpVI = 0.6, LFilterPu = 0.15, LTransformerPu = 0.06, Mq = 0.2, P0Pu = -4.984866248786608, Q0Pu = 0.011096011585512544, RFilterPu = 0.015, RTransformerPu = 0.006, SNom = 1000, U0Pu = 0.9924931047635974, UPhase0 = 0.25390369952200464, Wf = 31.4159, Wff = 60, XRratio = 10, XVI = 0.06, kVSM = 650, OmegaSetPu = 1, tVSC = 0.0004, omegaNPLL = 100, ZetaPLL = 1, omegaC = 1000, KDampingAngle = 1, W_CurrentLimit = 10000, Imax = 1.2, Imin = 0, DeltaIConvMaxPu = 0.15) annotation(
...
equation
  ...
  connect(omegaRefPu.y, AcGrid.OmegaRef) annotation(
    Line(points = {{-100, 20}, {-56, 20}, {-56, 67}, {64, 67}}, color = {0, 0, 127}));
  connect(AcGrid.aCPower, line.terminal2) annotation(
    Line(points = {{87.5, 69}, {87.5, 0}, {88, 0}}, color = {0, 0, 255}));
  ...
  connect(DynGFMCCVSM.terminal, measurements.terminal1) annotation(
    Line(points = {{14, 0}, {30, 0}}, color = {0, 0, 255}));
  connect(measurements.terminal2, line.terminal1) annotation(
    Line(points = {{50, 0}, {68, 0}}, color = {0, 0, 255}));
  annotation(
