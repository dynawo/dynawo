...
model DynGFMVSMSmibConvPLL "Single machine infinite bus test case for Grid Forming VSM model with dynamic filter and transformer"
  ...
  Dynawo.Electrical.Buses.InfiniteBusWithVariations_PhaseJump infiniteBusWithVariations_PhaseJump1(U0Pu = 1, UEvtPu = 1, UPhase = 0, dUPhaseEvt = -0.46, omega0Pu = 1, omegaEvtPu = 1, tOmegaEvtEnd = 0, tOmegaEvtStart = 0, tUEvtEnd = 0, tUEvtStart = 0, tUPhaseEvt = 10) annotation(
...
equation
  ...
  connect(DynGFMVSMConvPLL.terminal, line.terminal1) annotation(
    Line(points = {{6, -1}, {19, -1}, {19, -2}, {36, -2}}, color = {0, 0, 255}));
  ...
  connect(omegaRefPu.y, AcGrid.OmegaRef) annotation(
    Line(points = {{-100, 20}, {-60, 20}, {-60, 70}, {32, 70}}, color = {0, 0, 127}));
  connect(PRefPu.y, DynGFMVSMConvPLL.PFilterRefPu) annotation(
    Line(points = {{-102, 56}, {-44, 56}, {-44, 18}}, color = {0, 0, 127}));
  connect(AcGrid.aCPower, line.terminal2) annotation(
    Line(points = {{56, 70}, {56, -2}}, color = {0, 0, 255}));
  annotation(
