...
model GridForming_test_4_v2_Syncr "Grid Forming converters test case"
  /*
  ...
  Modelica.Blocks.Sources.Step step(height = 1, offset = 0, startTime = 0) annotation(
    Placement(visible = true, transformation(origin = {-5467, 1060}, extent = {{-125, -125}, {125, 125}}, rotation = 0)));
  Modelica.Blocks.Sources.Step step1(height = 1, offset = 0, startTime = 0) annotation(
    Placement(visible = true, transformation(origin = {-5465, 601}, extent = {{-125, -125}, {125, 125}}, rotation = 0)));
  ...
  Dynawo.Examples.GridForming.synchronisation synchronisation(Mp = Mp, WLP = WLP, WPLL = WPLL, Wref_FromPLL = false) annotation(
    Placement(visible = true, transformation(origin = {-1857, 1213}, extent = {{-243, -243}, {243, 243}}, rotation = 0)));
  Modelica.Blocks.Sources.Step step3(height = 1, offset = 0, startTime = 0) annotation(
    Placement(visible = true, transformation(origin = {-4129, 1378}, extent = {{-125, -125}, {125, 125}}, rotation = 0)));
  Modelica.Blocks.Sources.Step step4(height = 0.2, offset = 0.8, startTime = 10) annotation(
    Placement(visible = true, transformation(origin = {-3668, 1887}, extent = {{-125, -125}, {125, 125}}, rotation = 0)));
equation
...
//    Line(points = {{-259, 174}, {-228, 174}, {-228, 196}}, color = {0, 0, 127}));
  ...
  connect(step.y, voltagePOI.UFilterRefPu) annotation(
    Line(points = {{-5329.5, 1060}, {-4952, 1060}, {-4952, 742}, {-4563, 742}}, color = {0, 0, 127}));
  connect(step1.y, voltagePOI.QRefPu) annotation(
    Line(points = {{-5327.5, 601}, {-5029, 601}, {-5029, 614}, {-4563, 614}}, color = {0, 0, 127}));
  ...
  connect(synchronisation.theta, measurementPcc.theta) annotation(
    Line(points = {{-1590, 1335}, {412, 1335}, {412, 571}}, color = {0, 0, 127}));
  connect(step3.y, synchronisation.omegaRefPu) annotation(
    Line(points = {{-3991, 1378}, {-3697, 1378}, {-3697, 1043}, {-2124, 1043}}, color = {0, 0, 127}));
  connect(step4.y, synchronisation.PRefPu) annotation(
    Line(points = {{-3530, 1887}, {-3296, 1887}, {-3296, 1359}, {-2124, 1359}}, color = {0, 0, 127}));
  connect(pll.omegaPLLPu, synchronisation.omegaPLLSetPu) annotation(
    Line(points = {{297, -37}, {424, -37}, {424, 1771}, {-1857, 1771}, {-1857, 1480}}, color = {0, 0, 127}));
  connect(measurementPcc.PGenPu, synchronisation.PFilterPu) annotation(
    Line(points = {{493, 458}, {597, 458}, {597, 836}, {-2377, 836}, {-2377, 1194}, {-2124, 1194}}, color = {0, 0, 127}));
  connect(synchronisation.omegaPu, converter_v2.omegaPu) annotation(
    Line(points = {{-1590, 1074}, {-305, 1074}, {-305, 326}}, color = {0, 0, 127}));
  connect(converter_v2.omegaPu, currentFilterLoop.omegaPu) annotation(
    Line(points = {{-305, 326}, {-468, 326}, {-468, 407}, {-1032, 407}, {-1032, 369}, {-1027, 369}}, color = {0, 0, 127}));
  connect(converter_v2.omegaPu, gridconnection.omegaPu) annotation(
    Line(points = {{-305, 326}, {-242, 326}, {-242, 349}, {672, 349}, {672, 308}}, color = {0, 0, 127}));
  connect(currentFilterLoop.omegaPu, voltageFiltreControl.omegaPu) annotation(
    Line(points = {{-1027, 369}, {-1059, 369}, {-1059, 713}, {-2600, 713}, {-2600, 523}}, color = {0, 0, 127}));
protected
  annotation(
    ...
    Diagram(coordinateSystem(grid = {1, 1}, extent = {{-5650, 2080}, {1330, -1450}})));
end GridForming_test_4_v2_Syncr;