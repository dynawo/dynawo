...
equation
  ...
  connect(GFMVSM.terminal, line.terminal1) annotation(
  ...
  connect(omegaRefPu.y, GFMVSM.omegaRefPu) annotation(
    Line(points = {{-101, 20}, {-65.5, 20}, {-65.5, 6}, {-30, 6}}, color = {0, 0, 127}));
  connect(PRefPu.y, GFMVSM.PFilterRefPu) annotation(
    Line(points = {{-101, 60}, {-40, 60}, {-40, 14}, {-30, 14}}, color = {0, 0, 127}));
  connect(QRefPu.y, GFMVSM.QFilterRefPu) annotation(
    Line(points = {{-100, -20}, {-66, -20}, {-66, -8}, {-30, -8}}, color = {0, 0, 127}));
  connect(URefPu.y, GFMVSM.UFilterRefPu) annotation(
