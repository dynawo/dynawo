...
model DynGFMVSMSmib2 "Single machine infinite bus test case for Grid Forming VSM model with dynamic filter and transformer"
  ...
  Modelica.Blocks.Sources.Step PRefPu(height = 0.25, offset = 0.75, startTime = 7) annotation(
    Placement(visible = true, transformation(origin = {-112, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.PEIR.Converters.General.Average.GridForming.DynGFMVSM2 dynGFMVSM2(CFilterPu = 1e-05, H = 3, IMaxVI = 1.2, Kfd = 0.8, Kff = 0, Kfq = 0, Kic = 15, KpVI = 0.6, Kpc = 0.477465, LFilterPu = 0.15, LTransformerPu = 0.06, Mq = 0.2, P0Pu = -7.1894, Q0Pu = 0.1870, RFilterPu = 0.015, RTransformerPu = 0.006, SNom = 1000, U0Pu = 0.9996, UPhase0 = 0.0360, Wf = 31.4159, Wff = 60, XRratio = 10, XVI = 0, kVSM = 155.955, OmegaSetPu = 1, tVSC = 0.0004)  annotation(
...
equation
  ...
  annotation(
    ...
    experiment(StartTime = 0, StopTime = 25, Tolerance = 1e-06, Interval = 0.0240616),
