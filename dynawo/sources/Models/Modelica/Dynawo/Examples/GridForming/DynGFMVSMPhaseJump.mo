...
model DynGFMVSMPhaseJump "Single machine infinite bus test case for Grid Forming VSM model with dynamic filter and transformer"
  /*
  ...
  Electrical.Lines.Line line(BPu = 0, GPu = 0, RPu = 0.01, XPu = 0.1) annotation(
  ...
  Modelica.Blocks.Sources.Constant omegaRefPu(k = 1) annotation(
    Placement(visible = true, transformation(origin = {-112, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.PEIR.Converters.General.Average.GridForming.DynGFMVSM DynGFMVSM(CFilterPu = 1e-05, H = 3, IMaxVI = 1.2, Kfd = 0.8, Kff = 0, Kfq = 0, Kic = 15, KpVI = 0.6, Kpc = 0.477465, LFilterPu = 0.15, LTransformerPu = 0.06, Mq = 0.2, P0Pu = -4.983, Q0Pu = -0.611, RFilterPu = 0.015, RTransformerPu = 0.006, SNom = 1000, U0Pu = 0.977, UPhase0 = 0.527, Wf = 31.4159, Wff = 60, XRratio = 10, XVI = 0, kVSM = 155.955, OmegaSetPu = 1, tVSC = 0.0004) annotation(
  ...
  Electrical.Buses.InfiniteBusWithVariations_PhaseJump infiniteBusWithVariations_PhaseJump(U0Pu = 1, UEvtPu = 1, omega0Pu = 1, omegaEvtPu = 1, UPhase = 0, tUEvtStart = 0, tUEvtEnd = 0, tOmegaEvtStart = 0, tOmegaEvtEnd = 0, tUPhaseEvt = 10, dUPhaseEvt = 0.093)  annotation(
...
equation
  ...
  connect(line.terminal2, infiniteBusWithVariations_PhaseJump.terminal) annotation(
    Line(points = {{54, 0}, {78, 0}}, color = {0, 0, 255}));
  annotation(
