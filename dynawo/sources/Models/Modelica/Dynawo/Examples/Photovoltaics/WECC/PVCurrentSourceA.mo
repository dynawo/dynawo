...
model PVCurrentSourceA "WECC PV Model on infinite bus"
  ...
  Dynawo.Electrical.Photovoltaics.WECC.PVCurrentSourceA PV(DDn = 20, DPMaxPu = 999, DPMinPu = -999, DUp = 0.001, Dbd1Pu = -0.1, Dbd2Pu = 0.1, DbdPu = 0.01, EMaxPu = 999, EMinPu = -999, FDbd1Pu = 0.004, FDbd2Pu = 1, FEMaxPu = 999, FEMinPu = -999, FreqFlag = true, IMaxPu = 1.05, Id0Pu = 0.67611, Iq0Pu = 0.26996, Iqh1Pu = 2, Iql1Pu = -2, IqrMaxPu = 20, IqrMinPu = -20, Kc = 0, Ki = 1.5, KiPLL = 20, Kig = 2.36, Kp = 0.1, KpPLL = 3, Kpg = 0.05, Kqi = 0.5, Kqp = 1, Kqv = 2, Kvi = 1, Kvp = 1, Lvplsw = true, OmegaMaxPu = 1.5, OmegaMinPu = 0.5, P0Pu = -0.7, PF0 = 0.92871, PInj0Pu = 0.7, PMaxPu = 1, PMinPu = 0, PQFlag = false, PfFlag = false, Q0Pu = -0.2, QFlag = true, QInj0Pu = 0.2795, QMaxPu = 0.4, QMinPu = -0.4, RPu = 0, RateFlag = false, RefFlag = true, RrpwrPu = 10, SNom = 100, U0Pu = 1.0, UInj0Pu = 1.03534, UPhase0 = 0.00000144621, UPhaseInj0 = 0.10159, VCompFlag = false, VDipPu = 0.9, VFlag = true, VFrz = 0, VMaxPu = 1.1, VMinPu = 0.9, VRef0Pu = 1, VRef1Pu = 0, VUpPu = 1.1, XPu = 0.15, brkpt = 0.9, i0Pu = Complex(-0.7, 0.2), iInj0Pu = Complex(0.7, -0.2), lvpl1 = 1, s0Pu = Complex(-0.7, -0.2), tFilterGC = 0.02, tFilterPC = 0.04, tFt = 1e-10, tFv = 0.1, tG = 0.02, tIq = 0.02, tLag = 0.1, tP = 0.04, tPord = 0.02, tRv = 0.02, u0Pu = Complex(1, 0), uInj0Pu = Complex(1.03, 0.105), zerox = 0) annotation(
