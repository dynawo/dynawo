...
model PVVoltageSourceNoPPC "WECC Wind Type 4B Model on infinite bus"
  ...
  Electrical.Photovoltaics.WECC.PVVoltageSource1NoPlantControl PV(
    DPMaxPu = 999,
    DPMinPu = -999,
    Dbd1Pu = -0.1,
    Dbd2Pu = 0.1,
  ...
  Electrical.Photovoltaics.WECC.PVVoltageSourceNoPlantControl_INIT pVVoltageSourceNoPlantControl_INIT(
