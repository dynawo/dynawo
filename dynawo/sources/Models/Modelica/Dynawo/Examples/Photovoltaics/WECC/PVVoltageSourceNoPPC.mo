...
equation
  ...
  connect(QRef.y, PV.QConvRefPu) annotation(
    Line(points = {{79, 0}, {70, 0}, {70, -1}, {62, -1}}, color = {0, 0, 127}));
  ...
  connect(omegaRefPu.y, PV.omegaRefPu) annotation(
    Line(points = {{80, -40}, {70, -40}, {70, -12}, {62, -12}}, color = {0, 0, 127}));
  annotation(
