...
model PVCurrentSourceB "WECC PV Model on infinite bus"
  ...
  Dynawo.Electrical.PEIR.Plants.Photovoltaics.WECC.PVCurrentSourceB PV(
    DDn = 20,
    DPMaxPu = 999,
    DPMinPu = -999,
    DUp = 0.001,
  ...
  // Initialization
  Dynawo.Electrical.PEIR.Converters.Photovoltaics.WECC.PVCurrentSource_INIT pvCurrentSource_INIT(
    P0Pu = PV.P0Pu,
    Q0Pu = PV.Q0Pu,
    RPu = PV.RPu,
    SNom = PV.SNom,
