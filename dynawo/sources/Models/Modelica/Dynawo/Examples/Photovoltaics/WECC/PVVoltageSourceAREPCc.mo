...
model PVVoltageSourceAREPCc "WECC PV Vsource Model on infinite bus"
  ...
  // Initialization
  Electrical.Photovoltaics.WECC.PVVoltageSource_INIT pvVoltageSource_INIT(P0Pu = PV.P0Pu, Q0Pu = PV.Q0Pu, RPu = PV.RPu, RSourcePu = PV.RSourcePu, SNom = PV.SNom, U0Pu = PV.U0Pu, UPhase0 = 1.44625e-6, XPu = PV.XPu, XSourcePu = PV.XSourcePu) annotation(
...
equation
  ...
  connect(const.y, PV.PAuxPu) annotation(
    Line(points = {{-20, 88}, {10, 88}, {10, 22}}, color = {0, 0, 127}));
  connect(const.y, PV.UAuxPu) annotation(
    Line(points = {{-20, 88}, {34, 88}, {34, 22}}, color = {0, 0, 127}));
