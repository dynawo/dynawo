...
model PVVoltageSource2 "WECC PV Vsource Model on infinite bus"
  ...
  Modelica.Blocks.Sources.Step step(height = 0.2, offset = 0.7, startTime = 5)  annotation(
    Placement(transformation(origin = {78, -42}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
initial algorithm
...
equation
  ...
  connect(PFaRef.y, PV.PFaRef) annotation(
    Line(points = {{79, -80}, {20, -80}, {20, -22}}, color = {0, 0, 127}));
  connect(step.y, PV.PRefPu) annotation(
    Line(points = {{68, -42}, {42, -42}, {42, -12}}, color = {0, 0, 127}));
  annotation(
