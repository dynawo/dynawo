...
model PVPlantVoltageSource4 "WECC PV Vsource Model on infinite bus"
  ...
  Dynawo.Electrical.Photovoltaics.WECC.PVPlantVoltageSource4 PV(
  ...
  Modelica.Blocks.Sources.Constant PRefPu(k = PV.PControl0Pu) annotation(
    Placement(visible = true, transformation(origin = {90, -40}, extent = {{-10, 10}, {10, -10}}, rotation = 180)));
  Modelica.Blocks.Sources.Constant QRefPu(k = PV.QControl0Pu) annotation(
  ...
  // Initialization
  Dynawo.Electrical.Photovoltaics.WECC.PVPlantVoltageSource_INIT pvPlantVoltageSource_INIT(
...
initial algorithm
  PV.uPcc0Pu.re := pvPlantVoltageSource_INIT.uPcc0Pu.re;
  PV.uPcc0Pu.im := pvPlantVoltageSource_INIT.uPcc0Pu.im;
  PV.i0Pu.re := pvPlantVoltageSource_INIT.i0Pu.re;
  PV.i0Pu.im := pvPlantVoltageSource_INIT.i0Pu.im;
  PV.u0Pu.re := pvPlantVoltageSource_INIT.u0Pu.re;
  PV.u0Pu.im := pvPlantVoltageSource_INIT.u0Pu.im;
  PV.PF0 := pvPlantVoltageSource_INIT.PF0;
  PV.PInj0Pu := pvPlantVoltageSource_INIT.PInj0Pu;
  PV.QInj0Pu := pvPlantVoltageSource_INIT.QInj0Pu;
  PV.UInj0Pu := pvPlantVoltageSource_INIT.UInj0Pu;
  PV.UdInj0Pu := pvPlantVoltageSource_INIT.UdInj0Pu;
  PV.UqInj0Pu := pvPlantVoltageSource_INIT.UqInj0Pu;
  PV.uInj0Pu.re := pvPlantVoltageSource_INIT.uInj0Pu.re;
  PV.uInj0Pu.im := pvPlantVoltageSource_INIT.uInj0Pu.im;
  PV.iInj0Pu.re := pvPlantVoltageSource_INIT.iInj0Pu.re;
  PV.iInj0Pu.im := pvPlantVoltageSource_INIT.iInj0Pu.im;
  PV.PConv0Pu := pvPlantVoltageSource_INIT.PConv0Pu;
  PV.QConv0Pu := pvPlantVoltageSource_INIT.QConv0Pu;
  PV.UPhaseConv0 := pvPlantVoltageSource_INIT.UPhaseConv0;
  PV.UConv0Pu := pvPlantVoltageSource_INIT.UConv0Pu;
  PV.uConv0Pu.re := pvPlantVoltageSource_INIT.uConv0Pu.re;
  PV.uConv0Pu.im := pvPlantVoltageSource_INIT.uConv0Pu.im;
  PV.iConv0Pu.re := pvPlantVoltageSource_INIT.iConv0Pu.re;
  PV.iConv0Pu.im := pvPlantVoltageSource_INIT.iConv0Pu.im;
  PV.Id0Pu := pvPlantVoltageSource_INIT.Id0Pu;
  PV.Iq0Pu := pvPlantVoltageSource_INIT.Iq0Pu;
  PV.uSource0Pu.re := pvPlantVoltageSource_INIT.uSource0Pu.re;
  PV.uSource0Pu.im := pvPlantVoltageSource_INIT.uSource0Pu.im;
...
equation
  ...
  annotation(
    ...
    This test case consists in one PV park connected to an infinite bus whose voltage is reduced to 0.5 pu from t = 4 s to t = 8 s, and whose frequency is increased to 1.01 pu from t = 16 s to t = 16.5 s. This is a way to observe the PV park's response to a voltage and frequency variation at its terminal.
     <figure>
    <img width=\"450\" src=\"modelica://Dynawo/Examples/Photovoltaics/WECC/Resources/PVVoltageSource4_PPuSnRef.png\">
  </figure>
  <figure>
    <img width=\"450\" src=\"modelica://Dynawo/Examples/Photovoltaics/WECC/Resources/PVVoltageSource4_QPuSnRef.png\">
  </figure>
  <figure>
    <img width=\"450\" src=\"modelica://Dynawo/Examples/Photovoltaics/WECC/Resources/PVVoltageSource4_UPu.png\">
  </figure>
        </div>
