...
equation
  ...
  PV.regc.voltageSource.injectorURI.switchOffSignal1.value = false;
  PV.regc.voltageSource.injectorURI.switchOffSignal2.value = false;
  PV.regc.voltageSource.injectorURI.switchOffSignal3.value = false;
