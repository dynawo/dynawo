...
model IECWP4A "GWind Turbine Type 4A model from IEC 61400-27-1 standard with infinite bus - fault and reference tracking tests (Active and reactive power steps)"
  ...
  */
  ...
  Dynawo.Electrical.Transformers.TransformerFixedRatio transformer(BPu = 0, GPu = 0, RPu = 0, XPu = 0.1, rTfoPu = 1) annotation(
    Placement(visible = true, transformation(origin = {-9, 0}, extent = {{15, -15}, {-15, 15}}, rotation = 0)));
  ...
  Dynawo.Electrical.Lines.Line line(BPu = 0.005, GPu = 0, RPu = 0.015, XPu = 0.025) annotation(
    Placement(visible = true, transformation(origin = {-47, 0}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
  ...
  Dynawo.Examples.IECWT4ANeplan.BaseModel.IECWP4A iecwp4a(Bes = 0, DipMax = 1, DiqMax = 100, DiqMin = -100, DpMaxp4A = 1, DpRefMax4A = 100, DpRefMin4A = -100, Ges = 0, IGsIm0Pu = 0.4231, IGsRe0Pu = 0.93, IMax = 1.3, IMaxDip = 1.3, IMaxHookPu = 0, IdfHook = 0, IpMax0Pu = 1.2, IpfHook = 0, IqH1 = 1.05, IqMax = 1.05, IqMax0Pu = 0.4, IqMaxHook = 0, IqMin = -1.05, IqMin0Pu = -0.4, IqPost = 0, Kiq = 0, Kiu = 0, Kiwpp = 5, Kiwpx = 10, Kpq = 1.1, Kpqu = 20, Kpu = 2, Kpufrt = 2, Kpwpp = 2.25, Kpwpx = 0.5, Kqv = -2, Kwppref = 1.5, Kwpqref = 0, Kwpqu = 0, Mdfslim = true, MpUScale = false, MqG = 2, Mqfrt = 1, Mqpri = true, Mwpqmode = 0, OmegastepHPu = 0, P0Pu = -1, PstepHPu = -0.5, Q0Pu = 0.21, QMax = 0.8, QMax0Pu = 0.8, QMin = -0.8, QMin0Pu = -0.8, QlConst = true, RWPDrop = 0, RWTDrop = 0, Res = 0, SNom = 100, Td = 0, Tffilt = 0.01, Tg = 0.01, Tlag = 0.01, Tlead = 0.01, TpOrdp4A = 0.1, TpWTRef4A = 0.01, Tpfilt = 0.01, Tpll = 0.01, TqOrd = 0.05, Tqfilt = 0.01, Ts = 0.0001, Tufilt = 0.01, Tuqfilt = 0.01, Tuss = 1, U0Pu = 1, UGsIm0Pu = 0.2182, UGsRe0Pu = 0.9758, UMax = 1.1, UMin = 0.9, UPhase0 = 0.22, UdbOne = -0.1, UdbTwo = 0.1, UpDip = 0, Upll1 = 999, Upll2 = 0.13, UpquMax = 1.1, UqDip = 0.9, UqRise = 1.1, X0Pu = -0.21, XWPDrop = 0, XWT0Pu = -0.21, XWTDrop = 0, Xes = 0, XstepHPu = 0.21, dfMax = 1, dfMin = -1, dpRefMax = 1, dpRefMin = -1, dpWPRefMax = 1, dpWPRefMin = -1, dxRefMax = 10, dxRefMin = -10, fOver = 1.1, fUnder = 0.9, i0Pu = Complex(-0.93, -0.4231), pErrMax = 1, pErrMin = -1, pKIWPpMax = 1, pKIWPpMin = -1, pRefMax = 1, pRefMin = 0, pWPHookPu = 0, t_Omegastep = 0, t_Pstep = 2, t_Xstep = 4, u0Pu = Complex(0.9758, 0.2182), uOver = 1.1, uUnder = 0.9, uWPqdip = 0.8, uWPqrise = 1.2, xKIWPxMax = 1, xKIWPxMin = -1, xRefMax = 1, xRefMin = -1, xerrmax = 1, xerrmin = -1)  annotation(
...
equation
  ...
  connect(line.terminal2, transformer.terminal2) annotation(
    Line(points = {{-32, 0}, {-24, 0}}, color = {0, 0, 255}));
  connect(transformer.terminal1, line2.terminal1) annotation(
    Line(points = {{6, 0}, {10, 0}, {10, -20}, {16, -20}}, color = {0, 0, 255}));
  ...
  connect(transformer.terminal1, line1.terminal1) annotation(
    Line(points = {{6, 0}, {10, 0}, {10, 20}, {36, 20}}, color = {0, 0, 255}));
  connect(iecwp4a.aCPower, transformer2.terminal1) annotation(
    Line(points = {{-107.5, 0}, {-100, 0}}, color = {0, 0, 255}));
  ...
  connect(realExpression.y, iecwp4a.omegaPu)
  annotation(
    Line);
annotation(
