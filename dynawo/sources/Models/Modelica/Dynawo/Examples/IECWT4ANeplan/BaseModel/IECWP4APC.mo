...
model IECWP4APC "Wind Turbine Type 4A model from IEC 61400-27-1 standard: assembling the electrical part that includes the electrical and generator module, with the control, that includes the plant and generator control sub-structure, the measurement and grid protection modules"
  /*
  ...
  Dynawo.Electrical.Sources.WT4AIECelecPC wT4AIECelecPC(Bes = Bes, DipMax = DipMax, DiqMax = DiqMax, DiqMin = DiqMin, Ges = Ges, IGsIm0Pu = IGsIm0Pu, IGsRe0Pu = IGsRe0Pu, IpMax0Pu = IpMax0Pu, IqMax0Pu = IqMax0Pu, IqMin0Pu = IqMin0Pu, P0Pu = P0Pu, Q0Pu = Q0Pu, Res = Res, Rpc = Rpc, SNom = SNom, Tg = Tg, U0Pu = U0Pu, UGsIm0Pu = UGsIm0Pu, UGsRe0Pu = UGsRe0Pu, UPhase0 = UPhase0, Xes = Xes, Xpc = Xpc, i0Pu = i0Pu, u0Pu = u0Pu) annotation(
...
equation
  wT4AIECelecPC.switchOffSignal1.value = false;
  wT4AIECelecPC.switchOffSignal2.value = false;
  wT4AIECelecPC.switchOffSignal3.value = false;
/*Connectors*/
  connect(iECWP4AControl.PRefPu, PrefPu.y) annotation(
    Line(points = {{57.5, 13}, {69, 13}, {69, 50}, {78, 50}}, color = {0, 0, 127}));
  connect(iECWP4AControl.ipMaxPu, wT4AIECelecPC.ipMaxPu) annotation(
    Line(points = {{2.5, 20}, {-22, 20}}, color = {0, 0, 127}));
  connect(iECWP4AControl.iqMaxPu, wT4AIECelecPC.iqMaxPu) annotation(
    Line(points = {{2.5, 10}, {-22, 10}}, color = {0, 0, 127}));
  connect(iECWP4AControl.iqMinPu, wT4AIECelecPC.iqMinPu) annotation(
    Line(points = {{2.5, 0}, {-22, 0}}, color = {0, 0, 127}));
  connect(iECWP4AControl.ipCmdPu, wT4AIECelecPC.ipCmdPu) annotation(
    Line(points = {{2.5, -10}, {-22, -10}}, color = {0, 0, 127}));
  connect(iECWP4AControl.iqCmdPu, wT4AIECelecPC.iqCmdPu) annotation(
    Line(points = {{2.5, -20}, {-22, -20}}, color = {0, 0, 127}));
  connect(iECWP4AControl.theta, wT4AIECelecPC.theta) annotation(
    Line(points = {{30, 27.5}, {30, 40}, {-50, 40}, {-50, 28}}, color = {0, 0, 127}));
  connect(wT4AIECelecPC.uWtImPu, iECWP4AControl.uWtImPu) annotation(
    Line(points = {{-30, -28}, {-30, -34}, {10, -34}, {10, -27.5}}, color = {0, 0, 127}));
  connect(wT4AIECelecPC.uWtRePu, iECWP4AControl.uWtRePu) annotation(
    Line(points = {{-40, -28}, {-40, -40}, {20, -40}, {20, -27.5}}, color = {0, 0, 127}));
  connect(wT4AIECelecPC.iWtImPu, iECWP4AControl.iWtImPu) annotation(
    Line(points = {{-60, -28}, {-60, -46}, {40, -46}, {40, -27.5}}, color = {0, 0, 127}));
  connect(wT4AIECelecPC.iWtRePu, iECWP4AControl.iWtRePu) annotation(
    Line(points = {{-70, -28}, {-70, -52}, {50, -52}, {50, -27.5}}, color = {0, 0, 127}));
  connect(wT4AIECelecPC.terminal, aCPower) annotation(
