...
model IECWT4B "GWind Turbine Type 4A model from IEC 61400-27-1 standard with infinite bus - fault and reference tracking tests (Active and reactive power steps)"
  /*
  ...
  */
  ...
  Dynawo.Examples.IECWT4ANeplan.BaseModel.IECWT4B iecwt4b(Bes = 0, Cdrt = 0, DipMax = 1, DiqMax = 100, DiqMin = -100, DpMaxp4A = 1, DpRefMax4A = 100, DpRefMin4A = -100, Ges = 0, Hgen = 0.01, Hwtr = 0.01, IGsIm0Pu = 0.423168, IGsRe0Pu = 0.930069, IMax = 1.3, IMaxDip = 1.3, IMaxHookPu = 0, IdfHook = 0, IpMax0Pu = 1.2, IpfHook = 0, IqH1 = 1.05, IqMax = 1.05, IqMax0Pu = 0.4, IqMaxHook = 0, IqMin = -1.05, IqMin0Pu = -0.4, IqPost = 0, Kdrt = 0.05, Kiq = 0, Kiu = 0, Kpq = 1.1, Kpqu = 20, Kpu = 2, Kpufrt = 2, Kqv = -2, Mdfslim = false, MpUScale = false, MqG = 1, Mqfrt = 1, Mqpri = true, OmegastepHPu = 0, P0Pu = -1, PstepHPu = -0.5, Q0Pu = 0.21, QMax = 0.8, QMax0Pu = 0.8, QMin = -0.8, QMin0Pu = -0.8, QlConst = true, QstepHPu = 0.41, RWTDrop = 0, Res = 0, SNom = 100, TanPhi = 0.3, Td = 0, Tffilt = 0.01, Tg = 0.01, TpOrdp4A = 0.1, TpWTRef4A = 0.01, Tpaero = 0.1, Tpfilt = 0.01, Tpll = 0.01, TqOrd = 0.05, Tqfilt = 0.01, Ts = 0.0001, Tufilt = 0.01, Tuss = 1, U0Pu = 1, UGsIm0Pu = 0.21823, UGsRe0Pu = 0.975897, UMax = 1.1, UMin = 0.9, UPhase0 = 0.22, UdbOne = -0.1, UdbTwo = 0.1, UpDip = 0, Upll1 = 999, Upll2 = 0.13, UpquMax = 1.1, UqDip = 0.9, UqRise = 1.1, XWTDrop = 0, Xes = 0, i0Pu = Complex(-0.930069, -0.423168), t_Omegastep = 10, t_Pstep = 2, t_Qstep = 4, u0Pu = Complex(0.975897, 0.2183))  annotation(
...
equation
 ...
 connect(iecwt4b.aCPower, transformer2.terminal1) annotation(
 ...
 connect(iecwt4b.aCPower, nodeFault1.terminal) annotation(
    Line(points = {{-107.5, 0}, {-100, 0}, {-100, -30}, {-80, -30}, {-80, -42}}, color = {0, 0, 255}));
 annotation(
