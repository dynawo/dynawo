...
model BESSCurrentSource "WECC BESS with REEC-C and REGC-B with a plant controller REPC-A on infinite bus"
  ...
  */
  ...
  Dynawo.Electrical.BESS.WECC.BESSCurrentSource BESS(DDn = 126, DPMaxPu = 999, DPMinPu = -999, DUp = 126, Dbd1Pu = -0.05, Dbd2Pu = 0.05, DbdPu = 0, EMaxPu = 0.1, EMinPu = -0.1, FDbd1Pu = 0.00083, FDbd2Pu = 0.00083, FEMaxPu = 999, FEMinPu = -999, FreqFlag = true, IMaxPu = 1.11, Iqh1Pu = 0.75, Iql1Pu = -0.75, IqrMaxPu = 999, IqrMinPu = -999, Kc = 0, Ki = 1e-6, KiPLL = 20, Kig = 1e-6, Kp = 1e-6, KpPLL = 3, Kpg = 1, Kqi = 1, Kqp = 1e-6, Kqv = 15, Kvi = 0.1, Kvp = 1e-6, Lvplsw = false, OmegaMaxPu = 1.5, OmegaMinPu = 0.5, P0Pu = -0.03, PMaxPu = 1, PMinPu = -0.667, PQFlag = false, PfFlag = false, Q0Pu = 0, QFlag = false, QMaxPu = 0.75, QMinPu = -0.75, RefFlag = false, RrpwrPu = 10, SNom = 6, SOC0Pu = 0.5, SOCMaxPu = 0.8, SOCMinPu = 0.2, U0Pu = 1, VCompFlag = true, VDLIp11 = 0.2, VDLIp12 = 1.11, VDLIp21 = 0.5, VDLIp22 = 1.11, VDLIp31 = 0.75, VDLIp32 = 1.11, VDLIp41 = 1, VDLIp42 = 1.11, VDLIq11 = 0, VDLIq12 = 0.75, VDLIq21 = 0.2, VDLIq22 = 0.75, VDLIq31 = 0.5, VDLIq32 = 0.75, VDLIq41 = 1, VDLIq42 = 0.75, VDipPu = -99, VFlag = true, VFrz = 0, VMaxPu = 1.1, VMinPu = 0.9, VRef0Pu = 1, VUpPu = 99, brkpt = 0.1, lvpl1 = 1.22, tBattery = 999, tFilterGC = 0.02, tFilterPC = 0.02, tFt = 1e-10, tFv = 0.05, tG = 0.017, tIq = 0.017, tLag = 0.1, tP = 0.05, tPord = 0.017, tRv = 0.01, zerox = 0.05, Id0Pu(fixed = false), Iq0Pu(fixed = false), PConv0Pu(fixed = false), UPhaseConv0(fixed = false), PF0(fixed = false), PInj0Pu(fixed = false), QConv0Pu(fixed = false), QInj0Pu(fixed = false), UInj0Pu(fixed = false), i0Pu(im(fixed = false), re(fixed = false)), iConv0Pu(im(fixed = false), re(fixed = false)), s0Pu(im(fixed = false), re(fixed = false)), u0Pu(im(fixed = false), re(fixed = false)), UConv0Pu(fixed = false), uConv0Pu(im(fixed = false), re(fixed = false)), uInj0Pu(im(fixed = false), re(fixed = false)), uPcc0Pu(im(fixed = false), re(fixed = false)), RMvHvPu = 0, XMvHvPu = 0.15, RLvTrPu = 0, XLvTrPu = 0, UPhase0 = 0) annotation(
