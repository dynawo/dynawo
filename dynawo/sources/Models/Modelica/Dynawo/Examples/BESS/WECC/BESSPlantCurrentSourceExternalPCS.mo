...
model BESSPlantCurrentSourceExternalPCS "WECC BESS with REEC-C and REGC-A with a plant controller REPC-A on infinite bus"
...
end BESSPlantCurrentSourceExternalPCS;
