...
model BESSCurrentSource3 "WECC BESS with REEC-E and REGC-A with a plant controller REPC-A on infinite bus"
  ...
  Dynawo.Electrical.BESS.WECC.BESSCurrentSource3 BESS(
    DDn = 126,
    DPMaxPu = 999,
    DPMinPu = -999,
    DUp = 126,
