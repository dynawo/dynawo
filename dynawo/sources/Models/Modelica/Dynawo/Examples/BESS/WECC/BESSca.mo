...
equation
  ...
  BESSca.regc.injectorIDQ.switchOffSignal1.value = false;
  BESSca.regc.injectorIDQ.switchOffSignal2.value = false;
  BESSca.regc.injectorIDQ.switchOffSignal3.value = false;

  connect(line.terminal2, BESSca.terminal) annotation(
  ...
  connect(omegaRefPu.y, BESSca.omegaRefPu) annotation(
    Line(points = {{69, 40}, {60, 40}, {60, 12}, {42, 12}}, color = {0, 0, 127}));
  connect(QRefPu.y, BESSca.QRefPu) annotation(
    Line(points = {{70, 0}, {44, 0}, {44, 0}, {42, 0}}, color = {0, 0, 127}));
  connect(URefPu.y, BESSca.URefPu) annotation(
    Line(points = {{70, 80}, {20, 80}, {20, 22}}, color = {0, 0, 127}));
  connect(PFaRef.y, BESSca.PFaRef) annotation(
    Line(points = {{70, -80}, {20, -80}, {20, -22}}, color = {0, 0, 127}));
  connect(PAuxPu.y, BESSca.PAuxPu) annotation(
    Line(points = {{40, -60}, {32, -60}, {32, -22}}, color = {0, 0, 127}));
  connect(PRefPu.y, BESSca.PRefPu) annotation(
