...
model BESSPlantCurrentSource "WECC BESS with REEC-C and REGC-B with a plant controller REPC-A on infinite bus"
  ...
  Dynawo.Electrical.BESS.WECC.BESSPlantCurrentSource BESS(
  ...
  Modelica.Blocks.Sources.Step URef(height = 0.02, offset = BESS.repcA.URef0Pu, startTime = 5) annotation(
...
initial algorithm
  BESS.Id0Pu := weccPlantCurrentSource_INIT.Id0Pu;
  BESS.Iq0Pu := weccPlantCurrentSource_INIT.Iq0Pu;
  BESS.PF0 := weccPlantCurrentSource_INIT.PF0;
  BESS.PInj0Pu := weccPlantCurrentSource_INIT.PInj0Pu;
  BESS.QInj0Pu := weccPlantCurrentSource_INIT.QInj0Pu;
  BESS.UInj0Pu := weccPlantCurrentSource_INIT.UInj0Pu;
  BESS.i0Pu.re := weccPlantCurrentSource_INIT.i0Pu.re;
  BESS.i0Pu.im := weccPlantCurrentSource_INIT.i0Pu.im;
  BESS.iConv0Pu.re := weccPlantCurrentSource_INIT.iConv0Pu.re;
  BESS.iConv0Pu.im := weccPlantCurrentSource_INIT.iConv0Pu.im;
  BESS.s0Pu.re := weccPlantCurrentSource_INIT.s0Pu.re;
  BESS.s0Pu.im := weccPlantCurrentSource_INIT.s0Pu.im;
  BESS.u0Pu.re := weccPlantCurrentSource_INIT.u0Pu.re;
  BESS.u0Pu.im := weccPlantCurrentSource_INIT.u0Pu.im;
  BESS.uInj0Pu.re := weccPlantCurrentSource_INIT.uInj0Pu.re;
  BESS.uInj0Pu.im := weccPlantCurrentSource_INIT.uInj0Pu.im;
  BESS.UConv0Pu := weccPlantCurrentSource_INIT.UConv0Pu;
  BESS.uConv0Pu.re := weccPlantCurrentSource_INIT.uConv0Pu.re;
  BESS.uConv0Pu.im := weccPlantCurrentSource_INIT.uConv0Pu.im;
  BESS.uPcc0Pu.re := weccPlantCurrentSource_INIT.uPcc0Pu.re;
  BESS.uPcc0Pu.im := weccPlantCurrentSource_INIT.uPcc0Pu.im;
  BESS.PConv0Pu := weccPlantCurrentSource_INIT.PConv0Pu;
  BESS.QConv0Pu := weccPlantCurrentSource_INIT.QConv0Pu;
  BESS.UPhaseConv0 := weccPlantCurrentSource_INIT.UPhaseConv0;
...
equation
  ...
  connect(complexConst.y, BESS.uPccPu) annotation(
    Line(points = {{-59, -80}, {-30, -80}, {-30, -14}, {-2, -14}}, color = {85, 170, 255}));
  ...
  connect(const.y, BESS.QPccPu) annotation(
    Line(points = {{-59, -40}, {-40, -40}, {-40, -10}, {-2, -10}}, color = {0, 0, 127}));
  ...
  <figure>This example and the data are inspired by the article [P. <span style=\"text-decoration: underline;\">Pourbeik</span> and J. K. <span style=\"text-decoration: underline;\">Petter</span>, <span style=\"text-decoration: underline;\">“Modeling</span> and validation <span style=\"text-decoration: underline;\">of</span> <span style=\"text-decoration: underline;\">battery</span> <span style=\"text-decoration: underline;\">energy</span> <span style=\"text-decoration: underline;\">storage</span> <span style=\"text-decoration: underline;\">systems&nbsp;</span><span style=\"text-decoration: underline;\">using</span> simple <span style=\"text-decoration: underline;\">generic</span> <span style=\"text-decoration: underline;\">models</span> for <span style=\"text-decoration: underline;\">power</span> system <span style=\"text-decoration: underline;\">stability</span> <span style=\"text-decoration: underline;\">studies”</span>, <span style=\"text-decoration: underline;\">CIGRE</span> Science and Engineering, <span style=\"text-decoration: underline;\">October</span> 2017, pp. 63-72.]</figure><figure>At initial time, the active power demanded by the battery is 0.5 pu (base SNom = 6 MVA) and the reactive power is 0 pu (base SNom = 6 MVA).</figure><figure>The BESS is able to discharge since the initial state of charge SOC0Pu = 0.5 is between the accepted range [SOCMinPu = 0.2 , SOCMaxPu = 0.8]. Since the simulation is only for 3 s, and the discharge time is considered much longer, the state of charge SOCPu is considered constant all along the simulation time.</figure><figure>At t = 1 s, a fault at the infinite bus is simulated and it can be seen that the BESS starts injecting reactive power until the fault is cleared at t = 1.5 s.</figure><figure>
    <img width=\"450\" src=\"modelica://Dynawo/Examples/BESS/WECC/Resources/BESSCurrentSource_PInjPuSn.png\">
  </figure>
  <figure>
    <img width=\"450\" src=\"modelica://Dynawo/Examples/BESS/WECC/Resources/BESSCurrentSource_QInjPuSn.png\">
  </figure>
  <figure>
    <img width=\"450\" src=\"modelica://Dynawo/Examples/BESS/WECC/Resources/BESSCurrentSource_UPu.png\">
  </figure>
</body></html>"));
