...
model BESSCurrentSourceNoPPC "WECC Wind Type 4B Model on infinite bus"
  ...
  */
  ...
  Dynawo.Electrical.BESS.WECC.BESSCurrentSourceNoPlantControl BESS(ConverterLVControl = true, DPMaxPu = 2, DPMinPu = -2, Dbd1Pu = -0.05, Dbd2Pu = 0.05, IMaxPu = 1.3, Id0Pu(fixed = false), Iq0Pu(fixed = false), Iqh1Pu = 1.1, Iql1Pu = -1.1, IqrMaxPu = 20, IqrMinPu = -20, KiPLL = 20, KpPLL = 3, Kqi = 0.7, Kqp = 2, Kqv = 2, Kvi = 0.7, Kvp = 2, Lvplsw = false, OmegaMaxPu = 1.5, OmegaMinPu = 0.5, PConv0Pu(fixed = false), UPhaseConv0(fixed = false), PF0(fixed = false), PInj0Pu(fixed = false), PMaxPu = 1, PMinPu = 0, PQFlag = false, PfFlag = false, QConv0Pu(fixed = false), QFlag = true, QInj0Pu(fixed = false), QMaxPu = 0.4, QMinPu = -0.4, RLvTrPu = 0.015, RrpwrPu = 10, SNom = 100, SOC0Pu = 0.5, SOCMaxPu = 0.8, SOCMinPu = 0.1, UInj0Pu(fixed = false), UPhase0 = 0, VDLIp11 = 1.1, VDLIp12 = 1.1, VDLIp21 = 1.15, VDLIp22 = 1, VDLIp31 = 1.16, VDLIp32 = 1, VDLIp41 = 1.17, VDLIp42 = 1, VDLIq11 = 1.1, VDLIq12 = 1.1, VDLIq21 = 1.15, VDLIq22 = 1, VDLIq31 = 1.16, VDLIq32 = 1, VDLIq41 = 1.17, VDLIq42 = 1, VDipPu = 0.9, VFlag = true, VMaxPu = 1.1, VMinPu = 0.9, VRef0Pu = 0, VUpPu = 1.1, XLvTrPu = 0.06, brkpt = 0.1, i0Pu(im(fixed = false), re(fixed = false)), iConv0Pu(im(fixed = false), re(fixed = false)), lvpl1 = 1.22, s0Pu = Complex(-0.7, -0.2), tBattery = 999, tFilterGC = 0.02, tG = 0.02, tIq = 0.01, tP = 0.05, tPord = 0.01, tRv = 0.01, u0Pu = Complex(1, 0), UConv0Pu(fixed = false), uConv0Pu(im(fixed = false), re(fixed = false)), uInj0Pu(im(fixed = false), re(fixed = false)), zerox = 0.05) annotation(
    Placement(visible = true, transformation(origin = {40, 0}, extent = {{20, -20}, {-20, 20}}, rotation = 0)));
...
equation
  ...
  connect(omegaRefPu.y, BESS.omegaRefPu) annotation(
    Line(points = {{80, -40}, {68, -40}, {68, -12}, {62, -12}}, color = {0, 0, 127}));
  annotation(
