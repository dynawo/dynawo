...
equation
  ...
  <figure><span style=\"font-family: 'DejaVu Sans Mono'; font-size: 12px;\">This test case consists in one simplified BESS unit inverter connected to an infinite bus which voltage is reduced to 0.5 pu from t = 1 s to t = 2 s, and which frequency is increased to 1.01 pu from t = 6 s to t = 6.5 s. Step orders are also applied to Q Control at t = 13 s and to P control at t = 17 s. This is a way to observe the behavior of the drive train of a BESS unit inverter in response to a voltage and frequency variation at its terminal, as well as to step orders.</span></figure><figure>
    <img width=\"450\" src=\"modelica://Dynawo/Examples/BESS/WECC/Resources/BESSCurrentSourceNoPPC_PInjPuSn.png\">
  </figure>
  <figure>
    <img width=\"450\" src=\"modelica://Dynawo/Examples/BESS/WECC/Resources/BESSCurrentSourceNoPPC_QInjPuSn.png\">
  </figure>
  <figure>
    <img width=\"450\" src=\"modelica://Dynawo/Examples/BESS/WECC/Resources/BESSCurrentSourceNoPPC_UPu.png\">
  </figure>
</body></html>"),
