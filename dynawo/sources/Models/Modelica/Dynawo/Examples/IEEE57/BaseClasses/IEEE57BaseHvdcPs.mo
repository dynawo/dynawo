...
model IEEE57BaseHvdcPs "Base class for IEEE 57-bus system benchmark formed with 57 buses, 7 generators, 3 shunts, 16 transformers, 1 phase shifter, 63 lines, 1 HVDC line  and 42 loads"
  ...
  extends Dynawo.Examples.IEEE57.BaseClasses.IEEE57Base(redeclare Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerPhaseTapChanger TfoB7B29(BPu = 0.0 * ZBASE13_8, GPu = 0.0 * ZBASE13_8, RPu = 0.0 / ZBASE13_8, XPu = 0.12340521 / ZBASE13_8, NbTap = 13, RatioTfo0Pu = 1, Tap0 = 6, AlphaTfoMax = -0.05, AlphaTfoMin = 0.05, i10Pu = Complex(0.614995, -0.11085), i20Pu = Complex(-0.614995, 0.11085), u10Pu = Complex(0.982429, 0.0376055), u20Pu = Complex(0.975246, -0.00224616), P10Pu = 0.60002, Q10Pu = 0.132029, U10Pu = 0.983148, U20Pu = 0.975249));
  ...
  Dynawo.Electrical.HVDC.BaseControls.ACEmulation AcEmulation(DeltaThetaFiltered0 = 0.000446079, KACEmulation = 2, PRef0Pu = 0.17, PRefSet0Pu = 0.18, tFilter = 25, Theta10 = -0.00230321, Theta20 = -0.00274929);

  // Phase Shifter Controller
  Dynawo.Electrical.Controls.Transformers.PhaseShifterP PhaseShifterB7B29(increaseTapToDecreaseValue = true, increaseTapToIncreaseValue = false, regulating0 = false, P0 = 59, PDeadBand = 0.5, PTarget = 60, state0 = Dynawo.Electrical.Controls.Transformers.BaseClasses.TapChangerPhaseShifterParams.State.Standard, t1st = 25, tNext = 10, tap0 = 6, tapMax = 12, tapMin = 0);
