...
*/
  ...
  parameter Types.PerUnit UBusPu =1  "Complex voltage amplitude at the infinite bus in pu (base Unom)";
  parameter Types.Angle UBusPhase = 0.49 "Complex voltage phase at the infinite bus in rad";
  ...
  parameter Types.PerUnit BPu = 0.0000375 "Half-susceptance in pu (base SnRef, UNom)";
...
//Generator, lines and infinite bus
  ...
  Electrical.Events.NodeFault nodeFault(RPu = 0.0001, XPu = 0.0001, tBegin = 1, tEnd = 1.1)  annotation(
