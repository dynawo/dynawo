...
model generatorLoad_dynamicLine_Controlled
  ...
  Dynawo.Electrical.Lines.Line line2(BPu = 0, GPu = 0.0000375, RPu = 0.00375, XPu = 0.0375) annotation(
    Placement(visible = true, transformation(origin = {-8, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  ...
  Dynawo.Electrical.Lines.Line line3(BPu = 0, GPu = x * 0.0000375, RPu = x * 0.00375, XPu = x * 0.0375) annotation(
...
/*assert(generatorSynchronous.theta < Modelica.Constants.pi * 270 / 180, "temps critique atteint");*/
  ...
  connect(transformer.terminal1, line2.terminal2) annotation(
    Line(points = {{40, 42}, {40, 0}, {12, 0}}, color = {0, 0, 255}));
  ...
  connect(line1.terminal1, infiniteBus.terminal) annotation(
    Line(points = {{-50, 70}, {-60, 70}, {-60, 40}, {-80, 40}}, color = {0, 0, 255}));
  connect(line2.terminal1, infiniteBus.terminal) annotation(
    Line(points = {{-28, 0}, {-60, 0}, {-60, 40}, {-80, 40}}, color = {0, 0, 255}));
  connect(nodeFault.terminal, line3.terminal1) annotation(
    Line(points = {{-16, 94}, {0, 94}, {0, 70}}, color = {0, 0, 255}));
  annotation(
