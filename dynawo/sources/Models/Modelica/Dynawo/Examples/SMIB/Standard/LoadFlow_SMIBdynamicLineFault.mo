...
*/
  ...
  parameter Types.Angle U0Phase = 0.494442 "Start value of the voltage phase at the machine in rad";
  ...
  parameter Types.ComplexImpedancePu ZLigne1Pu (re = RLigne1, im = XLigne1) "Line 1 impedance";
  parameter Types.ComplexAdmittancePu YLigne1Pu (re = GLigne1, im = BLigne1) "Line 1 half-admittance";
  parameter Types.ComplexImpedancePu ZLigne2Pu (re = RLigne2, im = XLigne2) "Line 2 impedance";
...
This model is a load flow that can be used to correctly initialize the complex current at the tinfinite bus for SMIBdynmaicLineFault and SMIBdynamicLineFault_INIT for given values of lines parameters and machine initial U,P and Q. </body></html>"));
