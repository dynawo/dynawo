...
model GovHydro4St4b2 "Active power variation on the load with governor GovHydro4"
...
equation
  ...
  annotation(
    ...
    This test case tests the governor GovHydro4 in combination with a synchrounours generator and the AVR St4b2.&nbsp;</span><div><span style=\"font-size: 12px;\">An active load step of 0.05 pu is applied at t=0.1s.&nbsp;</span><div><br></div><div><span style=\"font-size: 12px;\"><div><br></div><div><figure>
