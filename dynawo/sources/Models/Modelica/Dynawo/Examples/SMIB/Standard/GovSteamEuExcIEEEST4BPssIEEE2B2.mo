...
model GovSteamEuExcIEEEST4BPssIEEE2B2 "Active power variation on the load with governor GovSteamEU"
  ...
  Dynawo.Electrical.Controls.Machines.Governors.Standard.Steam.GovSteamEU governor(PBaseMw = generatorSynchronous.PNomTurb, Pm0Pu = generatorSynchronous.Pm0Pu)          annotation(
    Placement(visible = true, transformation(origin = {115, -41}, extent = {{-23, -23}, {23, 23}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.Constant PGovernorRefPu(k = 0.8) annotation(
  ...
  Modelica.Blocks.Sources.Constant OmegaRef(k = Dynawo.Electrical.SystemBase.omega0Pu) annotation(
    Placement(visible = true, transformation(origin = {58, -72}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
equation
  ...
  connect(avr.EfdPu, generatorSynchronous.efdPu_in) annotation(
    Line(points = {{141, 18}, {158, 18}, {158, -100}, {8, -100}, {8, -16}}, color = {0, 0, 127}));
  connect(governor.PmPu, generatorSynchronous.PmPu_in) annotation(
    Line(points = {{142, -41}, {142, -48.25}, {150, -48.25}, {150, -90}, {32, -90}, {32, -16}}, color = {0, 0, 127}));
  ...
  connect(generatorSynchronous.PGenPu_out, governor.PGenPu) annotation(
    Line(points = {{38, 10}, {64, 10}, {64, -22}, {90, -22}}, color = {0, 0, 127}));
  connect(PGovernorRefPu.y, governor.PRefPu) annotation(
    Line(points = {{65, -30}, {78.5, -30}, {78.5, -27}, {90, -27}}, color = {0, 0, 127}));
  connect(generatorSynchronous.omegaPu_out, governor.OmegaPu) annotation(
    Line(points = {{38, -6}, {48, -6}, {48, -57}, {90, -57}}, color = {0, 0, 127}));
  connect(generatorSynchronous.omegaPu_out, governor.fPu) annotation(
    Line(points = {{38, -6}, {48, -6}, {48, -42}, {90, -42}}, color = {0, 0, 127}));
  connect(OmegaRef.y, governor.fRefPu) annotation(
    Line(points = {{64, -72}, {80, -72}, {80, -38}, {90, -38}}, color = {0, 0, 127}));
  connect(OmegaRef.y, governor.OmegaRefPu) annotation(
    Line(points = {{64, -72}, {80, -72}, {80, -52}, {90, -52}}, color = {0, 0, 127}));
  annotation(
    preferredView = "diagram",
    experiment(StartTime = 0, StopTime = 30, Tolerance = 1e-06, Interval = 0.03),
    __OpenModelica_simulationFlags(initialStepSize = "0.001", lv = "LOG_STATS", nls = "kinsol", s = "ida", nlsLS = "klu", maxIntegrationOrder = "2", maxStepSize = "10", emit_protected = "()"),
    Diagram(coordinateSystem(extent = {{-160, -100}, {160, 100}})));
end GovSteamEuExcIEEEST4BPssIEEE2B2;
