...
model SMIBdynamicLineINIT "Initialize the value of U0Pu and U0Phase on the two terminal of the dynamic line to start the dynamicLine_INIT, needs changes in the structure of the lines + fixing the value of the infitie bus using LoadFlow_ModelName "
  ...
  Dynawo.Electrical.Lines.Line line1( BPu = 0.0000375 * (1 -x), GPu = 0, RPu = 0.00375 * (1 -x), XPu = 0.0375 * (1 -x) ) annotation(
  ...
  Dynawo.Electrical.Lines.Line line(BPu = 0.0000375 * x, GPu = 0, RPu = 0.00375 * x, XPu = 0.0375 * x) annotation(
...
equation
  ...
  connect(nodeFault.terminal, line.terminal1) annotation(
    Line(points = {{18, 86}, {-20, 86}, {-20, 40}}, color = {0, 0, 255}));
