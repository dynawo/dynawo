...
model SMIBdynamicLineINIT "Initialize the value of U0Pu and U0Phase on the two terminal of the dynamic line to start the dynamicLine_INIT, needs changes in the structure of the lines + fixing the value of the infitie bus using LoadFlow_ModelName "
  ...
  Dynawo.Electrical.Lines.Line line2(BPu = 0.0000375, GPu = 0, RPu = 0.016854, XPu = 0.03370) annotation(
    Placement(visible = true, transformation(origin = {-30, -40}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Dynawo.Electrical.Lines.Line line1( BPu = 0.0000375 * (1 -x), GPu = 0, RPu = 0.016854 * (1 -x), XPu = 0.03370 * (1 -x) ) annotation(
  ...
  Dynawo.Electrical.Lines.Line line(BPu = 0.0000375 * x, GPu = 0, RPu = 0.016854 * x, XPu = 0.03370 * x) annotation(
