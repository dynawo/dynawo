...
model SMIBdynamicLineFault
  ...
  parameter Types.Time delta_t = 0.203;
  ...
  Dynawo.Electrical.Lines.DynamicLine line2(CPu = 0.0000375, GPu = 0, LPu = 0.0375, RPu = 0.00375, i10Pu = Complex(-11.0909, -0.482888), i20Pu = Complex(11.0909, 0.482888), iGC10Pu = Complex(0, 0), iGC20Pu = Complex(0, 0), iRL0Pu = Complex(-11.0909, -0.482888), u10Pu = Complex(0.8633141, -0.0928664), u20Pu = Complex(0.88668, 0.324829)) annotation(
    Placement(visible = true, transformation(origin = {-28, -20}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Dynawo.Electrical.Lines.DynamicLine line1(CPu = (1 - x) * 0.0000375, GPu = 0, LPu = (1 - x) * 0.0375, RPu = (1 - x) * 0.00375, i10Pu = Complex(-11.0909, -0.482888), i20Pu = Complex(11.0909, 0.482888), iGC10Pu = Complex(0, 0), iGC20Pu = Complex(0, 0), iRL0Pu = Complex(-11.0909, -0.482888), u10Pu = Complex(0.8633141, -0.0928664), u20Pu = Complex(0.874911, 0.115981)) annotation(
    Placement(visible = true, transformation(origin = {-60, 30}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  /* x */
  Dynawo.Electrical.Lines.DynamicLine line3(CPu = x * 0.0000375, GPu = 0, LPu = x * 0.0375, RPu = x * 0.00375, i10Pu = Complex(-11.0909, -0.482888), i20Pu = Complex(11.0909, 0.482888), iGC10Pu = Complex(0, 0), iGC20Pu = Complex(0, 0), iRL0Pu = Complex(-11.0909, -0.482888), u10Pu = Complex(0.874911, 0.115981), u20Pu = Complex(0.88668, 0.324829)) annotation(
  ...
  Electrical.Buses.InfiniteBus infiniteBus(UPhase = -18.9567, UPu = 0.868122) annotation(
