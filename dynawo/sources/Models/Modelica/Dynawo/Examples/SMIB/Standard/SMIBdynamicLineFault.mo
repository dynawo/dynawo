...
model SMIBdynamicLineFault "Realization of a fault on a line SMIB model with dynamic lines "
...
equation
  ...
  connect(line2.terminal1, infiniteBus.terminal) annotation(
   ...
   annotation( preferredView = "text", experiment(StartTime = 0, StopTime = 10, Tolerance = 1e-06),
    Documentation(info = "<html><head></head><body>The purpose of this test case is to evaluate the transient stability of an SMIB model with dynamic lines by evaluating the rotor angle Theta for a node falut that starts at (t_begin = 1 s) and (t_end = t_begin + delta_t).</body></html>"));
