...
model SMIBdynamicLineFault
  ...
  Dynawo.Electrical.Controls.Basics.SetPoint EfdPu(Value0 = 2.4659);
    Dynawo.Electrical.Lines.DynamicLine line2(CPu = 0.0000375, GPu = 0, RPu = 0.00375, LPu = 0.0375, iRL0Pu=Complex(-11.0904,-0.48131), i10Pu=Complex(-11.0904,-0.48131), i20Pu=Complex(11.0904,0.48131), u10Pu=Complex(0.8633141,-0.0928664) ,u20Pu=Complex(0.88668,0.324829) ) annotation(
      Placement(visible = true, transformation(origin = {-28, -20}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
    Dynawo.Electrical.Lines.DynamicLine line1(CPu = (1-x)*0.0000375, GPu = 0, LPu = (1-x)*0.0375, RPu = (1-x)*0.00375, i10Pu=Complex(-11.0904,-0.48131), i20Pu=Complex(11.0904,0.48131),iRL0Pu=Complex(-11.0904,-0.48131), u10Pu=Complex(0.8633141,-0.0928664) ,u20Pu=Complex(0.869035,0.011558) ) annotation(
      Placement(visible = true, transformation(origin = {-60, 30}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
    Dynawo.Electrical.Lines.DynamicLine line3(CPu = x*0.0000375 , GPu = 0, LPu = x*0.0375, RPu = x*0.00375, i10Pu=Complex(-11.0904,-0.48131), i20Pu=Complex(11.0904,0.48131),iRL0Pu=Complex(-11.0904,-0.48131), u10Pu=Complex(0.869035,0.011558) ,u20Pu=Complex(0.880244,0.2204) ) annotation(
...
//    Placement(visible = true, transformation(origin = {-8, 30}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Dynawo.Electrical.Events.NodeFault nodeFault(RPu = 0.00001, XPu = 0.00001, tBegin = 1, tEnd = 1.235) annotation(
...
equation
  ...
  connect(infiniteBus.terminal, line1.terminal1) annotation(
    Line(points = {{-96, 8}, {-96, 30}, {-80, 30}}, color = {0, 0, 255}));
  connect(infiniteBus.terminal, line2.terminal1) annotation(
    Line(points = {{-96, 8}, {-96, -20}, {-48, -20}}, color = {0, 0, 255}));
