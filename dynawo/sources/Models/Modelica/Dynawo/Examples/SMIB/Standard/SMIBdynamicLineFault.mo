...
model SMIBdynamicLineFault
  ...
  Dynawo.Electrical.Controls.Basics.SetPoint EfdPu(Value0 = 2.4659);
    ...
    Dynawo.Electrical.Lines.DynamicLine line1(CPu = (1-x)*0.0000375, GPu = 0, RPu = (1-x)*0.00375, LPu = (1-x)*0.0375,iRL0Pu=Complex(-11.0904,-0.48131), i10Pu=Complex(-11.0904,-0.48131), i20Pu=Complex(11.0904,0.48131), u10Pu=Complex(0.8633141,-0.0928664) ,u20Pu=Complex(0.874911,0.115981) ) annotation(
      Placement(visible = true, transformation(origin = {-60, 30}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
    Dynawo.Electrical.Lines.DynamicLine line3(CPu = x*0.0000375 , GPu = 0, RPu = x*0.00375 , LPu = x*0.0375,iRL0Pu=Complex(-11.0904,-0.48131), i10Pu=Complex(-11.0904,-0.48131), i20Pu=Complex(11.0904,0.48131), u10Pu=Complex(0.874911,0.115981) ,u20Pu=Complex(0.88668,0.324829) ) annotation(
