...
model SMIBline2
  ...
  Dynawo.Electrical.Lines.Line line3(BPu = 0.0000375, GPu = 0, RPu = 0.00375, XPu = 0.0375) annotation(
    Placement(visible = true, transformation(origin = {-10, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Lines.Line line1(BPu = 0.0000475, GPu = 0, RPu = 0.00475, XPu = 0.01) annotation(
