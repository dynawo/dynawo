...
model KundurVRPSSStepEfd "Synchronous machine infinite bus - Step on Pm"
  /*
  ...
  Dynawo.Electrical.Controls.Machines.PowerSystemStabilizers.Standard.PssKundur pssKundur(KStab = 9.5, VsMaxPu = 9999, VsMinPu = -9999, t1 = 0.154, t2 = 0.033, tW = 1.4)  annotation(
...
equation
  ...
  pssKundur.omegaPu = generatorSynchronous.omegaPu.value;
  pssKundur.omegaRefPu = Omega0Pu.setPoint.value;
  ...
  connect(pssKundur.UPssPu, voltageRegulator.UPssPu) annotation(
    Line(points = {{120, 6}, {108, 6}}, color = {0, 0, 127}));
  annotation(
