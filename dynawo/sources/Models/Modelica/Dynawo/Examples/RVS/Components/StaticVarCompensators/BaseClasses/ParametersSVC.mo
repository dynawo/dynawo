...
record ParametersSVC "Parameter sets for the static VAR compensators of the RVS test system"
  ...
  type svcParamNames = enumeration(SBase, UNom, UOvPu, BShuntPu, BMin, BMax, VMin, VMax, K, t3, t5) "Generator parameters";

  // SBase, UNom, UOvPu, BShuntPu, BMin, BMax, VMin, VMax, K, t3, t5
  final constant Real[svcFramePreset, svcParamNames] svcParamValues = {
    {1, 18, 0.5, 0, -50, 100, -50, 100, 150 * 150, 3.45, 0.3}, //K needs to be multiplied by susceptance range
    {1, 18, 0.5, 0, -50, 200, -50, 200, 150 * 250, 3.55, 0.3}  //K needs to be multiplied by susceptance range
