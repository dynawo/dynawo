...
model GeneratorSynchronousFourWindingsInterface "Synchronous generator with real interfaces (inputs, outputs)"
  /*
  ...
  import Dynawo;
  extends InitializedGeneratorSynchronousFourWindings;
  //Input variables
...
end GeneratorSynchronousFourWindingsInterface;
