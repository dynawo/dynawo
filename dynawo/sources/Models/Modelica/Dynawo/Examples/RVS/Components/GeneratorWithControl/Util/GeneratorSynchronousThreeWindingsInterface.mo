...
model GeneratorSynchronousThreeWindingsInterface "Synchronous generator with real interfaces (inputs, outputs)"
  /*
      * Copyright (c) 2023, RTE (http://www.rte-france.com) and UPC/Citcea (https://www.citcea.upc.edu/)
      * See AUTHORS.txt
      * All rights reserved.
  ...
  import Dynawo;
  extends InitializedGeneratorSynchronousThreeWindings;
  //Input variables
...
end GeneratorSynchronousThreeWindingsInterface;
