...
record ParametersEXAC "Parameter sets for the EXAC regulations of the RVS test system"
  ...
  type exciterParamNames = enumeration(tR, tB, tC, Ka, tA, VaMaxPu, VaMinPu, tE, Kf, tF, Kc, Kd, Ke, AEx, BEx) "Parameter names";

  // tR, tB, tC, Ka, tA, VaMaxPu, VaMinPu, tE, Kf, tF, Kc, Kd, Ke, AEx, BEx
  final constant Real[genFramePreset, exciterParamNames] exciterParams = {
    {1e-5, 1e-5, 1e-5, 400, 0.02, 9, -5.43, 0.8, 0.03, 1, 0.2, 0.48, 1, 0.00081, 0.687984},
    {1e-5, 1e-5, 1e-5, 400, 0.02, 9, -5.43, 0.8, 0.03, 1, 0.2, 0.48, 1, 0.00081, 0.687984},
    {1e-5, 1e-5, 1e-5, 400, 0.02, 9, -5.43, 0.8, 0.03, 1, 0.2, 0.48, 1, 0.00081, 0.687984},
    {1e-5, 1e-5, 1e-5, 400, 0.02, 9, -5.43, 0.8, 0.03, 1, 0.2, 0.48, 1, 0.00081, 0.687984},
    {1e-5, 1e-5, 1e-5, 400, 0.02, 9, -5.43, 0.8, 0.03, 1, 0.2, 0.48, 1, 0.00081, 0.687984},
