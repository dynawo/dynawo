...
model InitializedTransformerVariableTap "Model of transformer with variable tap and built-in initialization, for the Nordic 32 test system"
  ...
  import Dynawo.Examples.RVS.Components.TransformerWithControl.TransformerParameters;
  import Dynawo.Types;

  extends Dynawo.Examples.RVS.Components.TransformerWithControl.Utilities.TransformerVariableTapXtdPu(
