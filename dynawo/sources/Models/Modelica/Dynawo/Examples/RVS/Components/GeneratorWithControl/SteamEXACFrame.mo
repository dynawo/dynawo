...
model SteamEXACFrame "Model of a steam generator with a governor, a voltage regulator, a power system stabilizer and an overexcitation limiter, for the RVS test system"
  ...
  Dynawo.Electrical.Controls.Machines.VoltageRegulators.Standard.ExAc1 exac1(
    AEx = ParametersEXAC.exciterParams[exac1Preset, ParametersEXAC.exciterParamNames.AEx],
    BEx = ParametersEXAC.exciterParams[exac1Preset, ParametersEXAC.exciterParamNames.BEx],
    ...
    VaMaxPu = ParametersEXAC.exciterParams[exac1Preset, ParametersEXAC.exciterParamNames.VaMaxPu],
    VaMinPu = ParametersEXAC.exciterParams[exac1Preset, ParametersEXAC.exciterParamNames.VaMinPu],
    Ve0Pu = 3,
    VeMax0Pu = 999) annotation(
    Placement(visible = true, transformation(origin = {-120, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.BooleanConstant booleanConstant1(k = GovInService) annotation(
    Placement(visible = true, transformation(origin = {86, 40}, extent = {{6, -6}, {-6, 6}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant URefPu(k = exac1.UsRef0Pu) annotation(
    Placement(visible = true, transformation(origin = {-186, 20}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
...
equation
  ...
  connect(maxex2.UOelPu, exac1.UOelPu) annotation(
    Line(points = {{-141, 90}, {-154, 90}, {-154, 12}, {-144, 12}}, color = {0, 0, 127}));
  ...
  connect(URefPu.y, exac1.UsRefPu) annotation(
    Line(points = {{-179, 20}, {-160, 20}, {-160, 4}, {-144, 4}}, color = {0, 0, 127}));
  connect(generatorSynchronous.UStatorPu_out, exac1.UsPu) annotation(
    Line(points = {{-6, 18}, {-6, 60}, {-200, 60}, {-200, -4}, {-144, -4}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(pssIEEE2B.VPssPu, exac1.UPssPu) annotation(
    Line(points = {{-82, -60}, {-150, -60}, {-150, -20}, {-144, -20}}, color = {0, 0, 127}));
  ...
  connect(generatorSynchronous.IRotorPu_out, exac1.IrPu) annotation(
    Line(points = {{-18, -10}, {-30, -10}, {-30, 90}, {-100, 90}, {-100, 40}, {-150, 40}, {-150, 20}, {-144, 20}}, color = {0, 0, 127}));
  ...
  connect(const.y, exac1.UUelPu) annotation(
    Line(points = {{-180, -20}, {-160, -20}, {-160, -12}, {-144, -12}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(const.y, exac1.USclUelPu) annotation(
    Line(points = {{-180, -20}, {-160, -20}, {-160, -30}, {-80, -30}, {-80, 8}, {-96, 8}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(const.y, exac1.USclOelPu) annotation(
    Line(points = {{-180, -20}, {-160, -20}, {-160, -30}, {-80, -30}, {-80, 16}, {-96, 16}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
