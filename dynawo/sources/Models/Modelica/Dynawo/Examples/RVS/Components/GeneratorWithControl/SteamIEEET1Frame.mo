...
model SteamIEEET1Frame "Model of a steam generator with a governor, a voltage regulator, a power system stabilizer and an overexcitation limiter, for the RVS test system"
  ...
  Dynawo.Electrical.Controls.Machines.VoltageRegulators.Standard.IEEET1 ieeet1(
    AEx = ParametersIEEET1.exciterParams[ieeet1Preset, ParametersIEEET1.exciterParamNames.AEx],
    BEx = ParametersIEEET1.exciterParams[ieeet1Preset, ParametersIEEET1.exciterParamNames.BEx],
    ...
    VrMaxPu = ParametersIEEET1.exciterParams[ieeet1Preset, ParametersIEEET1.exciterParamNames.VrMaxPu],
    VrMinPu = ParametersIEEET1.exciterParams[ieeet1Preset, ParametersIEEET1.exciterParamNames.VrMinPu]) annotation(
    Placement(visible = true, transformation(origin = {-120, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
...
equation
  ...
  connect(const.y, ieeet1.UUelPu) annotation(
  ...
  connect(const.y, ieeet1.USclOelPu) annotation(
    Line(points = {{-168, 20}, {-160, 20}, {-160, 30}, {-80, 30}, {-80, 16}, {-96, 16}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(const.y, ieeet1.USclUelPu) annotation(
    Line(points = {{-168, 20}, {-160, 20}, {-160, 30}, {-80, 30}, {-80, 8}, {-96, 8}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
