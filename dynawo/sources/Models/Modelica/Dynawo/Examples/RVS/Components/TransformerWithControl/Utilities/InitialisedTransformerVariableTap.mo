within Dynawo.Examples.RVS.Components.TransformerWithControl.Utilities;
...
model InitialisedTransformerVariableTap "Model of transformer with variable tap and built-in initialization, for the Nordic 32 test system"
  import Dynawo;
  import Dynawo.Electrical;
  import Dynawo.Examples.Nordic.Components.TransformerWithControl.TransformerParameters;
  import Dynawo.Types;

  extends Dynawo.Electrical.Transformers.TransformerVariableTap_XtdPu(
