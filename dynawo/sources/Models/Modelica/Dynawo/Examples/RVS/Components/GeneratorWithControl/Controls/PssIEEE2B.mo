within Dynawo.Examples.RVS.Components.GeneratorWithControl.Controls;
...
model PssIEEE2B "IEEE Power System Stabilizer type 2B"
  ...
  parameter Types.AngularVelocityPu dOmega0Pu = 0;
  ...
  Modelica.Blocks.Interfaces.RealInput omegaPu(start = dOmega0Pu) "Angular frequency in pu (base omegaNom)" annotation(
    Placement(visible = true, transformation(origin = {-254, 40}, extent = {{-14, -14}, {14, 14}}, rotation = 0), iconTransformation(origin = {-120, 60}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  ...
  Modelica.Blocks.Continuous.Derivative derivative(T = tw1, initType = Modelica.Blocks.Types.Init.InitialState, k = tw1, x_start = dOmega0Pu) annotation(
    Placement(visible = true, transformation(origin = {-130, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.Derivative derivative1(T = tw2, initType = Modelica.Blocks.Types.Init.InitialOutput, k = tw2, x_start = 0) annotation(
    Placement(visible = true, transformation(origin = {-90, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.Derivative derivative2(T = tw3, initType = Modelica.Blocks.Types.Init.InitialState, k = tw3, x_start = PGen0Pu * SystemBase.SnRef / SNom) annotation(
    Placement(visible = true, transformation(origin = {-130, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.Derivative derivative3(T = tw4, initType = Modelica.Blocks.Types.Init.InitialState, k = tw4, x_start = 0) annotation(
    Placement(visible = true, transformation(origin = {-90, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Math.Feedback feedback annotation(
    Placement(visible = true, transformation(origin = {70, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder(T = t6, initType = Modelica.Blocks.Types.Init.InitialState, y_start = 0) annotation(
    Placement(visible = true, transformation(origin = {-50, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder1(T = t7, initType = Modelica.Blocks.Types.Init.InitialState, k = Ks2, y_start = 0) annotation(
    Placement(visible = true, transformation(origin = {-50, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter2(uMax = Vsi2MaxPu, uMin = Vsi2MinPu) annotation(
    Placement(visible = true, transformation(origin = {-170, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.NonElectrical.Blocks.Continuous.RampTrackingFilter rampTrackingFilter(M = 5, Y0 = 0, t1 = t8, t2 = t9) annotation(
    Placement(visible = true, transformation(origin = {30, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.TransferFunction transferFunction1(a = {t11, 1}, b = {t10, 1}, initType = Modelica.Blocks.Types.Init.InitialState, x_start = {0}) annotation(
    Placement(visible = true, transformation(origin = {170, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.TransferFunction transferFunction2(a = {t4, 1}, b = {t3, 1}, initType = Modelica.Blocks.Types.Init.InitialState, x_start = {0}) annotation(
    Placement(visible = true, transformation(origin = {130, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.TransferFunction transferFunction3(a = {t2, 1}, b = {t1, 1}, initType = Modelica.Blocks.Types.Init.InitialState, x_start = {0}) annotation(
...
equation
  ...
  connect(derivative3.y, firstOrder1.u) annotation(
    Line(points = {{-78, -40}, {-62, -40}}, color = {0, 0, 127}));
