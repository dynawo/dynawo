...
record ParametersIEEET1 "Parameter sets for the IEEET1 regulations of the RVS test system"
  ...
  type exciterParamNames = enumeration(tR, Ka, tA, VrMaxPu, VrMinPu, Ke, tE, Kf, tF, AEx, BEx) "Parameter names";

  // tR, Ka, tA, VrMaxPu, VrMinPu, Ke, tE, Kf, tF, AEx, BEx
  final constant Real[genFramePreset, exciterParamNames] exciterParams = {
    {1e-5, 400, 0.04, 7.3, -7.3, 1, 0.8, 0.03, 1, 1.4e-5, 2.308786},
    {1e-5, 400, 0.04, 7.3, -7.3, 1, 0.8, 0.03, 1, 1.4e-5, 2.308786}
