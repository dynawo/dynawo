...
model FullStatic1 "RVS test grid with buses, lines, shunts, PQ loads and transformers, used for load flow calculation (OpenModelica 1.17.0)"
  ...
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1118_118(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 450, Tap0 = 11, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 11) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_10118_ASTOR_G1(KGover = 0, PGen0Pu = PGen0Pu_gen_10118, PMaxPu = 999, PMinPu = 0, PNom = 400, PRef0Pu = -PGen0Pu_gen_10118, QMaxPu = 2, QMinPu = -0.5, QPercent = 1, U0Pu = U0Pu_gen_10118, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {-54, 200}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_20115_ARTHUR_G2(KGover = 0, PGen0Pu = PGen0Pu_gen_20115, PMaxPu = 999, PMinPu = 0, PNom = 12, PRef0Pu = -PGen0Pu_gen_20115, QMaxPu = 0.06, QMinPu = 0, QPercent = 0.05410822, U0Pu = U0Pu_gen_20115, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {-264, 252}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_30115_ARTHUR_G3(KGover = 0, PGen0Pu = PGen0Pu_gen_30115, PMaxPu = 999, PMinPu = 0, PNom = 12, PRef0Pu = -PGen0Pu_gen_30115, QMaxPu = 0.06, QMinPu = 0, QPercent = 0.05410822, U0Pu = U0Pu_gen_30115, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {-264, 212}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_40115_ARTHUR_G4(KGover = 0, PGen0Pu = PGen0Pu_gen_40115, PMaxPu = 999, PMinPu = 0, PNom = 12, PRef0Pu = -PGen0Pu_gen_40115, QMaxPu = 0.06, QMinPu = 0, QPercent = 0.05410822, U0Pu = U0Pu_gen_40115, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {-264, 172}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_60115_ARTHUR_G6(KGover = 0, PGen0Pu = PGen0Pu_gen_60115, PMaxPu = 999, PMinPu = 0, PNom = 155, PRef0Pu = -PGen0Pu_gen_60115, QMaxPu = 0.8, QMinPu = -0.5, QPercent = 0.7294589, U0Pu = U0Pu_gen_60115, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {-264, 92}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_10115_ARTHUR_G1(KGover = 0, PGen0Pu = PGen0Pu_gen_10115, PMaxPu = 999, PMinPu = 0, PNom = 12, PRef0Pu = -PGen0Pu_gen_10115, QMaxPu = 0.06, QMinPu = 0, QPercent = 0.05410822, U0Pu = U0Pu_gen_10115, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {-264, 292}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_50115_ARTHUR_G5(KGover = 0, PGen0Pu = PGen0Pu_gen_50115, PMaxPu = 999, PMinPu = 0, PNom = 12, PRef0Pu = -PGen0Pu_gen_50115, QMaxPu = 0.06, QMinPu = 0, QPercent = 0.05410822, U0Pu = U0Pu_gen_50115, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
  ...
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1115_115(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 400, Tap0 = 6, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 6) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
  ...
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1114_114(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 250, Tap0 = 6, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 6) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
  ...
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1116_116(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 150, Tap0 = 8, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 8) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_10116_ASSER_G1(KGover = 0, PGen0Pu = PGen0Pu_gen_10116, PMaxPu = 999, PMinPu = 0, PNom = 155, PRef0Pu = -PGen0Pu_gen_10116, QMaxPu = 0.8, QMinPu = -0.5, QPercent = 1, U0Pu = U0Pu_gen_10116, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_20101_ABEL_G2(KGover = 0, PGen0Pu = PGen0Pu_gen_20101, PMaxPu = 999, PMinPu = 0, PNom = 20, PRef0Pu = -PGen0Pu_gen_20101, QMaxPu = 0.1, QMinPu = 0, QPercent = 0.126, U0Pu = U0Pu_gen_20101, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {-208, -266}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_40101_ABEL_G4(KGover = 0, PGen0Pu = PGen0Pu_gen_40101, PMaxPu = 999, PMinPu = 0, PNom = 76, PRef0Pu = -PGen0Pu_gen_40101, QMaxPu = 0.3, QMinPu = -0.25, QPercent = 0.374, U0Pu = U0Pu_gen_40101, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {-128, -266}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_10101_ABEL_G1(KGover = 0, PGen0Pu = PGen0Pu_gen_10101, PMaxPu = 999, PMinPu = 0, PNom = 20, PRef0Pu = -PGen0Pu_gen_10101, QMaxPu = 0.1, QMinPu = 0, QPercent = 0.126, U0Pu = U0Pu_gen_10101, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {-248, -266}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_30101_ABEL_G3(KGover = 0, PGen0Pu = PGen0Pu_gen_30101, PMaxPu = 999, PMinPu = 0, PNom = 76, PRef0Pu = -PGen0Pu_gen_30101, QMaxPu = 0.3, QMinPu = -0.25, QPercent = 0.374, U0Pu = U0Pu_gen_30101, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
  ...
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1101_101(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 150, Tap0 = 10, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 10) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
    Placement(visible = true, transformation(origin = {-248, -186}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1103_103(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 250, Tap0 = 5, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 5) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
  ...
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_103_124(B = 0, G = 0, NbTap = 33, R = 0.008 * 100, SNom = 400, Tap0 = 1, X = 0.336 * 100, rTfo0Pu = 1 - 0.1 * (16 - 1) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_40102_ADAMS_G4(KGover = 0, PGen0Pu = PGen0Pu_gen_40102, PMaxPu = 999, PMinPu = 0, PNom = 76, PRef0Pu = -PGen0Pu_gen_40102, QMaxPu = 0.3, QMinPu = -0.25, QPercent = 0.322, U0Pu = U0Pu_gen_40102, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {76, -306}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_30102_ADAMS_G3(KGover = 0, PGen0Pu = PGen0Pu_gen_30102, PMaxPu = 999, PMinPu = 0, PNom = 76, PRef0Pu = -PGen0Pu_gen_30102, QMaxPu = 0.3, QMinPu = -0.25, QPercent = 0.322, U0Pu = U0Pu_gen_30102, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {36, -306}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_10102_ADAMS_G1(KGover = 0, PGen0Pu = PGen0Pu_gen_10102, PMaxPu = 999, PMinPu = 0, PNom = 20, PRef0Pu = -PGen0Pu_gen_10102, QMaxPu = 0.1, QMinPu = 0, QPercent = 0.178, U0Pu = U0Pu_gen_10102, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {-44, -306}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_20102_ADAMS_G2(KGover = 0, PGen0Pu = PGen0Pu_gen_20102, PMaxPu = 999, PMinPu = 0, PNom = 20, PRef0Pu = -PGen0Pu_gen_20102, QMaxPu = 0.1, QMinPu = 0, QPercent = 0.178, U0Pu = U0Pu_gen_20102, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
  ...
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1102_102(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 150, Tap0 = 11, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 11) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
  ...
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1106_106(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 200, Tap0 = 10, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 10) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
    Placement(visible = true, transformation(origin = {132, -266}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_10122_AUBREY_G1(KGover = 0, PGen0Pu = PGen0Pu_gen_10122, PMaxPu = 999, PMinPu = 0, PNom = 50, PRef0Pu = -PGen0Pu_gen_10122, QMaxPu = 0.16, QMinPu = -0.1, QPercent = 0.1666667, U0Pu = U0Pu_gen_10122, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {166, 278}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_40122_AUBREY_G4(KGover = 0, PGen0Pu = PGen0Pu_gen_40122, PMaxPu = 999, PMinPu = 0, PNom = 50, PRef0Pu = -PGen0Pu_gen_40122, QMaxPu = 0.16, QMinPu = -0.1, QPercent = 0.1666667, U0Pu = U0Pu_gen_40122, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_60122_AUBREY_G6(KGover = 0, PGen0Pu = PGen0Pu_gen_60122, PMaxPu = 999, PMinPu = 0, PNom = 50, PRef0Pu = -PGen0Pu_gen_60122, QMaxPu = 0.16, QMinPu = -0.1, QPercent = 0.1666667, U0Pu = U0Pu_gen_60122, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_50122_AUBREY_G5(KGover = 0, PGen0Pu = PGen0Pu_gen_50122, PMaxPu = 999, PMinPu = 0, PNom = 50, PRef0Pu = -PGen0Pu_gen_50122, QMaxPu = 0.16, QMinPu = -0.1, QPercent = 0.1666667, U0Pu = U0Pu_gen_50122, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_20122_AUBREY_G2(KGover = 0, PGen0Pu = PGen0Pu_gen_20122, PMaxPu = 999, PMinPu = 0, PNom = 50, PRef0Pu = -PGen0Pu_gen_20122, QMaxPu = 0.16, QMinPu = -0.1, QPercent = 0.1666667, U0Pu = U0Pu_gen_20122, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_30122_AUBREY_G3(KGover = 0, PGen0Pu = PGen0Pu_gen_30122, PMaxPu = 999, PMinPu = 0, PNom = 50, PRef0Pu = -PGen0Pu_gen_30122, QMaxPu = 0.16, QMinPu = -0.1, QPercent = 0.1666667, U0Pu = U0Pu_gen_30122, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
  ...
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1120_120(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 200, Tap0 = 10, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 10) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
    Placement(visible = true, transformation(origin = {146, 106}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1119_119(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 250, Tap0 = 7, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 7) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_10123_AUSTEN_G1(KGover = 0, PGen0Pu = PGen0Pu_gen_10123, PMaxPu = 999, PMinPu = 0, PNom = 155, PRef0Pu = -PGen0Pu_gen_10123, QMaxPu = 0.8, QMinPu = -0.5, QPercent = 0.258, U0Pu = U0Pu_gen_10123, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {296, 146}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_20123_AUSTEN_G2(KGover = 0, PGen0Pu = PGen0Pu_gen_20123, PMaxPu = 999, PMinPu = 0, PNom = 155, PRef0Pu = -PGen0Pu_gen_20123, QMaxPu = 0.8, QMinPu = -0.5, QPercent = 0.258, U0Pu = U0Pu_gen_20123, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_30123_AUSTEN_G3(KGover = 0, PGen0Pu = PGen0Pu_gen_30123, PMaxPu = 999, PMinPu = 0, PNom = 350, PRef0Pu = -PGen0Pu_gen_30123, QMaxPu = 1.5, QMinPu = -0.5, QPercent = 0.484, U0Pu = U0Pu_gen_30123, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {296, 66}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_10113_ARNE_G1(KGover = 0, PGen0Pu = PGen0Pu_gen_10113, PMaxPu = 999, PMinPu = 0, PNom = 197, PRef0Pu = -PGen0Pu_gen_10113, QMaxPu = 0.827791, QMinPu = 0, QPercent = 0.01492537, U0Pu = U0Pu_gen_10113, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {186, 46}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_30113_ARNE_G3(KGover = 0, PGen0Pu = PGen0Pu_gen_30113, PMaxPu = 999, PMinPu = 0, PNom = 197, PRef0Pu = -PGen0Pu_gen_30113, QMaxPu = 80, QMinPu = 0, QPercent = 0.4925373, U0Pu = U0Pu_gen_30113, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_20113_ARNE_G2(KGover = 0, PGen0Pu = PGen0Pu_gen_20113, PMaxPu = 999, PMinPu = 0, PNom = 197, PRef0Pu = -PGen0Pu_gen_20113, QMaxPu = 80, QMinPu = 0, QPercent = 0.4925373, U0Pu = U0Pu_gen_20113, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
  ...
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1113_113(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 350, Tap0 = 7, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 7) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_10107_ALDER_G1(KGover = 0, PGen0Pu = PGen0Pu_gen_10107, PMaxPu = 999, PMinPu = 0, PNom = 100, PRef0Pu = -PGen0Pu_gen_10107, QMaxPu = 0.6, QMinPu = 0, QPercent = 0.3333333, U0Pu = U0Pu_gen_10107, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_30107_ALDER_G3(KGover = 0, PGen0Pu = PGen0Pu_gen_30107, PMaxPu = 999, PMinPu = 0, PNom = 100, PRef0Pu = -PGen0Pu_gen_30107, QMaxPu = 0.6, QMinPu = 0, QPercent = 0.3333333, U0Pu = U0Pu_gen_30107, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {296, -214}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_20107_ALDER_G2(KGover = 0, PGen0Pu = PGen0Pu_gen_20107, PMaxPu = 999, PMinPu = 0, PNom = 100, PRef0Pu = -PGen0Pu_gen_20107, QMaxPu = 0.6, QMinPu = 0, QPercent = 0.3333333, U0Pu = U0Pu_gen_20107, qStatus0 = Dynawo.Electrical.Machines.SignalN.GeneratorPQProp.QStatus.Standard, QDeadBandPu=1e-4) annotation(
    Placement(visible = true, transformation(origin = {296, -174}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1107_107(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 200, Tap0 = 10, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 10) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
    Placement(visible = true, transformation(origin = {216, -214}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1108_108(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 250, Tap0 = 7, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 7) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
    Placement(visible = true, transformation(origin = {176, -174}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_109_111(B = 0, G = 0, NbTap = 33, R = 0.008 * 100, SNom = 400, Tap0 = 12, X = 0.336 * 100, rTfo0Pu = 1 - 0.1 * (16 - 12) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
    Placement(visible = true, transformation(origin = {-74, 16}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1109_109(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 250, Tap0 = 7, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 7) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
    Placement(visible = true, transformation(origin = {-80, -128}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1104_104(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 100, Tap0 = 4, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 4) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
    Placement(visible = true, transformation(origin = {-80, -168}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_110_112(B = 0, G = 0, NbTap = 33, R = 0.008 * 100, SNom = 400, Tap0 = 12, X = 0.336 * 100, rTfo0Pu = 1 - 0.1 * (16 - 12) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
    Placement(visible = true, transformation(origin = {28, 16}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_110_111(B = 0, G = 0, NbTap = 33, R = 0.008 * 100, SNom = 400, Tap0 = 13, X = 0.336 * 100, rTfo0Pu = 1 - 0.1 * (16 - 13) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
    Placement(visible = true, transformation(origin = {-24, -44}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_109_112(B = 0, G = 0, NbTap = 33, R = 0.008 * 100, SNom = 400, Tap0 = 0, X = 0.336 * 100, rTfo0Pu = 1 - 0.1 * (16 - 0) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
    Placement(visible = true, transformation(origin = {-24, -14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1105_105(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 100, Tap0 = 5, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 5) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
    Placement(visible = true, transformation(origin = {8, -224}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Transformers.TransformersVariableTap.TransformerVariableTap tfo_1110_110(B = 0, G = 0, NbTap = 33, R = 0.003 * 100, SNom = 250, Tap0 = 6, X = 0.15 * 100, rTfo0Pu = 1 - 0.1 * (16 - 6) / 16, rTfoMaxPu = 1.1, rTfoMinPu = 0.9, u10Pu = Complex(1, 0)) annotation(
...
equation
  ...
  tfo_1101_101.switchOffSignal2 = false;
  tfo_10101_101.switchOffSignal1 = false;
  tfo_10101_101.switchOffSignal2 = false;
  tfo_20101_101.switchOffSignal1 = false;
  tfo_20101_101.switchOffSignal2 = false;
  tfo_30101_101.switchOffSignal1 = false;
  tfo_30101_101.switchOffSignal2 = false;
  tfo_40101_101.switchOffSignal1 = false;
  tfo_40101_101.switchOffSignal2 = false;
  tfo_1102_102.switchOffSignal1 = false;
  tfo_1102_102.switchOffSignal2 = false;
  tfo_10102_102.switchOffSignal1 = false;
  tfo_10102_102.switchOffSignal2 = false;
  tfo_20102_102.switchOffSignal1 = false;
  tfo_20102_102.switchOffSignal2 = false;
  tfo_30102_102.switchOffSignal1 = false;
  tfo_30102_102.switchOffSignal2 = false;
  tfo_40102_102.switchOffSignal1 = false;
  tfo_40102_102.switchOffSignal2 = false;
  tfo_1103_103.switchOffSignal1 = false;
  tfo_1103_103.switchOffSignal2 = false;
  tfo_103_124.switchOffSignal1 = false;
  tfo_103_124.switchOffSignal2 = false;
  tfo_1104_104.switchOffSignal1 = false;
  tfo_1104_104.switchOffSignal2 = false;
  tfo_1105_105.switchOffSignal1 = false;
  tfo_1105_105.switchOffSignal2 = false;
  tfo_1106_106.switchOffSignal1 = false;
  tfo_1106_106.switchOffSignal2 = false;
  tfo_10106_106.switchOffSignal1 = false;
  tfo_10106_106.switchOffSignal2 = false;
  tfo_1107_107.switchOffSignal1 = false;
  tfo_1107_107.switchOffSignal2 = false;
  tfo_10107_107.switchOffSignal1 = false;
  tfo_10107_107.switchOffSignal2 = false;
  tfo_20107_107.switchOffSignal1 = false;
  tfo_20107_107.switchOffSignal2 = false;
  tfo_30107_107.switchOffSignal1 = false;
  tfo_30107_107.switchOffSignal2 = false;
  tfo_1108_108.switchOffSignal1 = false;
  tfo_1108_108.switchOffSignal2 = false;
  tfo_1109_109.switchOffSignal1 = false;
  tfo_1109_109.switchOffSignal2 = false;
  tfo_109_111.switchOffSignal1 = false;
  tfo_109_111.switchOffSignal2 = false;
  tfo_109_112.switchOffSignal1 = false;
  tfo_109_112.switchOffSignal2 = false;
  tfo_110_111.switchOffSignal1 = false;
  tfo_110_111.switchOffSignal2 = false;
  tfo_110_112.switchOffSignal1 = false;
  tfo_110_112.switchOffSignal2 = false;
  tfo_1110_110.switchOffSignal1 = false;
  tfo_1110_110.switchOffSignal2 = false;
  tfo_1113_113.switchOffSignal1 = false;
  tfo_1113_113.switchOffSignal2 = false;
  tfo_10113_113.switchOffSignal1 = false;
  tfo_10113_113.switchOffSignal2 = false;
  tfo_20113_113.switchOffSignal1 = false;
  tfo_20113_113.switchOffSignal2 = false;
  tfo_30113_113.switchOffSignal1 = false;
  tfo_30113_113.switchOffSignal2 = false;
  tfo_1114_114.switchOffSignal1 = false;
  tfo_1114_114.switchOffSignal2 = false;
  tfo_10114_114.switchOffSignal1 = false;
  tfo_10114_114.switchOffSignal2 = false;
  tfo_1115_115.switchOffSignal1 = false;
  tfo_1115_115.switchOffSignal2 = false;
  tfo_10115_115.switchOffSignal1 = false;
  tfo_10115_115.switchOffSignal2 = false;
  tfo_20115_115.switchOffSignal1 = false;
  tfo_20115_115.switchOffSignal2 = false;
  tfo_30115_115.switchOffSignal1 = false;
  tfo_30115_115.switchOffSignal2 = false;
  tfo_40115_115.switchOffSignal1 = false;
  tfo_40115_115.switchOffSignal2 = false;
  tfo_50115_115.switchOffSignal1 = false;
  tfo_50115_115.switchOffSignal2 = false;
  tfo_60115_115.switchOffSignal1 = false;
  tfo_60115_115.switchOffSignal2 = false;
  tfo_1116_116.switchOffSignal1 = false;
  tfo_1116_116.switchOffSignal2 = false;
  tfo_10116_116.switchOffSignal1 = false;
  tfo_10116_116.switchOffSignal2 = false;
  tfo_1118_118.switchOffSignal1 = false;
  tfo_1118_118.switchOffSignal2 = false;
  tfo_10118_118.switchOffSignal1 = false;
  tfo_10118_118.switchOffSignal2 = false;
  tfo_1119_119.switchOffSignal1 = false;
  tfo_1119_119.switchOffSignal2 = false;
  tfo_1120_120.switchOffSignal1 = false;
  tfo_1120_120.switchOffSignal2 = false;
  tfo_10121_121.switchOffSignal1 = false;
  tfo_10121_121.switchOffSignal2 = false;
  tfo_10122_122.switchOffSignal1 = false;
  tfo_10122_122.switchOffSignal2 = false;
  tfo_20122_122.switchOffSignal1 = false;
  tfo_20122_122.switchOffSignal2 = false;
  tfo_30122_122.switchOffSignal1 = false;
  tfo_30122_122.switchOffSignal2 = false;
  tfo_40122_122.switchOffSignal1 = false;
  tfo_40122_122.switchOffSignal2 = false;
  tfo_50122_122.switchOffSignal1 = false;
  tfo_50122_122.switchOffSignal2 = false;
  tfo_60122_122.switchOffSignal1 = false;
  tfo_60122_122.switchOffSignal2 = false;
  tfo_10123_123.switchOffSignal1 = false;
  tfo_10123_123.switchOffSignal2 = false;
  tfo_20123_123.switchOffSignal1 = false;
  tfo_20123_123.switchOffSignal2 = false;
  tfo_30123_123.switchOffSignal1 = false;
  tfo_30123_123.switchOffSignal2 = false;
  ...
  gen_10101_ABEL_G1.switchOffSignal1 = false;
  gen_10101_ABEL_G1.switchOffSignal2 = false;
  gen_10101_ABEL_G1.switchOffSignal3 = false;
  gen_10101_ABEL_G1.N = N.setPoint;
  gen_10101_ABEL_G1.NQ = vRRemote_bus_101.NQ;
  gen_10101_ABEL_G1.PRefPu = -PGen0Pu_gen_10101;
  gen_20101_ABEL_G2.switchOffSignal1 = false;
  gen_20101_ABEL_G2.switchOffSignal2 = false;
  gen_20101_ABEL_G2.switchOffSignal3 = false;
  gen_20101_ABEL_G2.N = N.setPoint;
  gen_20101_ABEL_G2.NQ = vRRemote_bus_101.NQ;
  gen_20101_ABEL_G2.PRefPu = -PGen0Pu_gen_20101;
  gen_30101_ABEL_G3.switchOffSignal1 = false;
  gen_30101_ABEL_G3.switchOffSignal2 = false;
  gen_30101_ABEL_G3.switchOffSignal3 = false;
  gen_30101_ABEL_G3.N = N.setPoint;
  gen_30101_ABEL_G3.NQ = vRRemote_bus_101.NQ;
  gen_30101_ABEL_G3.PRefPu = -PGen0Pu_gen_30101;
  gen_40101_ABEL_G4.switchOffSignal1 = false;
  gen_40101_ABEL_G4.switchOffSignal2 = false;
  gen_40101_ABEL_G4.switchOffSignal3 = false;
  gen_40101_ABEL_G4.N = N.setPoint;
  ...
  gen_10102_ADAMS_G1.switchOffSignal1 = false;
  gen_10102_ADAMS_G1.switchOffSignal2 = false;
  gen_10102_ADAMS_G1.switchOffSignal3 = false;
  gen_10102_ADAMS_G1.N = N.setPoint;
  gen_10102_ADAMS_G1.NQ = vRRemote_bus_102.NQ;
  gen_10102_ADAMS_G1.PRefPu = -PGen0Pu_gen_10102;
  gen_20102_ADAMS_G2.switchOffSignal1 = false;
  gen_20102_ADAMS_G2.switchOffSignal2 = false;
  gen_20102_ADAMS_G2.switchOffSignal3 = false;
  gen_20102_ADAMS_G2.N = N.setPoint;
  gen_20102_ADAMS_G2.NQ = vRRemote_bus_102.NQ;
  gen_20102_ADAMS_G2.PRefPu = -PGen0Pu_gen_20102;
  gen_30102_ADAMS_G3.switchOffSignal1 = false;
  gen_30102_ADAMS_G3.switchOffSignal2 = false;
  gen_30102_ADAMS_G3.switchOffSignal3 = false;
  gen_30102_ADAMS_G3.N = N.setPoint;
  gen_30102_ADAMS_G3.NQ = vRRemote_bus_102.NQ;
  gen_30102_ADAMS_G3.PRefPu = -PGen0Pu_gen_30102;
  gen_40102_ADAMS_G4.switchOffSignal1 = false;
  gen_40102_ADAMS_G4.switchOffSignal2 = false;
  gen_40102_ADAMS_G4.switchOffSignal3 = false;
  gen_40102_ADAMS_G4.N = N.setPoint;
  ...
  gen_10107_ALDER_G1.switchOffSignal1 = false;
  gen_10107_ALDER_G1.switchOffSignal2 = false;
  gen_10107_ALDER_G1.switchOffSignal3 = false;
  gen_10107_ALDER_G1.N = N.setPoint;
  gen_10107_ALDER_G1.NQ = vRRemote_bus_107.NQ;
  gen_10107_ALDER_G1.PRefPu = -PGen0Pu_gen_10107;
  gen_20107_ALDER_G2.switchOffSignal1 = false;
  gen_20107_ALDER_G2.switchOffSignal2 = false;
  gen_20107_ALDER_G2.switchOffSignal3 = false;
  gen_20107_ALDER_G2.N = N.setPoint;
  gen_20107_ALDER_G2.NQ = vRRemote_bus_107.NQ;
  gen_20107_ALDER_G2.PRefPu = -PGen0Pu_gen_20107;
  gen_30107_ALDER_G3.switchOffSignal1 = false;
  gen_30107_ALDER_G3.switchOffSignal2 = false;
  gen_30107_ALDER_G3.switchOffSignal3 = false;
  gen_30107_ALDER_G3.N = N.setPoint;
  ...
  gen_10113_ARNE_G1.switchOffSignal1 = false;
  gen_10113_ARNE_G1.switchOffSignal2 = false;
  gen_10113_ARNE_G1.switchOffSignal3 = false;
  gen_10113_ARNE_G1.N = N.setPoint;
  gen_10113_ARNE_G1.NQ = vRRemote_bus_113.NQ;
  gen_10113_ARNE_G1.PRefPu = -PGen0Pu_gen_10113;
  gen_20113_ARNE_G2.switchOffSignal1 = false;
  gen_20113_ARNE_G2.switchOffSignal2 = false;
  gen_20113_ARNE_G2.switchOffSignal3 = false;
  gen_20113_ARNE_G2.N = N.setPoint;
  gen_20113_ARNE_G2.NQ = vRRemote_bus_113.NQ;
  gen_20113_ARNE_G2.PRefPu = -PGen0Pu_gen_20113;
  gen_30113_ARNE_G3.switchOffSignal1 = false;
  gen_30113_ARNE_G3.switchOffSignal2 = false;
  gen_30113_ARNE_G3.switchOffSignal3 = false;
  gen_30113_ARNE_G3.N = N.setPoint;
  ...
  gen_10118_ASTOR_G1.switchOffSignal1 = false;
  gen_10118_ASTOR_G1.switchOffSignal2 = false;
  gen_10118_ASTOR_G1.switchOffSignal3 = false;
  gen_10118_ASTOR_G1.N = N.setPoint;
  ...
  gen_10115_ARTHUR_G1.switchOffSignal1 = false;
  gen_10115_ARTHUR_G1.switchOffSignal2 = false;
  gen_10115_ARTHUR_G1.switchOffSignal3 = false;
  gen_10115_ARTHUR_G1.N = N.setPoint;
  gen_10115_ARTHUR_G1.NQ = vRRemote_bus_115.NQ;
  gen_10115_ARTHUR_G1.PRefPu = -PGen0Pu_gen_10115;
  gen_20115_ARTHUR_G2.switchOffSignal1 = false;
  gen_20115_ARTHUR_G2.switchOffSignal2 = false;
  gen_20115_ARTHUR_G2.switchOffSignal3 = false;
  gen_20115_ARTHUR_G2.N = N.setPoint;
  gen_20115_ARTHUR_G2.NQ = vRRemote_bus_115.NQ;
  gen_20115_ARTHUR_G2.PRefPu = -PGen0Pu_gen_20115;
  gen_30115_ARTHUR_G3.switchOffSignal1 = false;
  gen_30115_ARTHUR_G3.switchOffSignal2 = false;
  gen_30115_ARTHUR_G3.switchOffSignal3 = false;
  gen_30115_ARTHUR_G3.N = N.setPoint;
  gen_30115_ARTHUR_G3.NQ = vRRemote_bus_115.NQ;
  gen_30115_ARTHUR_G3.PRefPu = -PGen0Pu_gen_30115;
  gen_40115_ARTHUR_G4.switchOffSignal1 = false;
  gen_40115_ARTHUR_G4.switchOffSignal2 = false;
  gen_40115_ARTHUR_G4.switchOffSignal3 = false;
  gen_40115_ARTHUR_G4.N = N.setPoint;
  gen_40115_ARTHUR_G4.NQ = vRRemote_bus_115.NQ;
  gen_40115_ARTHUR_G4.PRefPu = -PGen0Pu_gen_40115;
  gen_50115_ARTHUR_G5.switchOffSignal1 = false;
  gen_50115_ARTHUR_G5.switchOffSignal2 = false;
  gen_50115_ARTHUR_G5.switchOffSignal3 = false;
  gen_50115_ARTHUR_G5.N = N.setPoint;
  gen_50115_ARTHUR_G5.NQ = vRRemote_bus_115.NQ;
  gen_50115_ARTHUR_G5.PRefPu = -PGen0Pu_gen_50115;
  gen_60115_ARTHUR_G6.switchOffSignal1 = false;
  gen_60115_ARTHUR_G6.switchOffSignal2 = false;
  gen_60115_ARTHUR_G6.switchOffSignal3 = false;
  gen_60115_ARTHUR_G6.N = N.setPoint;
  ...
  gen_10122_AUBREY_G1.switchOffSignal1 = false;
  gen_10122_AUBREY_G1.switchOffSignal2 = false;
  gen_10122_AUBREY_G1.switchOffSignal3 = false;
  gen_10122_AUBREY_G1.N = N.setPoint;
  gen_10122_AUBREY_G1.NQ = vRRemote_bus_122.NQ;
  gen_10122_AUBREY_G1.PRefPu = -PGen0Pu_gen_10122;
  gen_20122_AUBREY_G2.switchOffSignal1 = false;
  gen_20122_AUBREY_G2.switchOffSignal2 = false;
  gen_20122_AUBREY_G2.switchOffSignal3 = false;
  gen_20122_AUBREY_G2.N = N.setPoint;
  gen_20122_AUBREY_G2.NQ = vRRemote_bus_122.NQ;
  gen_20122_AUBREY_G2.PRefPu = -PGen0Pu_gen_20122;
  gen_30122_AUBREY_G3.switchOffSignal1 = false;
  gen_30122_AUBREY_G3.switchOffSignal2 = false;
  gen_30122_AUBREY_G3.switchOffSignal3 = false;
  gen_30122_AUBREY_G3.N = N.setPoint;
  gen_30122_AUBREY_G3.NQ = vRRemote_bus_122.NQ;
  gen_30122_AUBREY_G3.PRefPu = -PGen0Pu_gen_30122;
  gen_40122_AUBREY_G4.switchOffSignal1 = false;
  gen_40122_AUBREY_G4.switchOffSignal2 = false;
  gen_40122_AUBREY_G4.switchOffSignal3 = false;
  gen_40122_AUBREY_G4.N = N.setPoint;
  gen_40122_AUBREY_G4.NQ = vRRemote_bus_122.NQ;
  gen_40122_AUBREY_G4.PRefPu = -PGen0Pu_gen_40122;
  gen_50122_AUBREY_G5.switchOffSignal1 = false;
  gen_50122_AUBREY_G5.switchOffSignal2 = false;
  gen_50122_AUBREY_G5.switchOffSignal3 = false;
  gen_50122_AUBREY_G5.N = N.setPoint;
  gen_50122_AUBREY_G5.NQ = vRRemote_bus_122.NQ;
  gen_50122_AUBREY_G5.PRefPu = -PGen0Pu_gen_50122;
  gen_60122_AUBREY_G6.switchOffSignal1 = false;
  gen_60122_AUBREY_G6.switchOffSignal2 = false;
  gen_60122_AUBREY_G6.switchOffSignal3 = false;
  gen_60122_AUBREY_G6.N = N.setPoint;
  ...
  gen_10116_ASSER_G1.switchOffSignal1 = false;
  gen_10116_ASSER_G1.switchOffSignal2 = false;
  gen_10116_ASSER_G1.switchOffSignal3 = false;
  gen_10116_ASSER_G1.N = N.setPoint;
  ...
  gen_10123_AUSTEN_G1.switchOffSignal1 = false;
  gen_10123_AUSTEN_G1.switchOffSignal2 = false;
  gen_10123_AUSTEN_G1.switchOffSignal3 = false;
  gen_10123_AUSTEN_G1.N = N.setPoint;
  gen_10123_AUSTEN_G1.NQ = vRRemote_bus_123.NQ;
  gen_10123_AUSTEN_G1.PRefPu = -PGen0Pu_gen_10123;
  gen_20123_AUSTEN_G2.switchOffSignal1 = false;
  gen_20123_AUSTEN_G2.switchOffSignal2 = false;
  gen_20123_AUSTEN_G2.switchOffSignal3 = false;
  gen_20123_AUSTEN_G2.N = N.setPoint;
  gen_20123_AUSTEN_G2.NQ = vRRemote_bus_123.NQ;
  gen_20123_AUSTEN_G2.PRefPu = -PGen0Pu_gen_20123;
  gen_30123_AUSTEN_G3.switchOffSignal1 = false;
  gen_30123_AUSTEN_G3.switchOffSignal2 = false;
  gen_30123_AUSTEN_G3.switchOffSignal3 = false;
  gen_30123_AUSTEN_G3.N = N.setPoint;
  gen_30123_AUSTEN_G3.NQ = vRRemote_bus_123.NQ;
  gen_30123_AUSTEN_G3.PRefPu = -PGen0Pu_gen_30123;
  sVarC_10114_ARNOLD_SVC.switchOffSignal1 = false;
  sVarC_10114_ARNOLD_SVC.switchOffSignal2 = false;
  sVarC_10114_ARNOLD_SVC.URefPu = 1.05;
  sVarC_10106_ALBER_SVC.switchOffSignal1 = false;
  sVarC_10106_ALBER_SVC.switchOffSignal2 = false;
