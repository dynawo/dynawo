...
model FullDynamicFromLoadflowAllLTCsSvcPV121
  ...
  final constant Types.ReactivePowerPu Q0Pu_shunt_reactor_101 = 0 / SnRef;
...
// if time < 1 then true else
  ...
  connect(gen_10121_ATTLEE_G1.terminal, bus_10121_ATTLEE_G1.terminal) annotation(
    Line(points = {{-122, 186}, {-100, 186}}, color = {0, 0, 255}));
  annotation(
    experiment(StartTime = 0, StopTime = 80, Tolerance = 0.001, Interval = 0.01),
...
end FullDynamicFromLoadflowAllLTCsSvcPV121;
