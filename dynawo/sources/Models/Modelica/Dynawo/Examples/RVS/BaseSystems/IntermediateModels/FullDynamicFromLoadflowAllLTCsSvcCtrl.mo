...
model FullDynamicFromLoadflowAllLTCsSvcCtrl
  ...
  Components.StaticVarCompensators.SVarCRVS sVarC_10114(Q0Pu = Q0Pu_sVarC_10114, U0Pu = U0Pu_sVarC_10114, UPhase0 = UPhase0_sVarC_10114, URef0Pu = 1.05, svcPreset = Dynawo.Examples.RVS.Components.StaticVarCompensators.Util.ParametersSVC.svcFramePreset.sVarC_10114)  annotation(
    Placement(visible = true, transformation(origin = {46, 28}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Examples.RVS.Components.StaticVarCompensators.SVarCRVS sVarC_10106(Q0Pu = Q0Pu_sVarC_10106, U0Pu = U0Pu_sVarC_10106, UPhase0 = UPhase0_sVarC_10106, URef0Pu = 1.05, svcPreset = Dynawo.Examples.RVS.Components.StaticVarCompensators.Util.ParametersSVC.svcFramePreset.sVarC_10106)  annotation(
...
/*gen_10121_ATTLEE_G1.generatorSynchronous.switchOffSignal1.value = false;
  ...
  */
  ...
  sVarC_10106.URefPu = 1.05;
  sVarC_10106.sVarCVPropInterface.switchOffSignal1.value = false;
  sVarC_10106.sVarCVPropInterface.switchOffSignal2.value = false;
  sVarC_10114.URefPu = 1.05;
  sVarC_10114.sVarCVPropInterface.switchOffSignal1.value = false;
  sVarC_10114.sVarCVPropInterface.switchOffSignal2.value = false;
// if time < 1 then true else
  ...
  connect(sVarC_10114.terminal, bus_10114_ARNOLD_SVC.terminal) annotation(
    Line(points = {{46, 28}, {28, 28}}, color = {0, 0, 255}));
  connect(sVarC_10106.terminal, bus_10106_ALBER_SVC.terminal) annotation(
    Line(points = {{206, -322}, {186, -322}}, color = {0, 0, 255}));
  annotation(
...
end FullDynamicFromLoadflowAllLTCsSvcCtrl;
