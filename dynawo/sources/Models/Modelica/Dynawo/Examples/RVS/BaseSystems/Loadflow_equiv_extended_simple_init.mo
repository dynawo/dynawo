...
model Loadflow_equiv_extended_simple_init
  ...
  final parameter Types.VoltageModulePu URef0Pu_sVarC_10106 = 0.9866;
  final parameter Types.ActivePowerPu PRef0Pu_gen_10101 = 10 / SnRef;
  final parameter Types.ReactivePowerPu QRef0Pu_gen_10101 = 3.440 / SnRef;
  final parameter Types.ComplexApparentPowerPu s0Pu_gen_10101 = Complex(PRef0Pu_gen_10101, QRef0Pu_gen_10101);
  final parameter Types.ComplexVoltagePu u0Pu_gen_10101 = ComplexMath.fromPolar(1.0056, from_deg(-18.7658));
  ...
  final parameter Types.ReactivePowerPu QRef0Pu_gen_20101 = 3.440 / SnRef;
  final parameter Types.ComplexApparentPowerPu s0Pu_gen_20101 = Complex(PRef0Pu_gen_20101, QRef0Pu_gen_20101);
  final parameter Types.ComplexVoltagePu u0Pu_gen_20101 = ComplexMath.fromPolar(1.0056, from_deg(-18.7658));
  ...
  final parameter Types.ReactivePowerPu QRef0Pu_gen_30101 = 10.211 / SnRef;
  final parameter Types.ComplexApparentPowerPu s0Pu_gen_30101 = Complex(PRef0Pu_gen_30101, QRef0Pu_gen_30101);
  final parameter Types.ComplexVoltagePu u0Pu_gen_30101 = ComplexMath.fromPolar(0.9964, from_deg(-14.8795));
  ...
  final parameter Types.ReactivePowerPu QRef0Pu_gen_40101 = 10.211 / SnRef;
  final parameter Types.ComplexApparentPowerPu s0Pu_gen_40101 = Complex(PRef0Pu_gen_40101, QRef0Pu_gen_40101);
  final parameter Types.ComplexVoltagePu u0Pu_gen_40101 = ComplexMath.fromPolar(0.9964, from_deg(-14.8795));
  ...
  final parameter Types.ComplexVoltagePu u0Pu_gen_10102 = ComplexMath.fromPolar(1.0457, from_deg(-19.7409));
  ...
  final parameter Types.ComplexVoltagePu u0Pu_gen_20102 = ComplexMath.fromPolar(1.0457, from_deg(-19.7409));
  ...
  final parameter Types.ReactivePowerPu QRef0Pu_gen_30102 = 25.424 / SnRef;
  final parameter Types.ComplexApparentPowerPu s0Pu_gen_30102 = Complex(PRef0Pu_gen_30102, QRef0Pu_gen_30102);
  final parameter Types.ComplexVoltagePu u0Pu_gen_30102 = ComplexMath.fromPolar(1.023, from_deg(-15.9019));
  ...
  final parameter Types.ReactivePowerPu QRef0Pu_gen_40102 = 25.424 / SnRef;
  final parameter Types.ComplexApparentPowerPu s0Pu_gen_40102 = Complex(PRef0Pu_gen_40102, QRef0Pu_gen_40102);
  final parameter Types.ComplexVoltagePu u0Pu_gen_40102 = ComplexMath.fromPolar(1.023, from_deg(-15.9019));
  ...
  final parameter Types.ComplexVoltagePu u0Pu_load_1101 = ComplexMath.fromPolar(1.043, from_deg(-28.4187));
  ...
  final parameter Types.ComplexVoltagePu u0Pu_load_1102 = ComplexMath.fromPolar(1.0412, from_deg(-28.6224));
  ...
  final parameter Types.ComplexVoltagePu u0Pu_load_1106 = ComplexMath.fromPolar(1.0366, from_deg(-46.4556));
  final parameter Types.ComplexCurrentPu i0Pu_load_1106 = ComplexMath.conj(s0Pu_load_1106 / u0Pu_load_1106);
  final parameter Types.ActivePowerPu P0Pu_svc_10106 = 0 / SystemBase.SnRef;
  final parameter Types.ReactivePowerPu Q0Pu_svc_10106 = 92.758 / SystemBase.SnRef;
  final parameter Types.ComplexApparentPowerPu s0Pu_svc_10106 = Complex(P0Pu_svc_10106, Q0Pu_svc_10106);
  final parameter Types.ComplexVoltagePu u0Pu_svc_10106 = ComplexMath.fromPolar(1.05, from_deg(-40.7899));
  final parameter Types.ComplexCurrentPu i0Pu_svc_10106 = ComplexMath.conj(s0Pu_svc_10106 / u0Pu_svc_10106);
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_20101_ABEL_G2(KGover = 0, PGen0Pu = PRef0Pu_gen_20101, PMaxPu = 999, PMinPu = 0, PNom = 20, PRef0Pu = -PRef0Pu_gen_20101, QMaxPu = 0.1, QMinPu = 0, QPercent = 0.126, U0Pu = 1, i0Pu = Complex(1, 0), u0Pu = Complex(1, 0)) annotation(
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_10101_ABEL_G1(KGover = 0, PGen0Pu = PRef0Pu_gen_10101, PMaxPu = 999, PMinPu = 0, PNom = 20, PRef0Pu = -PRef0Pu_gen_10101, QMaxPu = 0.1, QMinPu = 0, QPercent = 0.126, U0Pu = 1, i0Pu = Complex(1, 0), u0Pu = Complex(1, 0)
  ) annotation(
  ...
  QPercent = 0.374, U0Pu = 1, i0Pu = Complex(1, 0), u0Pu = Complex(1, 0)) annotation(
    Placement(visible = true, transformation(origin = {20, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Dynawo.Electrical.Loads.LoadPQ load_1101_ABEL(i0Pu = Complex(1, 0), s0Pu = s0Pu_load_1101, u0Pu = Complex(1, 0)) annotation(
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_40101_ABEL_G4(KGover = 0, PGen0Pu = PRef0Pu_gen_40101, PMaxPu = 999, PMinPu = 0, PNom = 76, PRef0Pu = -PRef0Pu_gen_40101, QMaxPu = 0.3, QMinPu = -0.25, QPercent = 0.374, U0Pu = 1, i0Pu = Complex(1, 0), u0Pu = Complex(1, 0)
  ) annotation(
    Placement(visible = true, transformation(origin = {60, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_10102_ADAMS_G1(KGover = 0, PGen0Pu = PRef0Pu_gen_10102, PMaxPu = 999, PMinPu = 0, PNom = 20, PRef0Pu = -PRef0Pu_gen_10102, QMaxPu = 0.1, QMinPu = 0, QPercent = 0.178, U0Pu = 1, i0Pu = Complex(1, 0), u0Pu = Complex(1, 0)) annotation(
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_30102_ADAMS_G3(KGover = 0, PGen0Pu = PRef0Pu_gen_30102, PMaxPu = 999, PMinPu = 0, PNom = 76, PRef0Pu = -PRef0Pu_gen_30102, QMaxPu = 0.3, QMinPu = -0.25, QPercent = 0.322, i0Pu = Complex(1, 0), u0Pu = Complex(1, 0)) annotation(
  ...
  Dynawo.Electrical.Loads.LoadPQ load_1102_ADAMS(i0Pu = Complex(1, 0), s0Pu = s0Pu_load_1102, u0Pu = Complex(1, 0))  annotation(
    Placement(visible = true, transformation(origin = {82, -70}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_40102_ADAMS_G4(KGover = 0, PGen0Pu = PRef0Pu_gen_40102, PMaxPu = 999, PMinPu = 0, PNom = 76, PRef0Pu = -PRef0Pu_gen_40102, QMaxPu = 0.3, QMinPu = -0.25, QPercent = 0.322, U0Pu = 1, i0Pu = Complex(1, 0), u0Pu = Complex(1, 0)) annotation(
    Placement(visible = true, transformation(origin = {272, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_20102_ADAMS_G2(KGover = 0, PGen0Pu = PRef0Pu_gen_20102, PMaxPu = 999, PMinPu = 0, PNom = 20, PRef0Pu = -PRef0Pu_gen_20102, QMaxPu = 0.1, QMinPu = 0, QPercent = 0.178, U0Pu = 1, i0Pu = Complex(1, 0), u0Pu = Complex(1, 0)) annotation(
  ...
  Dynawo.Electrical.Loads.LoadPQ load_1106_ALBER(i0Pu = i0Pu_load_1106, s0Pu = s0Pu_load_1106, u0Pu = u0Pu_load_1106)  annotation(
  ...
  Dynawo.Electrical.StaticVarCompensators.SVarCPVRemote sVarC_10106_ALBER_SVC(B0Pu = 0.1, BMaxPu = 0.5, BMinPu = -1, BShuntPu = 0.1, U0Pu = 1.05, UNomRemote = 138, URef0Pu = URef0Pu_sVarC_10106, i0Pu = i0Pu_svc_10106, u0Pu = u0Pu_svc_10106) annotation(
...
end Loadflow_equiv_extended_simple_init;
