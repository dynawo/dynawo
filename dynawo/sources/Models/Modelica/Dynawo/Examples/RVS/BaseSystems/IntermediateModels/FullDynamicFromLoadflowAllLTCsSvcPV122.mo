...
model FullDynamicFromLoadflowAllLTCsSvcPV122
  ...
  final constant Types.ActivePowerPu QRef0Pu_gen_10102 = 10.28 / SnRef;
...
// if time < 1 then true else
  ...
  annotation(
    experiment(StartTime = 0, StopTime = 20, Tolerance = 0.005, Interval = 0.01),
...
end FullDynamicFromLoadflowAllLTCsSvcPV122;
