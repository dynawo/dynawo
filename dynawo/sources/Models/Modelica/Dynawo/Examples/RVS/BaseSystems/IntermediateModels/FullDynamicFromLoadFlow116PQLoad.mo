...
model FullDynamicFromLoadFlow116PQLoad
...
//vRRemote_bus_107.URegulated = ComplexMath.'abs'(bus_107_ALDER.terminal.V) * UNom_lower;
  ...
  gen_10118_ASTOR_G1.NQ = 0;//vRRemote_bus_118.NQ;
...
/*gen_10121_ATTLEE_G1.generatorSynchronous.switchOffSignal1.value = false;
  ...
  */
  ...
  gen_10122_AUBREY_G1.NQ = 0;//vRRemote_bus_122.NQ;
  ...
  gen_20122_AUBREY_G2.NQ = 0;//vRRemote_bus_122.NQ;
  ...
  gen_30122_AUBREY_G3.NQ = 0;//vRRemote_bus_122.NQ;
  ...
  gen_40122_AUBREY_G4.NQ = 0;//vRRemote_bus_122.NQ;
  ...
  gen_50122_AUBREY_G5.NQ = 0;//vRRemote_bus_122.NQ;
  ...
  gen_60122_AUBREY_G6.NQ = 0;//vRRemote_bus_122.NQ;
...
// if time < 1 then true else
  ...
  annotation(
    experiment(StartTime = 0, StopTime = 1, Tolerance = 1e-03, Interval = 0.5),
...
end FullDynamicFromLoadFlow116PQLoad;
