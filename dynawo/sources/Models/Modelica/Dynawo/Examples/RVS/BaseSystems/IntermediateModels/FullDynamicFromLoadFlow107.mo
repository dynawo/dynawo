...
model FullDynamicFromLoadFlow107
  ...
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_20123_AUSTEN_G2(KGover = 0, PGen0Pu = PRef0Pu_gen_20123, PMaxPu = 999, PMinPu = 0, PNom = 155, PRef0Pu = -PRef0Pu_gen_20123, QGen0Pu = QRef0Pu_gen_20123, QMaxPu = 0.8, QMinPu = -0.5, QPercent = 0.258, QRef0Pu = -QRef0Pu_gen_20123, U0Pu = 1.0491, i0Pu = i0Pu_gen_20123, u0Pu = u0Pu_gen_20123) annotation(
    Placement(visible = true, transformation(origin = {330, 10}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Dynawo.Electrical.Machines.SignalN.GeneratorPQProp gen_30123_AUSTEN_G3(KGover = 0, PGen0Pu = PRef0Pu_gen_30123, PMaxPu = 999, PMinPu = 0, PNom = 350, PRef0Pu = -PRef0Pu_gen_30123, QGen0Pu = QRef0Pu_gen_30123, QMaxPu = 1.5, QMinPu = -0.5, QPercent = 0.484, QRef0Pu = -QRef0Pu_gen_30123, U0Pu = 1.0401, i0Pu = i0Pu_gen_30123, u0Pu = u0Pu_gen_30123) annotation(
  ...
  Electrical.Machines.SignalN.GeneratorPQProp gen_20113_ARNE_G2(KGover = 0, PGen0Pu = PRef0Pu_gen_20113, PMaxPu = 999, PMinPu = 0, PNom = 197, PRef0Pu = -PRef0Pu_gen_20113, QGen0Pu = QRef0Pu_gen_20113, QMaxPu = 80, QMinPu = 0, QPercent = 0.4925373, QRef0Pu = -QRef0Pu_gen_20113, i0Pu = i0Pu_gen_20113, u0Pu = u0Pu_gen_20113) annotation(
    Placement(visible = true, transformation(origin = {220, -90}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Electrical.Machines.SignalN.GeneratorPQProp gen_30113_ARNE_G3(KGover = 0, PGen0Pu = PRef0Pu_gen_30113, PMaxPu = 999, PMinPu = 0, PNom = 197, PRef0Pu = -PRef0Pu_gen_30113, QGen0Pu = QRef0Pu_gen_30113, QMaxPu = 80, QMinPu = 0, QPercent = 0.4925373, QRef0Pu = -QRef0Pu_gen_30113, i0Pu = i0Pu_gen_30113, u0Pu = u0Pu_gen_30113) annotation(
    Placement(visible = true, transformation(origin = {220, -130}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Electrical.Machines.SignalN.GeneratorPQProp gen_10113_ARNE_G1(KGover = 0, PGen0Pu = PRef0Pu_gen_10113, PMaxPu = 999, PMinPu = 0, PNom = 197, PRef0Pu = -PRef0Pu_gen_10113, QGen0Pu = QRef0Pu_gen_10113, QMaxPu = 0.827791, QMinPu = 0, QPercent = 0.01492537, QRef0Pu = -QRef0Pu_gen_10113, i0Pu = i0Pu_gen_10113, u0Pu = u0Pu_gen_10113) annotation(
    Placement(visible = true, transformation(origin = {220, -50}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Electrical.Controls.Voltage.VRRemote vRRemote_bus_113(Gain = 1, U0 = URef0_bus_113, URef0 = URef0_bus_113, tIntegral = 0.1) annotation(
  ...
  Electrical.Buses.InfiniteBus infiniteBus(UPhase = from_deg(13.4), UPu = 1.04685) annotation(
    Placement(visible = true, transformation(origin = {-100, 226}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Electrical.Controls.Voltage.VRRemote vRRemote_bus_123(Gain = 1, U0 = URef0_bus_123, URef0 = URef0_bus_123, tIntegral = 0.1) annotation(
...
end FullDynamicFromLoadFlow107;
