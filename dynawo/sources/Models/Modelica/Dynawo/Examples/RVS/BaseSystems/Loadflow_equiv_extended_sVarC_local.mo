...
model Loadflow_equiv_extended_sVarC_local
  ...
  final parameter Types.ComplexApparentPowerPu s0Pu_load_1106 = Complex(P0Pu_load_1102, Q0Pu_load_1102);
  final parameter Types.ComplexVoltagePu u0Pu_load_1106 = ComplexMath.fromPolar(0.9918, from_deg(-46.9903));
  final parameter Types.ComplexCurrentPu i0Pu_load_1106 = ComplexMath.conj(s0Pu_load_1102 / u0Pu_load_1102);
  ...
  Electrical.Controls.Basics.SetPoint URefPu_sVarC_10106(Value0 = URef0Pu_sVarC_10106);
  ...
  Dynawo.Electrical.Loads.LoadPQ load_1106_ALBER(s0Pu = s0Pu_load_1106)  annotation(
