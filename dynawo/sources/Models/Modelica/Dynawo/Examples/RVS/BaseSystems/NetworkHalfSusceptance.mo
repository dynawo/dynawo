...
model NetworkHalfSusceptance
  ...
  */
  ...
  Dynawo.Electrical.Buses.Bus bus1 annotation(
    Placement(visible = true, transformation(origin = {54, -140}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  Dynawo.Electrical.Switches.IdealSwitch breaker_line_106_110_bus_106 annotation(
    Placement(visible = true, transformation(origin = {54, -154}, extent = {{-6, -6}, {6, 6}}, rotation = 90)));
  Dynawo.Electrical.Switches.IdealSwitch breaker_line_106_110_bus_110 annotation(
    Placement(visible = true, transformation(origin = {54, -84}, extent = {{-6, -6}, {6, 6}}, rotation = 90)));
equation
  ...
  connect(line_108_109.terminal2, bus_109_ALI.terminal) annotation(
    Line(points = {{20, -120}, {-20, -120}, {-20, -90}, {-50, -90}, {-50, -70}, {-70, -70}}, color = {0, 0, 255}));
  ...
  connect(breaker_line_106_110_bus_106.terminal1, bus_106_ALBER.terminal) annotation(
    Line(points = {{54, -160}, {54, -170}, {80, -170}}, color = {0, 0, 255}));
  connect(breaker_line_106_110_bus_106.terminal2, bus1.terminal) annotation(
    Line(points = {{54, -148}, {54, -140}}, color = {0, 0, 255}));
  connect(breaker_line_106_110_bus_110.terminal2, bus_110_ALLEN.terminal) annotation(
    Line(points = {{54, -78}, {54, -70}, {30, -70}}, color = {0, 0, 255}));
  connect(breaker_line_106_110_bus_110.terminal1, bus.terminal) annotation(
    Line(points = {{54, -90}, {54, -100}}, color = {0, 0, 255}));
  ...
  breaker_line_106_110_bus_106.switchOffSignal1.value = false;
  breaker_line_106_110_bus_110.switchOffSignal1.value = false;
  connect(line_108_109.terminal1, bus_108_ALGER.terminal) annotation(
    Line(points = {{40, -120}, {130, -120}, {130, -130}}, color = {0, 0, 255}));
  annotation(
