...
model Loadflow_exact_init
  ...
  final parameter Types.ReactivePowerPu Q0Pu_line_reactor_106 = 78.879 / SnRef;
  ...
  Dynawo.Electrical.StaticVarCompensators.SVarCPVRemote sVarC_10114_ARNOLD_SVC( B0Pu = B0Pu_sVarC_10114,BMaxPu = 0.5, BMinPu = -2, BShuntPu = 0, U0Pu = 1.05, UNomRemote = 230, URef0Pu = URef0Pu_sVarC_10114, i0Pu = i0Pu_sVarC_10114, u0Pu = u0Pu_sVarC_10114) annotation(
    Placement(visible = true, transformation(origin = {10, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.StaticVarCompensators.SVarCPVRemote sVarC_10106_ALBER_SVC( B0Pu = B0Pu_sVarC_10106,BMaxPu = 0.5, BMinPu = -1, BShuntPu = 0, U0Pu = 1.05, UNomRemote = 138, URef0Pu = URef0Pu_sVarC_10106, i0Pu = i0Pu_sVarC_10106, u0Pu = u0Pu_sVarC_10106) annotation(
  ...
  Dynawo.Electrical.Shunts.ShuntB shuntB(BPu = 0.75, i0Pu = Complex(1, 0), s0Pu = Complex(1, 0), u0Pu = u0Pu_line_reactor_110) annotation(
    Placement(visible = true, transformation(origin = {40, -100}, extent = {{-6, -6}, {6, 6}}, rotation = -90)));
  Dynawo.Electrical.Shunts.ShuntB shuntB1(BPu = 0.75, i0Pu = Complex(1, 0), s0Pu = Complex(1, 0), u0Pu = u0Pu_line_reactor_106) annotation(
...
/*  vRRemote_bus_121.URegulated = ComplexMath.'abs'(bus_121_ATTLEE.terminal.V) * UNom_upper;
  ...
  sVarC_10114_ARNOLD_SVC.URegulatedPu = ComplexMath.'abs'(tfo_10114_114.terminal2.V);
