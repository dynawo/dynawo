...
model FullDynamicFromLoadFlow122RestorativePQLoadLTC
  ...
  Electrical.Loads.LoadPQ loadPQ(s0Pu = Complex(0, -0.6165), u0Pu = ComplexMath.fromPolar(1.0385, from_deg(-36.725)))  annotation(
...
end FullDynamicFromLoadFlow122RestorativePQLoadLTC;
