...
model FullDynamicFromLoadFlowAllLTCsNoSvc
  ...
  Dynawo.Electrical.Shunts.ShuntB shunt_106(BPu = B0Pu_sVarC_10106, i0Pu = i0Pu_sVarC_10106, s0Pu = Complex(0, Q0Pu_sVarC_10106), u0Pu = u0Pu_sVarC_10106)  annotation(
    Placement(visible = true, transformation(origin = {204, -302}, extent = {{-6, -6}, {6, 6}}, rotation = -90)));
  Dynawo.Electrical.Shunts.ShuntB shunt_114(BPu = B0Pu_sVarC_10114, i0Pu = i0Pu_sVarC_10114, s0Pu = Complex(0, Q0Pu_sVarC_10114), u0Pu = u0Pu_sVarC_10114) annotation(
    Placement(visible = true, transformation(origin = {48, 24}, extent = {{-6, -6}, {6, 6}}, rotation = -90)));
...
/*gen_10121_ATTLEE_G1.generatorSynchronous.switchOffSignal1.value = false;
  ...
  */
  ...
  shunt_106.switchOffSignal1.value = false;
  shunt_106.switchOffSignal2.value = false;
  shunt_114.switchOffSignal1.value = false;
  shunt_114.switchOffSignal2.value = false;
...
// if time < 1 then true else
  ...
  connect(shunt_106.terminal, bus_10106_ALBER_SVC.terminal) annotation(
    Line(points = {{204, -302}, {186, -302}, {186, -322}}, color = {0, 0, 255}));
  connect(shunt_114.terminal, bus_10114_ARNOLD_SVC.terminal) annotation(
    Line(points = {{48, 24}, {28, 24}, {28, 28}}, color = {0, 0, 255}));
...
end FullDynamicFromLoadFlowAllLTCsNoSvc;
