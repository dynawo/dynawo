...
model TestAShuntNoRestorative
  ...
  Dynawo.Electrical.Shunts.ShuntB shunt(BPu = 2.5 / 1.0342 ^ 2, State0 = Dynawo.Electrical.Constants.state.Open, i0Pu = Complex(0, 0), s0Pu = Complex(0, 0), state(start = Dynawo.Electrical.Constants.state.Open), u0Pu = ComplexMath.fromPolar(1.0342, from_deg(-18.6)))  annotation(
    Placement(visible = true, transformation(origin = {-166, -280}, extent = {{-6, -6}, {6, 6}}, rotation = -90)));
...
equation
  ...
  connect(shunt.terminal, bus_101_ABEL.terminal) annotation(
    Line(points = {{-166, -280}, {-166, -302}, {-134, -302}}, color = {0, 0, 255}));

  annotation(preferredView = "diagram",
    experiment(StartTime = 0, StopTime = 40, Tolerance = 0.005, Interval = 0.01),
