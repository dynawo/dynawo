...
model TestBNoSvcNoLoadReset
  ...
  extends Dynawo.Examples.RVS.BaseSystems.FullDynamicInfiniteBusNoLoadreset(
  ...
  //Real checkQInf;
equation
//Complex(checkPInf, checkQInf) = infiniteBus.terminal.V * ComplexMath.conj(infiniteBus.terminal.i);
