within Dynawo.Examples.RVS.TestCases.TestB.Grids;
...
model FullDynamicInfiniteBusNoLoadresetPQLoad
  import Modelica.SIunits.Conversions.from_deg;
  import Dynawo;
  import Dynawo.Examples.RVS.BaseSystems.NetworkWithTrfRestorative;
  ...
  Dynawo.Examples.RVS.Components.StaticVarCompensators.SVarCRVS sVarC_10114_ARNOLD_SVC(ControlInService = false, K = 150 * 250, Q0Pu = Q0Pu_sVarC_10114_ARNOLD_SVC, SBase = 100, U0Pu = U0Pu_sVarC_10114_ARNOLD_SVC, UPhase0 = UPhase0_sVarC_10114_ARNOLD_SVC, URef0Pu = U0Pu_sVarC_10114_ARNOLD_SVC, svcPreset = Dynawo.Examples.RVS.Components.StaticVarCompensators.Util.ParametersSVC.svcFramePreset.sVarC_10114) annotation(
    Placement(visible = true, transformation(origin = {50, 28}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Loads.LoadPQ loadPQ(i0Pu = Complex(0, 0), s0Pu = Complex(0, 0), u0Pu = Complex(1, 0)) annotation(
    Placement(visible = true, transformation(origin = {208, -322}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
...
*/
  ...
  connect(loadPQ.terminal, bus_10106_ALBER_SVC.terminal) annotation(
    Line(points = {{208, -322}, {186, -322}}, color = {0, 0, 255}));
  ...
  annotation(preferredView = "diagram",
    ...
    Diagram(coordinateSystem(extent = {{-340, -420}, {340, 340}})));
end FullDynamicInfiniteBusNoLoadresetPQLoad;
