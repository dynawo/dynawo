...
//  extends Dynawo.Examples.RVS.Grid.FullStatic1(
  extends Dynawo.Examples.RVS.Grid.FullStatic2(
    UNom_lower = 138,
    UNom_upper = 230,
    ...
    PGen0Pu_gen_10101 = 0.10000000000012331,
    PGen0Pu_gen_10102 = 0.10000000000001656,
    PGen0Pu_gen_10107 = 0.7999999999999469,
    PGen0Pu_gen_10113 = 1.6250000000182763,
    PGen0Pu_gen_10115 = 0.12000000000000558,
    PGen0Pu_gen_10116 = 1.5500000000057312,
    PGen0Pu_gen_10118 = 4.000000000000116,
    PGen0Pu_gen_10122 = 0.5000000000000253,
    PGen0Pu_gen_10123 = 1.5500000000002288,
    PGen0Pu_gen_20101 = 0.10000000000012331,
    PGen0Pu_gen_20102 = 0.10000000000001656,
    PGen0Pu_gen_20107 = 0.7999999999999469,
    PGen0Pu_gen_20113 = 1.625000000000306,
    PGen0Pu_gen_20115 = 0.12000000000000558,
    PGen0Pu_gen_20122 = 0.5000000000000254,
    PGen0Pu_gen_20123 = 1.5500000000002285,
    PGen0Pu_gen_30101 = 0.7600000000004553,
    PGen0Pu_gen_30102 = 0.7600000000000327,
    PGen0Pu_gen_30107 = 0.7999999999999469,
    PGen0Pu_gen_30113 = 1.625000000000306,
    PGen0Pu_gen_30115 = 0.12000000000000558,
    PGen0Pu_gen_30122 = 0.5000000000000254,
    PGen0Pu_gen_30123 = 3.5000000000005014,
    PGen0Pu_gen_40101 = 0.7600000000004553,
    PGen0Pu_gen_40102 = 0.7600000000000327,
    PGen0Pu_gen_40115 = 0.12000000000000558,
    PGen0Pu_gen_40122 = 0.5000000000000254,
    PGen0Pu_gen_50115 = 0.12000000000000558,
    PGen0Pu_gen_50122 = 0.5000000000000254,
    PGen0Pu_gen_60115 = 1.5500000000000716,
    PGen0Pu_gen_60122 = 0.5000000000000254,
...
equation
  ...
  annotation(
    ...
    Documentation(info = "<html><head></head><body>The LoadFlow model is simulable with OpenModelica 1.24.4.<br><br>If the model is modified to inherit from FullStatic1 instead of FullStatic2, it is simulable with older versions of OpenModelica (for instance 1.17.0) which do not need start values on every initial parameter.</body></html>"));
end LoadFlow;
