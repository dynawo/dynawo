...
model TestBNoSvcLoadReset
  import Dynawo;

  extends Icons.Example;
  extends Dynawo.Examples.RVS.BaseSystems.FullDynamicInfiniteBus(
...
equation
  ...
  annotation(preferredView = "diagram",
    experiment(StartTime = 0, StopTime = 40, Tolerance = 0.001, Interval = 0.01),
