...
*/
  ...
  parameter Types.PerUnit BPu = 0.000375  "Half-susceptance in pu (base SnRef, UNom)";
...
//Generator, lines and infinite bus
  ...
  Electrical.Events.NodeFault nodeFault(RPu = 0.005746957711326909, XPu = 0.019156525704423027, tBegin = 1, tEnd = 1+delta_t)  annotation(
