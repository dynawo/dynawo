...
model SMIBdynamicLineFault "Node fault on a line for SMIB model with dynamic lines "
  ...
  parameter Types.Time delta_t = 1 "Fault duration in seconds" ;
  ...
  Dynawo.Electrical.Lines.DynamicLine line2(CPu = BPu, GPu = GPu, LPu = XPu, RPu = RPu , i10Pu = Complex(-11.09234, -0.4319018) , i20Pu = Complex(11.09239, 0.4319759), iGC10Pu = Complex(3.597834e-05, 2.872566e-05), iGC20Pu = Complex(2.127141e-05, 4.533751e-05), iRL0Pu = Complex(-11.09237, -0.4319306), u10Pu = Complex(0.86272, -0.0967023), u20Pu = Complex(0.888119, 0.3208814)) annotation(
    Placement(visible = true, transformation(origin = {-22, -40}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Dynawo.Electrical.Lines.DynamicLine line1(CPu = (1 - x) * BPu, GPu = (1 - x)*GPu, LPu = (1 - x) * XPu , RPu = (1 - x) * RPu, i10Pu = Complex(-11.09234, -0.4319018) , i20Pu = Complex(11.09239, 0.4319759), iGC10Pu = Complex(3.597834e-05, 2.872566e-05), iGC20Pu = Complex(2.127141e-05, 4.533751e-05), iRL0Pu = Complex(-11.09237, -0.4319306), u10Pu = Complex(0.86272, -0.0967023), u20Pu = Complex(0.8754198, 0.1120889)) annotation(
    Placement(visible = true, transformation(origin = {-44, 30}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));

  Dynawo.Electrical.Lines.DynamicLine line3(CPu = x * BPu, GPu = x * GPu, LPu = x * XPu, RPu = x * RPu, i10Pu = Complex(-11.09234, -0.4319018) , i20Pu = Complex(11.09239, 0.4319759), iGC10Pu = Complex(3.597834e-05, 2.872566e-05), iGC20Pu = Complex(2.127141e-05, 4.533751e-05), iRL0Pu = Complex(-11.09237, -0.4319306), u10Pu = Complex(0.8754198, 0.1120889), u20Pu = Complex(0.888119, 0.3208814)) annotation(
    Placement(visible = true, transformation(origin = {2, 30}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));

  Dynawo.Electrical.Events.NodeFault nodeFault(RPu = 0.00223606797749979, XPu = 0.00447213595499958, tBegin = 1, tEnd = 1 + delta_t) annotation(
