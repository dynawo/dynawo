...
model TwoConverter_10hzOscillations
...
// No modifications in GFL set points
  ...
  annotation(
    ...
    Documentation(info = "<html><head></head><body>GFL model <b>is GFL </b>and oscillations of 10 hz are observed at the beginnig of the simulation but later on it will be demonstrated that this is because the initialisation and they dissapear at t=5s. Those oscillations decay during the time and <b>they do not corresponds to the stability limit</b>


    <p><b>GFL1 – Grid Following Converter Parameters</b></p>

<p><b>Rated values and operating point:</b></p>
<ul>
  <li>SNom = 1000</li>
  <li>U0Pu = 1.0847</li>
  <li>UPhase0 = -0.18</li>
...
<p><b>Filter and transformer impedances (pu):</b></p>
<ul>
  <li>RFilterPu = 0.003</li>
  <li>XFilterPu = 0.1</li>
  <li>BFilterPu = 1e-5</li>
  <li>RTransformerPu = 0.002</li>
  <li>XTransformerPu = 0.05</li>
</ul>
...
end TwoConverter_10hzOscillations;
