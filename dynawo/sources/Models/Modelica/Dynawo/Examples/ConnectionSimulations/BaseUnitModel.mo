...
model BaseUnitModel
  ...
  Dynawo.Electrical.Wind.WECC.WT4CurrentSource_INIT INIT(P0Pu = Unit.P0Pu, Q0Pu = Unit.Q0Pu, RPu = Unit.RPu, SNom = Unit.SNom, U0Pu = Unit.U0Pu, UPhase0 = UPhase0, XPu = Unit.XPu) annotation(
  ...
  Modelica.Blocks.Sources.Step URef(offset = Unit.URef0Pu, height = 0, startTime = 2) annotation(
  ...
  Dynawo.Electrical.Wind.WECC.WTG3CurrentSource1 Unit(
    ...
    zerox = 0, VDLIp11 = 0, VDLIp12 = 1.1, VDLIp21 = 1, VDLIp22 = 1.1, VDLIp31 = 2, VDLIp32 = 1.1, VDLIp41 = 3, VDLIp42 = 1.1, VDLIq11 = 0, VDLIq12 = 1.1, VDLIq21 = 1, VDLIq22 = 1.1, VDLIq31 = 2, VDLIq32 = 1.1, VDLIq41 = 3, VDLIq42 = 1.1
      ) annotation(
...
<ul>
  ...
  <li>You should define here the complete tuning of your model. This is where you define the tuning used across all simulations in this ConnectionSimulations package.</li>
  <br/>
