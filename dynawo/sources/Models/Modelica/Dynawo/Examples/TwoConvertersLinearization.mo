...
package TwoConvertersLinearization
  model TwoConvertersDynGFLDynLine_EMTP_parameters_v2_FilterMesures
    extends Icons.Example;
    Electrical.PEIR.Converters.General.Average.GridFollowing.DynGFLMeasurementFiltered GFL1(CFilterPu = 1e-5, Kfd = 1, Kfq = 1, Ki = 10, Kic = 1.87, Kid = 25, Kiq = 25, Kp = 2, Kpc = 0.18, Kpd = 0.1, Kpq = 0.1, LFilterPu = 0.1, LTransformerPu = 0.05, OmegaMaxPu = 1.1, OmegaMinPu = 0.9, P0Pu = 5, Q0Pu = -0.21, RFilterPu = 0.003, RTransformerPu = 0.002, SNom = 1000, U0Pu = 1.0847, UPhase0 = -0.18, tPFilt = 1 / 111, tQFilt = 1 / 111, tVSC = 0.00004) annotation(
    ...
    Dynawo.Electrical.Lines.DynLine dynLine2(LPu = 0.0218, P01Pu = 0.09, P02Pu = -0.09, Q01Pu = 0.9892, Q02Pu = -0.9892, RPu = 0.00218, U01Pu = 1.099, U02Pu = 1.1, UPhase01 = -0.04, UPhase02 = -0.04) annotation(
    ...
    Modelica.Blocks.Sources.Step step(height = -0.1, offset = -0.5, startTime = 5) annotation(
      Placement(visible = true, transformation(origin = {-120, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Sources.Step step1(height = 0.1, offset = 0.5, startTime = 5) annotation(
      Placement(visible = true, transformation(origin = {142, 2}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
    Dynawo.Electrical.PEIR.Converters.General.Average.GridFollowing.DynGFLMeasurementFiltered GFL2(CFilterPu = 1e-5, Kfd = 1, Kfq = 1, Ki = 10, Kic = 1.87, Kid = 25, Kiq = 25, Kp = 2, Kpc = 0.18, Kpd = 0.1, Kpq = 0.1, LFilterPu = 0.1, LTransformerPu = 0.05, OmegaMaxPu = 1.1, OmegaMinPu = 0.9, P0Pu = -5, Q0Pu = -0.21, RFilterPu = 0.003, RTransformerPu = 0.002, SNom = 1000, U0Pu = 1.1072, UPhase0 = 0.098, tPFilt = 1 / 111, tQFilt = 1 / 111, tVSC = 0.00004) annotation(
      Placement(visible = true, transformation(origin = {84, 0}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
    Modelica.Blocks.Sources.Ramp ramp(duration = 8, height = -1.6, offset = 0.8, startTime = 2) annotation(
      Placement(visible = true, transformation(origin = {-108, -38}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Sources.Ramp ramp1(duration = 8, height = 1.6, offset = -0.8, startTime = 2) annotation(
  ...
  // OmegaRef = 1
    ...
    connect(step.y, GFL1.PFilterRefPu) annotation(
      Line(points = {{-108, 4}, {-92, 4}, {-92, 8}, {-74, 8}}, color = {0, 0, 127}));
    connect(step1.y, GFL2.PFilterRefPu) annotation(
      Line(points = {{132, 2}, {124, 2}, {124, 8}, {96, 8}}, color = {0, 0, 127}));
    annotation(
      Diagram(coordinateSystem(extent = {{-140, 20}, {140, -80}})));
  end TwoConvertersDynGFLDynLine_EMTP_parameters_v2_FilterMesures;
 extends Icons.Package;
end TwoConvertersLinearization;
