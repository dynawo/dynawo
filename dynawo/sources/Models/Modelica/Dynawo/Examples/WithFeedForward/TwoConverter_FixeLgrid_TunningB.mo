...
model TwoConverter_FixeLgrid_TunningB
  ...
  Dynawo.Electrical.Lines.DynLine line22( LPu = 0.25, P01Pu = 0.11901040, P02Pu = -0.11194076, Q01Pu = 1.24143346, Q02Pu = -1.17073708,  RPu = 0.025,  U01Pu = 1.1, U02Pu = 1.03733331, UPhase01 = -0.04, UPhase02 = -2.278818 * 3.14 / 180) annotation(
...
// No modifications in GFL set points
  ...
  annotation(
    ...
    <p><b>GFL – Grid Following Converter Parameters:</b>Tunning B</p><p>Limit de stability not found since no oscillations are observed instead the system is stable and then an exponential response is shown without oscillations</p><ul>
</ul>

 <img width=\"900\" src=\"modelica://Dynawo/Examples/WithFeedForward/tunningB_Roots.png\">
<br><br>

</body></html>"));
end TwoConverter_FixeLgrid_TunningB;
