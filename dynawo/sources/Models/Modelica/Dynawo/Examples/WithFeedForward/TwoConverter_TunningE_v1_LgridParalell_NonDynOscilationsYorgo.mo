...
model TwoConverter_TunningE_v1_LgridParalell_NonDynOscilationsYorgo
  ...
  Electrical.Lines.Line line(BPu = 0, GPu = 0, RPu = 0.00144, XPu = 0.0144) annotation(
    Placement(visible = true, transformation(origin = {34, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Electrical.Lines.Line line1(BPu = 0, GPu = 0, RPu = 0.00144, XPu = 0.0144) annotation(
  ...
  Dynawo.Electrical.Buses.InfiniteBusWithVariations_PhaseJump infiniteBus(U0Pu = 1.1, UEvtPu = 1.14, UPhase = -0.04, dUPhaseEvt = -60 / 180 * 3.1416, omega0Pu = 1, omegaEvtPu = -1.8, tOmegaEvtEnd = tOmegaEvtEnd, tOmegaEvtStart = tOmegaEvtStart, tUEvtEnd = tMagnitudeEvtEnd, tUEvtStart = tMagnitudeEvtstart, tUPhaseEvt = 4) annotation(
  ...
  /*Dynawo.Electrical.Lines.DynLine_Ramp line22(L0Pu = 0.0304, LPuFinal = 0.05, P01Pu = 0.11901040, P02Pu = -0.11194076, Q01Pu = 1.24143346, Q02Pu = -1.17073708, R0Pu = 0.00304, U01Pu = 1.1, U02Pu = 1.03733331, UPhase01 = -0.04, UPhase02 = -2.278818 * 3.14 / 180) annotation(
    ...
    Dynawo.Electrical.Lines.Line line22(BPu = 0, GPu = 0, RPu = 0.0165, XPu = 0.165) annotation(
    Placement(visible = true, transformation(origin = {2, -22}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  ...
  Dynawo.Electrical.Lines.Line line221 (BPu = 0, GPu = 0, RPu = 0.00388, XPu = 0.0388) annotation(
  ...
  Modelica.Blocks.Sources.BooleanTable booleanTable(startValue = true, table = {0, 400}) annotation(
...
end TwoConverter_TunningE_v1_LgridParalell_NonDynOscilationsYorgo;
