...
model OneDynGFLDynLine_TunningE_LineRamp
  ...
  Dynawo.Electrical.Lines.DynLine_Ramp dynLine(L0Pu = 0.01, LPuFinal = 0.25, P01Pu = -5, P02Pu = 5.05, Q01Pu = 0.21, Q02Pu = 0.508, R0Pu = 0.001,  U01Pu = 1.0847, U02Pu = 1.099, UPhase01 = -0.18, UPhase02 = -0.04) annotation(
    Placement(visible = true, transformation(origin = {60, 14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  parameter Real modif1 = 1;
  Modelica.Blocks.Sources.Step step(height = 0.1 * 0, offset = 0.5, startTime = 2) annotation(
    Placement(visible = true, transformation(origin = {-120, 80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Step step2(height = 0.01 * 0, offset = 0.021, startTime = 8) annotation(
  ...
  Modelica.Blocks.Sources.Step step1(height = 0.1 * 0, offset = 0, startTime = 6) annotation(
  ...
  Modelica.Blocks.Sources.Step step3(height = 0.01 * 0, offset = 0, startTime = 10) annotation(
  ...
  Modelica.Blocks.Sources.Step step4(height = 0.1 * 0, offset = 0, startTime = 4) annotation(
...
end OneDynGFLDynLine_TunningE_LineRamp;
