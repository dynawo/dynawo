...
model TwoConverter_FixeLgrid_TunningE_v_Oscilations
  ...
  Dynawo.Electrical.Lines.DynLine_Ramp line22(L0Pu = 0.0304, LPuFinal = 0.14, P01Pu = 0.11901040, P02Pu = -0.11194076, Q01Pu = 1.24143346, Q02Pu = -1.17073708, R0Pu = 0.00304, U01Pu = 1.1, U02Pu = 1.03733331, UPhase01 = -0.04, UPhase02 = -2.278818 * 3.14 / 180) annotation(
...
end TwoConverter_FixeLgrid_TunningE_v_Oscilations;
