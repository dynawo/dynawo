...
model OneDynGFLDynLine_TunningE
  ...
  Dynawo.Electrical.Lines.DynLine dynLine(LPu = 0.1, P01Pu = -5, P02Pu = 5.05, Q01Pu = 0.21, Q02Pu = 0.508, RPu = 0.01, U01Pu = 1.0847, U02Pu = 1.099, UPhase01 = -0.18, UPhase02 = -0.04) annotation(
