...
model OneDynGFLDynLine_TunningE
  ...
  Modelica.Blocks.Sources.Step step(height = 0.1, offset = 0.5, startTime = 30) annotation(
    Placement(visible = true, transformation(origin = {-120, 80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Step step2(height = 0.01, offset = 0.021, startTime = 400) annotation(
  ...
  Modelica.Blocks.Sources.Step step1(height = 0.1, offset = 0, startTime = 300) annotation(
  ...
  Modelica.Blocks.Sources.Step step3(height = 0.01, offset = 0, startTime = 500) annotation(
  ...
  Modelica.Blocks.Sources.Step step4(height = 0.1, offset = 0, startTime = 200) annotation(
