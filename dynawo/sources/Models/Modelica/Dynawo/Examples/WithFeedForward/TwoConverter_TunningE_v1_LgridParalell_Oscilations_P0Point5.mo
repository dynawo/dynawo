...
model TwoConverter_TunningE_v1_LgridParalell_Oscilations_P0Point5
  ...
  Dynawo.Electrical.Buses.InfiniteBusWithVariations infiniteBus(U0Pu = 1.1, UEvtPu = 1.14, UPhase = -0.04, omega0Pu = 1, omegaEvtPu = 1.1, tOmegaEvtEnd = 400, tOmegaEvtStart = 400, tUEvtEnd = 400, tUEvtStart = 400) annotation(
  ...
  /*Dynawo.Electrical.Lines.DynLine_Ramp line22(L0Pu = 0.0304, LPuFinal = 0.05, P01Pu = 0.11901040, P02Pu = -0.11194076, Q01Pu = 1.24143346, Q02Pu = -1.17073708, R0Pu = 0.00304, U01Pu = 1.1, U02Pu = 1.03733331, UPhase01 = -0.04, UPhase02 = -2.278818 * 3.14 / 180) annotation(
    ...
    Dynawo.Electrical.Lines.DynLine line22(LPu = 0.125, P01Pu = 0.11901040, P02Pu = -0.11194076, Q01Pu = 1.24143346, Q02Pu = -1.17073708, RPu = 0.0125, U01Pu = 1.1, U02Pu = 1.03733331, UPhase01 = -0.04, UPhase02 = -2.278818 * 3.14 / 180) annotation(
    Placement(visible = true, transformation(origin = {2, -22}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Blocks.Sources.Step step1(height = -0.1, offset = -0.5, startTime = 250) annotation(
    Placement(visible = true, transformation(origin = {-108, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Step step3(height = 0.1, offset = 0.5, startTime = 250) annotation(
    Placement(visible = true, transformation(origin = {120, -60}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Dynawo.Electrical.Lines.DynLine line221(LPu = 0.0388, P01Pu = 0.11901040, P02Pu = -0.11194076, Q01Pu = 1.24143346, Q02Pu = -1.17073708, RPu = 0.00388, U01Pu = 1.1, U02Pu = 1.03733331, UPhase01 = -0.04, UPhase02 = -2.278818*3.14/180) annotation(
    Placement(transformation(origin = {-40, -22}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Electrical.Lines.idealSwitch idealSwitch(Ron = 1e-5, Goff = 1e-5)  annotation(
...
end TwoConverter_TunningE_v1_LgridParalell_Oscilations_P0Point5;
