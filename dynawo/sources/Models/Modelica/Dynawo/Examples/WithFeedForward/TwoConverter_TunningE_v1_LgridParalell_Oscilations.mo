...
model TwoConverter_TunningE_v1_LgridParalell_Oscilations
  ...
  Dynawo.Electrical.Buses.InfiniteBusWithVariations infiniteBus(U0Pu = 1.1, UEvtPu = 1.14, UPhase = -0.04, omega0Pu = 1, omegaEvtPu = 1.1, tOmegaEvtEnd = 6, tOmegaEvtStart = 4, tUEvtEnd = 400, tUEvtStart = 400) annotation(
...
end TwoConverter_TunningE_v1_LgridParalell_Oscilations;
