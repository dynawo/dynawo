...
model TwoConverter_FixeLgrid_TunningA
  ...
  Dynawo.Electrical.PEIR.Converters.General.Average.GridFollowing.DynGFLMeasurementFiltered GFL2(CFilterPu = 1e-5, Kfd = 1, Kfq = 1, Ki = 10, Kic = 2.1972, Kid = 25, Kiq = 25, Kp = 2, Kpc = 0.20981, Kpd = 0.1, Kpq = 0.1, LFilterPu = 0.1, LTransformerPu = 0.05, OmegaMaxPu = 1.1, OmegaMinPu = 0.9, P0Pu = -5, Q0Pu = -0.21, RFilterPu = 0.003, RTransformerPu = 0.002, SNom = 1000, U0Pu = 1.1072, UPhase0 = 0.098, tPFilt = 1 / 111, tQFilt = 1 / 111, tUFilt = 1 / 6283, tUqPLL = 1 / 111, tVSC = 1 / (22500 * 2 * 3.1416)) annotation(
  ...
  Dynawo.Electrical.Lines.DynLine line22(LPu = 0.015,P01Pu = 0.11901040, P02Pu = -0.11194076, Q01Pu = 1.24143346, Q02Pu = -1.17073708, RPu = 0.0015, U01Pu = 1.1, U02Pu = 1.03733331, UPhase01 = -0.04, UPhase02 = -2.278818 * 3.14 / 180) annotation(
...
// No modifications in GFL set points
  ...
  annotation(
    ...
    <p><b>GFL – Grid Following Converter Parameters:</b>Tunning A</p><ul>
</ul>

 <img width=\"900\" src=\"modelica://Dynawo/Examples/WithFeedForward/tunningA_Roots.png\">
<br><br>


</body></html>"));
end TwoConverter_FixeLgrid_TunningA;
