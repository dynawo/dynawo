...
equation
  ...
  annotation(
    ...
    Documentation(info = "<html><head></head><body>The event simulated is a 2% step order at t=2s on the plant voltage droop regulation required from PEIRs connected to the grid. Here, the short circuit impedance is small, emulating a strong grid situation. The test is described thorougly in fiche I2 from the french grid code.</body></html>"));
end SheetI2Xcca;
