...
record BaseParameters
  ...
  parameter Types.ApparentPowerModule SNom = 1000 "Nominal apparent power in MVA";
 /* parameter Types.PerUnit XaPu = 0.05 * Electrical.SystemBase.SnRef / SNom "Reactance a of the DTR in pu (base SnRef, UNom)";*/
 parameter Types.PerUnit XaPu = 0.005;
  parameter Types.PerUnit XbPu =0.036362139917695474;

  // Parameters that shouldn't be modified
  parameter Types.ActivePowerPu P0Pu = -10 "Start value of active power at regulated bus in pu (receptor convention) (base SnRef)";
