...
model WT3ACurrentSource2020 "Wind Turbine Type 3A model from IEC 61400-27-1 standard with infinite bus - fault and reference tracking tests (Active and reactive power steps)"
  ...
  Dynawo.Electrical.Wind.IEC.WT.WT3ACurrentSource2020 wT3ACurrentSource(BesPu = 0,DUdb1Pu = -0.1, DUdb2Pu = 0.1, DfcMaxPu = 1, DfpMaxPu = 1, GesPu = 0, IqH1Pu = 1.05, IqMaxPu = 1.05, IqMinPu = -1.05, IqPostPu = 0, Kiq = 2.25, Kiu = 10, Kpaw = 1000, Kpq = 1.1, Kpu = 2, Kpufrt = 2, Kqv = 2, MpUScale = true, MqG = 1, Mqfrt = 1,PBaseMeasurement = SystemBase.SnRef, RDropPu = 0, ResPu = 0, SNom = 100, UMaxPu = 1.1, UMinPu = 0.9, UPll1Pu = 999, UPll2Pu = 0.13, URef0Pu = 0, UqDipPu = 0.9, UqRisePu = 1.1, XDropPu = 0, XesPu = 0, tIcFilt = 0.01, tIpFilt = 0.01, tPcFilt = 0.01, tPll = 0.01, tPost = 0, tPpFilt = 0.01, tQcFilt = 0.01, tQord = 0.05, tQpFilt = 0.01, tS = 1e-6, tUcFilt = 0.01, tUpFilt = 0.01, tUss = 1, tfcFilt = 0.01, tfpFilt = 0.01)  annotation(
