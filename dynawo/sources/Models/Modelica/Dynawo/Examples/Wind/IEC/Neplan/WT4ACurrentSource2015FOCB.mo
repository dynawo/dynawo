...
model WT4ACurrentSource2015FOCB "Wind Turbine Type 4A model from IEC 61400-27-1:2015 standard with infinite bus - fault and reference tracking tests (Active and reactive power steps)"
  extends Icons.Example;

  Dynawo.Electrical.Wind.IEC.WT.WT4ACurrentSource2015 wT4ACurrentSource(BesPu = 0, DPMaxP4APu = 1, DfMaxPu = 1, DipMaxPu = 1, DiqMaxPu = 100, DiqMinPu = -100, GesPu = 0, IGsIm0Pu = 0.423168, IGsRe0Pu = 0.930069, IMaxDipPu = 1.3, IMaxPu = 1.3, IpMax0Pu = 1.2, IqH1Pu = 1.05, IqMax0Pu = 0.4, IqMaxPu = 1.05, IqMin0Pu = -0.4, IqMinPu = -1.05, IqPostPu = 0, Kipaw = 100, Kiq = 2.25, Kiqaw = 100, Kiu = 10, Kpaw = 1000, Kpq = 1.1, Kpqu = 20, Kpu = 2, Kqv = 2, MdfsLim = false, MqG = 1, MqUvrt = 1, Mqpri = true, Mzc = false, P0Pu = -1, PAg0Pu = 1, Q0Pu = 0.21, QMax0Pu = 0.8, QMaxPu = 0.8, QMin0Pu = -0.8, QMinPu = -0.8, QlConst = true, RDropPu = 0, ResPu = 0, SNom = 100, TabletUunderUwtfilt12 = 0.5, TabletUunderUwtfilt22 = 0.5, TabletUunderUwtfilt32 = 0.5, U0Pu = 1, UGsIm0Pu = 0.21823, UGsRe0Pu = 0.975897, UMaxPu = 1.1, UMinPu = 0.9, UOverPu = 1.1, UPhase0 = 0.21949, UPll1Pu = 999, UPll2Pu = 0.13, URef0Pu = 0, UUnderPu = 0.9, Udb1Pu = 0.9, Udb2Pu = 1.1, UpquMaxPu = 1.1, UqDipPu = 0.9, XDropPu = 0, XWT0Pu = -0.21, XesPu = 0, fOverPu = 1.1, fUnderPu = 0.9, i0Pu = Complex(-0.930069, -0.423168), tG = 0.01, tPFiltQ = 0.01, tPFiltql = 0.01, tPOrdP4A = 0.1, tPll = 0.01, tPost = 0, tQord = 0.05, tS = 0.001, tUFilt = 0.01, tUFiltP4A = 0.01, tUFiltQ = 0.01, tUFiltcl = 0.01, tUFiltql = 0.01, tfFilt = 0.01, tphiFilt = 0.02, u0Pu = Complex(0.975897, 0.2183)) annotation(
...
equation
  wT4ACurrentSource.injector.switchOffSignal1.value = false;
  wT4ACurrentSource.injector.switchOffSignal2.value = false;
  wT4ACurrentSource.injector.switchOffSignal3.value = false;
