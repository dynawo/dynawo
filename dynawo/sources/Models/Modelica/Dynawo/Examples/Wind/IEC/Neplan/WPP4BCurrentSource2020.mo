...
model WPP4BCurrentSource2020 "Wind Power Plant Type 4B model from IEC 61400-27-1:2020 standard with infinite bus - fault and reference tracking tests (Active and reactive power steps)"
  ...
  Dynawo.Electrical.Wind.IEC.WPP.WPP4BCurrentSource2020 wPP4BCurrentSource(CdrtPu = 15, DPMaxP4BPu = 1, DPRefMax4BPu = 100, DPRefMaxPu = 1, DPRefMin4BPu = -100, DPRefMinPu = -1, DPwpRefMaxPu = 1, DPwpRefMinPu = -1, DUdb1Pu = -0.1, DUdb2Pu = 0.1, DXRefMaxPu = 10, DXRefMinPu = -10, DfMaxPu = 1, DfcMaxPu = 1, DfpMaxPu = 1, DipMaxPu = 1, DiqMaxPu = 100, DiqMinPu = -100, Hgen = 1, Hwtr = 5, IMaxDipPu = 1.3, IMaxPu = 1.3, IpMax0Pu = 1.2, IqH1Pu = 1.05, IqMax0Pu = 0.4, IqMaxPu = 1.05, IqMin0Pu = -0.4, IqMinPu = -1.05, IqPostPu = 0, KdrtPu = 500, Kipaw = 100, Kiq = 2.25, Kiqaw = 100, Kiu = 10, Kiwpp = 5, Kiwpx = 10, Kpaw = 1000, Kpq = 1.1, Kpqu = 20, Kpu = 2, Kpufrt = 2, Kpwpp = 2.25, Kpwpx = 0.5, Kqv = 2, KwppRef = 1.5, KwpqRef = 0, Kwpqu = 0, MdfsLim = false, MpUScale = false, MqG = 2, Mqfrt = 1, Mqpri = true, MwpqMode = 0, P0Pu = -PRefPu.offset*wPP4BCurrentSource.SNom/SystemBase.SnRef, PErrMaxPu = 1, PErrMinPu = -1, PKiwppMaxPu = 1.01, PKiwppMinPu = -1, PRefMaxPu = 1.01, PRefMinPu = 0, Q0Pu = -xRefPu.offset*wPP4BCurrentSource.SNom/SystemBase.SnRef, QMax0Pu = 0.8, QMaxPu = 0.8, QMin0Pu = -0.8, QMinPu = -0.8, QlConst = true, RDropPu = 0, RwpDropPu = 0, SNom = 100, U0Pu = 1.00018, UMaxPu = 1.1, UMinPu = 0.9, UOverPu = 1.1, UPhase0 = 0.219441, UPll1Pu = 999, UPll2Pu = 0.13, URef0Pu = 0, UUnderPu = 0.9, UpDipPu = 0, UpquMaxPu = 1.1, UqDipPu = 0.9, UqRisePu = 1.1, UwpqDipPu = 0.8, UwpqRisePu = 1.2, XDropPu = 0, XErrMaxPu = 1, XErrMinPu = -1, XKiwpxMaxPu = 1, XKiwpxMinPu = -1, XRefMaxPu = 1, XRefMinPu = -1, XwpDropPu = 0, fOverPu = 1.1, fUnderPu = 0.9, tG = 0.01, tIFilt = 0.01, tIcFilt = 0.01, tIpFilt = 0.01, tLag = 0.01, tLead = 0.01, tPAero = 0.1, tPFilt = 0.01, tPOrdP4B = 0.05, tPcFilt = 0.01, tPll = 0.01, tPost = 0, tPpFilt = 0.01, tQFilt = 0.01, tQcFilt = 0.01, tQord = 0.05, tQpFilt = 0.01, tS = 0.001, tUFilt = 0.01, tUcFilt = 0.01, tUpFilt = 0.01, tUqFilt = 0.01, tUss = 1, tfFilt = 0.01, tfcFilt = 0.01, tfpFilt = 0.01, TableIpMaxUwt52 = 1.01, TableIpMaxUwt62 = 1.01, TableIpMaxUwt72 = 1.01, BMvHvPu = 0.001, GMvHvPu = 0.0005, RMvHvPu = 0.001, XMvHvPu = 0.01, PPCLocal = true, BLvTrPu = 0.001, GLvTrPu = 0.0005, RLvTrPu = 0.001, XLvTrPu = 0.01, ConverterLVControl = false) annotation(
