...
model WT4BCurrentSource2020 "Wind Turbine Type 4B model from IEC 61400-27-1:2020 standard with infinite bus - fault and reference tracking tests (Active and reactive power steps)"
  ...
  Dynawo.Electrical.Wind.IEC.WT.WT4BCurrentSource2020 wT4BCurrentSource(CdrtPu = 15, DPMaxP4BPu = 1, DPRefMax4BPu = 100, DPRefMin4BPu = -100, DUdb1Pu = -0.1, DUdb2Pu = 0.1, DfcMaxPu = 1, DfpMaxPu = 1, DipMaxPu = 1, DiqMaxPu = 100, DiqMinPu = -100, Hgen = 1, Hwtr = 5, IMaxDipPu = 1.3, IMaxPu = 1.3, IqH1Pu = 1.05, IqMaxPu = 1.05, IqMinPu = -1.05, IqPostPu = 0, KdrtPu = 500, Kipaw = 100, Kiq = 2.25, Kiqaw = 100, Kiu = 10, Kpaw = 1000, Kpq = 1.1, Kpqu = 20, Kpu = 2, Kpufrt = 2, Kqv = 2, MdfsLim = false, MpUScale = false, MqG = 1, Mqfrt = 1, Mqpri = true, P0Pu = -1, Q0Pu = 0.21, QMaxPu = 0.8, QMinPu = -0.8, QlConst = true, RDropPu = 0, SNom = 100, U0Pu = 1.00027, UMaxPu = 1.1, UMinPu = 0.9, UOverPu = 1.1, UPhase0 = 0.219014, UPll1Pu = 999, UPll2Pu = 0.13, URef0Pu = 0, UUnderPu = 0.9, UpDipPu = 0, UpquMaxPu = 1.1, UqDipPu = 0.9, UqRisePu = 1.1, XDropPu = 0, fOverPu = 1.1, fUnderPu = 0.9, tG = 0.01, tIcFilt = 0.01, tIpFilt = 0.01, tPAero = 0.1, tPOrdP4B = 0.05, tPcFilt = 0.01, tPll = 0.01, tPost = 0, tPpFilt = 0.01, tQcFilt = 0.01, tQord = 0.05, tQpFilt = 0.01, tS = 0.001, tUcFilt = 0.01, tUpFilt = 0.01, tUss = 1, tfcFilt = 0.01, tfpFilt = 0.01, GesPu = 0.0005, ResPu = 0.001, XesPu = 0.01, ConverterLVControl = false) annotation(
