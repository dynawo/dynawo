within Dynawo.Examples.Wind.IEC.SMIB;
...
equation
  ...
  connect(omegaRefPu.y, wt.omegaRefPu) annotation(
    Line(points = {{-159, -60}, {-146, -60}, {-146, -6}, {-89, -6}}, color = {0, 0, 127}));
  connect(xRefPu.y, wt.xWTRefPu) annotation(
    Line(points = {{-158, -20}, {-150, -20}, {-150, -2}, {-89, -2}}, color = {0, 0, 127}));
  connect(PRefPu.y, wt.PWTRefPu) annotation(
    Line(points = {{-158, 20}, {-150, 20}, {-150, 2}, {-89, 2}}, color = {0, 0, 127}));
  connect(tanPhi.y, wt.tanPhi) annotation(
    Line(points = {{-158, 60}, {-146, 60}, {-146, 6}, {-89, 6}}, color = {0, 0, 127}));
