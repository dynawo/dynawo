...
model WPP4BCurrentSource "Wind Power Plant Type 4A model from IEC 61400-27-1 standard with infinite bus - fault and reference tracking tests (Active and reactive power steps)"
  import Modelica;
  import Dynawo;

  extends Icons.Example;

  Dynawo.Electrical.Events.NodeFault nodeFault1(RPu = 0, XPu = 0.379, tBegin = 12, tEnd = 12.15) annotation(
  ...
  Dynawo.Electrical.Events.NodeFault nodeFault(RPu = 0, XPu = 0.091, tBegin = 6, tEnd = 6.4) annotation(
...
equation
  ...
  connect(PRefPu.y, wPP4BCurrentSource.PPDRefPu) annotation(
    Line(points = {{-158, 20}, {-150, 20}, {-150, 2}, {-140, 2}}, color = {0, 0, 127}));
  connect(xRefPu.y, wPP4BCurrentSource.xPDRefPu) annotation(
    Line(points = {{-158, -20}, {-150, -20}, {-150, -2}, {-140, -2}}, color = {0, 0, 127}));
