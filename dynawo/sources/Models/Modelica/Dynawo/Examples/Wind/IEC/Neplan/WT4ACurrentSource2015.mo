...
model WT4ACurrentSource2015 "Wind Turbine Type 4A model from IEC 61400-27-1:2015 standard with infinite bus - fault and reference tracking tests (Active and reactive power steps)"
  ...
  Dynawo.Electrical.Wind.IEC.WT.WT4ACurrentSource2015 wT4ACurrentSource(DPMaxP4APu = 1, DfMaxPu = 1, DipMaxPu = 1, DiqMaxPu = 100, DiqMinPu = -100, IMaxDipPu = 1.3, IMaxPu = 1.3, IpMax0Pu(fixed = false),  // = 1.2,
  IqH1Pu = 1.05, IqMax0Pu(fixed = false),  // = 0.4,
  IqMaxPu = 1.05, IqMin0Pu(fixed = false),  // = -0.4,
  IqMinPu = -1.05, IqPostPu = 0, Kipaw = 100, Kiq = 2.25, Kiqaw = 100, Kiu = 10, Kpaw = 1000, Kpq = 1.1, Kpqu = 20, Kpu = 2, Kqv = 2, MdfsLim = false, MqG = 1, MqUvrt = 1, Mqpri = true, Mzc = false, P0Pu = -1, Q0Pu = 0.21, QMax0Pu(fixed = false),  // = 0.8,
  QMaxPu = 0.8, QMin0Pu(fixed = false),  // = -0.8,
  QMinPu = -0.8, QlConst = true, RDropPu = 0, SNom = 100, U0Pu = 1, UMaxPu = 1.1, UMinPu = 0.9, UOverPu = 1.1, UPhase0 = 0.21949, UPll1Pu = 999, UPll2Pu = 0.13, URef0Pu = 0, UUnderPu = 0.9, Udb1Pu = 0.9, Udb2Pu = 1.1, UpquMaxPu = 1.1, UqDipPu = 0.9, XDropPu = 0, fOverPu = 1.1, fUnderPu = 0.9, tG = 0.01, tPFiltQ = 0.01, tPFiltql = 0.01, tPOrdP4A = 0.1, tPll = 0.01, tPost = 0, tQord = 0.05, tS = 0.001, tUFilt = 0.01, tUFiltP4A = 0.01, tUFiltQ = 0.01, tUFiltcl = 0.01, tUFiltql = 0.01, tfFilt = 0.01, tphiFilt = 0.02, BesPu = 0.001, GesPu = 0.0005, ResPu = 0.001, XesPu = 0.01, ConverterLVControl = false) annotation(
