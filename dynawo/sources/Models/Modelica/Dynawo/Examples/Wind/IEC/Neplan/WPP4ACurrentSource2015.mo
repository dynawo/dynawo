...
model WPP4ACurrentSource2015 "Wind Power Plant Type 4A model from IEC 61400-27-1:2015 standard with infinite bus - fault and reference tracking tests (Active and reactive power steps)"
  ...
  Modelica.Blocks.Sources.Step PRefPu(height = -0.5, offset = 1, startTime = 2) annotation(
    Placement(visible = true, transformation(origin = {-170, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Wind.IEC.WPP.WPP4ACurrentSource2015 wPP4ACurrentSource(BesPu = 0, DPMaxP4APu = 1, DPRefMaxPu = 1, DPRefMinPu = -1, DPwpRefMaxPu = 1, DPwpRefMinPu = -1, DXRefMaxPu = 10, DXRefMinPu = -10, DfMaxPu = 1, DipMaxPu = 1, DiqMaxPu = 100, DiqMinPu = -100, GesPu = 0, IGsIm0Pu = 0.423168, IGsRe0Pu = 0.930069, IMaxDipPu = 1.3, IMaxPu = 1.3, IpMax0Pu = 1.2, IqH1Pu = 1.05, IqMax0Pu = 0.4, IqMaxPu = 1.05, IqMin0Pu = -0.4, IqMinPu = -1.05, IqPostPu = 0, Kipaw = 100, Kiq = 2.25, Kiqaw = 100, Kiu = 10, Kiwpp = 5, Kiwpx = 10, Kpaw = 1000, Kpq = 1.1, Kpqu = 20, Kpu = 2, Kpwpp = 2.25, Kpwpx = 0.5, Kqv = 2, KwppRef = 1.5, KwpqRef = 0, Kwpqu = 0, MdfsLim = false, MqG = 2, MqUvrt = 1, Mqpri = true, MwpqMode = 0, P0Pu = -1, PAg0Pu = 1, PKiwppMaxPu = 1, PKiwppMinPu = -1, PRefMaxPu = 1, PRefMinPu = 0, Q0Pu = 0.21, QMax0Pu = 0.8, QMaxPu = 0.8, QMin0Pu = -0.8, QMinPu = -0.8, QlConst = true, RDropPu = 0, ResPu = 0, SNom = 100, U0Pu = 1, UGsIm0Pu = 0.21823, UGsRe0Pu = 0.975897, UMaxPu = 1.1, UMinPu = 0.9, UOverPu = 1.1, UPhase0 = 0.21949, UPll1Pu = 999, UPll2Pu = 0.13, URef0Pu = 0, UUnderPu = 0.9, Udb1Pu = 0.9, Udb2Pu = 1.1, UpquMaxPu = 1.1, UqDipPu = 0.9, UwpqDipPu = 0.8, X0Pu = -0.21, XDropPu = 0, XKiwpxMaxPu = 1, XKiwpxMinPu = -1, XRefMaxPu = 1, XRefMinPu = -1, XWT0Pu = -0.21, XesPu = 0, fOverPu = 1.1, fUnderPu = 0.9, i0Pu = Complex(-0.930069, -0.423168), tG = 0.01, tPFiltQ = 0.01, tPFiltql = 0.01, tPOrdP4A = 0.1, tPll = 0.01, tPost = 0, tQord = 0.05, tS = 0.001, tUFilt = 0.01, tUFiltP4A = 0.01, tUFiltQ = 0.01, tUFiltcl = 0.01, tUFiltql = 0.01, tUqFilt = 0.01, tWPPFiltP = 0.01, tWPPFiltQ = 0.01, tWPQFiltQ = 0.01, tWPUFiltQ = 0.01, tWPfFiltP = 0.01, tfFilt = 0.01, tpft = 0., tpfv = 0.3933, txft = 0, txfv = 0.1, u0Pu = Complex(0.975897, 0.2183)) annotation(
    Placement(visible = true, transformation(origin = {-130, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant URefPu(k = 1)  annotation(
    Placement(visible = true, transformation(origin = {-170, 94}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(QRefPu.y, wPP4ACurrentSource.QWPRefPu) annotation(
    Line(points = {{-158, -20}, {-148, -20}, {-148, 4}, {-140, 4}}, color = {0, 0, 127}));
  connect(URefPu.y, wPP4ACurrentSource.UWPRefPu) annotation(
    Line(points = {{-158, 94}, {-144, 94}, {-144, 8}, {-140, 8}}, color = {0, 0, 127}));
