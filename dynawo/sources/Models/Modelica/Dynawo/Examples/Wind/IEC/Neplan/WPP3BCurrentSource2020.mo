...
model WPP3BCurrentSource2020 "Wind Power Plant Type 4A model from IEC 61400-27-1:2020 standard with infinite bus - fault and reference tracking tests (Active and reactive power steps)"
  ...
  Dynawo.Electrical.Events.NodeFault nodeFault1(RPu = 0, XPu = 0.4, tBegin = 14 * 999, tEnd = 14.15 * 999) annotation(
  ...
  Dynawo.Electrical.Events.NodeFault nodeFault(RPu = 0, XPu = 0.09, tBegin = 10 * 99, tEnd = 10.25 * 99) annotation(
  ...
  Modelica.Blocks.Sources.Step xRefPu(height = 0.41, offset = -0.21, startTime = 6 * 99) annotation(
