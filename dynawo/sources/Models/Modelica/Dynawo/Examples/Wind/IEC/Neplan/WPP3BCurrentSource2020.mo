...
model WPP3BCurrentSource2020 "Wind Power Plant model with Turbine Type 3B model from IEC 61400-27-1 standard with infinite bus - voltage drop test."
  ...
  Dynawo.Electrical.Wind.IEC.WPP.WPP3CurrentSource_INIT init(
    ...
    TableQMaxPwtcFilt = wpp.TableQMaxPwtcFilt,
    TableQMaxUwtcFilt = wpp.TableQMaxUwtcFilt,
    TableQMinPwtcFilt = wpp.TableQMinPwtcFilt,
    TableQMinUwtcFilt = wpp.TableQMinUwtcFilt,
    U0Pu = wpp.U0Pu,
    UPhase0 = wpp.UPhase0,
...
equation
  wpp.wT3BCurrentSource.injector.switchOffSignal1 = false;
  wpp.wT3BCurrentSource.injector.switchOffSignal2 = false;
  wpp.wT3BCurrentSource.injector.switchOffSignal3 = false;
...
<div><b><u>Bug description:</u></b></div><div>This model does not behave as expected.</div><div>please see example WT3BCurrentSource2020.</div><div><br></div></body></html>"));
