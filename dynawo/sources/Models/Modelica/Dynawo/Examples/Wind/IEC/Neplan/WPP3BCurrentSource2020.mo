...
model WPP3BCurrentSource2020 "Wind Power Plant Type 3B model from IEC 61400-27-1:2020 standard with infinite bus - fault and reference tracking tests (Active and reactive power steps)"
  extends Icons.Example;

  Dynawo.Electrical.Events.NodeFault nodeFault1(RPu = 0, XPu = 0.4, tBegin = 50, tEnd = 50.15) annotation(
  ...
  Dynawo.Electrical.Buses.InfiniteBusWithVariations infiniteBusWithVariations(U0Pu = 1.0678, UEvtPu = 1, UPhase = -0.04, omega0Pu = 1, omegaEvtPu = 0.99, tOmegaEvtEnd = 61, tOmegaEvtStart = 60, tUEvtEnd = 999, tUEvtStart = 999) annotation(
    Placement(visible = true, transformation(origin = {140, 0}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Dynawo.Electrical.Events.NodeFault nodeFault(RPu = 0, XPu = 0.09, tBegin = 55, tEnd = 55.25) annotation(
  ...
  Modelica.Blocks.Sources.Step xRefPu(height = 0.41, offset = -0.21, startTime = 30) annotation(
    Placement(visible = true, transformation(origin = {-130, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Pulse omegaRefPu(amplitude = -0.01, nperiod = 1, offset = 1, period = 2, startTime = 70) annotation(
    Placement(visible = true, transformation(origin = {-130, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Step PRefPu(height = -0.5, offset = 1, startTime = 1 * 999) annotation(
    Placement(visible = true, transformation(origin = {-130, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Wind.IEC.WPP.WPP3BCurrentSource2020 wPP3BCurrentSource(BesPu = 0, CdrtPu = 2.344, DPMaxPu = 999, DPOmega0Pu = 0.48, DPOmegaThetaPu = 0.028, DPRefMax4abPu = 0.3, DPRefMaxPu = 0.001, DPRefMin4abPu = -0.3, DPRefMinPu = -0.001, DPThetaPu = -0.03, DPwpRefMaxPu = 1, DPwpRefMinPu = -1, DTauMaxPu = 0.25, DTauUvrtMaxPu = 0, DThetaCmax = 6, DThetaCmin = -3, DThetaMax = 6, DThetaMin = -3, DThetaOmegamax = 6, DThetaOmegamin = -3, DUdb1Pu = -0.1, DUdb2Pu = 0.1, DXRefMaxPu = 10, DXRefMinPu = -10, DfMaxPu = 1, DfcMaxPu = 1, DfpMaxPu = 1, DipMaxPu = 1, DiqMaxPu = 100, GesPu = 0, Hgen = 3.395, Hwtr = 0.962, IGsIm0Pu = 0.422574, IGsRe0Pu = 0.930137, IMaxDipPu = 1.3, IMaxPu = 1.3, IpMax0Pu = 1.2, IqH1Pu = 1.05, IqMax0Pu = 0.4, IqMaxPu = 1.05, IqMin0Pu = -0.4, IqMinPu = -1.05, IqPostPu = 0, KDtd = 1.5, KIcPu = 0, KIomegaPu = 15, KIp = 5, KPXPu = 1, KPcPu = 0, KPomegaPu = 15, KPp = 8, KdrtPu = 1.378, Kiq = 2.25, Kiu = 10, Kiwpp = 1, Kiwpx = 10, Kpq = 1.1, Kpqu = 20, Kpu = 2, Kpufrt = 2, Kpwpp = 0.5, Kpwpx = 0.5, Kqv = 2, KwppRef = 0.5, KwpqRef = 0, Kwpqu = 0, MCrb = false, MOmegaTMax = true, MOmegaTqpi = false, MPUvrt = true, MdfsLim = false, MpUScale = false, MqG = 2, Mqfrt = 1, Mqpri = true, MwpqMode = 0, OmegaDtdPu = 11.3, OmegaOffsetPu = 0, P0Pu = -1, PAg0Pu = 1, PAvailPu = 1, PDtdMaxPu = 0.15, PErrMaxPu = 0.2, PErrMinPu = -0.2, PKiwppMaxPu = 2, PKiwppMinPu = 0, PRefMaxPu = 1.1, PRefMinPu = -1e-6, PWTRef0Pu = 1.0, Q0Pu = 0.21, QMax0Pu = 0.8, QMaxPu = 0.8, QMin0Pu = -0.8, QMinPu = -0.8, QlConst = true, RDropPu = 0, ResPu = 0, RwpDropPu = 0, SNom = 100, TTheta = 0.25, TauEMinPu = 0.001, TauUscalePu = 1, Theta0 = 0, ThetaCmax = 35, ThetaCmin = 0, ThetaMax = 35, ThetaMin = 0, ThetaOmegamax = 35, ThetaOmegamin = 0, U0Pu = 1.00018, UDvsPu = 0.15, UGsIm0Pu = 0.217725, UGsRe0Pu = 0.976195, UMaxPu = 1.1, UMinPu = 0.9, UOverPu = 1.1, UPhase0 = 0.219443, UPll1Pu = 999, UPll2Pu = 0.13, URef0Pu = 0, UUnderPu = 0.9, UpDipPu = 0.9, UpquMaxPu = 1.1, UqDipPu = 0.9, UqRisePu = 1.1, UwpqDipPu = 0.8, UwpqRisePu = 1.2, X0Pu = -0.21, XDropPu = 0, XEqv = 10, XErrMaxPu = 1, XErrMinPu = -1, XKiwpxMaxPu = 1, XKiwpxMinPu = -1, XRefMaxPu = 1, XRefMinPu = -1, XWT0Pu = -0.21, XesPu = 0, XwpDropPu = 0, Zeta = 0.5, fOverPu = 1.1, fUnderPu = 0.9, i0Pu = Complex(-0.930137, -0.422574), tDvs = 0.05, tG = 0.01, tIFilt = 0.01, tIcFilt = 0.01, tIpFilt = 0.01, tLag = 0.01, tLead = 0.01, tOmegaRef = 0.005, tOmegafiltp3 = 0.005, tPFilt = 0.01, tPcFilt = 0.01, tPll = 0.01, tPord = 0.01, tPost = 0, tPpFilt = 0.01, tQFilt = 0.01, tQcFilt = 0.01, tQord = 0.05, tQpFilt = 0.01, tS = 0.001, tUFilt = 0.01, tUcFilt = 0.01, tUpFilt = 0.01, tUqFilt = 0.01, tUss = 1, tWo = 0.001, tfFilt = 0.01, tfcFilt = 0.01, tfpFilt = 0.01, u0Pu = Complex(0.976195, 0.217725)) annotation(
    Placement(visible = true, transformation(origin = {-90, 0}, extent = {{-12, -12}, {12, 12}}, rotation = 0)));
  Dynawo.Electrical.Wind.IEC.WT.WT3CurrentSource_INIT init(BesPu = wPP3BCurrentSource.BesPu, GesPu = wPP3BCurrentSource.GesPu, IMaxDipPu = wPP3BCurrentSource.IMaxDipPu, IMaxPu = wPP3BCurrentSource.IMaxPu, Kpqu = wPP3BCurrentSource.Kpqu, MdfsLim = wPP3BCurrentSource.MdfsLim, MqG = wPP3BCurrentSource.MqG, Mqpri = wPP3BCurrentSource.Mqpri, P0Pu = wPP3BCurrentSource.P0Pu, Q0Pu = wPP3BCurrentSource.Q0Pu, QMaxPu = wPP3BCurrentSource.QMaxPu, QMinPu = wPP3BCurrentSource.QMinPu, QlConst = wPP3BCurrentSource.QlConst, ResPu = wPP3BCurrentSource.ResPu, SNom = wPP3BCurrentSource.SNom, TableIpMaxUwt = wPP3BCurrentSource.TableIpMaxUwt, TableIqMaxUwt = wPP3BCurrentSource.TableIqMaxUwt, TableQMaxPwtcFilt = wPP3BCurrentSource.TableQMaxPwtcFilt, TableQMaxUwtcFilt = wPP3BCurrentSource.TableQMaxUwtcFilt, TableQMinPwtcFilt = wPP3BCurrentSource.TableQMinPwtcFilt, TableQMinUwtcFilt = wPP3BCurrentSource.TableQMinUwtcFilt, U0Pu = wPP3BCurrentSource.U0Pu, UPhase0 = wPP3BCurrentSource.UPhase0, UpquMaxPu = wPP3BCurrentSource.UpquMaxPu, XesPu = wPP3BCurrentSource.XesPu) annotation(
...
equation
  ...
  annotation(
    ...
    experiment(StartTime = 0, StopTime = 300, Tolerance = 1e-04, Interval = 0.005),
