...
equation
  ...
  connect(PRefPu.y, wPP4ACurrentSource.PPDRefPu) annotation(
    Line(points = {{-158, 20}, {-150, 20}, {-150, 2}, {-140, 2}}, color = {0, 0, 127}));
  connect(xRefPu.y, wPP4ACurrentSource.xPDRefPu) annotation(
    Line(points = {{-158, -20}, {-150, -20}, {-150, -2}, {-140, -2}}, color = {0, 0, 127}));
