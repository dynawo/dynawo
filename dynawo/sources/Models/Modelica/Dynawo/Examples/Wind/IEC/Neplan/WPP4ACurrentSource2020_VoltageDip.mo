...
model WPP4ACurrentSource2020_VoltageDip "Wind Power Plant Type 4A model from IEC 61400-27-1:2020 standard with infinite bus - fault and reference tracking tests (Active and reactive power steps)"
  ...
  Dynawo.Electrical.Events.VariableImpedantFault2Tables variableImpedantFault annotation(
...
equation
  ...
  connect(variableImpedantFault.terminal, transformer1.terminal2) annotation(
    Line(points = {{-70, -26}, {-70, 0}, {-80, 0}}, color = {0, 0, 255}));
  annotation(
...
end WPP4ACurrentSource2020_VoltageDip;
