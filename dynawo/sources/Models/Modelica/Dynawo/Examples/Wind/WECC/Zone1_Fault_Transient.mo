...
model Zone1_Fault_Transient "WECC Wind Type 4B Model on infinite bus"
  ...
  */
  ...
  Dynawo.Electrical.Buses.InfiniteBusWithVariations infiniteBus(U0Pu = 1.00125, UEvtPu = 0, UPhase = -0.04, omega0Pu = 1, omegaEvtPu = 1, tOmegaEvtEnd = 0, tOmegaEvtStart = 0, tUEvtEnd = 0, tUEvtStart = 0) annotation(
    Placement(visible = true, transformation(origin = {-82, 0}, extent = {{-20, -20}, {20, 20}}, rotation = -90)));
  Dynawo.Electrical.Lines.Line line(BPu = 0, GPu = 0, RPu = 0, XPu = 0.05) annotation(
    Placement(visible = true, transformation(origin = {-40, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant PInjRefPu(k = 1) annotation(
    Placement(visible = true, transformation(origin = {80, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Modelica.Blocks.Sources.Constant QInjRefPu(k = 0.1) annotation(
    Placement(visible = true, transformation(origin = {80, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  ...
  Electrical.Wind.WECC.WT4CurrentSource_INIT wT4CurrentSource_INIT(P0Pu = -1, Q0Pu = 0, RPu = 0.01, SNom = 100, U0Pu = 1, UPhase0 = 0.00996, XPu = 0.1) annotation(
    Placement(visible = true, transformation(origin = {-84, -84}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Events.NodeFault nodeFault(RPu = 0, XPu = 0.95, tBegin = 1, tEnd = 1.15) annotation(
