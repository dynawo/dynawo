...
model WPP4BCurrentSource "WECC Wind Type 4B Model (including a plant controller) - WPP4B - on infinite bus"
  ...
  Dynawo.Electrical.Controls.WECC.BaseClasses_INIT.WECCPlantCurrentSource_INIT weccPlantCurrentSource_INIT(
    ...
    XMvHvPu = WPP4B.XMvHvPu,
    rTfoPu = WPP4B.rTfoPu) annotation(
...
equation
  ...
  connect(omegaRefPu.y, WPP4B.omegaRefPu) annotation(
  ...
  connect(const.y, WPP4B.PPccPu) annotation(
    Line(points = {{-38, -40}, {-20, -40}, {-20, -6}, {-2, -6}}, color = {0, 0, 127}));
  connect(const.y, WPP4B.QPccPu) annotation(
    Line(points = {{-38, -40}, {-20, -40}, {-20, -10}, {-2, -10}}, color = {0, 0, 127}));
  connect(complexConst.y, WPP4B.uPccPu) annotation(
    Line(points = {{-38, -80}, {-10, -80}, {-10, -14}, {-2, -14}}, color = {85, 170, 255}));
  connect(line.terminal2, WPP4B.terminal) annotation(
  ...
  connect(QRef.y, WPP4B.QRefPu) annotation(
  ...
  annotation(
    ...
    <div><br></div><div><br></div><div><br></div><div><br></div><div><br></div><div><span style=\"font-size: 12px;\"><br></span></div></div></figure><figure>
      <img width=\"450\" src=\"modelica://Dynawo/Examples/Wind/WECC/Resources/WPP4BCurrentSource_PInjPu.png\">
    </figure>
    <figure>
      <img width=\"450\" src=\"modelica://Dynawo/Examples/Wind/WECC/Resources/WPP4BCurrentSource_QInjPu.png\">
    </figure>
    <figure>
      <img width=\"450\" src=\"modelica://Dynawo/Examples/Wind/WECC/Resources/WPP4BCurrentSource_UPu.png\">
    </figure></body></html>"),
