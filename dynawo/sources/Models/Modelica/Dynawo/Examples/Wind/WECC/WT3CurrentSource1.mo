...
model WT3CurrentSource1 "WECC Wind Type 3 Model on infinite bus"
  ...
  Dynawo.Electrical.Wind.WECC.WT3CurrentSource1 WT3(
...
initial algorithm
  ...
  WT3.Pm0Pu := weccInverterCurrentSource_INIT.Pm0Pu;
...
equation
  ...
  annotation(
    ...
    <div><br></div><div><br></div><div><br></div><div><br></div><div><br></div><div><span style=\"font-size: 12px;\"><br></span></div></div></figure><figure>
      <img width=\"450\" src=\"modelica://Dynawo/Examples/Wind/WECC/Resources/WT3CurrentSource1_PInjPu.png\">
    </figure>
    <figure>
      <img width=\"450\" src=\"modelica://Dynawo/Examples/Wind/WECC/Resources/WT3CurrentSource1_QInjPu.png\">
    </figure>
    <figure>
      <img width=\"450\" src=\"modelica://Dynawo/Examples/Wind/WECC/Resources/WT3CurrentSource1_UPu.png\">
    </figure></body></html>"),
