...
equation
  ...
  WTG4A.regc.injectorIDQ.switchOffSignal1.value = false;
  WTG4A.regc.injectorIDQ.switchOffSignal2.value = false;
  WTG4A.regc.injectorIDQ.switchOffSignal3.value = false;
