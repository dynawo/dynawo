...
model Zone1_PSetPoint "WECC Wind Type 4B Model on infinite bus"
  ...
  Dynawo.Electrical.Lines.Line line(BPu = 0, GPu = 0, RPu = 0.03333333333333333, XPu = 0.3333333333333333) annotation(
  ...
  Dynawo.Electrical.Wind.WECC.WT4CurrentSource_INIT wT4CurrentSource_INIT(P0Pu = -0.8660008104701283, Q0Pu = 0.2459918952779657, RPu = 0.005, SNom = 100, U0Pu = 1, UPhase0 = 0.2747683864792003, XPu = 0.05) annotation(
  ...
  Modelica.Blocks.Sources.Step PRef(height = -0.05, offset = 0.8660008104701283, startTime = 3) annotation(
    Placement(visible = true, transformation(origin = {80, -12}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Step QRef(height = 0, offset = -0.2459918952779657, startTime = 4) annotation(
...
equation
  ...
  connect(PRef.y, WT4B.PInjRefPu) annotation(
    Line(points = {{69, -12}, {42, -12}}, color = {0, 0, 127}));
  connect(QRef.y, WT4B.QInjRefPu) annotation(
