...
model Zone1_PSetPoint "WECC Wind Type 4B Model on infinite bus"
  /*
  ...
  */
  ...
  Dynawo.Electrical.Lines.Line line(BPu = 0, GPu = 0, RPu = 0.0333333333, XPu = 0.3333333333) annotation(
    Placement(visible = true, transformation(origin = {-40, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant QInjRefPu(k = -0.2459918952779657) annotation(
...
equation
  ...
  connect(WT4B.PInjRefPu, step.y) annotation(
    Line(points = {{42, -12}, {60, -12}, {60, -40}, {70, -40}}, color = {0, 0, 127}));
  annotation(
