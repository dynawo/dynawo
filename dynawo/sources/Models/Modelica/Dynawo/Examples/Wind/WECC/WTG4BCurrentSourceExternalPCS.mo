...
model WTG4BCurrentSourceExternalPCS "WECC Wind Type 4B Model (including a plant controller and an external power collection system) - WTG4B - on infinite bus"
  ...
  */
  ...
  Dynawo.Electrical.Transformers.TransformersFixedTap.TransformerFixedRatio ZPcs(BPu = 0, GPu = 0, RPu = 0.01, XPu = 0.15, rTfoPu = 0.95) annotation(
    Placement(transformation(origin = {-40, 0}, extent = {{-20, -20}, {20, 20}})));
  Modelica.Blocks.Sources.Step URef(height = 0.02, offset = WTG4B.wecc_repc.URef0Pu, startTime = 1) annotation(
    Placement(visible = true, transformation(origin = {90, 80}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Step PRef(height = 0.05, offset = 0.35, startTime = 8) annotation(
    Placement(visible = true, transformation(origin = {90, -40}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Dynawo.Electrical.Wind.WECC.WTG4BCurrentSource WTG4B(BMvHvPu = 0, ConverterLVControl = true, DDn = 20, DPMaxPu = 2, DPMinPu = -2, DUp = 0.001, Dbd1Pu = -0.05, Dbd2Pu = 0.05, DbdPu = 0.0001, EMaxPu = 0.5, EMinPu = -0.5, FDbd1Pu = 0.004, FDbd2Pu = 1, FEMaxPu = 999, FEMinPu = -999, FreqFlag = true, GMvHvPu = 0, IMaxPu = 1.3, Id0Pu(fixed = false), Iq0Pu(fixed = false), IqFrzPu = 0, Iqh1Pu = 1.1, Iql1Pu = -1.1, IqrMaxPu = 20, IqrMinPu = -20, Kc = 0.2, Ki = 7, KiPLL = 20, Kig = 7, Kp = 2, KpPLL = 3, Kpg = 2, Kqi = 10, Kqp = 2, Kqv = 2, Kvi = 10, Kvp = 2, Lvplsw = false, OmegaMaxPu = 1.5, OmegaMinPu = 0.5, P0Pu = -0.7058725761772852, PConv0Pu(fixed = false), UPhaseConv0(fixed = false), PF0(fixed = false), PFlag = true, PInj0Pu(fixed = false), PMaxREECPu = 1, PMaxREPCPu = 1, PMinREECPu = 0, PMinREPCPu = 0, PPCLocal = false, PPcc0Pu = -0.7, PQFlag = false, PfFlag = false, Q0Pu = -0.28808864265927975, QConv0Pu(fixed = false), QFlag = true, QInj0Pu(fixed = false), QMaxREECPu = 0.5, QMaxREPCPu = 0.5, QMinREECPu = -0.5, QMinREPCPu = -0.5, QPcc0Pu = -0.2, RLvTrPu = 0.015, RMvHvPu = 0, RefFlag = true, RrpwrPu = 10, SNom = 200, U0Pu = 0.9948728673356535, UInj0Pu(fixed = false), UPcc0Pu = 1, UPhase0 = 0.14453232453351325, VCompFlag = false, VDLIp11 = 1.1, VDLIp12 = 1.1, VDLIp21 = 1.15, VDLIp22 = 1, VDLIp31 = 1.16, VDLIp32 = 1, VDLIp41 = 1.17, VDLIp42 = 1, VDLIq11 = 1.1, VDLIq12 = 1.1, VDLIq21 = 1.15, VDLIq22 = 1, VDLIq31 = 1.16, VDLIq32 = 1, VDLIq41 = 1.17, VDLIq42 = 1, VDipPu = 0.9, VFlag = true, VFrz = 0, VMaxPu = 1.1, VMinPu = 0.9, VRef0Pu = 0, VRef1Pu = 0, VUpPu = 1.1, XLvTrPu = 0.06, XMvHvPu = 1e-5, brkpt = 0.1, i0Pu(im(fixed = false), re(fixed = false)), iConv0Pu(im(fixed = false), re(fixed = false)), lvpl1 = 1.22, s0Pu(im(fixed = false), re(fixed = false)), tFilterGC = 0.02, tFilterPC = 0.04, tFt = 1e-10, tFv = 0.1, tG = 0.02, tHoldIpMax = 0, tHoldIq = 0, tIq = 0.01, tLag = 0.1, tpREEC = 0.05, tpREPC = 0.05, tPord = 0.01, tRv = 0.01, u0Pu(im(fixed = false), re(fixed = false)), UConv0Pu(fixed = false), uConv0Pu(im(fixed = false), re(fixed = false)), uInj0Pu(im(fixed = false), re(fixed = false)), uPcc0Pu(im(fixed = false), re(fixed = false)), zerox = 0.05, omegaRefWTGQPu0(fixed = false)) annotation(
    Placement(visible = true, transformation(origin = {20, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 180)));
  // Initialization
  Dynawo.Electrical.Controls.WECC.BaseClasses_INIT.WECCPlantCurrentSource_INIT wTG4CurrentSource_INIT(BMvHvPu = WTG4B.BMvHvPu, ConverterLVControl = WTG4B.ConverterLVControl, GMvHvPu = WTG4B.GMvHvPu, P0Pu = WTG4B.P0Pu, PPCLocal = WTG4B.PPCLocal, PPcc0Pu = WTG4B.PPcc0Pu, Q0Pu = WTG4B.Q0Pu, QPcc0Pu = WTG4B.QPcc0Pu, RLvTrPu = WTG4B.RLvTrPu, RMvHvPu = WTG4B.RMvHvPu, SNom = WTG4B.SNom, U0Pu = WTG4B.U0Pu, UPcc0Pu = WTG4B.UPcc0Pu, UPhase0 = WTG4B.UPhase0, UPhasePcc0 = 0.03533563863002929, XLvTrPu = WTG4B.XLvTrPu, XMvHvPu = WTG4B.XMvHvPu) annotation(
