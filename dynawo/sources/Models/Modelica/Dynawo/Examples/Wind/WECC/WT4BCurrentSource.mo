...
equation
  ...
  WT4B.regc.injectorIDQ.switchOffSignal1.value = false;
  WT4B.regc.injectorIDQ.switchOffSignal2.value = false;
  WT4B.regc.injectorIDQ.switchOffSignal3.value = false;
