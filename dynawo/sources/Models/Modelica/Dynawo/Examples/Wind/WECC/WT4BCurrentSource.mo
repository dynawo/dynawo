...
model WT4BCurrentSource "WECC Wind Type 4B Model on infinite bus"
  ...
  */
  ...
  Dynawo.Electrical.Wind.WECC.WT4BCurrentSource WT4B(ConverterLVControl = false, DPMaxPu = 2, DPMinPu = -2, Dbd1Pu = -0.05, Dbd2Pu = 0.05, IMaxPu = 1.3, IqFrzPu = 0.1, Iqh1Pu = 1.1, Iql1Pu = -1.1, IqrMaxPu = 20, IqrMinPu = -20, KiPLL = 20, KpPLL = 3, Kqi = 0.7, Kqp = 2, Kqv = 2, Kvi = 0.7, Kvp = 2, Lvplsw = false, OmegaMaxPu = 1.5, OmegaMinPu = 0.5, PFlag = false, PMaxPu = 1, PMinPu = 0, PQFlag = false, PfFlag = false, QFlag = false, QMaxPu = 0.4, QMinPu = -0.4, RLvTrPu = 0, RrpwrPu = 10, SNom = 100, VDLIp11 = 1.1, VDLIp12 = 1.1, VDLIp21 = 1.15, VDLIp22 = 1, VDLIp31 = 1.16, VDLIp32 = 1, VDLIp41 = 1.17, VDLIp42 = 1, VDLIq11 = 1.1, VDLIq12 = 1.1, VDLIq21 = 1.15, VDLIq22 = 1, VDLIq31 = 1.16, VDLIq32 = 1, VDLIq41 = 1.17, VDLIq42 = 1, VDipPu = 0.9, VFlag = false, VMaxPu = 1.1, VMinPu = 0.9, VRef0Pu = 0, VRef1Pu = 0, VUpPu = 1.1, XLvTrPu = 0.15, brkpt = 0.1, lvpl1 = 1.22, s0Pu = Complex(-0.7, -0.2), tFilterGC = 0.02, tG = 0.02, tHoldIpMax = 0, tHoldIq = 0.1, tIq = 0.01, tP = 0.05, tPord = 0.01, tRv = 0.01, u0Pu = Complex(1, 0), zerox = 0.05, UConv0Pu(fixed = false), uConv0Pu(im(fixed = false), re(fixed = false)), uInj0Pu(im(fixed = false), re(fixed = false)), i0Pu(im(fixed = false), re(fixed = false)), iConv0Pu(im(fixed = false), re(fixed = false)), UInj0Pu(fixed = false), QInj0Pu(fixed = false), QConv0Pu(fixed = false), PInj0Pu(fixed = false), PConv0Pu(fixed = false), UPhaseConv0(fixed = false), PF0(fixed = false), Id0Pu(fixed = false), Iq0Pu(fixed = false), UPhase0 = 1.4461e-06) annotation(
  ...
  // Initialization
  Dynawo.Electrical.Wind.WECC.WT4CurrentSource_INIT wt4CurrentSource_INIT(ConverterLVControl = WT4B.ConverterLVControl, P0Pu = WT4B.s0Pu.re, Q0Pu = WT4B.s0Pu.im, RLvTrPu = WT4B.RLvTrPu, SNom = WT4B.SNom, U0Pu = Modelica.ComplexMath.'abs'(WT4B.u0Pu), UPhase0 = WT4B.UPhase0, XLvTrPu = WT4B.XLvTrPu) annotation(
