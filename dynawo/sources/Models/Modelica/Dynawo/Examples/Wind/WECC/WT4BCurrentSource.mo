...
equation
  ...
  connect(PInjRefPu.y, WT4B.PInjRefPu) annotation(
    Line(points = {{79, -30}, {54, -30}, {54, -12}, {42, -12}}, color = {0, 0, 127}));
  ...
  connect(WT4B.QInjRefPu, QInjRefPu.y) annotation(
    Line(points = {{42, 12}, {54, 12}, {54, 30}, {80, 30}}, color = {0, 0, 127}));
  annotation(
