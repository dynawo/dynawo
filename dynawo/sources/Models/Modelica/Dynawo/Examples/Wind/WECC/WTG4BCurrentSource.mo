...
model WTG4BCurrentSource "WECC Wind Type 4B Model(including a plant controller) - WTG4B - on infinite bus"
  ...
  Dynawo.Electrical.Wind.WECC.WTG4BCurrentSource WTG4B(Brkpt = 0.9, DDnPu = 20, DPMaxPu = 2, DPMinPu = -2, DUpPu = 0.001, Dbd1Pu = -0.05, Dbd2Pu = 0.05, DbdPu = 0.01, EMaxPu = 0.5, EMinPu = -0.5, FDbd1Pu = -0.004, FDbd2Pu = 1, FEMaxPu = 999, FEMinPu = -999, FreqFlag = true, IMaxPu = 1.3, Ip0Pu = 0.67611, Iq0Pu = 0.26996, IqFrzPu = 0, Iqh1Pu = 1.1, Iql1Pu = -1.1, IqrMaxPu = 20, IqrMinPu = -20, Kc = 0, Ki = 1.5, KiPLL = 20, Kig = 2.36, Kp = 0.1, KpPLL = 3, Kpg = 0.05, Kqi = 0.7, Kqp = 1, Kqv = 2, Kvi = 0.7, Kvp = 1, Lvpl1 = 1.22, LvplSw = false, OmegaMaxPu = 1.5, OmegaMinPu = 0.5, P0Pu = -0.7, PF0 = 0.92871, PFlag = true, PInj0Pu = 0.7, PMaxPu = 1, PMinPu = 0, PQFlag = false, PfFlag = false, Q0Pu = -0.2, QFlag = true, QInj0Pu = 0.2795, QMaxPu = 0.4, QMinPu = -0.4, RPu = 0, RateFlag = false, RefFlag = 1, RrpwrPu = 10, SNom = 100, U0Pu = 1.0, UCompFlag = false, UDipPu = 0.9, UFlag = true, UFrzPu = 0, UInj0Pu = 1.03534, UMaxPu = 1.1, UMinPu = 0.9, UPhaseInj0 = 0.10159, UUpPu = 1.1, VDLIp11 = 1.1, VDLIp12 = 1.1, VDLIp21 = 1.15, VDLIp22 = 1, VDLIq11 = 1.1, VDLIq12 = 1.1, VDLIq21 = 1.15, VDLIq22 = 1, VRef0Pu = 0, VRef1Pu = 0, XPu = 0.15, Zerox = 0.4, i0Pu = Complex(-0.7, 0.2), s0Pu = Complex(-0.7, -0.2), tFilterGC = 0.02, tFilterPC = 0.04, tFt = 1e-10, tFv = 0.1, tG = 0.02, tHld = 0, tHld2 = 0, tIq = 0.01, tLag = 0.1, tP = 0.05, tPOrd = 0.01, tRv = 0.01, u0Pu = Complex(1, 0), uInj0Pu = Complex(1.03, 0.105)) annotation(
...
equation
  ...
  WTG4B.regc.injectorIDQ.switchOffSignal1.value = false;
  WTG4B.regc.injectorIDQ.switchOffSignal2.value = false;
  WTG4B.regc.injectorIDQ.switchOffSignal3.value = false;
