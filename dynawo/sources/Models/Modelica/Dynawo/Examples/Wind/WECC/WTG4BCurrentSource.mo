...
model WTG4BCurrentSource "WECC Wind Type 4B Model(including a plant controller) - WTG4B - on infinite bus"
  ...
  Modelica.Blocks.Sources.Step step(height = 0.05, offset = 1, startTime = 2)  annotation(
    Placement(visible = true, transformation(origin = {60, 82}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
equation
