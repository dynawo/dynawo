...
model WTG4BCurrentSource "WECC Wind Type 4B Model(including a plant controller) - WTG4B - on infinite bus"
  ...
  */
  ...
  Dynawo.Electrical.Buses.InfiniteBusWithVariations infiniteBus(U0Pu = 0.9906184368094055, UEvtPu = 0.9906184368094055, UPhase = 0, omega0Pu = 1, omegaEvtPu = 1, tOmegaEvtEnd = 6.5, tOmegaEvtStart = 6, tUEvtEnd = 2, tUEvtStart = 1) annotation(
  ...
  Modelica.Blocks.Sources.Constant PRefPu(k = 0.35) annotation(
