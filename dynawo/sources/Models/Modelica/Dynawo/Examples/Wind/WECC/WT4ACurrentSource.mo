...
model WT4ACurrentSource "WECC Wind Type 4A Model on infinite bus"
  ...
  Dynawo.Electrical.Wind.WECC.WT4ACurrentSource WT4A(Brkpt = 0.9, DPMaxPu = 2, DPMinPu = -2, Dbd1Pu = -0.05, Dbd2Pu = 0.05, Dshaft = 1.5, Hg = 1, Ht = 5, IMaxPu = 1.3,Ip0Pu = 0.67611, Iq0Pu = 0.26996, IqFrzPu = 0, Iqh1Pu = 1.1, Iql1Pu = -1.1, IqrMaxPu = 20, IqrMinPu = -20, KiPLL = 20, KpPLL = 3, Kqi = 0.7, Kqp = 1, Kqv = 2, Kshaft = 200, Kvi = 0.7, Kvp = 1, Lvpl1 = 1.22, LvplSw = false, OmegaMaxPu = 1.5, OmegaMinPu = 0.5, PF0 = 0.92871, PFlag = true, PInj0Pu = 0.7, PMaxPu = 1, PMinPu = 0, PQFlag = false, PfFlag = false, QFlag = true, QInj0Pu = 0.2795, QMaxPu = 0.4, QMinPu = -0.4, RPu = 0, RateFlag = false, RrpwrPu = 10, SNom = 100, UDipPu = 0.9, UFlag = true, UInj0Pu = 1.03534, UMaxPu = 1.1, UMinPu = 0.9, UPhaseInj0 = 0.10159, UUpPu = 1.1, VDLIp11 = 1.1, VDLIp12 = 1.1, VDLIp21 = 1.15, VDLIp22 = 1, VDLIq11 = 1.1, VDLIq12 = 1.1, VDLIq21 = 1.15, VDLIq22 = 1, VRef0Pu = 0, VRef1Pu = 0, XPu = 0.15, Zerox = 0.4, i0Pu = Complex(-0.7, 0.2), s0Pu = Complex(-0.7, -0.2), tFilterGC = 0.02, tG = 0.02, tHld = 0, tHld2 = 0, tIq = 0.01, tP = 0.05, tPOrd = 0.01, tRv = 0.01, u0Pu = Complex(1, 0), uInj0Pu = Complex(1.03, 0.105)) annotation(
...
equation
  ...
  WT4A.regc.injectorIDQ.switchOffSignal1.value = false;
  WT4A.regc.injectorIDQ.switchOffSignal2.value = false;
  WT4A.regc.injectorIDQ.switchOffSignal3.value = false;
