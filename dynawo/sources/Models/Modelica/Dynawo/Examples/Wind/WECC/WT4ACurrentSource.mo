...
model WT4ACurrentSource "WECC Wind Type 4A Model on infinite bus"
  ...
  Dynawo.Electrical.Wind.WECC.WT4ACurrentSource WT4A(Id0Pu = 0.67611, IMaxPu = 1.3, IqFrzPu = 0, Iq0Pu = 0.26996, Iqh1Pu = 1.1, Iql1Pu = -1.1, IqrMaxPu = 20, IqrMinPu = -20, Kqi = 0.7, Kqp = 1, Kqv = 2, Kvi = 0.7, Kvp = 1, PF0 = 0.92871, PInj0Pu = 0.7, PMaxPu = 1, PMinPu = 0, PPriority = false, PfFlag = false, QFlag = true, QInj0Pu = 0.2795, QMaxPu = 0.4, QMinPu = -0.4, RPu = 0, RateFlag = false, SNom = 100, tFilterGC = 0.02, tG = 0.02, Tiq = 0.01, tP = 0.05, tPord = 0.01, tRv = 0.01, HoldIq = 0, HoldIpMax = 0, UInj0Pu = 1.03534, UMaxPu = 1.1, UMinPu = 0.9, UPhaseInj0 = 0.10159, VFlag = true, VMaxPu = 1.1, VMinPu = 0.9, VRef0Pu = 0, VRef1Pu = 0, XPu = 0.15, DPMax = 2, DPMin = -2, Dbd1 = -0.05, Dbd2 = 0.05, PFlag = true, VDLIp11 = 1.1, VDLIp12 = 1.1, VDLIp21 = 1.15, VDLIp22 = 1, VDLIq11 = 1.1, VDLIq12 = 1.1, VDLIq21 = 1.15, VDLIq22 = 1, Dshaft = 1.5, Hg = 1, Ht = 5, Kshaft = 200, i0Pu = Complex(-0.7, 0.2), Rrpwr = 10, s0Pu = Complex(-0.7, -0.2), u0Pu = Complex(1, 0), uInj0Pu = Complex(1.03, 0.105)) annotation(
  ...
  Modelica.Blocks.Sources.Constant QInjRefPu(k = 0.2) annotation(
    Placement(visible = true, transformation(origin = {90, 28}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
...
equation
  ...
  connect(QInjRefPu.y, WT4A.QInjRefPu) annotation(
    Line(points = {{79, 28}, {64, 28}, {64, 12}, {42, 12}}, color = {0, 0, 127}));
  connect(PInjRefPu.y, WT4A.PInjRefPu) annotation(
    Line(points = {{79, -30}, {66, -30}, {66, -12}, {42, -12}}, color = {0, 0, 127}));
  annotation(
