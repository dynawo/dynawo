...
model CurrentSourceIEC63406
  ...
  Modelica.Blocks.Sources.Step PRefPu(height = -1.5, offset = 1, startTime = 2) annotation(
  ...
  Modelica.Blocks.Sources.Step PPrimPu(height = 0, offset = 1, startTime = 2) annotation(
    Placement(visible = true, transformation(origin = {-190, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Events.NodeFault nodeFault(RPu = 0, XPu = 0, tBegin = 6, tEnd = 6.25) annotation(
    Placement(visible = true, transformation(origin = {70, -40}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
  Dynawo.Electrical.Sources.ConverterCurrentSourceIEC63406 converterCurrentSourceIEC63406(BesPu = 0,ComFlag = 3, DUdb1Pu = -0.01, DUdb2Pu = 0.01, DeltaT = 0.001, FFRflag = true, GesPu = 0, HVRTinQFlag = false, IMaxPu = 1.3, IPMax0Pu = 1.2, IPMaxPu = 1.2, IPMin0Pu = -1.2, IPMinPu = -1.2, IQMax0Pu = 0.4, IQMaxPu = 1.2, IQMin0Pu = -0.4, IQMinPu = -1.2, IsIm0Pu = 0.423168, IsRe0Pu = 0.930069, K1IpHV = 0, K1IpLV = 0, K1IqHV = -2, K1IqLV = -2, K2IpHV = 1, K2IpLV = 1, K2IqHV = 0, K2IqLV = 0, KDroop = 1, KIp = 10, KIpll = 20, KIqi = 10, KIqu = 10, KIui = 10, KIuq = 10, KPp = 2, KPpll = 3, KPqi = 2, KPqu = 2, KPui = 2, KPuq = 2, KpHVRT = 1, KpLVRT = 1, KqHVRT = 1, KqLVRT = 1, LFlag = 1, LVRTinQFlag = false, P0Pu = -1, PAvailIn0Pu = -1, PFFlag = 1, PFlag = true, PLLFlag = 2, PMaxPu = 1, PffrMaxPu = 0.05, PffrMinPu = -0.05, PriorityFlag = true, Q0Pu = 0.21, QLimFlag = true, QMax0Pu = 0.8, QMaxUd = 0.8, QMin0Pu = -0.8, QMinUd = -0.8, ResPu = 0, SNom = 100, SOCFlag = false, SOCInit = 50, SOCMax = 100, SOCMin = 10, StorageFlag = true, Tcom = 0.01, Tconv = 1, Tess = 40, TfFilt = 0.01, Tg = 0.01, TiFilt = 0.01, Tiq = 0.01, Tlag = 1, Tlead = 1, TpFilt = 0.01, TpRef = 0.1, TpllFilt = 0.01, TqFilt = 0.01, Trocof = 0.01, TuFilt = 0.01, U0Pu = 1, UFlag = false, UMaxPu = 1.1, UMinPu = 0.9, UPhase0 = 0.21949, UpllPu = 0.1, UsIm0Pu = 0.2183, UsRe0Pu = 0.975897, WMaxPu = 0.5, WMinPu = -0.5, XesPu = 0, f0Pu = 1, fThresholdPu = 0.001, fref = 50, i0Pu = Complex(-0.930069, -0.423168), iPSetHVPu = 0, iPSetLVPu = 0, iQSetHVPu = 0, iQSetLVPu = 0, pSetHVPu = 0, pSetLVPu = 0, pqFRTFlag = true, qSetHVPu = 0, qSetLVPu = 0, tS = 0.001, u0Pu = Complex(0.975897, 0.2183), uHVRTPu = 1.1, uLVRTPu = 0.9)  annotation(
