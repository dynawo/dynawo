...
model VoltageSourceIEC63406 "Example for the IEC 63406 standard as a production unit with voltage source"
  ...
  Dynawo.Electrical.Sources.ConverterVoltageSourceIEC63406 converterVoltageSourceIEC63406(ComFlag = 3, DUdb1Pu = -0.01, DUdb2Pu = 0.01, DeltaT = 0.001, FFRflag = false, HVRTinQFlag = false, IMaxPu = 1.3, IPMax0Pu = 1.2, IPMaxPu = 1.2, IPMin0Pu = -1.2, IPMinPu = -1.2, IQMax0Pu = 0.4, IQMaxPu = 1.2, IQMin0Pu = -0.4, IQMinPu = -1.2, IsIm0Pu = -0.422694, IsRe0Pu = -0.930285, K1IpHV = 0, K1IpLV = 0, K1IqHV = -2, K1IqLV = -2, K2IpHV = 1, K2IpLV = 1, K2IqHV = 0, K2IqLV = 0, KDroop = 1, KIp = 10, KIpll = 20 * 150, KIqi = 10, KIqu = 10, KIui = 10, KIuq = 10, KPp = 2, KPpll = 3 * 150, KPqi = 2, KPqu = 2, KPui = 2, KPuq = 2, KpHVRT = 1, KpLVRT = 1, KqHVRT = 1, KqLVRT = 1, LFlag = 1, LVRTinQFlag = false, P0Pu = -1, PAvailIn0Pu = 0, PFFlag = 1, PFlag = true, PLLFlag = 2, PMaxPu = 1, PffrMaxPu = 0.05, PffrMinPu = -0.05, PriorityFlag = true, Q0Pu = 0.21, QLimFlag = true, QMax0Pu = 0.8, QMaxPu = 0.8, QMin0Pu = -0.8, QMinPu = -0.8, ResPu = 0.015, SNom = 100, SOCFlag = false, SOCInit = 50, SOCMax = 100, SOCMin = 10, StorageFlag = false, Tcom = 0.01, Tconv = 1, Te = 0.005, Tess = 10, TfFilt = 0.01, Tg = 0.01, TiFilt = 0.01, Tiq = 0.01, Tlag = 1, Tlead = 1, TpFilt = 0.01, TpRef = 0.1, TpllFilt = 0.01, TqFilt = 0.01, Trocof = 0.01, TuFilt = 0.01, U0Pu = 1, UFlag = false, UMaxPu = 1.1, UMinPu = 0.9, UPhase0 = 0.21949, UeIm0Pu = 0.217732, UeRe0Pu = 0.976009, Ued0Pu = 0.9835, Ueq0Pu = 0.15315, UpllPu = 0.1,  WMaxPu = 0.5, WMinPu = -0.5, XesPu = 0.15, f0Pu = 1, fThresholdPu = 0.001, i0Pu = Complex(-0.930285, -0.422694), iPSetHVPu = 0, iPSetLVPu = 0, iQSetHVPu = 0, iQSetLVPu = 0, pSetHVPu = 0, pSetLVPu = 0, pqFRTFlag = true, qSetHVPu = 0, qSetLVPu = 0, tS = 0.001, u0Pu = Complex(0.976009, 0.217732), uHVRTPu = 1.1, uLVRTPu = 0.9, FFRTableName = "FFRTable", InertialTableName = "InertialTable", QMaxtoPTableName = "QMaxtoPTable", QMaxtoUTableName = "QMaxtoUTable", QMintoPTableName = "QMintoPTable", QMintoUTableName = "QMintoUTable", TableFileName = "../dynawo/examples/DynaSwing/IEC/Converter/IEC63406CurrentSourceUCPO/TableFile.txt", TDerThetaMax = 0.5, TDerfMax = 0.5, THVP1 = 1, THVP2 = 0.5, THVP3 = 0.3, THfP1 = 1, THfP2 = 0.5, THfP3 = 0.25, TLVP1 = 1, TLVP2 = 0.5, TLVP3 = 0.3, TLfP1 = 1, TLfP2 = 0.5, TLfP3 = 0.25, UHVP1 = 1.1, UHVP2 = 1.15, UHVP3 = 1.2, ULVP1 = 0.9, ULVP2 = 0.85, ULVP3 = 0.8, fHfP1 = 1.004, fHfP2 = 1.01, fHfP3 = 1.02, fLfP1 = 0.996, fLfP2 = 0.99, fLfP3 = 0.98, DerThetaMax = 1, DerfMaxPu = 0.02)  annotation(
