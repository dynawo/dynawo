...
model TwoConvertersWECC
  ...
  // ════════════════════════════════════════════════════════════════
  Dynawo.Electrical.Photovoltaics.WECC.PVVoltageSource4 PV1(P0Pu = -5.010676, Q0Pu = -0.21, U0Pu = 1.091230, SNom = 1000,  // Impedance = LC filter + LV transformer of GFLmodel (RfPu+RPuLV, LfPu+LPuLV)
  RSourcePu = 0.003, XSourcePu = 0.1, XMvHvPu = 0.0025, RLvTrPu = 2e-4, XLvTrPu = 0.0025,  // PLL — original RTE values
  KpPLL = 0.6366197723675814, KiPLL = 31.830988618379067, OmegaMaxPu = 1.1, OmegaMinPu = 0.9,  // Measurement filters — original RTE values
  tFilterPC = 1/300, tFilterGC = 1/300, tpREPC = 1/300, tpREEC = 1/300,  // Plant controller REPC‑A — original RTE values
  PPCLocal = true, RefFlag = true, FreqFlag = true, VCompFlag = false, VFrz = 0.0, Kp = 0.2, Ki = 2, Kpg = 0.2, Kig = 2, Kc = 0.417, tLag = 1e-9, tFt = 1e-10, tFv = 1e-9, DDn = 15.0, DUp = 0, DbdPu = 0.0001, EMaxPu = 999.0, EMinPu = -999.0, FDbd1Pu = 0.005, FDbd2Pu = 0.1, FEMaxPu = 999.0, FEMinPu = -999.0, PMaxREPCPu = 2.0, PMaxREECPu = 2.0, PMinREPCPu = 0.0, PMinREECPu = 0.0, QMaxREPCPu = 0.3, QMaxREECPu = 0.3, QMinREPCPu = -0.3, QMinREECPu = -0.3,  // Electrical controller REEC‑B — original RTE values
  PfFlag = false, QFlag = true, VFlag = false, PQFlag = false, Kqp = 1/30, Kqi = 10, Kvp = 1e-4, Kvi = 1e-4, Kqv = 0.0, IMaxPu = 2, Iqh1Pu = 1.2, Iql1Pu = -1.2, DPMaxPu = 999.0, DPMinPu = -999.0, Dbd1Pu = -0.1, Dbd2Pu = 0.1, VDipPu = 0.9, VUpPu = 1.1, VMaxPu = 1.1, VMinPu = 0.9, VRef0Pu = 1.0, VRef1Pu = 0.0, tIq = 1/300, tPord = 1/300, tRv = 1/300,  // Converter REGC‑C — original RTE values
  RrpwrPu = 10.0, tE = 1/300, IqrMaxPu = 20.0, IqrMinPu = -20.0, Kip = 0.48, Kii = 4.8, RateFlag = false, ConverterLVControl = true,  // Initial values (to be filled by PVVoltageSource_INIT)
  i0Pu(im(fixed = false), re(fixed = false)), u0Pu(im(fixed = false), re(fixed = false)), s0Pu(im(fixed = false), re(fixed = false)), uConv0Pu(im(fixed = false), re(fixed = false)), iSource0Pu(im(fixed = false), re(fixed = false)), iConv0Pu(im(fixed = false), re(fixed = false)), iInj0Pu(im(fixed = false), re(fixed = false)), uInj0Pu(im(fixed = false), re(fixed = false)), uSource0Pu(im(fixed = false), re(fixed = false)), Id0Pu(fixed = false), Iq0Pu(fixed = false), PConv0Pu(fixed = false), UPhaseConv0(fixed = false), PF0(fixed = false), PInj0Pu(fixed = false), QConv0Pu(fixed = false), QInj0Pu(fixed = false), UInj0Pu(fixed = false), UConv0Pu(fixed = false), UdInj0Pu(fixed = false), UqInj0Pu(fixed = false), uPcc0Pu(im(fixed = false), re(fixed = false))) annotation(
    Placement(transformation(origin = {-70, 0}, extent = {{-20, -20}, {20, 20}})));
  // ════════════════════════════════════════════════════════════════
  // PV2 — active load (P0Pu = +4.989324 pu, consuming power)
  // ════════════════════════════════════════════════════════════════
  Dynawo.Electrical.Photovoltaics.WECC.PVVoltageSource4 PV2(P0Pu = 4.989324, Q0Pu = -0.21, U0Pu = 1.086638, SNom = 1000,  // Impedance = LC filter + LV transformer of GFLmodel (RfPu+RPuLV, LfPu+LPuLV)
  RSourcePu = 0.003, XSourcePu = 0.1, XMvHvPu = 0.0025, RLvTrPu = 2e-4, XLvTrPu = 0.0025,  // PLL — original RTE values
  KpPLL = 0.6366197723675814, KiPLL = 31.830988618379067, OmegaMaxPu = 1.1, OmegaMinPu = 0.9,  // Measurement filters — original RTE values
  tFilterPC = 1/300, tFilterGC = 1/300, tpREPC = 1/300, tpREEC = 1/300,  // Plant controller REPC‑A — original RTE values
  PPCLocal = true, RefFlag = true, FreqFlag = true, VCompFlag = false, VFrz = 0.0, Kp = 0.2, Ki = 2, Kpg = 0.2, Kig = 2, Kc = 0.417, tLag = 1e-9, tFt = 1e-10, tFv = 1e-9, DDn = 15.0, DUp = 0, DbdPu = 0.0001, EMaxPu = 999.0, EMinPu = -999.0, FDbd1Pu = 0.005, FDbd2Pu = 0.1, FEMaxPu = 999.0, FEMinPu = -999.0, PMaxREPCPu = 0.0, PMaxREECPu = 0.0, PMinREPCPu = -2.0, PMinREECPu = -2.0, QMaxREPCPu = 0.3, QMaxREECPu = 0.3, QMinREPCPu = -0.3, QMinREECPu = -0.3,  // Electrical controller REEC‑B — original RTE values
  PfFlag = false, QFlag = true, VFlag = false, PQFlag = false, Kqp = 1/30, Kqi = 10, Kvp = 1e-4, Kvi = 1e-4, Kqv = 0.0, IMaxPu = 2, Iqh1Pu = 1.2, Iql1Pu = -1.2, DPMaxPu = 999.0, DPMinPu = -999.0, Dbd1Pu = -0.1, Dbd2Pu = 0.1, VDipPu = 0.9, VUpPu = 1.1, VMaxPu = 1.1, VMinPu = 0.9, VRef0Pu = 1.0, VRef1Pu = 0.0, tIq = 1/300, tPord = 1/300, tRv = 1/300,  // Converter REGC‑C — original RTE values
  RrpwrPu = 10.0, tE = 1/300, IqrMaxPu = 20.0, IqrMinPu = -20.0, Kip = 0.48, Kii = 4.8, RateFlag = false, ConverterLVControl = true,  // Initial values (to be filled by PVVoltageSource_INIT)
  i0Pu(im(fixed = false), re(fixed = false)), u0Pu(im(fixed = false), re(fixed = false)), s0Pu(im(fixed = false), re(fixed = false)), uConv0Pu(im(fixed = false), re(fixed = false)), iSource0Pu(im(fixed = false), re(fixed = false)), iConv0Pu(im(fixed = false), re(fixed = false)), iInj0Pu(im(fixed = false), re(fixed = false)), uInj0Pu(im(fixed = false), re(fixed = false)), uSource0Pu(im(fixed = false), re(fixed = false)), Id0Pu(fixed = false), Iq0Pu(fixed = false), PConv0Pu(fixed = false), UPhaseConv0(fixed = false), PF0(fixed = false), PInj0Pu(fixed = false), QConv0Pu(fixed = false), QInj0Pu(fixed = false), UInj0Pu(fixed = false), UConv0Pu(fixed = false), UdInj0Pu(fixed = false), UqInj0Pu(fixed = false), uPcc0Pu(im(fixed = false), re(fixed = false))) annotation(
  ...
  // ════════════════════════════════════════════════════════════════
  Dynawo.Electrical.Lines.Line line(RPu = 0.00144, XPu = 0.0144, BPu = 0, GPu = 0) annotation(
    Placement(transformation(origin = {-28, 0}, extent = {{-10, -10}, {10, 10}})));
  Dynawo.Electrical.Lines.Line line1(RPu = 0.00144, XPu = 0.0144, BPu = 0, GPu = 0) annotation(
    Placement(transformation(origin = {30, 0}, extent = {{-10, -10}, {10, 10}})));
  Dynawo.Electrical.Lines.Line line2(RPu = 0.01, XPu = 0.1, BPu = 0, GPu = 1e-4) annotation(
    Placement(transformation(origin = {0, -30}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Dynawo.Electrical.Lines.Line line3(RPu = 0.0077775, XPu = 0.077775, BPu = 0, GPu = 0) annotation(
    Placement(transformation(origin = {-36, -30}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  ...
  // ════════════════════════════════════════════════════════════════
  Dynawo.Electrical.Buses.InfiniteBusWithVariations infiniteBusWithVariations(U0Pu = 1.1, UPhase = -0.001082, omega0Pu = 1.0, UEvtPu = 0.5, tUEvtStart = 15.1, tUEvtEnd = 15.1, omegaEvtPu = 1.0, tOmegaEvtStart = 1e6, tOmegaEvtEnd = 1e6) annotation(
    Placement(transformation(origin = {0, -94}, extent = {{-10, -10}, {10, 10}})));
  // ════════════════════════════════════════════════════════════════
  // Setpoints for PV1
  // ════════════════════════════════════════════════════════════════
  // Active power reference: step from 0.5 pu to 0.6 pu at t = 50 s
  Modelica.Blocks.Sources.Step PRefPu1(offset = 0.5, height = 0.1, startTime = 50.0) annotation(
  ...
  Modelica.Blocks.Sources.Step PRefPu2(offset = -0.5, height = 0.1, startTime = 50.0) annotation(
  ...
  // ════════════════════════════════════════════════════════════════
  Dynawo.Electrical.Photovoltaics.WECC.PVVoltageSource_INIT pvInit1(ConverterLVControl = PV1.ConverterLVControl, P0Pu = PV1.P0Pu, PPCLocal = PV1.PPCLocal, Q0Pu = PV1.Q0Pu, RSourcePu = PV1.RSourcePu, SNom = PV1.SNom, U0Pu = PV1.U0Pu, UPhase0 = 0.063246, XSourcePu = PV1.XSourcePu, BMvHvPu = PV1.BMvHvPu, GMvHvPu = PV1.GMvHvPu, RMvHvPu = PV1.RMvHvPu, XMvHvPu = PV1.XMvHvPu, RLvTrPu = PV1.RLvTrPu, XLvTrPu = PV1.XLvTrPu, PPcc0Pu = PV1.PPcc0Pu, QPcc0Pu = PV1.QPcc0Pu, UPcc0Pu = PV1.UPcc0Pu) annotation(
    Placement(transformation(origin = {-60, 80}, extent = {{-10, -10}, {10, 10}})));
  Dynawo.Electrical.Photovoltaics.WECC.PVVoltageSource_INIT pvInit2(ConverterLVControl = PV2.ConverterLVControl, P0Pu = PV2.P0Pu, PPCLocal = PV2.PPCLocal, Q0Pu = PV2.Q0Pu, RSourcePu = PV2.RSourcePu, SNom = PV2.SNom, U0Pu = PV2.U0Pu, UPhase0 = -0.063421, XSourcePu = PV2.XSourcePu, BMvHvPu = PV2.BMvHvPu, GMvHvPu = PV2.GMvHvPu, RMvHvPu = PV2.RMvHvPu, XMvHvPu = PV2.XMvHvPu, RLvTrPu = PV2.RLvTrPu, XLvTrPu = PV2.XLvTrPu, PPcc0Pu = PV2.PPcc0Pu, QPcc0Pu = PV2.QPcc0Pu, UPcc0Pu = PV2.UPcc0Pu) annotation(
    Placement(transformation(origin = {60, 80}, extent = {{-10, -10}, {10, 10}})));
...
// Line3 switching via IdealSwitch controlled by BooleanTable
  ...
  annotation(
    experiment(StartTime = 0, StopTime = 70, Tolerance = 1e-05, Interval = 0.005),
    ...
    __OpenModelica_simulationFlags(lv = "LOG_STDOUT,LOG_ASSERT,LOG_STATS,LOG_LS", s = "ida", nls = "kinsol", noHomotopyOnFirstTry = "()", initialStepSize = "0.00001", maxStepSize = "0.0001"),
   ...
   *<br><div><br></div><div>HVmeasurements.QPu and UPu</div></body></html>"),
