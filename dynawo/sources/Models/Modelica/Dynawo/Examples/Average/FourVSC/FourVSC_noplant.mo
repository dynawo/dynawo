...
model FourVSC_noplant
  ...
  // ═══════════════════════════════════════════════════════════════
  Dynawo.Electrical.PEIR.Converters.Average.GFLmodel_noplant_v_control gFL_HVDC1(SNom = 1200, U0Pu = 1.016485, Uphase = 0.210724, P0_pcc = -11.445, Q0_pcc = 0.536945, Omega0Pu = 1.0, tVSC = 1e-3, RfPu = 0.005, LfPu = 0.15, CfPu = 1e-9, omegaNom = 2*Modelica.Constants.pi*50, RPuLV = 1e-5, LPuLV = 1e-5, RPuHV = 1e-5, LPuHV = 1e-5, k_filter = 1, T_filter = 0.0033, k_p_d_current = 0.5730, k_i_d_current = 6, k_p_q_current = 0.5730, k_i_q_current = 6, k_p_d_outer = 0.0333, k_i_d_outer = 10, k_p_q_outer = 0.1667, k_i_q_outer = 50, UboostHigh = 1.1, UboostLow = 0.9, Kqv = 0, Imax = 1.1, PQFlag = false, IqBoostMax = 2, IqBoostMin = -2, K_p_pll = 0.31831, K_i_pll = 7.95775, OmegaMaxPu = 1.5, OmegaMinPu = 0.5, DyMax_pi_d = 5, DyMax_pi_q = 5, DuMax_idref = 0.5, DuMin_idref = -999, tS_idref = 1e-4, voltagefeedforwardflag_d = 1, voltagefeedforwardflag_q = 0, T_boost = 1e-3) annotation(
  ...
  // gFL_HVDC1.
  // ═══════════════════════════════════════════════════════════════
  Dynawo.Electrical.PEIR.Converters.Average.GFLmodel_noplant_v_control gFL_HVDC2(SNom = 1700, U0Pu = 1.018446, Uphase = 0.216682, P0_pcc = -13.94108, Q0_pcc = -5.04, Omega0Pu = 1.0, tVSC = 1e-3, RfPu = 0.005, LfPu = 0.15, CfPu = 1e-9, omegaNom = 2*Modelica.Constants.pi*50, RPuLV = 1e-5, LPuLV = 1e-5, RPuHV = 1e-5, LPuHV = 1e-5, k_filter = 1, T_filter = 0.0033, k_p_d_current = 0.5730, k_i_d_current = 6, k_p_q_current = 0.5730, k_i_q_current = 6, k_p_d_outer = 0.1667, k_i_d_outer = 50, k_p_q_outer = 0.1667, k_i_q_outer = 50, UboostHigh = 1.1, UboostLow = 0.9, Kqv = 0, Imax = 1.1, PQFlag = false, IqBoostMax = 2, IqBoostMin = -2, K_p_pll = 0.31831, K_i_pll = 7.95775, OmegaMaxPu = 1.5, OmegaMinPu = 0.5, DyMax_pi_d = 5, DyMax_pi_q = 5, DuMax_idref = 0.5, DuMin_idref = -999, tS_idref = 1e-4, voltagefeedforwardflag_d = 1, voltagefeedforwardflag_q = 0, T_boost = 1e-3) annotation(
  ...
  // ═══════════════════════════════════════════════════════════════
  Dynawo.Electrical.PEIR.Converters.Average.GFLmodel_noplant_v_control gFL_WP1(SNom = 2400, U0Pu = 1.06870, Uphase = 0.352335, P0_pcc = -19.916, Q0_pcc = 1.594, Omega0Pu = 1.0, tVSC = 1e-3, RfPu = 0.005, LfPu = 0.12, CfPu = 1e-9, omegaNom = 2*Modelica.Constants.pi*50, RPuLV = 1e-5, LPuLV = 1e-5, RPuHV = 1e-5, LPuHV = 1e-5, k_filter = 1, T_filter = 0.0333, k_p_d_current = 0.4584, k_i_d_current = 6, k_p_q_current = 0.4584, k_i_q_current = 6, k_p_d_outer = 0.0333, k_i_d_outer = 10, k_p_q_outer = 0.033, k_i_q_outer = 10, UboostHigh = 1.1, UboostLow = 0.9, Kqv = 0, Imax = 1, PQFlag = false, IqBoostMax = 2, IqBoostMin = -2, K_p_pll = 0.31831, K_i_pll = 7.95775, OmegaMaxPu = 1.5, OmegaMinPu = 0.5, DyMax_pi_d = 5, DyMax_pi_q = 5, DuMax_idref = 0.5, DuMin_idref = -999, tS_idref = 1e-4, voltagefeedforwardflag_d = 1, voltagefeedforwardflag_q = 0, T_boost = 1e-3) annotation(
  ...
  // ═══════════════════════════════════════════════════════════════
  Dynawo.Electrical.PEIR.Converters.Average.GFLmodel_noplant_v_control gFL_WP2(SNom = 2400, U0Pu = 1.037386, Uphase = 0.366498, P0_pcc = -19.917, Q0_pcc = 7.368258, Omega0Pu = 1.0, tVSC = 1e-3, RfPu = 0.005, LfPu = 0.12, CfPu = 1e-9, omegaNom = 2*Modelica.Constants.pi*50, RPuLV = 1e-5, LPuLV = 1e-5, RPuHV = 1e-5, LPuHV = 1e-5, k_filter = 1, T_filter = 0.0033, k_p_d_current = 0.4584, k_i_d_current = 6, k_p_q_current = 0.4584, k_i_q_current = 6, k_p_d_outer = 0.0333, k_i_d_outer = 10, k_p_q_outer = 0.1667, k_i_q_outer = 50, UboostHigh = 1.1, UboostLow = 0.9, Kqv = 0, Imax = 1.1, PQFlag = false, IqBoostMax = 2, IqBoostMin = -2, K_p_pll = 0.31831, K_i_pll = 7.95775, OmegaMaxPu = 1.5, OmegaMinPu = 0.5, DyMax_pi_d = 5, DyMax_pi_q = 5, DuMax_idref = 0.5, DuMin_idref = -999, tS_idref = 1e-4, voltagefeedforwardflag_d = 1, voltagefeedforwardflag_q = 0, T_boost = 1e-3) annotation(
  ...
  // B-C (Line5/Line6)
  Dynawo.Electrical.Lines.DynLine_pi lineBC1(RPu = 0.0007, XPu = 0.014, BPu = 0.336/2, GPu = 0, U01Pu = 1.01845, UPhase01 = 0.21668, P01Pu = 15.75887, Q01Pu = 2.04163, U02Pu = 1.00055, UPhase02 = 0.00000, P02Pu = -15.58796, Q02Pu = 1.03420) annotation(
    Placement(transformation(origin = {100, -30}, extent = {{10, -10}, {-10, 10}})));
  Dynawo.Electrical.Lines.DynLine_pi lineBC2(RPu = 0.0007, XPu = 0.014, BPu = 0.336/2, GPu = 0, U01Pu = 1.01845, UPhase01 = 0.21668, P01Pu = 15.75887, Q01Pu = 2.04163, U02Pu = 1.00055, UPhase02 = 0.00000, P02Pu = -15.58796, Q02Pu = 1.03420) annotation(
    Placement(transformation(origin = {140, -60}, extent = {{10, -10}, {-10, 10}})));
  // A2-E (Line7)
  Dynawo.Electrical.Lines.DynLine_pi lineA2E(RPu = 0.00082963, XPu = 0.0016395, BPu = 9.1125/2, GPu = 0, U01Pu = 1.05091, UPhase01 = 0.32458, P01Pu = -19.62557, Q01Pu = -6.24039, U02Pu = 1.06870, UPhase02 = 0.35234, P02Pu = 19.91600, Q02Pu = -3.42139) annotation(
    Placement(transformation(origin = {-220, -40}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  // B2-F (Line8)
  Dynawo.Electrical.Lines.DynLine_pi lineB2F(RPu = 0.00082963, XPu = 0.0016395, BPu = 9.1125/2, GPu = 0, U01Pu = 1.02590, UPhase01 = 0.33389, P01Pu = -19.60662, Q01Pu = -1.71674, U02Pu = 1.03739, UPhase02 = 0.36650, P02Pu = 19.91712, Q02Pu = -7.36826) annotation(
    Placement(transformation(origin = {220, -40}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  // ═══════════════════════════════════════════════════════════════
  // Network buses
  // ═══════════════════════════════════════════════════════════════
  ...
  Dynawo.Electrical.Lines.Line lineInfBus(RPu = 0, XPu = 0.005, BPu = 0, GPu = 0) annotation(
  ...
  // ═══════════════════════════════════════════════════════════════
  Dynawo.Electrical.Events.NodeFault fault(tBegin = 5, tEnd = 5.1, RPu = 0, XPu = 0) annotation(
    Placement(transformation(origin = {-180, 126}, extent = {{-10, -10}, {10, 10}})));
  // ═══════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════
  ...
  annotation(
    experiment(StartTime = 0, StopTime = 7, Tolerance = 1e-05, Interval = 0.0005),
...
After the fault, oscillations at approximately 20 Hz appear, consistently
with the oscillatory behavior observed in EMTP and reported in Gaia
Bergamaschi's thesis. These oscillations are damped over time. &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; issues at init are due to dynamic lines, if initial equations are removed, they will get worse</p><p><br></p>
</body></html>"));
end FourVSC_noplant;
