...
model GFM_1transfo
  ...
  Electrical.Lines.Line line2(BPu = 0, GPu = 0, RPu = 0.002, XPu = 0.02) annotation(
  ...
  Electrical.PEIR.Converters.General.Average.GridFollowing.GFL GFL2(BFilterPu = 1e-5, Ki = 10, Kic = 7, Kid = 50, Kiq = 50, Kp = 2, Kpc = 0.5, Kpd = 0.11, Kpq = 0.11, OmegaMaxPu = 1.1, OmegaMinPu = 0.9, P0Pu = -5*(1/2), Q0Pu = -0.21*(1/2), RFilterPu = 0.003, RTransformerPu = 0.002, SNom = 1000*(1/2), U0Pu = 1.1072, UPhase0 = 0.098, XFilterPu = 0.1, XTransformerPu = 0.05, tPFilt = 0.01, tQFilt = 0.01) annotation(
  ...
  Electrical.Lines.Line transfo1(BPu = 0, GPu = 0, RPu = 0.0006271*2, XPu = 0.03437*2) annotation(
    Placement(transformation(origin = {42, 16}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Electrical.Lines.Line transfo2(BPu = 0, GPu = 0, RPu = 0.0006271*2, XPu = 0.03437*2) annotation(
    Placement(transformation(origin = {42, -10}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
...
// No modifications in GFL set points
  ...
  connect(transfo1.terminal2, line.terminal1) annotation(
    Line(points = {{32, 16}, {4, 16}, {4, 0}, {-2, 0}}, color = {0, 0, 255}));
  connect(transfo2.terminal2, line.terminal1) annotation(
    Line(points = {{32, -10}, {4, -10}, {4, 0}, {-2, 0}}, color = {0, 0, 255}));
  ...
  connect(transfo1.terminal1, GFL2.terminal) annotation(
    Line(points = {{52, 16}, {84, 16}}, color = {0, 0, 255}));
  connect(transfo2.terminal1, GFL3.terminal) annotation(
    Line(points = {{52, -10}, {84, -10}}, color = {0, 0, 255}));
  connect(DynGFMVSM.terminal, line.terminal1) annotation(
    Line(points = {{40, 52}, {-2, 52}, {-2, 0}}, color = {0, 0, 255}));
  annotation(
    experiment(StartTime = 0, StopTime = 5, Tolerance = 1e-06, Interval = 0.001),
    Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}})),
    Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}})),
  Documentation(info = "<html><head></head><body>1 transformateur 400/63kV</body></html>"));
