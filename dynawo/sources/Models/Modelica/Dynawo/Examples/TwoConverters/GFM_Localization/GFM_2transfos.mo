...
model GFM_2transfos
  ...
  Electrical.Lines.Line transfo1(BPu = 0, GPu = 0, RPu = 0.0003125*2, XPu = 0.0225*2) annotation(
    Placement(transformation(origin = {32, 16}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  ...
  Electrical.Lines.Line transfo3(BPu = 0, GPu = 0, RPu = 0.000625*2, XPu = 0.01575*2) annotation(
    Placement(transformation(origin = {62, 16}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Electrical.Lines.Line transfo4(BPu = 0, GPu = 0, RPu = 0.000625*2, XPu = 0.01575*2) annotation(
...
// No modifications in GFL set points
  ...
  connect(transfo1.terminal2, line.terminal1) annotation(
    Line(points = {{22, 16}, {4, 16}, {4, 0}, {-2, 0}}, color = {0, 0, 255}));
  ...
  connect(transfo3.terminal2, transfo1.terminal1) annotation(
    Line(points = {{52, 16}, {42, 16}}, color = {0, 0, 255}));
  ...
  Documentation(info = "<html><head></head><body>Transfo 400/225 et 225/63</body></html>"));
