...
model GFM225kV
  ...
  Electrical.PEIR.Converters.General.Average.GridFollowing.GFL GFL2(BFilterPu = 1e-5, Ki = 10, Kic = 7, Kid = 50, Kiq = 50, Kp = 2, Kpc = 0.5, Kpd = 0.11, Kpq = 0.11, OmegaMaxPu = 1.1, OmegaMinPu = 0.9, P0Pu = -5*(1/8), Q0Pu = -0.21*(1/8), RFilterPu = 0.003, RTransformerPu = 0.002, SNom = 700*0.5, U0Pu = 1.1072, UPhase0 = 0.098, XFilterPu = 0.1, XTransformerPu = 0.05, tPFilt = 0.01, tQFilt = 0.01) annotation(
...
// No modifications in GFL set points
  ...
  connect(DynGFMVSM.terminal, transfo1.terminal1) annotation(
    Line(points = {{46, 52}, {32, 52}, {32, 16}}, color = {0, 0, 255}));
  annotation(
