...
model GFM225kV
  ...
  Electrical.Lines.Line line(RPu = 0.001875, XPu = 0.01875, GPu = 0, BPu = 0) annotation(
    Placement(transformation(origin = {-18, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
...
// No modifications in GFL set points
  ...
  connect(transfo1.terminal2, line.terminal1) annotation(
    Line(points = {{10, 16}, {4, 16}, {4, 0}, {-8, 0}}, color = {0, 0, 255}));
  connect(transfo2.terminal2, line.terminal1) annotation(
    Line(points = {{10, -10}, {4, -10}, {4, 0}, {-8, 0}}, color = {0, 0, 255}));
  ...
  connect(DynGFMVSM.terminal, transfo1.terminal1) annotation(
    Line(points = {{82, 52}, {30, 52}, {30, 16}}, color = {0, 0, 255}));
  annotation(
