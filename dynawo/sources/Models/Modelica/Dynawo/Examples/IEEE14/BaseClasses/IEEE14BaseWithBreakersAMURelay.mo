...
model IEEE14BaseWithBreakersAMURelay "Base class for IEEE 14-bus system benchmark formed with 14 buses, 5 generators (2 generators and 3 synchronous condensers), 1 shunt, 3 transformers , 17 lines and 11 loads."
  /*
  ...
  Electrical.Loads.LoadAlphaBetaRestorative Load12(Alpha = alpha, Beta = beta, UMaxPu = uMaxPu, UMinPu = uMinPu, i0Pu = Complex(0.051876, -0.029677), s0Pu = Complex(0.061000, 0.016000), tFilter = tfilter, u0Pu = Complex(1.018873, -0.274446)) annotation(
    Placement(transformation(origin = {-154, 142}, extent = {{-10, -10}, {10, 10}})));
  ...
  // Buses
  Electrical.Buses.Bus Bus1(terminal.V.re(start = 1)) annotation(
  ...
  Electrical.Buses.Bus Bus5 annotation(
    Placement(visible = true, transformation(origin = {-30, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Buses.Bus Bus6 annotation(
    Placement(visible = true, transformation(origin = {-30, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Buses.Bus Bus7 annotation(
    Placement(visible = true, transformation(origin = {110, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Buses.Bus Bus8 annotation(
    Placement(visible = true, transformation(origin = {170, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Buses.Bus Bus9 annotation(
    Placement(visible = true, transformation(origin = {70, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Buses.Bus Bus10 annotation(
    Placement(visible = true, transformation(origin = {30, 100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Buses.Bus Bus11 annotation(
    Placement(visible = true, transformation(origin = {10, 140}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Buses.Bus Bus12 annotation(
    Placement(transformation(origin = {-144, 160}, extent = {{-10, -10}, {10, 10}})));
  Electrical.Buses.Bus Bus13 annotation(
    Placement(visible = true, transformation(origin = {-70, 200}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Buses.Bus Bus14 annotation(
    Placement(visible = true, transformation(origin = {10, 180}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  // Lines
  Electrical.Lines.Line LineB10B11(BPu = 0, GPu = 0, RPu = 0.156256/ZBASE2, XPu = 0.365778/ZBASE2) annotation(
    Placement(visible = true, transformation(origin = {40, 130}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Electrical.Lines.Line LineB12B13(BPu = 0, GPu = 0, RPu = 0.42072/ZBASE2, XPu = 0.380651/ZBASE2) annotation(
    Placement(transformation(origin = {-152, 210}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Electrical.Lines.Line LineB13B14(BPu = 0, GPu = 0, RPu = 0.325519/ZBASE2, XPu = 0.662769/ZBASE2) annotation(
    Placement(visible = true, transformation(origin = {-30, 200}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Lines.Line LineB1B2(BPu = 5.54505E-4*ZBASE1, GPu = 0, RPu = 0.922682/ZBASE1, XPu = 2.81708/ZBASE1) annotation(
    Placement(visible = true, transformation(origin = {-150, -120}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Lines.Line LineB1B5(BPu = 5.167E-4*ZBASE1, GPu = 0, RPu = 2.57237/ZBASE1, XPu = 10.6189/ZBASE1) annotation(
    Placement(visible = true, transformation(origin = {-70, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Lines.Line LineB2B3(BPu = 4.599875E-4*ZBASE1, GPu = 0, RPu = 2.23719/ZBASE1, XPu = 9.42535/ZBASE1) annotation(
    Placement(visible = true, transformation(origin = {10, -160}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Lines.Line LineB2B4(BPu = 3.57068E-4*ZBASE1, GPu = 0, RPu = 2.76662/ZBASE1, XPu = 8.3946/ZBASE1) annotation(
    Placement(visible = true, transformation(origin = {10, -120}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Lines.Line LineB2B5(BPu = 3.63369E-4*ZBASE1, GPu = 0, RPu = 2.71139/ZBASE1, XPu = 8.27843/ZBASE1) annotation(
    Placement(visible = true, transformation(origin = {-52, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Lines.Line LineB3B4(BPu = 1.344255E-4*ZBASE1, GPu = 0, RPu = 3.19035/ZBASE1, XPu = 8.14274/ZBASE1) annotation(
    Placement(visible = true, transformation(origin = {100, -112}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Electrical.Lines.Line LineB4B5(BPu = 0, GPu = 0, RPu = 0.635593/ZBASE1, XPu = 2.00486/ZBASE1) annotation(
    Placement(visible = true, transformation(origin = {28, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Lines.Line LineB6B11(BPu = 0, GPu = 0, RPu = 0.18088/ZBASE2, XPu = 0.378785/ZBASE2) annotation(
    Placement(visible = true, transformation(origin = {-30, 90}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Electrical.Lines.Line LineB6B121(BPu = 0, GPu = 0, RPu = 0.23407/ZBASE2, XPu = 0.487165/ZBASE2) annotation(
    Placement(transformation(origin = {-102, 74}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Electrical.Lines.Line LineB6B13(BPu = 0, GPu = 0, RPu = 0.125976/ZBASE2, XPu = 0.248086/ZBASE2) annotation(
    Placement(visible = true, transformation(origin = {-50, 120}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Lines.Line LineB7B8(BPu = 0, GPu = 0, RPu = 0, XPu = 0.33546/ZBASE2) annotation(
    Placement(visible = true, transformation(origin = {150, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electrical.Lines.Line LineB7B9(BPu = 0, GPu = 0, RPu = 0, XPu = 0.209503/ZBASE2) annotation(
    Placement(visible = true, transformation(origin = {110, 50}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Electrical.Lines.Line LineB9B10(BPu = 0, GPu = 0, RPu = 0.060579/ZBASE2, XPu = 0.160922/ZBASE2) annotation(
    Placement(visible = true, transformation(origin = {60, 90}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Electrical.Lines.Line LineB9B14(BPu = 0, GPu = 0, RPu = 0.242068/ZBASE2, XPu = 0.514912/ZBASE2) annotation(
  ...
  Electrical.Transformers.TransformerFixedRatio Tfo3(BPu = 0, GPu = 0, RPu = 0, XPu = 0.39824802/ZBASE2, rTfoPu = 1.0224948) annotation(
  ...
  Electrical.Switches.IdealSwitch idealSwitch_Bus12_LineB12B121 annotation(
    Placement(transformation(origin = {-102, 144}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Electrical.Switches.IdealSwitch idealSwitch_Bus12_LineB12B13 annotation(
    Placement(transformation(origin = {-144, 182}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Dynawo.Electrical.Buses.Bus Bus121 annotation(
    Placement(transformation(origin = {-102, 90}, extent = {{-10, -10}, {10, 10}})));
  Dynawo.Electrical.Lines.Line LineB12B121(BPu = 0, GPu = 0, RPu = 0.23407/ZBASE2*1/100, XPu = 0.487165/ZBASE2*1/100) annotation(
...
// Network connections
  ...
  connect(Bus12.terminal, Load12.terminal) annotation(
    Line(points = {{-144, 160}, {-144, 150}, {-154, 150}, {-154, 142}}, color = {0, 0, 255}));
  ...
  connect(idealSwitch_Bus12_LineB12B13.terminal2, LineB12B13.terminal1) annotation(
    Line(points = {{-144, 192}, {-144, 194}, {-152, 194}, {-152, 200}}, color = {0, 0, 255}));
  connect(idealSwitch_Bus12_LineB12B13.terminal1, Bus12.terminal) annotation(
    Line(points = {{-144, 172}, {-144, 160}}, color = {0, 0, 255}));
  connect(LineB6B121.terminal1, Bus121.terminal) annotation(
    Line(points = {{-102, 84}, {-102, 90}}, color = {0, 0, 255}));
  connect(Bus12.terminal, idealSwitch_Bus12_LineB12B121.terminal1) annotation(
    Line(points = {{-144, 160}, {-102, 160}, {-102, 154}}, color = {0, 0, 255}));
  connect(idealSwitch_Bus12_LineB12B121.terminal2, LineB12B121.terminal1) annotation(
    Line(points = {{-102, 134}, {-102, 122}}, color = {0, 0, 255}));
  connect(LineB12B121.terminal2, Bus121.terminal) annotation(
    Line(points = {{-102, 102}, {-102, 90}}, color = {0, 0, 255}));
  connect(LineB6B121.terminal2, idealSwitch_Bus6_LineB6B121.terminal2) annotation(
...
end IEEE14BaseWithBreakersAMURelay;
