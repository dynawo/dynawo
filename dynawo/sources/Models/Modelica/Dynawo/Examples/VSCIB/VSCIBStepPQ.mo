...
model VSCIBStepPQ "Grid following Voltage Source Converter with infinite bus - Active and reactive power reference tracking test"
  ...
  Dynawo.Examples.VSCIB.BaseModel.GfolConverter gfolConverter(Cdc = 0.01, Cfilter = 0.066, ConvFixLossPu = 0, ConvVarLossPu = 0, DroopFP = 0, DroopUQ = 0, IMaxPu = 1.1, IdConv0Pu = 0.5, IdPcc0Pu = 0.5, IdcSource0Pu = 0.45, IdcSourceRef0Pu = 1, IqConv0Pu = 0, IqPcc0Pu = 0, KiPll = 0, Kic = 25, KpPll = 1, Kpc = 2.39, Kpdc = 50, Lfilter = 0.15, Ltransformer = 0.2, P0Pu = 0.45, PMaxPu = 0.9, PRef0Pu = 0.45, PstepHPu = 0, Q0Pu = 0, QMaxPu = 0.3, QRef0Pu = 0, QstepHPu = 0, RPmaxPu = 0, Rfilter = 0.005, Rtransformer = 0.01, SNom = 100, Theta0 = 0.12, UdConv0Pu = 0.9, UdFilter0Pu = 0.9, Udc0Pu = 1, UqConv0Pu = 0, UstepHPu = 0, i0Pu = Complex(-0.5, 0), t_Pstep = 0.4, t_Qstep = 0, t_Ustep = 0, tauIdRef = 0.04, tauIqRef = 0.04, u0Pu = Complex(0.9, 0)) annotation(
    Placement(visible = true, transformation(origin = {84, -4.21885e-15}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
  Dynawo.Electrical.Events.NodeFault nodeFault(RPu = 0, XPu = 0, tBegin = 0.8, tEnd = 0.9) annotation(
