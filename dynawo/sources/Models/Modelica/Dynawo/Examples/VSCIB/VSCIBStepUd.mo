...
model VSCIBStepUd "Voltage Source Converter infinite bus - Step on Ud"
  /*
  ...
  */
  ...
  Dynawo.Electrical.Sources.GfolConverter gfolConverter(Cdc = 0.01, Cfilter = 0.066, ConvFixLossPu = 0, ConvVarLossPu = 0, DroopFP = 0, DroopUQ = 0, IdConv0Pu = 0.5, IdPcc0Pu = 0.5, IdcSource0Pu = 0.45, ImaxPu = 1.1, IqConv0Pu = 0, IqPcc0Pu = 0, KiPll = 100, Kic = 10, KpPll = 0.4, Kpc = 1, Kpdc = 50, Lfilter = 0.15, Ltransformer = 0.2, P0Pu = 0.45, PRef0Pu = 0.45, PmaxPu = 0.9, PstepHPu = 0.2, Q0Pu = 0, QRef0Pu = 0, QmaxPu = 0.3, QstepHPu = 0.2, RPmaxPu = 0, Rfilter = 0.005, Rtransformer = 0.01, SNom = 100, Theta0 = 0.1, URef0Pu = 0.9, UdConv0Pu = 0.9, UdFilter0Pu = 0.9, UdcSource0Pu = 1, UqConv0Pu = 0, UstepHPu = 0, i0Pu = Complex(-0.5, 0), t_Pstep = 0.5, t_Qstep = 1.25, t_Ustep = 0, tauIdRef = 0.1, tauIqRef = 0.1, u0Pu = Complex(0.9, 0)) annotation(
