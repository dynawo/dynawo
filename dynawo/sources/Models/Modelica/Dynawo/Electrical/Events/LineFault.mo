...
model LineFault "AC power line with fault - PI models"
  ...
  Modelica.Blocks.Interfaces.BooleanInput lineFault(start = false) "True when the fault is ongoing, false otherwise";
...
equation
  line1.switchOffSignal1 = switchOffSignal1;
  line1.switchOffSignal2 = false;
  line2.switchOffSignal1 = switchOffSignal1;
  ...
  if lineFault or switchOffSignal1 then
...
The LineFault model is a juxtaposition of two classical Pi-line models with a possible fault between them. The equivalent circuit and conventions are as follows:<div><br></div><div>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<span style=\"font-family: 'Courier New'; font-size: 12pt;\">----</span></div><div><pre style=\"margin-top: 0px; margin-bottom: 0px;\"><span style=\"font-family: 'Courier New'; font-size: 12pt;\">                                     </span><span style=\"font-family: 'Courier New'; font-size: 12pt;\">| </span></pre></div><div>
<p style=\"margin: 0px;\">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<span style=\"font-family: 'Courier New'; font-size: 12pt;\">RFault+jXFault</span></p>
<pre style=\"margin-top: 0px; margin-bottom: 0px;\"><span style=\"font-family: 'Courier New'; font-size: 12pt;\">                                     </span><span style=\"font-family: 'Courier New'; font-size: 12pt;\">|</span></pre>
<pre style=\"margin-top: 0px; margin-bottom: 0px;\"><span style=\"font-family: 'Courier New'; font-size: 12pt;\">            I1                   (terminal)                      I2</span></pre><pre style=\"margin-top: 0px; margin-bottom: 0px;\"><span style=\"font-family: 'Courier New'; font-size: 12pt;\">(terminal1) --&gt;-------D*(R+jX)-------*-------(1-D)*(R+jX)--</span><span style=\"font-family: 'Courier New'; font-size: 12pt;\">-----</span><span style=\"font-family: 'Courier New'; font-size: 12pt;\">&lt;-- (terminal2)</span></pre>
