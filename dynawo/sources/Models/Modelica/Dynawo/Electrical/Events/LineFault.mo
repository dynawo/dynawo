...
model LineFault "AC power line with fault - PI models"
  ...
  Dynawo.Electrical.Lines.Line impedance(RPu = RFaultPu, XPu = XFaultPu, GPu = 0, BPu = 0);
...
equation
  ...
  connect(impedance.terminal1, line1.terminal2);
  connect(terminal, impedance.terminal2);
