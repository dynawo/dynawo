...
model EventReal "Specific model for Real events"
  //extends EventEquations(redeclare type typeParameter = Real, redeclare connector typeConnector = discrete Modelica.Blocks.Interfaces.RealOutput);
...
protected
  ...
  replaceable connector typeConnector = discrete Modelica.Blocks.Interfaces.RealOutput;
