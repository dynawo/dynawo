...
//  extends EventEquations(redeclare type typeParameter = Integer, redeclare connector typeConnector = Modelica.Blocks.Interfaces.IntegerOutput);
...
protected
  ...
  replaceable connector typeConnector = Modelica.Blocks.Interfaces.IntegerOutput;
  replaceable type typeParameter = Integer;
