...
model VariableImpedantFault2Tables "AC power line - PI model"
...
*/
  ...
  // Variable
  Types.ComplexImpedancePu ZvPu;

  Modelica.Blocks.Sources.CombiTimeTable ZvTimeTable(table = [0, 0, 100; 9.9, 0, 100; 10.00, 0, 0.1; 10.15, 0, 0.1; 11.15, 0, 1; 15.00, 0, 1; 15.2, 0, 100; 17.00, 0, 100])  annotation(
...
<pre style=\"margin-top: 0px; margin-bottom: 0px;\"><span style=\"font-family: 'Courier New'; font-size: 12pt;\">               I1                  </span></pre>
...
end VariableImpedantFault2Tables;
