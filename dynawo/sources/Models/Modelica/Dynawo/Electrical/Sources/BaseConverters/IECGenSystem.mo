...
model IECGenSystem
  ...
  */
  ...
  Modelica.Blocks.Interfaces.RealInput theta(start = UPhase0) "Phase shift of the converter's rotating frame with respect to the grid rotating frame in radians" annotation(
    ...
    /*Ouputs*/
  Modelica.Blocks.Interfaces.RealOutput iGsRePu(start = IGsRe0Pu) "Real component of the current at the generator system module (converter) terminal in pu (Ubase,SNom) (generator convention)" annotation(
