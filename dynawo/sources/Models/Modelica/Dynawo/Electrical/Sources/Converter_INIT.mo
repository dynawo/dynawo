...
model Converter_INIT "Initialization model for converter model for grid forming and grid following applications"
  ...
  Types.ComplexCurrentPu i0Pu "Start value of the complex current at terminal in pu (base UNom, SnRef) (receptor convention)";
  Types.ComplexVoltagePu u0Pu "Start value of the complex voltage at terminal in pu (base UNom)";
  Types.VoltageComponentPu UdPcc0Pu "Start value of the d-axis voltage at the PCC in pu (base UNom)";
  Types.VoltageComponentPu UqPcc0Pu "Start value of the q-axis voltage at the PCC in pu (base UNom)";
  ...
  Types.CurrentModulePu IConv0Pu "Start value of module of the current injected by the converter in pu (base UNom, SNom)";
  Types.ActivePowerPu PGen0Pu "Start value of active power generated by the converter at the PCC in pu (base UNom, SnRef) (generator convention)";
  Types.ReactivePowerPu QGen0Pu "Start value of reactive power generated by the converter at the PCC in pu (base UNom, SnRef) (generator convention)";
