...
model Converter_INIT "Initialization model for converter model for grid forming and grid following applications"
  ...
  Dynawo.Connectors.PerUnitOutput UdConv0Pu "Start value of d-axis modulation voltage in pu (base UNom)";
  Dynawo.Connectors.PerUnitOutput UqConv0Pu "Start value of q-axis modulation voltage in pu (base UNom)";
  Dynawo.Connectors.PerUnitOutput IdConv0Pu "Start value of d-axis current in the converter in pu (base UNom, SNom) (generator convention)";
  Dynawo.Connectors.PerUnitOutput IqConv0Pu "Start value of q-axis current in the converter in pu (base UNom, SNom) (generator convention)";
  ...
  Dynawo.Connectors.PerUnitOutput UdFilter0Pu "Start value of d-axis voltage at the converter's capacitor in pu (base UNom)";
  Dynawo.Connectors.PerUnitOutput UqFilter0Pu "Start value of q-axis voltage at the converter's capacitor in pu (base UNom)";
  Dynawo.Connectors.AngleOutput Theta0 "Start value of phase shift between the converter's rotating frame and the grid rotating frame in rad";
  Dynawo.Connectors.ActivePowerPuOutput PFilter0Pu "Start value of active power generated at the converter's capacitor in pu (base SNom) (generator convention)";
  Dynawo.Connectors.ReactivePowerPuOutput QFilter0Pu "Start value of reactive power generated at the converter's capacitor in pu (base SNom) (generator convention)";
