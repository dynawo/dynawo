...
model GenSystem3a "Control parameters for generator system of WT, specific to Type 3A"
...
model GenSystem3b "Control parameters for generator system of WT, specific to Type 3B"
...
model InitialUiGrid "Initial voltage and current for grid side"
...
model InitialUGrid "Initial voltage for grid side"
...
model InitialIGs "Initial current for generator system (GS) side"
...
model InitialUGs "Initial voltage for generator system (GS) side"
...
model InitialPqGrid "Initial P and Q for grid side"
...
model InitialGenSystem "Initial parameters for Generator System"
