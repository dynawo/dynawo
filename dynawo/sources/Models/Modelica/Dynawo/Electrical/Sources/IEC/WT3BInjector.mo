...
model WT3BInjector "Converter model and grid interface according to IEC N°61400-27-1 standard for type 3B
 wind turbines"
  ...
  Dynawo.Electrical.Sources.IEC.BaseConverters.GenSystem3b genSystem3b(DipMaxPu = DipMaxPu, DiqMaxPu = DiqMaxPu, IpMax0Pu = IpMax0Pu, IqMax0Pu = IqMax0Pu, IqMin0Pu = IqMin0Pu, MCrb = MCrb, P0Pu = P0Pu, Q0Pu = Q0Pu, SNom = SNom, U0Pu = U0Pu, UPhase0 = UPhase0, XEqv = XEqv, tCrb = tCrb, tG = tG, tWo = tWo, iGs0Pu = elecSystem.i10Pu, uGs0Pu = elecSystem.u10Pu, Iq0Pu = Iq0Pu, Ip0Pu = Ip0Pu) annotation(
    Placement(transformation(origin = {-40, 0}, extent = {{-20, -20}, {20, 20}})));

equation
  genSystem3b.running = running;
  elecSystem.switchOffSignal1 = switchOffSignal1;
  elecSystem.switchOffSignal2 = switchOffSignal2;
  ...
  connect(fOCB, genSystem3b.fOCB) annotation(
    Line(points = {{40, 110}, {40, 54}, {-32, 54}, {-32, 22}}, color = {255, 0, 255}));
  ...
  connect(genSystem3b.PAgPu, PAgPu) annotation(
    Line(points = {{-18, -16}, {0, -16}, {0, -60}, {-80, -60}, {-80, -110}}, color = {0, 0, 127}));
