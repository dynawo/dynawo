...
model InjectorCurrentSource "Converter model and grid interface (IEC63406)"
  ...
  Dynawo.Electrical.Sources.IEC.BaseConverters.ElecSystem elecSystem(BPu = BesPu, GPu = GesPu, RPu = ResPu, SNom = SNom, XPu = XesPu, i20Pu = i0Pu, u20Pu = u0Pu) annotation(
    Placement(visible = true, transformation(origin = {40, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
...
equation
  ...
  currentSourceIEC63406.running = running;
  ...
  connect(elecSystem.terminal2, terminal) annotation(
    Line(points = {{62, 0}, {112, 0}}, color = {0, 0, 255}));
