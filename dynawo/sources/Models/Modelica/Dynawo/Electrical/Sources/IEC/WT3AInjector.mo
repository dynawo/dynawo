...
model WT3AInjector "Converter model and grid interface according to IEC N°61400-27-1 standard for type 3A
 wind turbines"
  ...
  Dynawo.Electrical.Sources.IEC.BaseConverters.GenSystem3a genSystem3a(DipMaxPu = DipMaxPu, DiqMaxPu = DiqMaxPu, IpMax0Pu = IpMax0Pu, IqMax0Pu = IqMax0Pu, IqMin0Pu = IqMin0Pu, KPc = KPc, P0Pu = P0Pu, Q0Pu = Q0Pu, SNom = SNom, U0Pu = U0Pu, UPhase0 = UPhase0, tIc = tIc, iGs0Pu = elecSystem.i10Pu, uGs0Pu = elecSystem.u10Pu, Iq0Pu = Iq0Pu, Ip0Pu = Ip0Pu, XEqv = XEqv) annotation(
    Placement(transformation(origin = {-40, 0}, extent = {{-20, -20}, {20, 20}})));

equation
  genSystem3a.running = running;
