...
model InjectorVoltageSource "Converter model and grid interface (IEC63406)"
  ...
  Dynawo.Electrical.Sources.IEC.BaseConverters.ElecSystem elecSystem(BPu = 0, GPu = 0, RPu = ResPu, SNom = SNom, XPu = XesPu, i20Pu = i0Pu, u20Pu = u0Pu) annotation(
...
equation
  ...
  voltageSourceIEC63406.running = running;

  connect(elecSystem.switchOffSignal1, switchOffSignal1);
  connect(elecSystem.switchOffSignal2, switchOffSignal2);
  ...
  connect(elecSystem.u2RePu, realToComplex1.re) annotation(
    Line(points = {{22, -22}, {22, -86}, {58, -86}}, color = {0, 0, 127}));
  connect(elecSystem.u2ImPu, realToComplex1.im) annotation(
    Line(points = {{26, -22}, {26, -74}, {58, -74}}, color = {0, 0, 127}));
  connect(elecSystem.i2RePu, realToComplex.re) annotation(
    Line(points = {{32, -22}, {32, -46}, {58, -46}}, color = {0, 0, 127}));
  connect(elecSystem.i2ImPu, realToComplex.im) annotation(
  ...
  connect(realToComplex1.y, voltageSourceIEC63406.uPu) annotation(
    Line(points = {{82, -80}, {90, -80}, {90, -100}, {0, -100}, {0, -18}, {-18, -18}}, color = {85, 170, 255}));
