...
//  parameter Types.PerUnit Usd0Pu "Initial direct component of the voltage at converter terminal in pu (base UNom)";
//  parameter Types.PerUnit Usq0Pu "Initial direct component of the voltage at converter terminal in pu (base UNom)";
//  parameter Types.PerUnit Isd0Pu "Initial direct component of the voltage at converter and grid terminal in pu (base UNom)";
//  parameter Types.PerUnit Isq0Pu "Initial direct component of the voltage at converter and grid terminal in pu (base UNom)";
  ...
  Modelica.Blocks.Continuous.FirstOrder firstOrder2(T = Tg, y_start = Ued0Pu) annotation(
    Placement(visible = true, transformation(origin = {-30, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder3(T = Tg, y_start = Ueq0Pu) annotation(
...
//  Isd0Pu = -P0Pu * SystemBase.SnRef / (SNom * U0Pu);
//  Isq0Pu = Q0Pu * SystemBase.SnRef / (SNom * U0Pu);
//  Usd0Pu = UsRe0Pu * cos(UPhase0) + UsIm0Pu * sin(UPhase0);
//  Usq0Pu = -(UsIm0Pu * sin(UPhase0)) + UsRe0Pu * cos(UPhase0);

//  Complex(Ued0Pu, Ueq0Pu) = Complex(Usd0Pu, Usq0Pu) + Complex(ResPu, XesPu)*Complex(Isd0Pu, Isq0Pu);
