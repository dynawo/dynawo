...
model RefFrameRotation "Reference frame rotation module (IEC N°61400-27-1)"
  ...
  //Output variables
  Modelica.Blocks.Interfaces.RealOutput iGsImPu(start = iGs0Pu.im) "Imaginary component of the current at converter terminal in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput iGsRePu(start = iGs0Pu.re) "Real component of the current at converter terminal in pu (base UNom, SNom) (generator convention)" annotation(
    Placement(visible = true, transformation(origin = {110, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {40, 50}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
