...
equation
  ...
  annotation(
    ...
    Icon(coordinateSystem(initialScale = 0.1), graphics = {Rectangle(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {-33, 34}, extent = {{-59, 22}, {129, -88}}, textString = "Injector"), Text(origin = {-148, 82}, extent = {{-32, 12}, {4, -4}}, textString = "idPu"), Text(origin = {-148, -18}, extent = {{-32, 12}, {4, -4}}, textString = "iqPu"), Text(origin = {170, -70}, extent = {{-32, 12}, {4, -4}}, textString = "terminal"), Text(origin = {158, 92}, extent = {{-32, 12}, {4, -4}}, textString = "UPu"), Text(origin = {158, 54}, extent = {{-32, 12}, {24, -8}}, textString = "PInjPuSn"), Text(origin = {158, 24}, extent = {{-32, 12}, {24, -20}}, textString = "QInjPuSn"), Text(origin = {164, -20}, extent = {{-32, 12}, {4, -4}}, textString = "uPu"), Text(origin = {58, 132}, extent = {{-32, 12}, {4, -4}}, textString = "UPhase")}));
end InjectorIDQ;
