...
model DynRLTransformer "Dynamic RL Transformer in (dq) frame"
  ...
  */
  ...
  final parameter Types.PerUnit UdFilter0Pu = RPu * IdPcc0Pu - Omega0Pu * LPu * IqPcc0Pu + UdPcc0Pu "Start value of d-axis voltage at the filter in pu (base UNom)";
  final parameter Types.PerUnit UqFilter0Pu = RPu * IqPcc0Pu + Omega0Pu * LPu * IdPcc0Pu + UqPcc0Pu "Start value of q-axis voltage at the filter in pu (base UNom)";
