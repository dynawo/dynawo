...
model RLCFilter "RLC Filter in (dq) frame"
  ...
  */
  ...
  parameter Types.PerUnit BPu "Susceptance in pu (base UNom, SNom)";
  ...
  final parameter Types.PerUnit IdConv0Pu = -BPu* UqFilter0Pu + IdPcc0Pu "Start value of d-axis current at the converter in pu (base UNom, SNom) in generator convention";
  final parameter Types.PerUnit IqConv0Pu = BPu * UdFilter0Pu + IqPcc0Pu "Start value of q-axis current at the converter in pu (base UNom, SNom) in generator convention";
  final parameter Types.PerUnit UdConv0Pu = RPu * IdConv0Pu - XPu * IqConv0Pu + UdFilter0Pu "Start value of d-axis voltage at the converter in pu (base UNom)";
  final parameter Types.PerUnit UqConv0Pu = RPu * IqConv0Pu + XPu * IdConv0Pu + UqFilter0Pu "Start value of q-axis voltage at the converter in pu (base UNom)";

equation
  0 = udConvPu - RPu * idConvPu + XPu * iqConvPu - udFilterPu;
  0 = uqConvPu - RPu * iqConvPu - XPu * idConvPu - uqFilterPu;
  0 = idConvPu + BPu * uqFilterPu - idPccPu;
  0 = iqConvPu - BPu * udFilterPu - iqPccPu;
