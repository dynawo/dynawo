...
model Converter1 "Converter physical part comprising an ideal voltage source, a RLC Filter and a RL Transformer"
  ...
  parameter Types.PerUnit XFilterPu "Impedance in pu (base UNom, SNom)";
  parameter Types.PerUnit BFilterPu "Susceptance in pu (base UNom, SNom)";
  ...
  Dynawo.Electrical.Sources.PEIR.Converters.BaseConverters.RLCFilter RLCFilter(BPu = BFilterPu, IdPcc0Pu = refFrameRotation.IdPcc0Pu, IqPcc0Pu = refFrameRotation.IqPcc0Pu, RPu = RFilterPu, UdFilter0Pu = RLTransformer.UdFilter0Pu, UqFilter0Pu = RLTransformer.UqFilter0Pu, XPu = XFilterPu)  annotation(
...
equation
  ...
  connect(udConvRefPu, RLCFilter.udConvPu) annotation(
    Line(points = {{-112, 20}, {-76, 20}, {-76, 10}, {-44, 10}}, color = {245, 121, 0}, thickness = 0.5));
  connect(uqConvRefPu, RLCFilter.uqConvPu) annotation(
    Line(points = {{-112, -14}, {-76, -14}, {-76, -4}, {-44, -4}}, color = {245, 121, 0}, thickness = 0.5));
