...
equation
  ...
  connect(phaseurGrid.PPu, add3.u2) annotation(
    Line(points = {{571, -14}, {634, -14}, {634, -78}, {76, -78}, {76, 50}, {94, 50}}, color = {0, 0, 127}));
  ...
  connect(integrator1.y, phaseurGrid.UPhaseOffs) annotation(
    Line(points = {{469, -42}, {502, -42}}, color = {0, 0, 127}));
  ...
  connect(phaseurGrid.terminal, aCPower) annotation(
    Line(points = {{570, -26}, {688, -26}, {688, -22}, {690, -22}}, color = {0, 0, 255}));
