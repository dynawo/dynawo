...
model ConverterVoltageSourceIEC63406
  ...
  Dynawo.Electrical.Sources.IEC.InjectorVoltageSource injectorVoltageSource(BesPu = BesPu, GesPu = GesPu, IsIm0Pu = IsIm0Pu, IsRe0Pu = IsRe0Pu, P0Pu = P0Pu, Q0Pu = Q0Pu, ResPu = ResPu, SNom = SNom, Tg = Tg, U0Pu = U0Pu, UPhase0 = UPhase0, UeIm0Pu = UeIm0Pu, UeRe0Pu = UeRe0Pu, Ued0Pu = Ued0Pu, Ueq0Pu = Ueq0Pu, XesPu = XesPu, i0Pu = i0Pu, u0Pu = u0Pu)  annotation(
