...
model ConverterVoltageSourceIEC63406
  ...
  parameter Types.PerUnit PFFR0Pu "Initial output power utilized for FFR control" annotation(
    Dialog(tab = "Operating point"));
  Dynawo.Electrical.Controls.IEC.IEC63406.InjectorVoltageSource injectorVoltageSource(BesPu = BesPu, GesPu = GesPu, IsIm0Pu = IsIm0Pu, IsRe0Pu = IsRe0Pu, P0Pu = P0Pu, Q0Pu = Q0Pu, ResPu = ResPu, SNom = SNom, Tg = Tg, U0Pu = U0Pu, UPhase0 = UPhase0, UsIm0Pu = UsIm0Pu, UsRe0Pu = UsRe0Pu, XesPu = XesPu, i0Pu = i0Pu, u0Pu = u0Pu)  annotation(
