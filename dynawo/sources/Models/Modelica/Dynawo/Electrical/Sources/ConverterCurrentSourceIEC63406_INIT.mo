...
model ConverterCurrentSourceIEC63406_INIT "Wind Turbine Type 4 model from IEC 61400-27-1 standard : initialization model"
  ...
  //Init variables
  Types.PerUnit PAvailIn0Pu "Initial minimum output electrical power available to the active power control module";
...
equation
  ...
  QMax0Pu = if QLimFlag then QMaxUd else max0.y;
  QMin0Pu = if QLimFlag then QMinUd else min.y;
  IPMax0Pu = switch12.y;
  IPMin0Pu = switch13.y;
  IQMax0Pu = switch11.y;
  IQMin0Pu = switch16.y;
