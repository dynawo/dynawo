...
*/
  ...
  Types.PerUnit IConvPu(start = sqrt(IdConv0Pu * IdConv0Pu + IqConv0Pu * IqConv0Pu)) "Module of the current injected by the converter in p.u (base UNom, SNom)";
  Types.PerUnit PGenPu(start = (UdPcc0Pu * IdPcc0Pu + UqPcc0Pu * IqPcc0Pu) * SNom / SystemBase.SnRef) "Active power generated by the converter at the PCC in p.u (base UNom, SnRef) (generator convention)";
  Types.PerUnit QGenPu(start = (UqPcc0Pu * IdPcc0Pu - UdPcc0Pu * IqPcc0Pu) * SNom / SystemBase.SnRef) "Reactive power generated by the converter at the PCC in p.u (base UNom, SnRef) (generator convention)";
  Types.PerUnit PGenPuBaseSNom(start = (UdPcc0Pu * IdPcc0Pu + UqPcc0Pu * IqPcc0Pu)) "Active power generated by the converter at the PCC in p.u (base UNom, SNom) (generator convention)";
  Types.PerUnit QGenPuBaseSNom(start = (UqPcc0Pu * IdPcc0Pu - UdPcc0Pu * IqPcc0Pu)) "Reactive power generated by the converter at the PCC in p.u (base UNom, SNom) (generator convention)";
  Types.PerUnit UConvPu(start = UdFilter0Pu) "Module of the voltage at filter (base UNom)";
