...
annotation(preferredView = "text",
    ...
    Icon(coordinateSystem(grid = {1, 1}, initialScale = 0.1), graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}), Text(origin = {-123, -85.5}, extent = {{-8, 4.5}, {8, -4.5}}, textString = "omegaPu"), Text(origin = {-123, 4.5}, extent = {{-17, 7.5}, {8, -4.5}}, textString = "IdcSourcePu"), Text(origin = {-123, 44.5}, extent = {{-17, 8.5}, {8, -4.5}}, textString = "udConvRefPu"), Text(origin = {-123, 94.5}, extent = {{-5, 1.5}, {8, -4.5}}, textString = "theta"), Text(origin = {-119, -66.5}, extent = {{-20, 7.5}, {8, -4.5}}, textString = "UdcSourceRefPu"), Text(origin = {118, 94.5}, extent = {{-8, 4.5}, {14, -7.5}}, textString = "udFilterPu"), Text(origin = {-123, -35.5}, extent = {{-17, 8.5}, {8, -4.5}}, textString = "uqConvRefPu"), Text(origin = {118, 64.5}, extent = {{-8, 4.5}, {9, -6.5}}, textString = "idPccPu"), Text(origin = {117, 6.5}, extent = {{-8, 4.5}, {14, -10.5}}, textString = "UdcSourcePu"), Text(origin = {118, 34.5}, extent = {{-8, 4.5}, {10, -5.5}}, textString = "idConvPu"), Text(origin = {118, -26.5}, extent = {{-8, 4.5}, {10, -5.5}}, textString = "iqConvPu"), Text(origin = {118, -56.5}, extent = {{-8, 4.5}, {9, -6.5}}, textString = "iqPccPu"), Text(origin = {118, -85.5}, extent = {{-8, 4.5}, {14, -7.5}}, textString = "uqFilterPu"), Text(origin = {17, -107.5}, extent = {{-8, 4.5}, {14, -7.5}}, textString = "ACPower"), Text(origin = {5, 6}, extent = {{-95, 56}, {90, -68}}, textString = "Converter")}));
