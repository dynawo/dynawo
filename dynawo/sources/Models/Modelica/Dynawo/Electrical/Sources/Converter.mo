...
*/
  ...
  Connectors.ACPower terminal (V (re (start = u0Pu.re), im (start = u0Pu.im)), i (re (start = i0Pu.re), im (start = i0Pu.im))) "Connector used to connect the converter to the grid" annotation(
    Placement(visible = true, transformation(extent = {{0, 0}, {0, 0}}, rotation = 0), iconTransformation(origin = {1, -65}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealInput IdcSourcePu(start = IdcSource0Pu) "DC Current generated by the DC current source in p.u (base UNom, SNom)"  annotation(
    Placement(visible = true, transformation(origin = {-58, 0}, extent = {{-3, -3}, {3, 3}}, rotation = 0), iconTransformation(origin = {-60, 0}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput udConvRefPu(start = UdConv0Pu) "d-axis modulated voltage reference in p.u (base UNom)" annotation(
    Placement(visible = true, transformation(origin = {-58, 30}, extent = {{-3, -3}, {3, 3}}, rotation = 0), iconTransformation(origin = {-60, 25}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealInput theta(start = Theta0) "Phase shift between the converter's rotating frame and the grid rotating frame" annotation(
    Placement(visible = true, transformation(origin = {-58, -50}, extent = {{-3, -3}, {3, 3}}, rotation = 0), iconTransformation(origin = {-60, -55}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealInput UdcSourceRefPu(start = SystemBase.omegaRef0Pu) "DC Voltage reference in p.u (base UNom)" annotation(
    Placement(visible = true, transformation(origin = {0, 63}, extent = {{-3, -3}, {3, 3}}, rotation = -90), iconTransformation(origin = {0, 65}, extent = {{-5, -5}, {5, 5}}, rotation = -90)));
  ...
  Modelica.Blocks.Interfaces.RealOutput udFilterPu(start = UdFilter0Pu) "d-axis voltage at the converter's capacitor in p.u (base UNom)" annotation(
    Placement(visible = true, transformation(origin = {67, 60}, extent = {{-3, -3}, {3, 3}}, rotation = 0), iconTransformation(origin = {69, 45}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealOutput uqFilterPu(start = 0) "q-axis voltage at the converter's capacitor in p.u (base UNom)" annotation(
    Placement(visible = true, transformation(origin = {67, -60}, extent = {{-3, -3}, {3, 3}}, rotation = 0), iconTransformation(origin = {69, -46}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealOutput idConvPu(start = IdConv0Pu) "d-axis current created by the converter in p.u (base UNom, SNom) (generator convention)" annotation(
    Placement(visible = true, transformation(origin = {67, 20}, extent = {{-3, -3}, {3, 3}}, rotation = 0), iconTransformation(origin = {69, 15}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealOutput idPccPu(start = IdPcc0Pu) "d-axis current at the PCC in p.u (base UNom, SNom) (generator convention)" annotation(
    Placement(visible = true, transformation(origin = {67, 40}, extent = {{-3, -3}, {3, 3}}, rotation = 0), iconTransformation(origin = {69, 30}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealOutput UdcSourcePu(start = UdcSource0Pu) "DC Voltage in p.u (base UNom)" annotation(
    Placement(visible = true, transformation(origin = {67, 0}, extent = {{-3, -3}, {3, 3}}, rotation = 0), iconTransformation(origin = {69, 0}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
...
annotation(preferredView = "text",
    ...
    Icon(coordinateSystem(grid = {1, 1}, extent = {{-55, -60}, {64, 60}}, initialScale = 0.1), graphics = {Text(origin = {-78, 59.5}, extent = {{-8, 4.5}, {8, -4.5}}, textString = "omegaPu"), Text(origin = {-78, 4.5}, extent = {{-17, 7.5}, {8, -4.5}}, textString = "IdcSourcePu"), Text(origin = {-78, 29.5}, extent = {{-17, 8.5}, {8, -4.5}}, textString = "udConvRefPu"), Text(origin = {-78, -50.5}, extent = {{-5, 1.5}, {8, -4.5}}, textString = "theta"), Text(origin = {-8, 76.5}, extent = {{-20, 7.5}, {8, -4.5}}, textString = "UdcSourceRefPu"), Text(origin = {82, 49.5}, extent = {{-8, 4.5}, {14, -7.5}}, textString = "udFilterPu"),  Text(origin = {-78, -20.5}, extent = {{-17, 8.5}, {8, -4.5}}, textString = "uqConvRefPu"), Text(origin = {82, 34.5}, extent = {{-8, 4.5}, {9, -6.5}}, textString = "idPccPu"), Text(origin = {81, 6.5}, extent = {{-8, 4.5}, {14, -10.5}}, textString = "UdcSourcePu"), Text(origin = {82, 19.5}, extent = {{-8, 4.5}, {10, -5.5}}, textString = "idConvPu"), Text(origin = {82, -11.5}, extent = {{-8, 4.5}, {10, -5.5}}, textString = "iqConvPu"), Text(origin = {82, -26.5}, extent = {{-8, 4.5}, {9, -6.5}}, textString = "iqPccPu"), Text(origin = {82, -41.5}, extent = {{-8, 4.5}, {14, -7.5}}, textString = "uqFilterPu"), Text(origin = {18, -67.5}, extent = {{-8, 4.5}, {14, -7.5}}, textString = "ACPower"), Text(origin = {5, 6}, extent = {{-36, 21}, {36, -21}}, textString = "Converter")}));
