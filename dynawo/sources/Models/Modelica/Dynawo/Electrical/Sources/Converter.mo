...
*/
  ...
  Types.VoltageComponentPu udConvPu(start = UdConv0Pu) "d-axis modulation voltage in pu (base UNom)";
  Types.VoltageComponentPu uqConvPu(start = UqConv0Pu) "q-axis modulation voltage in pu (base UNom)";
  Types.VoltageComponentPu udPccPu(start = UdPcc0Pu) "d-axis voltage at the PCC in pu (base UNom)";
  Types.VoltageComponentPu uqPccPu(start = UqPcc0Pu) "q-axis voltage at the PCC in pu (base UNom)";
  Types.CurrentModulePu IdcPu(start = IdcSource0Pu) "DC current entering the converter in pu (base UdcNom, SNom)";
  Types.CurrentModulePu IConvPu(start = IConv0Pu) "Module of the current injected by the converter in pu (base UNom, SNom)";
  Types.ActivePowerPu PGenPu(start = PGen0Pu) "Active power generated by the converter at the PCC in pu (base UNom, SnRef) (generator convention)";
  Types.ReactivePowerPu QGenPu(start = QGen0Pu) "Reactive power generated by the converter at the PCC in pu (base UNom, SnRef) (generator convention)";
  ...
  parameter Types.ComplexCurrentPu i0Pu "Start value of the complex current at terminal in pu (base UNom, SnRef) (receptor convention)";
  parameter Types.ComplexVoltagePu u0Pu "Start value of the complex voltage at terminal in pu (base UNom)";
  parameter Types.VoltageComponentPu UdPcc0Pu "Start value of the d-axis voltage at the PCC in pu (base UNom)";
  parameter Types.VoltageComponentPu UqPcc0Pu "Start value of the q-axis voltage at the PCC in pu (base UNom)";
  ...
  parameter Types.CurrentModulePu IConv0Pu "Start value of module of the current injected by the converter in pu (base UNom, SNom)";
  parameter Types.ActivePowerPu PGen0Pu "Start value of active power generated by the converter at the PCC in pu (base UNom, SnRef) (generator convention)";
  parameter Types.ReactivePowerPu QGen0Pu "Start value of reactive power generated by the converter at the PCC in pu (base UNom, SnRef) (generator convention)";
