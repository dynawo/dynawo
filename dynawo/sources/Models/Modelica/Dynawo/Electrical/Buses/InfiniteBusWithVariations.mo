...
model InfiniteBusWithVariations "Infinite bus with configurable variations on the voltage module and on the frequency"
  ...
  parameter Types.VoltageModulePu U0Pu "Infinite bus voltage module before and after event in pu (base UNom)";
  parameter Types.VoltageModulePu UEvtPu "Infinite bus voltage module during event in pu (base UNom)";
  parameter Types.AngularVelocityPu omega0Pu "Infinite bus angular frequency before and after event in pu (base OmegaNom)";
  parameter Types.AngularVelocityPu omegaEvtPu "Infinite bus angular frequency during event in pu (base OmegaNom)";
  ...
  Types.VoltageModulePu UPu "Infinite bus voltage module in pu (base UNom)";
  Types.ActivePowerPu PPu "Infinite bus active power in pu (base SnRef) (receptor convention)";
  Types.ReactivePowerPu QPu "Infinite bus reactive power in pu (base SnRef) (receptor convention)";
  Types.AngularVelocityPu omegaPu "Infinite bus angular frequency in pu (base OmegaNom)";
