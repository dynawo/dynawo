...
model SVarCSimplified "Simplified static var compensator model"
  import Modelica;
  import Dynawo.Types;
  ...
  BaseControls.RegulationSimplified regulation(BMaxPu = BMaxPu, BMinPu = BMinPu, BVar0Pu = BVar0Pu, Kp = Kp, Lambda = Lambda, SNom = SNom, Ti = Ti)  annotation(
  ...
  BaseControls.ModeHandlingSimplified modeHandling(Mode0 = Mode0, UNom = UNom, URefDown = URefDown, URefUp = URefUp, UThresholdDown = UThresholdDown, UThresholdUp = UThresholdUp, tThresholdDown = tThresholdDown, tThresholdUp = tThresholdUp, URef0 = URef0)  annotation(
