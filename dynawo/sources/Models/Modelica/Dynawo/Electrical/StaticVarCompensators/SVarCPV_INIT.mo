...
model SVarCPV_INIT "Initialization for standard static var compensator model"
  ...
  Types.PerUnit G0Pu "Start value of the conductance in p.u (base SnRef)";
...
equation
  ...
  URef0 = (U0Pu - Lambda*Q0Pu) * UNom;

  s0Pu = Complex(P0Pu, Q0Pu);
  u0Pu = ComplexMath.fromPolar(U0Pu, UPhase0);
  s0Pu = u0Pu * ComplexMath.conj(i0Pu);

  G0Pu = ComplexMath.real(i0Pu / u0Pu);
