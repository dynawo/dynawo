...
package SystemBase "Dynawo system base definition (for per-unit purposes)"
  ...
  public
    ...
    final constant Types.AngularVelocity omegaRef0Pu = 1 "Reference for system angular frequency (p.u. base omegaNom)";
    final constant Types.AngularVelocity omega0Pu = 1 "System angular frequency (p.u. base omegaNom)";
