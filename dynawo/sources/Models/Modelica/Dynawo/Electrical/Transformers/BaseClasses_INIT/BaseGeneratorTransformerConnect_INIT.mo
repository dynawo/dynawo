...
partial model BaseGeneratorTransformerConnect_INIT "Base model for initialization of GeneratorTransformer"
  /*
...
equation
  ...
  u10Pu = Modelica.ComplexMath.fromPolar(U10Pu, U1Phase0);
  s10Pu = u10Pu*Modelica.ComplexMath.conj(i10Pu);
  P20Pu = -Modelica.ComplexMath.real(u20Pu*Modelica.ComplexMath.conj(i20Pu));
  Q20Pu = -Modelica.ComplexMath.imag(u20Pu*Modelica.ComplexMath.conj(i20Pu));
  U20Pu = Modelica.ComplexMath.'abs'(u20Pu);
  U2Phase0 = Modelica.ComplexMath.arg(u20Pu);

  annotation(
    preferredView = "text");
end BaseGeneratorTransformerConnect_INIT;
