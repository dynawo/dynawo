...
model TransformerVariableTapPQControlled_INIT
  ...
  TransformersVariableTap.TransformerVariableTapPQ_INIT transformerVariableTapPQ_INIT(B = B, G = G, NbTap = NbTap, P10Pu = P10Pu, Q10Pu = Q10Pu, R = R, SNom = SNom, U10Pu = U10Pu, U1Phase0 = U1Phase0, Uc20Pu = Uc20Pu, X = X, rTfoMaxPu = rTfoMaxPu, rTfoMinPu = rTfoMinPu) annotation(
