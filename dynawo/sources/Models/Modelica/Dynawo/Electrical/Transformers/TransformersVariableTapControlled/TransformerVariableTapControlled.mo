...
// Initial parameters
  ...
  //parameter Integer Tap0 "Start value of transformer tap"; //check if tapo0 and Tap0 are equal
...
annotation(
    Icon(graphics = {Ellipse(origin = {3, -9}, extent = {{57, 49}, {-23, -31}}), Line(origin = {-80, 0}, points = {{-20, 0}, {20, 0}, {20, 0}}), Text(origin = {0, 61}, lineColor = {0, 0, 255}, extent = {{-80, 11}, {80, -11}}, textString = "%name"), Ellipse(origin = {-15, -7}, extent = {{-45, 47}, {35, -33}}), Line(origin = {80, 0}, points = {{-20, 0}, {20, 0}})}));
