...
model TransformerVariableTap2 "Transformer with variable tap to be connected to a tap changer"
  /*
...
// Transformer equations
    ...
    rTfoPu * rTfoPu * ZPu * terminal1.i = rTfoPu * rTfoPu * terminal1.V - rTfoPu * terminal2.V;
  else
