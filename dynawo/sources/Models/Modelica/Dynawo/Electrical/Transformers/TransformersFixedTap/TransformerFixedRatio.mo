...
model TransformerFixedRatio "Two winding transformer with a fixed ratio"
  ...
  //Outputs
  Modelica.Blocks.Interfaces.RealOutput Q2Pu "Reactive power on side 2 in pu (base SnRef) (receptor convention)" annotation(
    Placement(transformation(origin = {-100, -108}, extent = {{-10, -10}, {10, 10}}, rotation = -90), iconTransformation(origin = {-98, -98}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Modelica.Blocks.Interfaces.RealOutput U2Pu "Voltage on side 2 in pu (base U2Nom)" annotation(
    Placement(transformation(origin = {100, -108}, extent = {{-10, -10}, {10, 10}}, rotation = -90), iconTransformation(origin = {96, -100}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Modelica.Blocks.Interfaces.RealOutput P2Pu "Active power on side 2 in pu (base SnRef) (receptor convention)" annotation(
    Placement(transformation(origin = {0, -108}, extent = {{-10, -10}, {10, 10}}, rotation = -90), iconTransformation(origin = {0, -100}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
equation
  if running then
