...
equation
  PCS.switchOffSignal1 = wT3ACurrentSource.injector.switchOffSignal1;
  PCS.switchOffSignal2 = wT3ACurrentSource.injector.switchOffSignal2;

  connect(wT3ACurrentSource.terminal, PCS.terminal1) annotation(
