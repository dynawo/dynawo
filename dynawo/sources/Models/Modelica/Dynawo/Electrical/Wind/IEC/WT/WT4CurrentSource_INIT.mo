...
model WT4CurrentSource_INIT "Wind Turbine Type 4 model from IEC 61400-27-1 standard : initialization model"
  ...
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds2Init(table = TableQMaxPwtcFilt, tableOnFile = QLimitTablesOnFile) annotation(
  ...
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds1Init(table = TableQMinUwtcFilt, tableOnFile = QLimitTablesOnFile) annotation(
    Placement(visible = true, transformation(origin = {110, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1DsInit(table = TableQMaxUwtcFilt, tableOnFile = QLimitTablesOnFile) annotation(
    Placement(visible = true, transformation(origin = {110, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds3Init(table = TableQMinPwtcFilt, tableOnFile = QLimitTablesOnFile) annotation(
  ...
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds4Init(table = TableIpMaxUwt, tableOnFile = CurrentLimitTablesOnFile) annotation(
  ...
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds5Init(table = TableIqMaxUwt, tableOnFile = CurrentLimitTablesOnFile) annotation(
