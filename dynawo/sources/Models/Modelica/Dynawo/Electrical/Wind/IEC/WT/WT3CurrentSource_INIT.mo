...
equation
  ...
  uGs0Pu = u0Pu - Complex(ResPu, XesPu) * i0Pu * SystemBase.SnRef / SNom;
...
//  U0Pu * iGs0Pu.re * SNom / SystemBase.SnRef = -P0Pu * cos(UPhase0) - Q0Pu * sin(UPhase0);
//  U0Pu * iGs0Pu.im * SNom / SystemBase.SnRef = -P0Pu * sin(UPhase0) + Q0Pu * cos(UPhase0);
