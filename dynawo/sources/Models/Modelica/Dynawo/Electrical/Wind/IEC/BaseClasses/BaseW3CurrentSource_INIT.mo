...
model BaseW3CurrentSource_INIT "Wind Turbine Type 3 model from IEC 61400-27-1 standard : initialization model"
  ...
  Types.ComplexVoltagePu uGs0Pu "Initial complex voltage at converter terminal in pu (base UNom)";
  ...
  Modelica.Blocks.Sources.RealExpression const1Init annotation(
    Placement(visible = true, transformation(origin = {50, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.RealExpression const2Init annotation(
  ...
  Modelica.Blocks.Sources.RealExpression constInit annotation(
    Placement(visible = true, transformation(origin = {-190, 100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.RealExpression const3Init annotation(
  ...
  Modelica.Blocks.Sources.RealExpression const5Init annotation(
