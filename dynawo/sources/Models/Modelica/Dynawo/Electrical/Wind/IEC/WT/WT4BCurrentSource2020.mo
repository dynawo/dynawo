...
model WT4BCurrentSource2020 "Wind Turbine Type 4B model from IEC 61400-27-1:2020 standard : measurement, PLL, protection, PControl, QControl, limiters, electrical, generator and mechanical modules"
  ...
  extends Dynawo.Electrical.Controls.IEC.IEC61400.Parameters.ControlSubstructure4P;
...
equation
  ...
  connect(controlSubstructure.PAeroPu, mechanical.PAeroPu) annotation(
    Line(points = {{-60, -62}, {-60, -88}, {58, -88}}, color = {0, 0, 127}));
  connect(injector.PAgPu, mechanical.PAgPu) annotation(
    Line(points = {{42, -56}, {48, -56}, {48, -72}, {58, -72}}, color = {0, 0, 127}));
  annotation(
