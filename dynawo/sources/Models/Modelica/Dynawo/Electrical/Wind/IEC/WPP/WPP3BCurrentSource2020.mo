...
equation
  PCS.switchOffSignal1 = wT3BCurrentSource.injector.switchOffSignal1;
  PCS.switchOffSignal2 = wT3BCurrentSource.injector.switchOffSignal2;

  connect(wT3BCurrentSource.terminal, PCS.terminal1) annotation(
    Line(points = {{42, 40}, {58, 40}}, color = {0, 0, 255}));
  connect(tanPhi, wT3BCurrentSource.tanPhi) annotation(
    Line(points = {{-20, 120}, {-20, 52}, {-2, 52}}, color = {0, 0, 127}));
  connect(wPPControl.PPDRefComPu, wT3BCurrentSource.PWTRefPu) annotation(
    Line(points = {{-38, 48}, {-20, 48}, {-20, 44}, {-2, 44}}, color = {0, 0, 127}));
  connect(xWPRefPu, wPPControl.xWPRefPu) annotation(
    Line(points = {{-140, 40}, {-100, 40}, {-100, 48}, {-82, 48}}, color = {0, 0, 127}));
  ...
  connect(omegaRefPu, wPPControl.omegaRefPu) annotation(
    Line(points = {{-140, 0}, {-100, 0}, {-100, 22}, {-82, 22}}, color = {0, 0, 127}));
  ...
  annotation(
    ...
    Icon(graphics = {Text(origin = {1, -30}, extent = {{-73, 35}, {73, -35}}, textString = "Type 3B
2020")}));
