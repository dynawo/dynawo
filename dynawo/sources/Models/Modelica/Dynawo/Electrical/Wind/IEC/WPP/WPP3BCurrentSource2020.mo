...
model WPP3BCurrentSource2020 "Wind Power Plant Type 3B model from IEC 61400-27-1:2020 standard : WT3B, communication modules"
  extends Dynawo.Electrical.Wind.IEC.BaseClasses.BaseWPP3;
  ...
  //qControl.absLimRateLimFeedthroughFreezeLimDetection.Y0=(IGsRe0Pu+UGsIm0Pu/XEqv)*sin(UPhase0) - (IGsIm0Pu-UGsRe0Pu/XEqv)*cos(UPhase0) + (UGsIm0Pu^2+UGsRe0Pu^2)^0.5/XEqv,
  //qControl.absLimRateLimFeedthroughFreezeLimDetection.U0=(IGsRe0Pu+UGsIm0Pu/XEqv)*sin(UPhase0) - (IGsIm0Pu-UGsRe0Pu/XEqv)*cos(UPhase0) + (UGsIm0Pu^2+UGsRe0Pu^2)^0.5/XEqv,
  //qControl.antiWindupIntegrator.Y0=((IGsRe0Pu+UGsIm0Pu/XEqv)*sin(UPhase0) - (IGsIm0Pu-UGsRe0Pu/XEqv)*cos(UPhase0) + (UGsIm0Pu^2+UGsRe0Pu^2)^0.5/XEqv)*(1-KwpqRef),
...
equation
  connect(wT3BCurrentSource.terminal, elecMeasurements.terminal1) annotation(
