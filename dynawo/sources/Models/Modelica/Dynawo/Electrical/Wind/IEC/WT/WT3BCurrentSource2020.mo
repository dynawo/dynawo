...
model WT3BCurrentSource2020 "Wind Turbine Type 3B model from IEC 61400-27-1:2020 standard"
  ...
  final parameter Types.PerUnit OmegaRef0Pu = Modelica.Math.Vectors.interpolate(TableOmegaPPu[:, 1], TableOmegaPPu[:, 2], POrd0Pu) "Initial value for omegaRef (output of omega(p) characteristic) in pu (base omegaNom)";
  final parameter Types.PerUnit POrd0Pu = ((iGs0Pu.re + uGs0Pu.im / XEqv) * cos(UPhase0) + (iGs0Pu.im - uGs0Pu.re / XEqv) * sin(UPhase0)) * U0Pu "Initial active power order in pu (base SNom) (generator convention)";
...
equation
  ...
  connect(gridProtection.fOCB, injector.fOCB) annotation(
    Line(points = {{60, -2}, {60, -6}, {14, -6}, {14, -14}}, color = {255, 0, 255}));
  ...
  connect(mechanical.omegaGenPu, control.omegaGenPu) annotation(
    Line(points = {{102, -72}, {108, -72}, {108, -10}, {-58, -10}, {-58, -14}}, color = {0, 0, 127}));
  connect(mechanical.omegaWTRPu, control.omegaWTRPu) annotation(
    Line(points = {{102, -88}, {110, -88}, {110, -8}, {-64, -8}, {-64, -14}}, color = {0, 0, 127}));
  connect(mechanical.omegaWTRPu, pitchAngleControl.omegaWTRPu) annotation(
    Line(points = {{102, -88}, {110, -88}, {110, -116}, {-100, -116}, {-100, -86}, {-92, -86}}, color = {0, 0, 127}));
