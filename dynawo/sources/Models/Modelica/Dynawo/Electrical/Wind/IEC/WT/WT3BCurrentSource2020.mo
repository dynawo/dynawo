...
model WT3BCurrentSource2020 "Wind Turbine Type 3B model from IEC 61400-27-1:2020 standard"
  ...
  Dynawo.Electrical.Controls.IEC.IEC61400.BaseControls.WT.Mechanical mechanical(CdrtPu = CdrtPu, Hgen = Hgen, Hwtr = Hwtr, Ip0Pu = Ip0Pu, KdrtPu = KdrtPu, PAg0Pu = PAg0Pu, SNom = SNom, U0Pu = U0Pu) annotation(
