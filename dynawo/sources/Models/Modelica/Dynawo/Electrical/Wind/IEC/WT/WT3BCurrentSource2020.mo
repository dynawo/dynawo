...
model WT3BCurrentSource2020 "Wind Turbine Type 4A model from IEC 61400-27-1:2020 standard"
  ...
  redeclare Dynawo.Electrical.Sources.IEC.WT3bInjector injector(MCrb=MCrb, tG=tG, tWo=tWo, tCrb=tCrb, XEqv=XEqv,BesPu = BesPu, DipMaxPu = DipMaxPu, DiqMaxPu = DiqMaxPu, GesPu = GesPu, IGsIm0Pu = IGsIm0Pu, IGsRe0Pu = IGsRe0Pu, IpMax0Pu = IpMax0Pu, IqMax0Pu = IqMax0Pu, IqMin0Pu = IqMin0Pu, P0Pu = P0Pu, PAg0Pu = PAg0Pu, Q0Pu = Q0Pu, ResPu = ResPu, SNom = SNom, U0Pu = U0Pu, UGsIm0Pu = UGsIm0Pu, UGsRe0Pu = UGsRe0Pu, UPhase0 = UPhase0, XesPu = XesPu, i0Pu = i0Pu, u0Pu = u0Pu)
