...
model WPP4CurrentSource2020_INIT "Wind Power Plant Type 4 model from IEC 61400-27-1:2020 standard : initialization model"
  ...
  parameter Types.PerUnit RwpDropPu "Resistive component of voltage drop impedance in pu (base UNom, SNom)";
  parameter Types.PerUnit XwpDropPu "Inductive component of voltage drop impedance in pu (base UNom, SNom)";
  ...
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds6Init(table = TableQwpUErr, tableOnFile = QControlTablesOnFile) annotation(
...
equation
  UWpp0DroppedPu = ((Modelica.ComplexMath.'abs'(uControl0Pu) - RwpDropPu * PControl0Pu / U0Pu - XwpDropPu * QControl0Pu / U0Pu) ^ 2 + (XwpDropPu * PControl0Pu / U0Pu - RwpDropPu * QControl0Pu / U0Pu) ^ 2) ^ 0.5;
