...
equation
  ...
  annotation(
    ...
    Icon(graphics = {Text(origin = {81, -3}, extent = {{-12, 15}, {13, -15}}, textString = "3A"), Text(origin = {3, -41}, extent = {{-53, 24}, {53, -24}}, textString = "2020")}));
