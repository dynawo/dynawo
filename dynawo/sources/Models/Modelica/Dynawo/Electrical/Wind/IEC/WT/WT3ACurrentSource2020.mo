...
model WT3ACurrentSource2020 "Wind Turbine Type 4A model from IEC 61400-27-1:2020 standard"
  ...
  Dynawo.Electrical.Controls.IEC.IEC61400.BaseControls.WT.Aerodynamic2D aerodynamic2d(DPOmega0Pu = DPOmega0Pu, DPOmegaThetaPu = DPOmegaThetaPu, DPThetaPu = DPThetaPu, IGsIm0Pu = IGsIm0Pu, IGsRe0Pu = IGsRe0Pu, P0Pu = P0Pu, PAvailPu = PAvailPu, Theta0 = Theta0, UGsIm0Pu = UGsIm0Pu, UGsRe0Pu = UGsRe0Pu) annotation(
    Placement(visible = true, transformation(origin = {-34, -94}, extent = {{-12, -12}, {12, 12}}, rotation = 0)));
  Dynawo.Electrical.Controls.IEC.IEC61400.BaseControls.WT.PitchAngleControl pitchAngleControl(Theta0 = Theta0, DPThetaPu = DPMaxPu, PAvailPu = PAvailPu, PAg0Pu = PAg0Pu, DThetaCMax = DThetaCMax, DThetaCMin = DThetaCMin, DThetaMax = DThetaMax, DThetaMin = DThetaMin, DThetaOmegaMax = DThetaOmegaMax, DThetaOmegaMin = DThetaOmegaMin, KIcPu = KIcPu, KIomegaPu = KIomegaPu, KPXPu = KPXPu, KPcPu = KPcPu, KPomegaPu = KPomegaPu, P0Pu = P0Pu, PWTRef0Pu = PWTRef0Pu, SNom = SNom, TTheta = TTheta, ThetaCMax = ThetaCMax, ThetaCMin = ThetaCMin, ThetaMax = ThetaMax, ThetaMin = ThetaMin, ThetaOmegaMax = ThetaOmegaMax, ThetaOmegaMin = ThetaOmegaMin, OmegaRef0Pu = OmegaRef0Pu) annotation(
