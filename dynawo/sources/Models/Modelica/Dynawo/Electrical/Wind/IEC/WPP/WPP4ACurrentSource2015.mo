...
model WPP4ACurrentSource2015 "Wind Power Plant Type 4A model from IEC 61400-27-1:2015 standard : WT4A, communication modules"
  ...
  final parameter Types.PerUnit X0Pu = if MwpqMode == 0 then QControl0Pu else if MwpqMode == 1 then QControl0Pu/PControl0Pu else if MwpqMode == 2 then Modelica.ComplexMath.'abs'(uControl0Pu) + UErr0 else if MwpqMode == 3 then U0Pu + Kwpqu*QControl0Pu else 0;
