...
equation
  ...
  connect(QWPRefPu, wPPControl2015.QWPRefPu) annotation(
    Line(points = {{-140, 26}, {-100, 26}, {-100, 46}, {-82, 46}}, color = {0, 0, 127}));
  connect(omegaRefPu, wPPControl2015.omegaRefPu) annotation(
    Line(points = {{-140, 0}, {-88, 0}, {-88, 22}, {-82, 22}}, color = {0, 0, 127}));
  connect(tanPhi, wPPControl2015.tanPhi) annotation(
    Line(points = {{-20, 120}, {-20, 62}, {-70, 62}}, color = {0, 0, 127}));
  connect(wPPControl2015.xWTRefPu, wT4ACurrentSource.xWTRefPu) annotation(
    Line(points = {{-38, 32}, {-8, 32}, {-8, 36}, {-2, 36}}, color = {0, 0, 127}));
  ...
  connect(realToComplex.y, wPPControl2015.iPu) annotation(
    Line(points = {{2, -4}, {-92, -4}, {-92, 30}, {-82, 30}}, color = {85, 170, 255}));
