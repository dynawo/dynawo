...
equation
  ...
  connect(UWPRefPu, wPPControl2015.UWPRefPu) annotation(
    Line(points = {{-140, 12}, {-111, 12}, {-111, 52}, {-82, 52}}, color = {0, 0, 127}));
