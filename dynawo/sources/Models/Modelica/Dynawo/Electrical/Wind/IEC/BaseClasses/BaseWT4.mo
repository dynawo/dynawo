...
partial model BaseWT4 "Base model for Wind Turbine Type 4 from IEC 61400-27-1 standard"
  ...
  final parameter Types.VoltageModulePu UWt0DroppedPu = (((U0Pu + RDropPu * P0Pu + XDropPu * Q0Pu) ^ 2 + (-XDropPu * P0Pu + RDropPu * Q0Pu) ^ 2) ^ 0.5) * SystemBase.SnRef / (SNom * U0Pu) "Initial voltage magnitude controlled by the WT in pu (base UNom)";
