...
partial model BaseWT4 "Base model for Wind Turbine Type 4 from IEC 61400-27-1 standard"
  ...
  final parameter Types.CurrentModulePu ip0Pu = (cos(UPhase0)*real(Complex(GesPu, BesPu)*(u0Pu - Complex(ResPu, XesPu)*i0Pu*SystemBase.SnRef/SNom) - i0Pu*SystemBase.SnRef/SNom) + sin(UPhase0)*imag(Complex(GesPu, BesPu)*(u0Pu - Complex(ResPu, XesPu)*i0Pu*SystemBase.SnRef/SNom) - i0Pu*SystemBase.SnRef/SNom)) "Initial active current component at converter terminal in pu (base UNom, SNom) (generator convention)";
  parameter Types.PerUnit IpMax0Pu "Initial maximum active current at converter terminal in pu (base UNom, SNom) (generator convention)" annotation(
    Dialog(group = "Initialization"));
  final parameter Types.CurrentModulePu iq0Pu = (cos(UPhase0)*imag(Complex(GesPu, BesPu)*(u0Pu - Complex(ResPu, XesPu)*i0Pu*SystemBase.SnRef/SNom) - i0Pu*SystemBase.SnRef/SNom) - sin(UPhase0)*real(Complex(GesPu, BesPu)*(u0Pu - Complex(ResPu, XesPu)*i0Pu*SystemBase.SnRef/SNom) - i0Pu*SystemBase.SnRef/SNom)) "Initial reactive current component at converter terminal in pu (base UNom, SNom) (generator convention)" annotation(
    Dialog(group = "Initialization"));
  ...
  final parameter Types.ActivePowerPu PAg0Pu = ip0Pu * U0Pu "Initial generator (air gap) power in pu (base SNom) (generator convention)" annotation(
    Dialog(group = "Initialization"));
