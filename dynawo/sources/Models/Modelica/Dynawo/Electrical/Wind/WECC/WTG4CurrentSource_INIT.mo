...
model WTG4CurrentSource_INIT "Initialization model for WECC Wind model with a current source as interface with the grid"
  ...
  parameter Types.PerUnit UPcc0Pu "Start value of voltage magnitude at PPC regulated bus in pu (bae UNom)" annotation(
    Dialog(enable = not PPCLocal));
  parameter Types.Angle UPhasePcc0 "Start value of voltage phase angle at PPC regulated bus in rad" annotation(
    Dialog(enable = not PPCLocal));
  ...
  Types.PerUnit QConv0Pu "Start value of reactive power at converter terminal in pu (base SNom) (generator convention)";
