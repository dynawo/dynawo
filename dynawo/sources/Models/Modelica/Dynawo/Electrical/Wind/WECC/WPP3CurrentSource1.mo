...
model WPP3CurrentSource1 "WECC Wind Turbine model with a current source as interface with the grid and the mechanical controllers"
...
equation
  ...
  connect(wecc_repc.URefPu, URefPu) annotation(
    Line(points = {{-121, -11}, {-121, -20}, {-190, -20}}, color = {0, 0, 127}));
  ...
  annotation(
    ...
    &nbsp;</span></div> </body></html>"),
    Icon(graphics = {Text(origin = {-26, 11}, extent = {{-48, 27}, {98, -53}}, textString = "WECC WPP 3 1"), Rectangle(extent = {{-100, 100}, {100, -100}})}, coordinateSystem(extent = {{-100, -100}, {100, 100}})),
