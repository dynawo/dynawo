...
model WTG4BCurrentSource "WECC Wind Turbine model with a current source as interface with the grid"
  ...
  Dynawo.Electrical.Controls.WECC.REPC.REPCa wecc_repc(DDn = DDn, DUp = DUp, DbdPu = DbdPu, EMaxPu = EMaxPu, EMinPu = EMinPu, FDbd1Pu = FDbd1Pu, FDbd2Pu = FDbd2Pu, FEMaxPu = FEMaxPu, FEMinPu = FEMinPu, FreqFlag = FreqFlag, Kc = Kc, Ki = Ki, Kig = Kig, Kp = Kp, Kpg = Kpg, PConv0Pu = PConv0Pu, PMaxPu = PMaxPu, PMinPu = PMinPu, PPcc0Pu = PPcc0Pu, QConv0Pu = QConv0Pu, QMaxPu = QMaxPu, QMinPu = QMinPu, QPcc0Pu = QPcc0Pu, RcPu = RPu, RefFlag = RefFlag, SNom = SNom, UInj0Pu = UInj0Pu, UPcc0Pu = UPcc0Pu, VCompFlag = VCompFlag, VFrz = VFrz, XcPu = XPu, iPcc0Pu = iPcc0Pu, tFilterPC = tFilterPC, tFt = tFt, tFv = tFv, tLag = tLag, tP = tP, uPcc0Pu = uPcc0Pu) annotation(
