...
model WTG4ACurrentSource "WECC Wind Turbine model with a simplified drive train model WTGTB (dual-mass model) and with a current source as interface with the grid"
  ...
  extends Dynawo.Electrical.Wind.WECC.BaseClasses.BaseWT4(LvTfo(RPu = RPu, XPu = XPu));
...
equation
  ...
  connect(injector.PInjPuSn, wecc_wtgt.PePu) annotation(
    Line(points = {{12, -4}, {20, -4}, {20, -40}, {-78, -40}}, color = {0, 0, 127}));
