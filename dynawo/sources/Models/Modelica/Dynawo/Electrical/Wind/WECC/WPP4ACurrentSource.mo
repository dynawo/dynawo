...
model WPP4ACurrentSource "WECC Wind Turbine model with a simplified drive train model WTGTB (dual-mass model) and with a current source as interface with the grid"
