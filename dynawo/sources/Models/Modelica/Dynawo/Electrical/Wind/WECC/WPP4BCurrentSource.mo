...
model WPP4BCurrentSource "WECC Wind Turbine model with a current source as interface with the grid"
...
equation
  ...
  connect(pll.omegaPLLPu, wecc_repc.omegaPu) annotation(
    Line(points = {{-148, 50}, {-140, 50}, {-140, 8}, {-132, 8}}, color = {0, 0, 127}));
...
<li> Injector (id,iq). </li>
    ...
    Icon(graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}), Text(origin = {-24, 11}, extent = {{-48, 27}, {98, -53}}, textString = "WECC WPP 4B")}, coordinateSystem(extent = {{-100, -100}, {100, 100}})),
