...
partial model BaseWT4 "Partial base model for the WECC Wind Turbine models including the electrical control, the generator control, the injector, the measurements and the equivalent branch connection to the grid"
  ...
  Dynawo.Electrical.Controls.WECC.REEC.REECa wecc_reec(DPMaxPu = DPMaxPu, DPMinPu = DPMinPu, Dbd1Pu = Dbd1Pu, Dbd2Pu = Dbd2Pu, IMaxPu = IMaxPu,Id0Pu = Id0Pu, Iq0Pu = Iq0Pu, IqFrzPu = IqFrzPu, Iqh1Pu = Iqh1Pu, Iql1Pu = Iql1Pu, Kqi = Kqi, Kqp = Kqp, Kqv = Kqv, Kvi = Kvi, Kvp = Kvp, PF0 = PF0, PFlag = PFlag, PInj0Pu = PInj0Pu, PMaxPu = PMaxPu, PMinPu = PMinPu, PQFlag = PQFlag, PfFlag = PfFlag, QFlag = QFlag, QInj0Pu = QInj0Pu, QMaxPu = QMaxPu, QMinPu = QMinPu, SNom = SNom, UInj0Pu = UInj0Pu, VDLIp11 = VDLIp11, VDLIp12 = VDLIp12, VDLIp21 = VDLIp21, VDLIp22 = VDLIp22, VDLIp31 = VDLIp31, VDLIp32 = VDLIp32, VDLIp41 = VDLIp41, VDLIp42 = VDLIp42, VDLIq11 = VDLIq11, VDLIq12 = VDLIq12, VDLIq21 = VDLIq21, VDLIq22 = VDLIq22, VDLIq31 = VDLIq31, VDLIq32 = VDLIq32, VDLIq41 = VDLIq41, VDLIq42 = VDLIq42, VDipPu = VDipPu, VFlag = VFlag, VMaxPu = VMaxPu, VMinPu = VMinPu, VRef0Pu = VRef0Pu, VRef1Pu = VRef1Pu, VUpPu = VUpPu, s0Pu = s0Pu, tHoldIpMax = tHoldIpMax, tHoldIq = tHoldIq, tIq = tIq, tP = tP, tPord = tPord, tRv = tRv, u0Pu = u0Pu) annotation(
    Placement(visible = true, transformation(origin = {-80.1315, -0.1384}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Controls.WECC.REGC.REGCa wecc_regc( Id0Pu = Id0Pu, Iq0Pu = Iq0Pu,IqrMaxPu = IqrMaxPu, IqrMinPu = IqrMinPu, Lvplsw = Lvplsw, QInj0Pu = QInj0Pu, RrpwrPu = RrpwrPu, UInj0Pu = UInj0Pu, brkpt = brkpt, lvpl1 = lvpl1, tFilterGC = tFilterGC, tG = tG, u0Pu = u0Pu, zerox = zerox) annotation(
    Placement(visible = true, transformation(origin = {-40, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Sources.InjectorIDQ injector(Id0Pu = Id0Pu, Iq0Pu = Iq0Pu, P0Pu = - PInj0Pu * (SNom / SystemBase.SnRef), Q0Pu = - QInj0Pu * (SNom / SystemBase.SnRef), SNom = SNom, U0Pu = UInj0Pu, UPhase0 = UPhaseInj0, i0Pu = i0Pu, s0Pu = Complex(-PInj0Pu * (SNom / SystemBase.SnRef), -QInj0Pu * (SNom / SystemBase.SnRef)), u0Pu = uInj0Pu) annotation(
  ...
  Dynawo.Electrical.Lines.Line LvToMvTsfo(BPu = 0, GPu = 0, RPu = RPu, XPu = XPu)  annotation(
...
equation
  LvToMvTsfo.switchOffSignal1.value = injector.switchOffSignal1.value;
  LvToMvTsfo.switchOffSignal2.value = injector.switchOffSignal2.value;
  ...
  connect(LvToMvTsfo.terminal1, injector.terminal) annotation(
    Line(points = {{40, 0}, {30, 0}, {30, 8}, {12, 8}}, color = {0, 0, 255}));
  connect(LvToMvTsfo.terminal2, measurements.terminal1) annotation(
  ...
  connect(measurements.UPu, wecc_regc.UPu) annotation(
    Line(points = {{80, -11}, {80, -20}, {-46, -20}, {-46, -11}}, color = {0, 0, 127}));
  connect(measurements.UPu, wecc_reec.UPu) annotation(
    Line(points = {{80, -11}, {80, -20}, {-74, -20}, {-74, -11}}, color = {0, 0, 127}));
  connect(measurements.PPu, wecc_reec.PInjPu) annotation(
    Line(points = {{84, -11}, {84, -30}, {-80, -30}, {-80, -11}}, color = {0, 0, 127}));
  connect(measurements.QPu, wecc_reec.QInjPu) annotation(
    Line(points = {{88, -11}, {88, -40}, {-89, -40}, {-89, -11}}, color = {0, 0, 127}));
  connect(measurements.uPu, pll.uPu) annotation(
    Line(points = {{92, -11}, {92, -20}, {110, -20}, {110, 60}, {-180, 60}, {-180, 50}, {-171, 50}}, color = {85, 170, 255}));
  annotation(
