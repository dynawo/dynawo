...
model WTG3CurrentSource1 "WECC Wind Turbine model with a current source as interface with the grid and the mechanical controllers"
  ...
  Dynawo.Electrical.Controls.WECC.Mechanical.WTGPa wecc_wtgp(Kiw = Kiw, Kpw = Kpw, Kic = Kic, Kpc = Kpc, Kcc = Kcc, tTheta = tTheta, ThetaMax = ThetaMax, ThetaMin = ThetaMin, ThetaRMax = ThetaRMax, ThetaRMin = ThetaRMin, PInj0Pu = PInj0Pu, Theta0 = Theta0, omegaRefWTGQPu0 = omegaRefWTGQPu0) annotation(
...
equation
  ...
  connect(wecc_reec.frtOn, wecc_wtgq.freeze) annotation(
    Line(points = {{152, -10}, {166, -10}, {166, -36}, {-36, -36}, {-36, -44}}, color = {255, 0, 255}));
  annotation(
