...
// Initial parameters
 ...
 Modelica.Blocks.Sources.Constant OmegRef(k = 1)  annotation(
    Placement(transformation(origin = {-18, 46}, extent = {{-10, -10}, {10, 10}})));      equation
  ...
  connect(wecc_wtgt.omegaGPu, wecc_wtgq.wg) annotation(
    Line(points = {{114, -53}, {114, -48}, {180, -48}, {180, -86}, {-88, -86}, {-88, -65}, {-63, -65}}, color = {0, 0, 127}));
  connect(wecc_repc.PInjRefPu, wecc_wtgq.Pref0) annotation(
    Line(points = {{116, -4}, {116, 18}, {-80, 18}, {-80, -49}, {-63, -49}}, color = {0, 0, 127}));
  ...
  connect(injector.PInjPuSn, wecc_wtgt.PePu) annotation(
    Line(points = {{248, -14}, {266, -14}, {266, -66}, {125, -66}}, color = {0, 0, 127}));
  connect(injector.PInjPuSn, wecc_wtgq.Pe) annotation(
    Line(points = {{248, -14}, {265, -14}, {265, 65}, {-90, 65}, {-90, -57}, {-63, -57}}, color = {0, 0, 127}));
  ...
  connect(wecc_wtgq.Pref, wecc_reec.PInjRefPu) annotation(
    Line(points = {{-35, -65}, {-35, -64}, {-15, -64}, {-15, -33}, {-2, -33}, {-2, -32}, {122, -32}, {122, -4}, {129, -4}}, color = {0, 0, 127}));
  ...
  connect(wecc_wtgt.omegaGPu, wecc_reec.omegaGPu) annotation(
    Line(points = {{114, -53}, {114, -48}, {134, -48}, {134, -20}}, color = {0, 0, 127}));
  ...
  connect(URefPu, wecc_repc.URefPu) annotation(
    Line(points = {{32, -24}, {104, -24}, {104, -20}}, color = {0, 0, 127}));
  ...
  connect(wecc_repc.freeze, wecc_wtgq.freeze) annotation(
    Line(points = {{116, -10}, {120, -10}, {120, -29}, {-47, -29}, {-47, -43}, {-46, -43}}, color = {255, 0, 255}));
  connect(wecc_wtga.Pm, wecc_wtgt.Pm) annotation(
    Line(points = {{73.5, -57}, {88, -57}}, color = {0, 0, 127}));
  connect(wecc_wtgp.theta, wecc_wtga.Theta) annotation(
    Line(points = {{23, -57}, {40.5, -57}}, color = {0, 0, 127}));
