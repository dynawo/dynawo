...
partial model BaseWT4A "Partial base model for WECC Wind Turbine 4A"
  ...
  Dynawo.Electrical.Controls.WECC.Mechanical.WTGTa wecc_wtgt(Dshaft = Dshaft, Hg = Hg, Ht = Ht, Kshaft = Kshaft, PConv0Pu = PConv0Pu, PePu(start = PConv0Pu), Pm0Pu = PConv0Pu) annotation(
