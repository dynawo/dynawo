...
model WT3CurrentSource1 "WECC Wind Turbine model with a current source as interface with the grid and the mechanical controllers"
  ...
  extends Electrical.Controls.WECC.Parameters.REEC.ParamsREECa;
  extends Electrical.Controls.WECC.Parameters.REGC.ParamsREGC;
  extends Electrical.Controls.WECC.Parameters.REGC.ParamsREGCa;
  extends Electrical.Controls.WECC.Parameters.Mechanical.ParamsWTGP;
  extends Electrical.Controls.WECC.Parameters.Mechanical.ParamsWTGAa;
  extends Electrical.Controls.WECC.Parameters.Mechanical.ParamsWTGQa;
  ...
  Electrical.Controls.WECC.Mechanical.WTGAa wecc_wtga(
    Theta0 = Theta0,
    Ka = Ka,
    Pm0Pu = Pm0Pu) annotation(
    Placement(transformation(origin = {10, -46}, extent = {{-10, -10}, {10, 10}})));
  Electrical.Controls.WECC.Mechanical.WTGQa wecc_wtgq(
    Kip = Kip,
    Kpp = Kpp,
    tP = tP,
    tOmegaRef = tOmegaRef,
  ...
  Electrical.Controls.WECC.Mechanical.WTGTa wecc_wtgt(
    Ht = Ht,
    Hg = Hg,
    Dshaft = Dshaft,
    Kshaft = Kshaft,
  ...
  Electrical.Controls.WECC.REGC.REGCa wecc_regc(
    IqrMaxPu = IqrMaxPu,
    IqrMinPu = IqrMinPu,
    tFilterGC = tFilterGC,
    tG = tG,
  ...
  Electrical.Sources.InjectorIDQ injector(
    Id0Pu = Id0Pu,
    Iq0Pu = Iq0Pu,
    SNom = SNom,
    UPhase0 = UPhaseConv0,
  ...
  Electrical.Controls.WECC.REEC.REECa wecc_reec(
    DPMaxPu = DPMaxPu,
    DPMinPu = DPMinPu,
    Dbd1Pu = Dbd1Pu,
    Dbd2Pu = Dbd2Pu,
  ...
  Electrical.Sources.IEC.BaseConverters.ElecSystem LvTfo(
    BPu = 0,
    GPu = 0,
    RPu = RPu,
    SNom = SNom,
    ...
    Placement(transformation(origin = {40, 0}, extent = {{-10, -10}, {10, 10}})));
  Electrical.Controls.WECC.Utilities.Measurements LvMeasurements(SNom = SNom) annotation(
...
equation
  ...
  connect(PmRefPu, wecc_wtga.PmRefPu) annotation(
    Line(points = {{6, -110}, {6, -83.5}, {15, -83.5}, {15, -57}}, color = {0, 0, 127}));
  ...
  connect(PConvRefPu, wecc_wtgq.PRef0Pu) annotation(
    Line(points = {{-190, 20}, {-120, 20}, {-120, -40}, {-100, -40}}, color = {0, 0, 127}));
  connect(QConvRefPu, wecc_reec.QConvRefPu) annotation(
    Line(points = {{-190, -20}, {-156, -20}, {-156, -6}, {-90, -6}}, color = {0, 0, 127}));
  connect(wecc_reec.frtOn, wecc_wtgq.freeze) annotation(
    Line(points = {{-68, 0}, {-64, 0}, {-64, -28}, {-86, -28}, {-86, -34}}, color = {255, 0, 255}));
