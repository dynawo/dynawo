...
model ShuntBWithSections "Shunt element with voltage-dependent reactive power and a variable susceptance given by a table and a section"
  ...
  Modelica.Blocks.Tables.CombiTable1Dv tableBPu(
    tableOnFile=true,
    tableName=TableBPuName,
    fileName=TableBPuFile) "Table to get BPu from the section of the shunt";

  Types.VoltageModulePu UPu(start=Modelica.ComplexMath.abs(u0Pu))
    "Voltage amplitude at shunt terminal in pu (base UNom)";
  ...
  Types.PerUnit BPu(start=-s0Pu.im/Modelica.ComplexMath.abs(u0Pu)^2)
    "Variable susceptance of the shunt in pu (base SnRef, UNom)";
