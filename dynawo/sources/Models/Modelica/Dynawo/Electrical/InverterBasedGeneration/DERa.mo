...
model DERa "Aggregated model of inverter-based generation (IBG) as defined by EPRI under the name der_a"
  extends BaseClasses.DERa.BaseDERa;
  ...
  Dynawo.Electrical.InverterBasedGeneration.BaseClasses.DERa.LVRT lvrt(RecoveringShare = RecoveringShare, Ul0Pu = Ul0Pu, Ul1Pu = Ul1Pu, tvl0 = tvl0, tvl1 = tvl1) annotation(
    Placement(visible = true, transformation(origin = {-410, -140}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Dynawo.Electrical.InverterBasedGeneration.BaseClasses.DERa.OVRT ovrt(RecoveringShare = RecoveringShare, Uh0Pu = Uh0Pu, Uh1Pu = Uh1Pu, tvh0 = tvh0, tvh1 = tvh1) annotation(
    Placement(visible = true, transformation(origin = {-410, -100}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
...
equation
  ...
  connect(UFilter.y, ovrt.UMonitoredPu) annotation(
    Line(points = {{-398, -20}, {-360, -20}, {-360, -100}, {-398, -100}}, color = {0, 0, 127}));

  annotation(
    preferredView = "diagram",
    Documentation(info = "<html><head></head><body>Aggregated model of inverter-based generation (IBG) as defined in https://www.epri.com/research/products/000000003002015320.</body></html>"));
end DERa;
