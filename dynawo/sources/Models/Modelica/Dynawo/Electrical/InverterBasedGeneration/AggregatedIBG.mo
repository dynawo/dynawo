...
model AggregatedIBG "Aggregated model of inverter-based generation (IBG)"
  ...
  Dynawo.Electrical.InverterBasedGeneration.BaseClasses.AggregatedIBG.FrequencyProtection frequencyProtection(OmegaMaxPu = OmegaMaxPu, OmegaMinPu = OmegaMinPu, p = pOmegaPu, r = rOmega) annotation(
    Placement(visible = true, transformation(origin = {-48, -344}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.InverterBasedGeneration.BaseClasses.AggregatedIBG.OverFrequencySupport overFrequencySupport(OmegaDeadBandPu = OmegaDeadBandPu, OmegaMaxPu = OmegaMaxPu, s = sOmega) annotation(
  ...
  Modelica.Blocks.Math.Product IqPartialTripping annotation(
    Placement(visible = true, transformation(origin = {230, -274}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.RealExpression PartialTripping2(y = partialTrippingRatio) annotation(
    Placement(visible = true, transformation(origin = {190, -250}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(PartialTripping2.y, IqPartialTripping.u1) annotation(
    Line(points = {{201, -250}, {209, -250}, {209, -268}, {217, -268}}, color = {0, 0, 127}));
  ...
  connect(IpPartialTripping.y, injector.idPu) annotation(
    Line(points = {{202, -166}, {220, -166}, {220, -12}, {228, -12}}, color = {0, 0, 127}));
  ...
  connect(limitUpdating.IqMinPu, iQLimiter.limit2) annotation(
    Line(points = {{50, -228}, {34, -228}, {34, -288}, {48, -288}}, color = {0, 0, 127}));
  connect(limitUpdating.IqMaxPu, iQLimiter.limit1) annotation(
    Line(points = {{50, -224}, {38, -224}, {38, -272}, {48, -272}}, color = {0, 0, 127}));
  connect(IqPartialTripping.y, injector.iqPu) annotation(
    Line(points = {{242, -274}, {250, -274}, {250, -160}, {216, -160}, {216, -2}, {228, -2}}, color = {0, 0, 127}));
  ...
  connect(gain.y, IqPartialTripping.u2) annotation(
    Line(points = {{202, -280}, {218, -280}}, color = {0, 0, 127}));
