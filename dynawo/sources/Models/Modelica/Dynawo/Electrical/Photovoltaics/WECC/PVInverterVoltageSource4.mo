...
model PVInverterVoltageSource4 "WECC PV model with a voltage source as interface with the grid (REEC-B REGC-C)"
...
equation
  ...
  connect(wecc_reec.ipMaxPu, wecc_regc.ipMaxPu) annotation(
    Line(points = {{-88, 11}, {-88, 23}, {-44, 23}, {-44, 11}}, color = {0, 0, 127}));
