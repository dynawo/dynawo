...
model PVCurrentSourceA "WECC PV model with a current source as interface with the grid (REPC-A REEC-B REGC-A)"
  ...
  Dynawo.Electrical.Controls.WECC.REGC.REGCa wecc_regc( Id0Pu = Id0Pu, Iq0Pu = Iq0Pu,IqrMaxPu = IqrMaxPu, IqrMinPu = IqrMinPu, Lvplsw = Lvplsw, RateFlag = RateFlag, RrpwrPu = RrpwrPu, UInj0Pu = UInj0Pu, brkpt = brkpt, lvpl1 = lvpl1, tFilterGC = tFilterGC, tG = tG, zerox = zerox) annotation(
    Placement(visible = true, transformation(origin = {-40.1954, 0.000560045}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(injector.UPu, wecc_regc.UPu) annotation(
    Line(points = {{11.5, -8}, {20, -8}, {20, -20}, {-40, -20}, {-40, -11}}, color = {0, 0, 127}));
  ...
  connect(wecc_repc.QInjRefPu, wecc_regc.Qgen0) annotation(
    Line(points = {{-109, -6}, {-100, -6}, {-100, 24}, {-46, 24}, {-46, 11}}, color = {0, 0, 127}));
