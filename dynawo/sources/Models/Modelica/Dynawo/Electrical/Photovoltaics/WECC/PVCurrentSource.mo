...
model PVCurrentSource "WECC PV model with a current source as interface with the grid"
  ...
  Dynawo.Electrical.Controls.WECC.PlantControl wecc_repc(Ddn = 20, Dup = 0.001, FreqFlag = true, Kc = 0.1769, Ki = 1.5, Kig = 2.36, Kp = 0.1, Kpg = 0.05, PMax = 1, PMin = 0, QMax = 0.4, QMin = -0.4, Rc = RPu * SNom / SystemBase.SnRef, RefFlag = true, Tfltr = 0.04, Tft = 0, Tfv = 0.1, Tlag = 0.1, Tp = 0.04, VcompFlag = false, Vfrz = 0.0, Xc = XPu * SNom / SystemBase.SnRef, dbd = 0.01, eMax = 999, eMin = -999, fdbd1 = 0.004, fdbd2 = 1, feMax = 999, feMin = -999, iInj0Pu = iInj0Pu, u0Pu = u0Pu, U0Pu = U0Pu, UInj0Pu = UInj0Pu, PInj0Pu = PInj0Pu, PGen0Pu = PGen0Pu, QInj0Pu = QInj0Pu, QGen0Pu = QGen0Pu) annotation(
    Placement(visible = true, transformation(origin = {-40, -18}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Controls.WECC.ElectricalControl wecc_reec(Imax = 1.05, Iqh1 = 2, Iql1 = -2, Kqi = 0.5, Kqp = 1, Kqv = 2, Kvi = 1, Kvp = 1, PfFlag = false, Pmax = 1, Pmin = 0, PPriority = false, QFlag = true, Qmax = 0.4, Qmin = -0.4, Tiq = 0.02, Tp = 0.04, Tpord = 0.02, Trv = 0.02, VFlag = true, UMinPu = 0.9, Vmax = 1.1, Vmin = 0.9, Vref0 = 1, UMaxPu = 1.1, dPmax = 999, dPmin = -999, dbd1 = -0.1, dbd2 = 0.1, PInj0Pu = PInj0Pu, QInj0Pu = QInj0Pu, UInj0Pu = UInj0Pu, PF0 = PF0) annotation(
    Placement(visible = true, transformation(origin = {0, -18}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Controls.WECC.GeneratorControl wecc_regc(Iqrmax = 20, Iqrmin = -20, RateFlag = false, Tfltr = 0.02, Tg = 0.02, rrpwr = 10, UInj0Pu = UInj0Pu, Id0Pu = Id0Pu, Iq0Pu = Iq0Pu) annotation(
    Placement(visible = true, transformation(origin = {40, -18}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
