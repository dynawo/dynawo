...
model PVVoltageSource3 "WECC PV model with a voltage source as interface with the grid (REPC-A REEC-A REGC-C)"
...
equation
  ...
  connect(wecc_reec.ipMaxPu, wecc_regc.ipMaxPu) annotation(
    Line(points = {{-88, 11}, {-88, 21}, {-44, 21}, {-44, 11}}, color = {0, 0, 127}));
  connect(wecc_reec.ipMinPu, wecc_regc.ipMinPu) annotation(
    Line(points = {{-84, 11}, {-84, 19}, {-48, 19}, {-48, 11}}, color = {0, 0, 127}));
