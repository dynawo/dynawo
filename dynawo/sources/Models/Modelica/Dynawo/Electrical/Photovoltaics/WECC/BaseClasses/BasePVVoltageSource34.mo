...
partial model BasePVVoltageSource34 "Base model for WECC PV with a voltage source as interface with the grid (REGC-C)"
  ...
  */
  ...
  Dynawo.Electrical.Controls.WECC.REGC.REGCc wecc_regc(IMaxPu = IMaxPu, Id0Pu = Id0Pu, Iq0Pu = Iq0Pu, IqrMaxPu = IqrMaxPu, IqrMinPu = IqrMinPu, KiPLLInj = KiPLLInj, Kii = Kii, Kip = Kip, KpPLLInj = KpPLLInj, OmegaMaxInjPu = OmegaMaxInjPu, OmegaMinInjPu = OmegaMinInjPu, QInj0Pu = QInj0Pu, RSourcePu = RSourcePu, RateFlag = RateFlag, RrpwrPu = RrpwrPu, UInj0Pu = UInj0Pu, UdInj0Pu = UdInj0Pu, UqInj0Pu = UqInj0Pu, XSourcePu = XSourcePu, iInj0Pu = -i0Pu * SystemBase.SnRef / SNom, tE = tE, tFilterGC = tFilterGC, tG = tG, uInj0Pu = uInj0Pu, uSource0Pu = uSource0Pu) annotation(
