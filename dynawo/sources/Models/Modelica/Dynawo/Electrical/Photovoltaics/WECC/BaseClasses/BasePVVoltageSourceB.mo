...
partial model BasePVVoltageSourceB "Base model for WECC PV with a voltage source as interface with the grid (REGC-B)"
  ...
  */
  ...
  Dynawo.Electrical.Controls.WECC.REGC.REGCb wecc_regc(DerIqrMaxPu = DerIqrMaxPu, DerIqrMinPu = DerIqrMinPu, Id0Pu = Id0Pu, Iq0Pu = Iq0Pu, QInj0Pu = QInj0Pu, RSourcePu = RSourcePu, RateFlag = RateFlag, RrpwrPu = RrpwrPu, UInj0Pu = UInj0Pu, UdInj0Pu = UdInj0Pu, UqInj0Pu = UqInj0Pu, XSourcePu = XSourcePu, tE = tE, tFilterGC = tFilterGC, tG = tG, uInj0Pu = uInj0Pu, uSource0Pu = uSource0Pu) annotation(
