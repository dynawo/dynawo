...
model IdealSwitch2 "Ideal switch with initial values"
  ...
  // Switch start values
  parameter Types.ActivePowerPu P10Pu "Start value of active power at terminal 1 in pu (receptor convention)";
  parameter Types.ReactivePowerPu Q10Pu "Start value of reactive power at terminal 1 in pu (receptor convention)";
  parameter Types.VoltageModulePu U10Pu "Start value of voltage amplitude at terminal 1 in pu";

  parameter Types.ActivePowerPu P20Pu "Start value of active power at terminal 2 in pu (receptor convention)";
  parameter Types.ReactivePowerPu Q20Pu "Start value of reactive power at terminal 2 in pu (receptor convention)";
  parameter Types.VoltageModulePu U20Pu "Start value of voltage amplitude at terminal 2 in pu";
