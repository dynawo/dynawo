...
model DynGFMVSM_A "PEIR model with GFM VSM control and dynamic connections to the grid"
  /*
...
equation
  ...
  connect(QFilterRefPu, Control.QFilterRefPu) annotation(
    Line(points = {{-110, 16}, {-78, 16}, {-78, 44}, {-70, 44}}, color = {0, 0, 127}));
  connect(Measurements.QFilterPu, Control.QFilterPu) annotation(
    Line(points = {{-4, -44}, {-4, -47}, {-70, -47}, {-70, 29}}, color = {85, 170, 0}));
