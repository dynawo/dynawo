...
model DynGFLBandwith "PEIR model with GFL control and dynamic connections to the grid, dynamics provided through bandwith values"
  ...
  */
  ...
  Dynawo.Connectors.ACPower terminal(V(re(start = u0Pu.re), im(start = u0Pu.im)), i(re(start = i0Pu.re), im(start = i0Pu.im))) annotation(
    Placement(visible = true, transformation(origin = {106, 40}, extent = {{-6, -6}, {6, 6}}, rotation = 0), iconTransformation(origin = {110, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Dynawo.Electrical.Controls.PEIR.Converters.Average.DynGridFollowingControl Control(IMaxPu = IMaxPu,IdConv0Pu = Converter.RLCFilter.IdConv0Pu, IqConv0Pu = Converter.RLCFilter.IqConv0Pu, Kfd = Kfd, Kfq = Kfq, Ki = Ki, Kic = Kic, Kid = Kid, Kiq = Kiq, Kp = Kp, Kpc = Kpc, Kpd = Kpd, Kpq = Kpq, Kqv = Kqv, LFilterPu = LFilterPu, LTransformerPu = LTransformerPu, Omega0Pu = SystemBase.omegaRef0Pu, OmegaMaxPu = OmegaMaxPu, OmegaMinPu = OmegaMinPu, PFilter0Pu = Measurements.PFilter0Pu, PQFlag = PQFlag, QFilter0Pu = Measurements.QFilter0Pu, RFilterPu = RFilterPu, RTransformerPu = RTransformerPu, Theta0 = Converter.Theta0, UFrt = UFrt, UPcc0Pu = Measurements.UPcc0Pu, UdConv0Pu = Converter.RLCFilter.UdConv0Pu, UdFilter0Pu = Converter.RLTransformer.UdFilter0Pu, UqConv0Pu = Converter.RLCFilter.UqConv0Pu, UqFilter0Pu = Converter.RLTransformer.UqFilter0Pu) annotation(
...
equation
  ...
  connect(Measurements.uqFilteredFilterPLLPu, Control.uqFilteredPLLPu) annotation(
    Line(points = {{6, -62}, {6, -68}, {-88, -68}, {-88, 42}, {-70, 42}}, color = {0, 0, 127}));
  connect(Measurements.UFilteredPccPu, Control.UFilteredPccPu) annotation(
    Line(points = {{28, -62}, {28, -96}, {-46, -96}, {-46, 18}}, color = {85, 170, 255}));
  connect(Measurements.uqFilteredFilterPu, Control.uqFilterPu) annotation(
    Line(points = {{-10, -38}, {-56, -38}, {-56, 18}}, color = {85, 170, 0}));
  connect(Measurements.udFilterPu, Converter.udFilterPu) annotation(
    Line(points = {{34, -54}, {74, -54}, {74, 18}}, color = {0, 0, 127}));
  connect(Measurements.uqFilterPu, Converter.uqFilterPu) annotation(
    Line(points = {{34, -58}, {78, -58}, {78, 18}}, color = {0, 0, 127}));
  connect(Measurements.uqPccPu, Converter.uqPccPu) annotation(
    Line(points = {{34, -46}, {68, -46}, {68, 18}}, color = {0, 0, 127}));
  annotation(
