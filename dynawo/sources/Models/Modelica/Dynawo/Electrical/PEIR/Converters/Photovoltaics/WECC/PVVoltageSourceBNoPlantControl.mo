...
model PVVoltageSourceBNoPlantControl "WECC PV model with a voltage source as interface with the grid (REEC-B REGC-B)"
...
/*                uSourcePu                                uInjPu                      uPu
    ...
    | Source |--------+---->>--------RSourcePu+jXSourcePu-----+------RPu+jXPu-----<<----+---- terminal
     --------           iSourcePu                                                 iPu
*/
  extends Dynawo.Electrical.PEIR.Converters.Photovoltaics.WECC.BaseClasses.BasePVVoltageSource;
...
end PVVoltageSourceBNoPlantControl;
