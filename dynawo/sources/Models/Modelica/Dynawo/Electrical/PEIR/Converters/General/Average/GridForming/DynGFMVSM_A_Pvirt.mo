...
model DynGFMVSM_A_Pvirt
"PEIR model with GFM VSM control and dynamic connections to the grid"
  /*
  ...
  */
  ...
  Modelica.Blocks.Sources.Constant omegaSet(k = OmegaSetPu) annotation(
    Placement(transformation(origin = {-200, 98}, extent = {{-6, -6}, {6, 6}})));
  ...
  Modelica.Blocks.Continuous.FirstOrder firstOrder(T = tPLL, y_start = omegaRes0Pu)  annotation(
    Placement(transformation(origin = {-148, 12}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
equation
  ...
  connect(Converter.UpccPu, pll.uPu) annotation(
    Line(points = {{88, 32}, {102, 32}, {102, -96}, {-148, -96}, {-148, -37}, {-150, -37}}, color = {85, 170, 255}));
  connect(omegaRefPu, pll.omegaRefPu) annotation(
    Line(points = {{-110, 48}, {-126, 48}, {-126, 8}, {-114, 8}, {-114, -37}, {-138, -37}}, color = {0, 0, 127}));
  connect(pll.omegaPLLPu, firstOrder.u) annotation(
    Line(points = {{-149, -15}, {-149, 0}, {-148, 0}}, color = {0, 0, 127}));
  connect(firstOrder.y, Control.omegaSetPu) annotation(
    Line(points = {{-148, 24}, {-148, 60}, {-70, 60}}, color = {0, 0, 127}));
  annotation(
