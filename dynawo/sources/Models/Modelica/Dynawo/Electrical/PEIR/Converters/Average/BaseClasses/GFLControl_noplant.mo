within Dynawo.Electrical.PEIR.Converters.Average.BaseClasses;

model GFLControl_noplant
...
// =============================================================================
 ...
 id_ref_0 = id_ref_0, id_meas_0 = id_conv_0, iq_ref_0 = iq_ref_0, iq_meas_0 = iq_conv_0, vd_0 = vd_0, vq_0 = vq_0, Omega0Pu = Omega0Pu, vmd_0 = vmd_0, vmq_0 = vmq_0,  voltagefeedforwardflag_d = voltagefeedforwardflag_d, voltagefeedforwardflag_q = voltagefeedforwardflag_q) annotation(
  ...
  Electrical.Controls.PEIR.BaseControls.Average.outer_loop_no_plant outer_loop_GFL(
    k_p_d           = k_p_d_outer,
    k_i_d           = k_i_d_outer,
    k_p_q           = k_p_q_outer,
    k_i_q           = k_i_q_outer,
    ...
    IqBoostMin      = IqBoostMin,
     ...
     PInjPu0 = PInj0Pu, QInjPu0 = QInj0Pu, U_filter0 = U_LV0, i_d_ref_0 = id_ref_0, i_q_ref_0 = iq_ref_0, DyMax_pi_d = DyMax_pi_d, DyMax_pi_q = DyMax_pi_q, DuMax_idref = DuMax_idref, DuMin_idref = DuMin_idref, tS_idref = tS_idref, T_boost = T_boost) annotation(
...
// ── External inputs ──────────────────────────────────────────
  ...
  Modelica.Blocks.Interfaces.RealInput U_ref (start=QInj0Pu) annotation(
...
// omegaPLL to plant controller (measured frequency for droop)
  ...
  connect(outer_loop_GFL.U_ref, U_ref) annotation(
 ...
 connect(U_ref, outer_loop_GFL.U_ref) annotation(
    Line(points = {{-270, 46}, {-238, 46}}, color = {0, 0, 127}));
  annotation(
