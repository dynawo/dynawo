...
model GFL "PEIR model with GFL control and dynamic connections to the grid"
  /*
...
equation
 ...
 connect(Control.QFilterRefPu, QFilterRefPu) annotation(
    Line(points = {{-68, 38}, {-80, 38}, {-80, 32}, {-110, 32}}, color = {85, 170, 0}, thickness = 0.5));
 ...
 connect(Measurements.QFilterPu, Control.QFilterPu) annotation(
    Line(points = {{-4, -36}, {-76, -36}, {-76, 24}, {-68, 24}}, color = {85, 170, 0}));
 ...
 connect(Control.theta, Converter.theta) annotation(
    Line(points = {{-56, 64}, {-56, 78}, {70, 78}, {70, 64}}, color = {0, 0, 127}));
