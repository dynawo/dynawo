...
model DynGFMDroop "PEIR model with GFM Droop control and dynamic connections to the grid"
  ...
  parameter Types.PerUnit Mp "Active power droop control coefficient" annotation(Dialog(tab = "Droop"));
  parameter Types.PerUnit WfDroop "Cutoff pulsation of the active filter (in rad/s)" annotation(Dialog(tab = "Droop"));
...
equation
  ...
  connect(Control.omegaSetPu, omegaSet.y) annotation(
    Line(points = {{-70, 52}, {-80, 52}, {-80, 66}, {-100, 66}}, color = {0, 0, 127}));
