...
model TP_GFL "PEIR model with GFL control and dynamic connections to the grid"
  /*
  ...
  parameter Types.PerUnit RFilterPu "Filter resistance in pu (base UNom, SNom)" annotation(
    Dialog(tab = "Filter"));
  parameter Types.PerUnit XFilterPu "Filter inductance in pu (base UNom, SNom)" annotation(
    Dialog(tab = "Filter"));
  parameter Types.PerUnit BFilterPu "Filter capacitance in pu (base UNom, SNom)" annotation(
    Dialog(tab = "Filter"));
  ...
  Electrical.Sources.PEIR.Converters.Average.Converter1 Converter(BFilterPu = BFilterPu, RFilterPu = RFilterPu, RTransformerPu = RTransformerPu, SNom = SNom, Theta0 = Theta0, XFilterPu = XFilterPu, XTransformerPu = XTransformerPu, i0Pu = i0Pu, u0Pu = u0Pu) annotation(
  ...
  Controls.PEIR.Converters.Average.TP_GridFollowingControl Control(IdConv0Pu = Converter.RLCFilter.IdConv0Pu, IqConv0Pu = Converter.RLCFilter.IqConv0Pu, Kfd = Kfd, Kfq = Kfq, Ki = Ki, Kic = Kic, Kid = Kid, Kiq = Kiq, Kp = Kp, Kpc = Kpc, Kpd = Kpd, Kpq = Kpq, Omega0Pu = SystemBase.omegaRef0Pu, OmegaMaxPu = OmegaMaxPu, OmegaMinPu = OmegaMinPu, PFilter0Pu = Measurements.PFilter0Pu, QFilter0Pu = Measurements.QFilter0Pu, RFilterPu = RFilterPu, RTransformerPu = RTransformerPu, Theta0 = Converter.Theta0, UdConv0Pu = Converter.RLCFilter.UdConv0Pu, UdFilter0Pu = Converter.RLTransformer.UdFilter0Pu, UqConv0Pu = Converter.RLCFilter.UqConv0Pu, UqFilter0Pu = Converter.RLTransformer.UqFilter0Pu, XFilterPu = XFilterPu, XTransformerPu = XTransformerPu, tPFilt = tPFilt, tQFilt = tQFilt) annotation(
    Placement(transformation(origin = {-52, 42}, extent = {{-20, -20}, {20, 20}})));
equation
  ...
  connect(Converter.idPccPu, Measurements.idPccPu) annotation(
    Line(points = {{52, 20}, {52, -16}, {40, -16}}, color = {85, 170, 255}));
  ...
  connect(Measurements.udPccPu, Converter.udPccPu) annotation(
    Line(points = {{40, -30}, {63, -30}, {63, 20}}, color = {85, 170, 255}));
  ...
  connect(Measurements.uqFilterPu, Converter.uqFilterPu) annotation(
    Line(points = {{40, -46}, {78, -46}, {78, 20}}, color = {85, 170, 0}, pattern = LinePattern.Dash));
  connect(Control.udConvRefPu, Converter.udConvRefPu) annotation(
    Line(points = {{-30, 50}, {48, 50}}, color = {245, 121, 0}, thickness = 0.5));
  connect(Control.uqConvRefPu, Converter.uqConvRefPu) annotation(
    Line(points = {{-30, 34}, {48, 34}}, color = {245, 121, 0}, thickness = 0.5));
  connect(Control.theta, Converter.theta) annotation(
    Line(points = {{-62, 64}, {-62, 80}, {70, 80}, {70, 64}}, color = {0, 0, 127}));
  connect(PFilterRefPu, Control.PFilterRefPu) annotation(
    Line(points = {{-110, 64}, {-82, 64}, {-82, 58}, {-74, 58}}, color = {85, 170, 0}, thickness = 0.5));
  connect(omegaRefPu, Control.omegaRefPu) annotation(
    Line(points = {{-110, 48}, {-74, 48}}, color = {0, 0, 127}, thickness = 0.5));
  connect(QFilterRefPu, Control.QFilterRefPu) annotation(
    Line(points = {{-110, 32}, {-86, 32}, {-86, 38}, {-74, 38}}, color = {85, 170, 0}, thickness = 0.5));
  connect(Control.PFilterPu, Measurements.PFilterPu) annotation(
    Line(points = {{-74, 28}, {-84, 28}, {-84, -44}, {-4, -44}}, color = {85, 170, 0}));
  connect(Measurements.QFilterPu, Control.QFilterPu) annotation(
    Line(points = {{-4, -36}, {-80, -36}, {-80, 24}, {-74, 24}}, color = {85, 170, 0}));
  connect(Converter.idConvPu, Control.idConvPu) annotation(
    Line(points = {{84, 20}, {84, -80}, {-64, -80}, {-64, 20}}, color = {245, 121, 0}));
  connect(Control.iqConvPu, Converter.iqConvPu) annotation(
    Line(points = {{-68, 20}, {-70, 20}, {-70, -88}, {88, -88}, {88, 20}}, color = {245, 121, 0}));
  connect(Control.uqFilterPu, Converter.uqFilterPu) annotation(
    Line(points = {{-60, 20}, {-58, 20}, {-58, -74}, {78, -74}, {78, 20}}, color = {85, 170, 0}));
  connect(Control.udFilterPu, Converter.udFilterPu) annotation(
    Line(points = {{-56, 20}, {-54, 20}, {-54, -66}, {74, -66}, {74, 20}}, color = {85, 170, 0}));
protected
  annotation(
  ...
  Icon(graphics = {Rectangle(fillColor = {246, 245, 244}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {1, 6}, extent = {{-73, 44}, {73, -44}}, textString = "GFL")}));
end TP_GFL;
