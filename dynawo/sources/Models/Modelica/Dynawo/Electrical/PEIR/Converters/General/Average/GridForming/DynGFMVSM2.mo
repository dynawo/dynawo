...
model DynGFMVSM2 "PEIR model with GFM VSM control and dynamic connections to the grid"
  ...
  Sources.PEIR.Converters.Average.DynConverter2 Converter(SNom = SNom, tVSC = tVSC, RFilterPu = RFilterPu, LFilterPu = LFilterPu, CFilterPu = CFilterPu, RTransformerPu = RTransformerPu, LTransformerPu = LTransformerPu, i0Pu = i0Pu, u0Pu = u0Pu, Theta0 = Theta0, Omega0Pu = SystemBase.omegaRef0Pu)  annotation(
