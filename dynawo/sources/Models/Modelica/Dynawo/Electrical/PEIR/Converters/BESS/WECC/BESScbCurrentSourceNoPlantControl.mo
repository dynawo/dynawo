within Dynawo.Electrical.PEIR.Converters.BESS.WECC;
...
model BESScbCurrentSourceNoPlantControl "WECC BESS with electrical control model type C and generator/converter model type B (without plant control)"
  extends Dynawo.Electrical.PEIR.Converters.BESS.WECC.BaseClasses.BaseBESScbCurrentSource;
...
end BESScbCurrentSourceNoPlantControl;
