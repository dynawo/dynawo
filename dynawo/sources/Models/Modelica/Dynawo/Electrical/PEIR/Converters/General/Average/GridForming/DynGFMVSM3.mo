...
model DynGFMVSM3 "PEIR model with GFM VSM control and dynamic connections to the grid"
  /*
  ...
  //Blocks
  Electrical.Controls.PEIR.Converters.Average.DynGridFormingControlVSM Control(H = H, IMaxVI = IMaxVI, IdConv0Pu = Converter.transformRItoDQConv.IdConv0Pu, IdPcc0Pu = Converter.transformRItoDQIPcc.IdConv0Pu, IqConv0Pu = Converter.transformRItoDQConv.IqConv0Pu, IqPcc0Pu = Converter.transformRItoDQIPcc.IqConv0Pu, Kfd = Kfd, Kff = Kff, Kfq = Kfq, Kic = Kic, KpVI = KpVI, Kpc = Kpc, LFilterPu = LFilterPu, LTransformerPu = LTransformerPu, Mq = Mq, Omega0Pu = SystemBase.omegaRef0Pu, PFilter0Pu = Measurements.PFilter0Pu, QFilter0Pu = Measurements.QFilter0Pu, RFilterPu = RFilterPu, RTransformerPu = RTransformerPu, Theta0 = Converter.Theta0, UdConv0Pu = Converter.transformRItoDQConv.UdFilter0Pu, UdFilter0Pu = Converter.transformRItoDQFilter.UdFilter0Pu, UdPcc0Pu = Converter.transformRItoDQUPcc.UdFilter0Pu, UqConv0Pu = Converter.transformRItoDQConv.UqFilter0Pu, UqFilter0Pu = Converter.transformRItoDQFilter.UqFilter0Pu, UqPcc0Pu = Converter.transformRItoDQUPcc.UqFilter0Pu, Wf = Wf, Wff = Wff, XRratio = XRratio, XVI = XVI, kVSM = kVSM) annotation(
  ...
  Sources.PEIR.Converters.Average.DynConverter3 Converter(SNom = SNom, tVSC = tVSC, RFilterPu = RFilterPu, LFilterPu = LFilterPu, CFilterPu = CFilterPu, RTransformerPu = RTransformerPu, LTransformerPu = LTransformerPu, i0Pu = i0Pu, u0Pu = u0Pu, Theta0 = Theta0, Omega0Pu = SystemBase.omegaRef0Pu)  annotation(
...
equation
  ...
  connect(Control.omegaPu, Converter.omegaPu) annotation(
    Line(points = {{-36, 64}, {-36, 72}, {48, 72}, {48, 64}}, color = {0, 0, 127}));
  annotation(
