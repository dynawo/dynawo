...
model PlantControllerPI
  ...
  parameter Types.ReactivePower QMaxReg "Maximum reactive powerat regulated bus in Mvar";
  ...
  Modelica.Blocks.Math.Gain basePInj(k = 1) annotation(
    Placement(transformation(origin = {130, -40}, extent = {{-10, -10}, {10, 10}})));
  // Initial parameters
...
equation
  ...
  connect(limiter.y, basePInj.u) annotation(
    Line(points = {{102, -40}, {118, -40}}, color = {0, 0, 127}));
  connect(basePInj.y, PInjPu) annotation(
