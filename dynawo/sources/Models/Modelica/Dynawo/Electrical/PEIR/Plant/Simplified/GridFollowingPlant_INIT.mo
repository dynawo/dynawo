...
model GridFollowingPlant_INIT
  ...
  parameter Types.ReactivePowerPu QReg0Pu "Start value of active power at regulated bus in pu (base SnRef) (receptor convention)";
  ...
  Types.ComplexPerUnit uInj0Pu "Start value of complex voltage at injector terminal in pu (base UNom)";
