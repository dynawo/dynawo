within Dynawo.Electrical.PEIR.Plants.Simplified.BaseControls;
...
model PlantControllerPropInt "Simplified plant model with PI controller"
  ...
  final parameter Types.PerUnit AlphaPu = AlphaPuPNom*PNom/SNom "Frequency sensitivity in pu (base SNom, OmegaNom)";
