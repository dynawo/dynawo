...
model MeasurementBlock_emtp
  ...
  //parameter Real T_filter_v "Measurement low-pass filter time constant (s)";
  //parameter Real T_filter_pll "Measurement low-pass filter time constant (s)";
  ...
  parameter Real U_pcc_q_0 "Initial q-axis PCC voltage in PLL frame (pu)";
   parameter Real U_filter_d_0 "Initial d-axis filter voltage in PLL frame (pu)";
  ...
  Modelica.Blocks.Interfaces.RealInput V_pcc_re(start = UrPcc0Pu) "Real part of PCC voltage in αβ frame (pu)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput V_pcc_im(start = UiPcc0Pu) "Imaginary part of PCC voltage in αβ frame (pu)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput I_pcc_re(start = IrPcc0Pu) "Real part of PCC current in αβ frame (pu, generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput I_pcc_im(start = IiPcc0Pu) "Imaginary part of PCC current in αβ frame (pu, generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput theta_pll(start = Theta0) "PLL angle θ_PLL used for αβ → dq frame transformation (rad)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput u_LV_re(start = u_LV_re_0) "Real part of internal LV node voltage in αβ frame (pu)" annotation(
    Placement(transformation(origin = {-109, -9}, extent = {{-9, -9}, {9, 9}}), iconTransformation(origin = {32, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Blocks.Interfaces.RealInput u_LV_im(start = u_LV_im_0) "Imaginary part of internal LV node voltage in αβ frame (pu)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput I_conv_re(start = I_conv_re_0) "Real part of converter output current in αβ frame (pu)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput I_conv_im(start = I_conv_im_0) "Imaginary part of converter output current in αβ frame (pu)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput U_filter_q(start = U_pcc_q_0) "q-axis PCC voltage in PLL dq frame; ≈ 0 at PLL lock (pu)" annotation(
    Placement(transformation(origin = {110, -112}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {82, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      ...
      Modelica.Blocks.Interfaces.RealOutput U_filter_d(start = U_filter_d_0) "q-axis PCC voltage in PLL dq frame; ≈ 0 at PLL lock (pu)" annotation(
    Placement(transformation(origin = {24, -100}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {112, -100}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput I_conv_q(start = I_conv_q_0) "q-axis converter output current (pu)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput V_LV_d(start = V_LV_d_0) "d-axis voltage at internal LV node (pu)" annotation(
    Placement(transformation(origin = {110, 0}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {110, -30}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Interfaces.RealOutput V_LV_q(start = V_LV_q_0) "q-axis voltage at internal LV node (pu)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput P_plant(start = P0_pcc) "Filtered active power at PCC, generator convention (pu)" annotation(
    Placement(transformation(origin = {109, 83}, extent = {{-9, -9}, {9, 9}}), iconTransformation(origin = {-10, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Blocks.Interfaces.RealOutput Q_plant(start = Q0_pcc) "Filtered reactive power at PCC, generator convention (pu)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput P_LV(start = P0_LV) "Filtered active power at internal LV node, generator convention (pu)" annotation(
    Placement(transformation(origin = {110, -34}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {110, 80}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Interfaces.RealOutput Q_LV(start = Q0_LV) "Filtered reactive power at internal LV node, generator convention (pu)" annotation(
  ...
  Modelica.Blocks.Sources.RealExpression abs_value(y = sqrt(V_pcc_re^2 + V_pcc_im^2)) "Instantaneous PCC voltage magnitude (pu)" annotation(
  ...
  Modelica.Blocks.Sources.RealExpression P_LV_expre(y = transformRItoDQ2.ud*transformRItoDQ1.ud + transformRItoDQ2.uq*transformRItoDQ1.uq) "Instantaneous active power at LV node in dq frame (pu)" annotation(
    Placement(transformation(origin = {40, -34}, extent = {{-10, -10}, {10, 10}})));
  // Reactive power at LV node: Q_LV = V_LV_q · Id_pcc − V_LV_d · Iq_pcc
  Modelica.Blocks.Sources.RealExpression Q_LV_expr(y = transformRItoDQ2.uq*transformRItoDQ1.ud - transformRItoDQ2.ud*transformRItoDQ1.uq) "Instantaneous reactive power at LV node in dq frame (pu)" annotation(
  ...
  Modelica.Blocks.Sources.RealExpression P_from_RI(y = V_pcc_re*I_pcc_re + V_pcc_im*I_pcc_im) "Active power computed directly in αβ frame (pu) – diagnostic / cross-check";
  // ──────────────────────────────────────────────────────────────────────────
  ...
  Dynawo.NonElectrical.Blocks.Continuous.RateLimFirstOrderFreeze rateLimFirstOrderFreeze(k = k_filter, T = T_filter, Y0 = U0_pcc) "Low-pass filter for PCC voltage magnitude" annotation(
    Placement(transformation(origin = {70, 20}, extent = {{-10, -10}, {10, 10}})));
  // Filter for plant-level active power at PCC → P_plant
  Dynawo.NonElectrical.Blocks.Continuous.RateLimFirstOrderFreeze rateLimFirstOrderFreeze1(k = k_filter, T = T_filter, Y0 = P0_pcc) "Low-pass filter for active power at PCC" annotation(
    Placement(transformation(origin = {70, 82}, extent = {{-10, -10}, {10, 10}})));
  // Filter for plant-level reactive power at PCC → Q_plant
  Dynawo.NonElectrical.Blocks.Continuous.RateLimFirstOrderFreeze rateLimFirstOrderFreeze2(k = k_filter, T = T_filter, Y0 = Q0_pcc) "Low-pass filter for reactive power at PCC" annotation(
    Placement(transformation(origin = {70, 50}, extent = {{-10, -10}, {10, 10}})));
  // Filter for active power at LV node → P_LV
  Dynawo.NonElectrical.Blocks.Continuous.RateLimFirstOrderFreeze rateLimFirstOrderFreeze3(k = k_filter, T = T_filter, Y0 = P0_LV) "Low-pass filter for active power at internal LV node" annotation(
    Placement(transformation(origin = {70, -34}, extent = {{-10, -10}, {10, 10}})));
  // Filter for reactive power at LV node → Q_LV
  Dynawo.NonElectrical.Blocks.Continuous.RateLimFirstOrderFreeze rateLimFirstOrderFreeze4(k = k_filter, T = T_filter, Y0 = Q0_LV) "Low-pass filter for reactive power at internal LV node" annotation(
    Placement(transformation(origin = {70, -84}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Interfaces.RealInput v_filt_re annotation(
    Placement(transformation(origin = {-110, -100}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-110, -68}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Interfaces.RealInput v_filt_im annotation(
...
// real part of PCC voltage phasor
  V_pcc_im = transformRItoDQ.u.im;
// imaginary part of PCC voltage phasor
  I_pcc_re = transformRItoDQ1.u.re;
// real part of PCC current phasor
  I_pcc_im = transformRItoDQ1.u.im;
// imaginary part of PCC current phasor
  u_LV_re = transformRItoDQ2.u.re;
// real part of LV node voltage phasor
  u_LV_im = transformRItoDQ2.u.im;
// imaginary part of LV node voltage phasor
  I_conv_re = transformRItoDQ3.u.re;
// real part of converter current phasor
  I_conv_im = transformRItoDQ3.u.im;
// imaginary part of converter current phasor
  v_filt_re = transformRItoDQ4.u.re;
  v_filt_im = transformRItoDQ4.u.im;
// ──────────────────────────────────────────────────────────────────────────
...
// Reactive power at LV node: expression → filter → output
  ...
  connect(transformRItoDQ3.uq, I_conv_q) annotation(
    Line(points = {{-10, -68}, {110, -68}}, color = {0, 0, 127}));
  connect(transformRItoDQ3.ud, I_conv_d) annotation(
    Line(points = {{-10, -54}, {110, -54}}, color = {0, 0, 127}));
  connect(transformRItoDQ2.uq, V_LV_q) annotation(
    Line(points = {{-6, -14}, {110, -14}}, color = {0, 0, 127}));
  connect(transformRItoDQ2.ud, V_LV_d) annotation(
    Line(points = {{-6, 0}, {110, 0}}, color = {0, 0, 127}));
  connect(U_filter_d, transformRItoDQ4.ud) annotation(
    Line(points = {{24, -100}, {-10, -100}}, color = {0, 0, 127}));
  annotation(
