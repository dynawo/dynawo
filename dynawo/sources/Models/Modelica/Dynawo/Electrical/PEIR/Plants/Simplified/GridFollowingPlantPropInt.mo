...
model GridFollowingPlantPropInt "Simplified grid following model with plant control"
  ...
  parameter Boolean VRegFlag "If true U + lambda Q regulation, if false Q is constant";
  ...
  Dynawo.Electrical.PEIR.Plants.Simplified.BaseControls.PlantControllerPropInt plantControllerPropInt(DbdPu = DbdPu, EMaxPu = EMaxPu, EMinPu = EMinPu, Ki = Ki, Kp = Kp, PMin = PMin, PMax = PMax, PNom = PNom, AlphaPuPNom = AlphaPuPNom, LambdaPuSNom = LambdaPuSNom, QMaxRegPu = QMaxRegPu, QMinRegPu = QMinRegPu, SNom = SNom, UReg0Pu = UReg0Pu, QMaxPu = QMaxPu, QMinPu = QMinPu, PInj0Pu = -P0Pu*SystemBase.SnRef/SNom, QInj0Pu = -Q0Pu*SystemBase.SnRef/SNom, QReg0Pu = QReg0Pu, VRegFlag = VRegFlag) annotation(
  ...
  Dynawo.Electrical.PEIR.Plants.Simplified.BaseControls.InjectorInterface injector(SNom = SNom, i0Pu = i0Pu, U0Pu = U0Pu, u0Pu = u0Pu, PInj0Pu = -P0Pu*SystemBase.SnRef/SNom, QInj0Pu = -Q0Pu*SystemBase.SnRef/SNom) annotation(
