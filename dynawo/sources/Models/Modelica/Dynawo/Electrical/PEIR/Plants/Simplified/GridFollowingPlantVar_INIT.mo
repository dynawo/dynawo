...
model GridFollowingPlantVar_INIT "Grid following plant external variable initilization model"
  extends AdditionalIcons.Init;

  // Initial variables coming from load flow
