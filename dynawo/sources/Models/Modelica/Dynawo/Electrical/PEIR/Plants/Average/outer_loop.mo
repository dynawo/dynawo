...
model outer_loop
  ...
  Modelica.Blocks.Interfaces.RealInput P_ref  (start=PInjPu0) annotation(
    Placement(transformation(origin = {-90, 82}, extent = {{-20, -20}, {20, 20}}), iconTransformation(origin = {-226, 92}, extent = {{-14, -14}, {14, 14}})));
  Modelica.Blocks.Interfaces.RealInput P_meas  (start=PInjPu0) annotation(
    Placement(transformation(origin = {-90, 50}, extent = {{-20, -20}, {20, 20}}), iconTransformation(origin = {-226, 160}, extent = {{-14, -14}, {14, 14}})));
  Modelica.Blocks.Interfaces.RealInput Q_ref (start=QInjPu0) annotation(
    Placement(transformation(origin = {-90, 18}, extent = {{-20, -20}, {20, 20}}), iconTransformation(origin = {-223, 15}, extent = {{-15, -15}, {15, 15}})));
  Modelica.Blocks.Interfaces.RealInput Q_meas (start=QInjPu0) annotation(
    Placement(transformation(origin = {-88, -12}, extent = {{-20, -20}, {20, 20}}), iconTransformation(origin = {-225, -65}, extent = {{-15, -15}, {15, 15}})));
  Modelica.Blocks.Interfaces.RealInput V_ref (start=U_filter0-k_q*QInjPu0) annotation(
    Placement(transformation(origin = {-88, -44}, extent = {{-20, -20}, {20, 20}}), iconTransformation(origin = {34, 214}, extent = {{-14, -14}, {14, 14}}, rotation = -90)));
  Modelica.Blocks.Interfaces.RealInput V_meas (start=U_filter0) annotation(
    Placement(transformation(origin = {-86, -76}, extent = {{-20, -20}, {20, 20}}), iconTransformation(origin = {-93, 219}, extent = {{-13, -13}, {13, 13}}, rotation = -90)));
  ...
  Modelica.Blocks.Nonlinear.SlewRateLimiter PrefRamp(Rising = dPrefMaxPu, Falling = -dPrefMaxPu, y(start = PInjPu0)) annotation(
    Placement(transformation(origin = {-60, 82}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Nonlinear.SlewRateLimiter QrefRamp(Rising = dQrefMaxPu, Falling = -dQrefMaxPu, y(start = QInjPu0)) annotation(
  ...
  // ── PI controllers ───────────────────────────────────────────
  Dynawo.Electrical.Controls.PEIR.BaseControls.Average.pi_controller pi_controller_d(k_i = k_i_d, k_p = k_p_d, y_start = y_start_outer_d) annotation(
    Placement(transformation(origin = {0, 66}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Math.Add qvdroop(k1 = k_q, k2 = 0) annotation(
    Placement(transformation(origin = {4, -16}, extent = {{-10, -10}, {10, 10}})));
  Dynawo.Electrical.Controls.PEIR.BaseControls.Average.pi_controller pi_controller_q(k_p = k_p_q, k_i = k_i_q, y_start = y_start_outer_q) annotation(
    Placement(transformation(origin = {52, -16}, extent = {{-10, -10}, {10, 10}})));
  // ── Current limiter ──────────────────────────────────────────
  Dynawo.Electrical.Controls.PEIR.BaseControls.Average.current_limiter_reactive_boost current_limiter_outer_loop(Imax = Imax, PQFlag = PQFlag, UboostStart = UboostStart, Kqv = Kqv, IqBoostMax = IqBoostMax, IqBoostMin = IqBoostMin) annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput i_d_ref (start=i_d_ref_0) annotation(
    Placement(transformation(origin = {122, 50}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {225, 59}, extent = {{-15, -15}, {15, 15}})));
  Modelica.Blocks.Interfaces.RealOutput i_q_ref (start=i_q_ref_0) annotation(
    Placement(transformation(origin = {122, 30}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {225, -23}, extent = {{-15, -15}, {15, 15}})));
  // ── Parameters ───────────────────────────────────────────────
  ...
  parameter Real dPrefMaxPu "Max rate of change of P reference (pu/s)";
  parameter Real dQrefMaxPu  "Max rate of change of Q reference (pu/s)";
...
// ── Qref path: rate limiter → sum node → qvdroop → PI ────────
  ...
  connect(sum_node_q.y, qvdroop.u1) annotation(
    Line(points = {{-20, 18}, {-10, 18}, {-10, -10}, {-8, -10}}, color = {0, 0, 127}));
// ── V path: unchanged ────────────────────────────────────────
  ...
  connect(sum_node_v.y, qvdroop.u2) annotation(
    Line(points = {{-36, -44}, {-16, -44}, {-16, -22}, {-8, -22}}, color = {0, 0, 127}));
// ── Q PI ─────────────────────────────────────────────────────
  connect(qvdroop.y, pi_controller_q.e) annotation(
    Line(points = {{15, -16}, {41, -16}}, color = {0, 0, 127}));
// ── Current limiter ──────────────────────────────────────────
