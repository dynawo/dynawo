...
model DERa "Aggregated model of inverter-based generation (IBG) as defined by EPRI under the name der_a"
  ...
  Dynawo.Electrical.Controls.PEIR.Protections.DER.LVRTDERa lvrt(RecoveringShare = RecoveringShare, Ul0Pu = Ul0Pu, Ul1Pu = Ul1Pu, tvl0 = tvl0, tvl1 = tvl1) annotation(
    Placement(visible = true, transformation(origin = {-410, -140}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Dynawo.Electrical.Controls.PEIR.Protections.DER.OVRTDERa ovrt(RecoveringShare = RecoveringShare, Uh0Pu = Uh0Pu, Uh1Pu = Uh1Pu, tvh0 = tvh0, tvh1 = tvh1) annotation(
