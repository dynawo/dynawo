...
equation
  ...
  connect(add_q.y, vm_q) annotation(
    Line(points = {{27, -60}, {210, -60}}, color = {0, 0, 127}));
  ...
  connect(product.y, add_q.u1) annotation(
    Line(points = {{-6, -32}, {4, -32}, {4, -52}}, color = {0, 0, 127}));
