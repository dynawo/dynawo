...
model simulation_weak_grid
  ...
  CfPu = 1e-9,  // 1 % filter susceptance  →  fr ≈ 712 Hz
  ...
  UboostHigh = 1.1, UboostLow = 0.9, Kqv = 0.3, Imax = 8, PQFlag = false, IqBoostMax = 0.5, IqBoostMin = -0.5,  // ── Plant controller — ω_c = 2 rad/s ─────────────────────
  K_p_q_plant = 0.1, K_i_q_plant = 1.0, K_p_p_plant = 0.8, K_i_p_plant = 5.0, Lambda = 0.286, Kdroop = 20, QMaxPu = 0.5, QMinPu = -0.5, PMaxPu = 23, PMinPu = 0, FEMaxPu = 999, FEMinPu = -999, FDbd1Pu = 0.005, FDbd2Pu = 0.1, DbdPu = 0.0001,  // ── PLL — ω_c = 20 rad/s (weak-grid tuning) ──────────────
