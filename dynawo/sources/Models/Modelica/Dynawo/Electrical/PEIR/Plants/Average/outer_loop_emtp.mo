...
model outer_loop_emtp
  ...
  Modelica.Blocks.Interfaces.RealInput v_d (start=U_filter_d_0) annotation(
    Placement(transformation(origin = {-294, 46}, extent = {{-20, -20}, {20, 20}}), iconTransformation(origin = {-214, 0}, extent = {{-14, -14}, {14, 14}})));
equation
// ── P path ───────────────────────────────────────────────────
...
// ── Current limiter → i_q_ref ────────────────────────────────
  ...
  connect(division1.u2, v_d) annotation(
    Line(points = {{-78, 36}, {-294, 36}, {-294, 46}}, color = {255, 120, 0}, thickness = 0.75));
  connect(division.u2, v_d) annotation(
    Line(points = {{-62, -42}, {-294, -42}, {-294, 46}}, color = {255, 120, 0}, thickness = 0.75));
  annotation(
