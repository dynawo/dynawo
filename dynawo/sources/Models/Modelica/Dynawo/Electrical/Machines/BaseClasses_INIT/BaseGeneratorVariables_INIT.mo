...
partial model BaseGeneratorVariables_INIT "Base initialization model for simplified generator models"
  ...
  flow Dynawo.Connectors.ComplexCurrentPuOutput i0Pu(re(start = iStart0Pu.re)) "Start value of complex current at terminal in pu (base UNom, SnRef) (receptor convention)";
