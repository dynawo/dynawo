...
model MotorFifthOrder "Two-cage (or one-cage if Lpp = Lp) induction motor model, based on https://www.powerworld.com/WebHelp/Content/TransientModels_HTML/Load%20Characteristic%20MOTORW.htm, must be incorporated in a load model."
  ...
  Types.Time tTripThresholdReached1(start = Constants.inf) "Time when the trip threshold 1 was reached";
  Types.Time tTripThresholdReached2(start = Constants.inf) "Time when the trip threshold 2 was reached";
  Types.Time tReconnectThresholdReached1(start = Constants.inf) "Time when the reconnect threshold 1 was reached";
  Types.Time tReconnectThresholdReached2(start = Constants.inf) "Time when the reconnect threshold 2 was reached";
