...
partial model BaseGeneratorSimplified "Base model for simplified generator models"
  ...
  Dynawo.Connectors.ReactivePowerPuOutput QGenPu(start = QGen0Pu) "Reactive power at terminal in pu (base SnRef) (generator convention)";
  ...
  Dynawo.Connectors.VoltageModulePuOutput UPu(start = U0Pu) "Voltage amplitude at terminal in pu (base UNom)";
