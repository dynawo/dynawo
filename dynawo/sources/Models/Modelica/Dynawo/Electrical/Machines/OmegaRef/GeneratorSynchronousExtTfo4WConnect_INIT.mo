...
model GeneratorSynchronousExtTfo4WConnect_INIT "Synchronous machine with 4 windings - Initialization model from external parameters"
  extends Dynawo.Electrical.Machines.BaseClasses_INIT.BaseGeneratorVariablesConnect_INIT;
...
end GeneratorSynchronousExtTfo4WConnect_INIT;
