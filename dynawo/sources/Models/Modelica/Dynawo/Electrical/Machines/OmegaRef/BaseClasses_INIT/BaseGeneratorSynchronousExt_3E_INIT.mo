...
partial model BaseGeneratorSynchronousExt_3E_INIT "Base initialization model for synchronous machine from external parameters with three windings"
...
end BaseGeneratorSynchronousExt_3E_INIT;
