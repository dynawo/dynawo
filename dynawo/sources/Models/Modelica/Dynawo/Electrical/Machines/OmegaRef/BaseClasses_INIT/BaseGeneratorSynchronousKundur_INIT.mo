...
partial model BaseGeneratorSynchronousKundur_INIT "Base initialization model for synchronous machine"
  extends BaseClasses.GeneratorSynchronousParametersKundur6thOrder;
...
end BaseGeneratorSynchronousKundur_INIT;
