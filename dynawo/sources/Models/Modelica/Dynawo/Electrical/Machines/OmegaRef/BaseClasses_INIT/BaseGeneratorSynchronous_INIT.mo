...
partial model BaseGeneratorSynchronous_INIT "Base initialization model for synchronous machine"
  ...
  Modelica.Blocks.Interfaces.RealInput PGen0Pu "Start value of active power at terminal in pu (base SnRef) (generator convention)";
  ...
  Modelica.Blocks.Interfaces.RealInput Efd0Pu "Start value of input exciter voltage in pu (user-selected base)";
  ...
  Modelica.Blocks.Interfaces.RealInput UStator0Pu "Start value of stator voltage amplitude in pu (base UNom)";
  ...
  Modelica.Blocks.Interfaces.RealInput IRotor0Pu "Start value of rotor current in pu (base SNom, user-selected base voltage)";
