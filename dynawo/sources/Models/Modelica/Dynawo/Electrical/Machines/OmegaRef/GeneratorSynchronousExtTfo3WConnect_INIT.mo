...
model GeneratorSynchronousExtTfo3WConnect_INIT "Synchronous machine with 3 windings - Initialization model from external parameters"
...
end GeneratorSynchronousExtTfo3WConnect_INIT;
