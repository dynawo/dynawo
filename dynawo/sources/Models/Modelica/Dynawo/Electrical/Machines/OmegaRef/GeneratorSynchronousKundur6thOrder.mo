...
model GeneratorSynchronousKundur6thOrder "6th order synchronous machine based on the Kundur book"
  extends BaseClasses.BaseGeneratorSynchronousKundur6thOrder;
...
end GeneratorSynchronousKundur6thOrder;
