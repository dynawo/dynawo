...
partial model BaseGeneratorSynchronous "Synchronous machine - Base dynamic model"
  ...
  Modelica.Blocks.Interfaces.RealInput efdPu(start = Efd0Pu) "Input voltage of exciter winding in pu (user-selected base voltage)";

  // Output variables
  Modelica.Blocks.Interfaces.RealOutput omegaPu(start = SystemBase.omega0Pu) "Angular frequency in pu";
