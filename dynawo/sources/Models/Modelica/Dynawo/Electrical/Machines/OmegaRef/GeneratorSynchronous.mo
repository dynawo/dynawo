...
model GeneratorSynchronous "Synchronous machine"
  ...
  */
  ...
  Modelica.Blocks.Interfaces.RealOutput PGenPu(start = PGen0Pu) "Active power generated by the synchronous machine in pu (base SnRef)";
  Modelica.Blocks.Interfaces.RealOutput QGenPu(start = QGen0Pu) "Reactive power generated by the synchronous machine in pu (base SnRef)";
  ...
  Modelica.ComplexBlocks.Interfaces.ComplexOutput uPu(re(start = u0Pu.re), im(start = u0Pu.im)) "Complex voltage at terminal in pu (base UNom)";
  Modelica.ComplexBlocks.Interfaces.ComplexOutput iStatorPu(re(start = iStator0Pu.re), im(start = iStator0Pu.im)) "Complex current at stator side in pu (base UNom, SnRef)";
