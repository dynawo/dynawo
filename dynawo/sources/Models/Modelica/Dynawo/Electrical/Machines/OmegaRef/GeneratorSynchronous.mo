...
model GeneratorSynchronous "Synchronous machine"
  ...
  */
  ...
  Dynawo.Connectors.ActivePowerPuOutput PGenPu(start = PGen0Pu) "Active power generated by the synchronous machine in pu (base SnRef)";
  Dynawo.Connectors.ReactivePowerPuOutput QGenPu(start = QGen0Pu) "Reactive power generated by the synchronous machine in pu (base SnRef)";
  ...
  Dynawo.Connectors.VoltageModulePuOutput UStatorPu(start = UStator0Pu) "Stator voltage amplitude in pu (base UNom)";
  Dynawo.Connectors.CurrentModulePuOutput IStatorPu(start = IStator0Pu) "Stator current amplitude in pu (base UNom, SnRef)";
  Dynawo.Connectors.ReactivePowerPuOutput QStatorPu(start = QStator0Pu) "Stator reactive power generated in pu (base SnRef)";
  Dynawo.Connectors.ReactivePowerPuOutput QStatorPuQNom(start = QStator0PuQNom) "Stator reactive power generated in pu (base QNomAlt)";
  Dynawo.Connectors.CurrentModulePuOutput IRotorPu(start = IRotor0Pu) "Rotor current in pu (base SNom, user-selected base voltage)";
  ...
  Dynawo.Connectors.ComplexVoltagePuOutput uPu(re(start = u0Pu.re), im(start = u0Pu.im)) "Complex voltage at terminal in pu (base UNom)";
  Dynawo.Connectors.ComplexCurrentPuOutput iStatorPu(re(start = iStator0Pu.re), im(start = iStator0Pu.im)) "Complex current at stator side in pu (base UNom, SnRef)";
