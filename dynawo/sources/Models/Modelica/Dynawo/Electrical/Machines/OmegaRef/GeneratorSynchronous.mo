...
model GeneratorSynchronous "Synchronous machine"
  ...
  */
  ...
  Dynawo.Connectors.ActivePowerPuConnector PGenPu(start = PGen0Pu) "Active power generated by the synchronous machine in pu (base SnRef)";
  Dynawo.Connectors.ReactivePowerPuConnector QGenPu(start = QGen0Pu) "Reactive power generated by the synchronous machine in pu (base SnRef)";
