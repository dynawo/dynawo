...
model GeneratorPVRemoteDiagramPQ_INIT "Initialisation model for generator PV based on SignalN for the frequency handling and with a diagram for handling the reactive power limits"
...
equation
  ...
  elseif (QGen0Pu > QMin0Pu or URegulated0 < URef0) and (QGen0Pu < QMax0Pu or URegulated0 > URef0) then
