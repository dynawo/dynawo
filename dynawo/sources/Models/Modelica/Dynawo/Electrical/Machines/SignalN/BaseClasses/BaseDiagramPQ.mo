...
partial model BaseDiagramPQ "Base dynamic model for a PQ diagram"
  ...
  Modelica.Blocks.Tables.CombiTable1Dv tableQMax(tableOnFile = true, tableName = QMaxTableName, fileName = QMaxTableFile) "Table to get QMaxPu from PGenPu";
  Modelica.Blocks.Tables.CombiTable1Dv tableQMin(tableOnFile = true, tableName = QMinTableName, fileName = QMinTableFile) "Table to get QMinPu from PGenPu";
