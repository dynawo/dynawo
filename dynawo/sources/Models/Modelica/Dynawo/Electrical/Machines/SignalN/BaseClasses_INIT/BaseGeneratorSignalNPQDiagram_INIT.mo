...
partial model BaseGeneratorSignalNPQDiagram_INIT "Base initialization model for SignalN generator models with PQ diagram"
  ...
  Types.ReactivePowerPu QGen0Pu "Start value of reactive power at terminal in pu (base SnRef) with limits (generator convention)";
  Types.VoltageModulePu U0PuVar "Start value of voltage amplitude at terminal in pu (base UNom)";
