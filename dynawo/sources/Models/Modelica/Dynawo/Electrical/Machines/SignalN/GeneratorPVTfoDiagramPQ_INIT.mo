...
model GeneratorPVTfoDiagramPQ_INIT "Initialisation model for generator PV based on SignalN for the frequency handling, with a transformer, a voltage regulation at stator and with an N points PQ diagram. The voltage module reference at stator is calculated using the voltage module reference at terminal."
  ...
  Dynawo.Connectors.ReactivePowerPuOutput QStator0Pu "Start value of stator reactive power in pu (base QNomAlt) (generator convention)";
  ...
  Dynawo.Connectors.VoltageModulePuOutput UStatorRef0Pu "Start value of voltage regulation set point at stator in pu (base UNom)";
...
equation
  if QGenRaw0Pu <= QMin0Pu and UStator0Pu >= UStatorRef0Pu then
    qStatus0 = QStatus.AbsorptionMax;
    QGen0Pu = QMin0Pu;
  elseif QGenRaw0Pu >= QMax0Pu and UStator0Pu <= UStatorRef0Pu then
