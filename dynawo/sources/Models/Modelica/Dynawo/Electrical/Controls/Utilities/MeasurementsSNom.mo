...
model MeasurementsSNom "This block measures the voltage, current, active power and reactive power in pu (base UNom, SNom)"
  /*
  ...
  */
  ...
  Modelica.Blocks.Interfaces.RealOutput IPu "Current module at terminal 1 in pu (base UNom, SNom)" annotation(
  ...
  Modelica.ComplexBlocks.Interfaces.ComplexOutput iPu "Complex current at terminal 1 in pu (base UNom, SNom) (receptor convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput PPu "Active power at terminal 1 in pu (base SNom) (receptor convention)" annotation(
    Placement(visible = true, transformation(origin = {20, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 90), iconTransformation(origin = {20, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Blocks.Interfaces.RealOutput QPu "Reactive power at terminal 1 in pu (base SNom) (receptor convention)" annotation(
    Placement(visible = true, transformation(origin = {40, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 90), iconTransformation(origin = {40, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
...
equation
  ...
  terminal1.i = iPu;
  terminal1.V = uPu;
  IPhase = Modelica.ComplexMath.arg(iPu);
  IPu = Modelica.ComplexMath.'abs'(iPu);
  PPu = Modelica.ComplexMath.real(uPu*Modelica.ComplexMath.conj(iPu));
  QPu = Modelica.ComplexMath.imag(uPu*Modelica.ComplexMath.conj(iPu));
  UPhase = Modelica.ComplexMath.arg(uPu);
  UPu = Modelica.ComplexMath.'abs'(uPu);
  annotation(
    preferredView = "text");
end MeasurementsSNom;
