...
model SimplifiedSFR "Simplified system frequency response model, based on the proposition by Anderson in 1990"
  ...
  Modelica.Blocks.Interfaces.RealOutput deltaFrequency(start = 0) annotation(
    Placement(visible = true, transformation(origin = {106, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealOutput deltaOmegaPu(start = 0) annotation(
    Placement(visible = true, transformation(origin = {106, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(gain.y, deltaFrequency) annotation(
    Line(points = {{68, 0}, {106, 0}}, color = {0, 0, 127}));
  ...
  connect(deltaOmegaPu, inertia.y) annotation(
    Line(points = {{106, -40}, {20, -40}, {20, 0}, {-10, 0}}, color = {0, 0, 127}));
