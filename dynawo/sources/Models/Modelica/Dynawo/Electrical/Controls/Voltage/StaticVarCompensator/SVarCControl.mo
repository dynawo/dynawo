...
model SVarCControl "Control for standard static var compensator model"
  ...
  ModeHandling modeHandling(Mode0 = Mode0, UBlock = UBlock, UUnblockDown = UUnblockDown, UUnblockUp = UUnblockUp, UNom = UNom, URefDown = URefDown, URefUp = URefUp, UThresholdDown = UThresholdDown, UThresholdUp = UThresholdUp, tThresholdDown = tThresholdDown, tThresholdUp = tThresholdUp, URef0 = URef0)  annotation(
...
equation
  connect(setModeManual, modeHandling.setModeManual) annotation(
    Line(points = {{-168, 84}, {-122, 84}, {-122, 52}, {-82, 52}, {-82, 52}}, color = {255, 127, 0}));
