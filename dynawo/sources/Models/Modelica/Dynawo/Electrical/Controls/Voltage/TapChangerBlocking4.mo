...
equation
  ...
  when UMonitored1 < UMin1 or UMonitored2 < UMin2 or UMonitored3 < UMin3 or UMonitored4 < UMin4 then
    UUnderMin = true;
    tUnderUmin = time;
  elsewhen UMonitored1 >= UMin1 and UMonitored2 >= UMin2 and UMonitored3 >= UMin3 and UMonitored4 >= UMin4 and pre(UUnderMin) then
    UUnderMin = false;
