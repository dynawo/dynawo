...
model SecondaryVoltageControl "Model for simplified secondary voltage control"
  ...
  */
  ...
  Modelica.Blocks.Continuous.FirstOrder firstOrder(T = tSampling/20, y_start = Up0Pu) annotation(
    Placement(transformation(origin = {-138, -80}, extent = {{-10, -10}, {10, 10}})));
...
equation
  ...
  connect(firstOrder1.y, firstOrder.u) annotation(
    Line(points = {{-168, -80}, {-150, -80}}, color = {0, 0, 127}));
  connect(UpPu, firstOrder1.u) annotation(
    Line(points = {{-220, -60}, {-192, -60}, {-192, -80}}, color = {0, 0, 127}));
  connect(firstOrder.y, feedback1.u2) annotation(
    Line(points = {{-126, -80}, {-126.75, -80}, {-126.75, -78}, {-103.5, -78}, {-103.5, -62}, {-119, -62}, {-119, -66}, {-166, -66}, {-166, -44}, {-180, -44}, {-180, -8}}, color = {0, 0, 127}));
  annotation(
