...
partial model SwitchOffLogicSide1 "Manage switch-off logic for side 1 of a quadripole"
  ...
  Dynawo.Connectors.BPin switchOffSignal1Side1(value(start = false)) "Switch-off signal 1 for side 1 of the quadripole";
  Dynawo.Connectors.BPin switchOffSignal2Side1(value(start = false)) if NbSwitchOffSignalsSide1 >= 2 "Switch-off signal 2 for side 1 of the quadripole";
  Dynawo.Connectors.BPin switchOffSignal3Side1(value(start = false)) if NbSwitchOffSignalsSide1 >= 3 "Switch-off signal 3 for side 1 of the quadripole";

  Dynawo.Connectors.BPin runningSide1(value(start = true)) "Indicates if the component is running on side 1 or not";
