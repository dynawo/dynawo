...
model PControl3AB2020
  ...
  Modelica.Blocks.Interfaces.RealInput PWTRefPu(start = POrd0Pu) "Wind Turbine (WT) active power reference in pu (base PNomTurb) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput POrdPu "Active power order from wind turbine controller in pu (base PNomTurb) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput omegaRefPu "Angular velocity reference value in pu (base OmegaNom" annotation(
  ...
  Modelica.Blocks.Nonlinear.Limiter limitLargerZero(limitsAtInit = true, uMax = 9999, uMin = 0.01) annotation(
  ...
  Modelica.Blocks.Nonlinear.Limiter limitDtd(limitsAtInit = true, uMax = PDtdMaxPu) annotation(
  ...
  // TODO initialize lagtOmegaRef with table output
