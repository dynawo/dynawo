...
model InjectorVoltageSource
  ...
  parameter Types.Angle UPhase0 "Initial Phase angle outputted by phase-locked loop" annotation(
    Dialog(group = "Operating point"));
  Dynawo.Electrical.Sources.IEC.BaseConverters.VoltageSourceIEC63406 voltageSourceIEC63406(IGsIm0Pu = IsIm0Pu, IGsRe0Pu = IsRe0Pu, P0Pu = P0Pu, Q0Pu = Q0Pu, ResPu = ResPu, SNom = SNom, Tg = Tg, U0Pu = U0Pu, UGsIm0Pu = UsIm0Pu, UGsRe0Pu = UsRe0Pu, UPhase0 = UPhase0, XesPu = XesPu)  annotation(
