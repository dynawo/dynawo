...
equation
  ...
  annotation(
    ...
    Icon(graphics = {Rectangle(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {1, 46}, extent = {{-101, 54}, {101, -54}}, textString = "QLimiter")}));
end BaseQLimiter;
