within Dynawo.Electrical.Controls.IEC.IEC63406.Protections.BaseProtections;
...
model FRTControl
  ...
  Modelica.Blocks.Interfaces.RealInput pMeasPu(start = -P0Pu * SystemBase.SnRef / (SNom * U0Pu)) annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput qMeasPu(start = -Q0Pu * SystemBase.SnRef / (SNom * U0Pu)) annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput iPMinPu(start = IPMin0Pu) annotation(
    Placement(visible = true, transformation(origin = {52, 170}, extent = {{-10, -10}, {10, 10}}, rotation = -90), iconTransformation(origin = {-100, 180}, extent = {{-20, -20}, {20, 20}}, rotation = -90)));
  Modelica.Blocks.Interfaces.RealInput iPMaxPu(start = IPMax0Pu) annotation(
    Placement(visible = true, transformation(origin = {68, 170}, extent = {{-10, -10}, {10, 10}}, rotation = -90), iconTransformation(origin = {-40, 180}, extent = {{-20, -20}, {20, 20}}, rotation = -90)));
  ...
  Modelica.Blocks.Sources.BooleanExpression booleanExpression3(y = HVRTinPFlag) annotation(
      Placement(visible = true, transformation(origin = {-80, -20}, extent = {{-20, -10}, {20, 10}}, rotation = 0)));
  Dynawo.Electrical.Controls.IEC.IEC63406.Protections.BaseProtections.AuxiliaryProtections.FRTCurrentBounds LVRTCurrentBounds annotation(
    Placement(visible = true, transformation(origin = {60, 80}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Dynawo.Electrical.Controls.IEC.IEC63406.Protections.BaseProtections.AuxiliaryProtections.FRTCurrentBounds HVRTCurrentBounds1 annotation(
    Placement(visible = true, transformation(origin = {60, -80}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Dynawo.Electrical.Controls.IEC.IEC63406.Protections.BaseProtections.AuxiliaryProtections.FRTCurrentCalculation LVRTCurrentCalculation annotation(
    Placement(visible = true, transformation(origin = {-80, 80}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Dynawo.Electrical.Controls.IEC.IEC63406.Protections.BaseProtections.AuxiliaryProtections.FRTCurrentCalculation HVRTCurrentCalculation annotation(
    Placement(visible = true, transformation(origin = {-80, -80}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
...
equation
  ...
  connect(HVRTCurrentBounds1.iqMinPu, variableLimiter2.limit2) annotation(
    Line(points = {{82, -94}, {110, -94}, {110, -148}, {128, -148}}, color = {0, 0, 127}));
  connect(iPMinPu, LVRTCurrentBounds.iPMinPu) annotation(
    Line(points = {{52, 170}, {52, 104}}, color = {0, 0, 127}));
  connect(iPMaxPu, LVRTCurrentBounds.iPMaxPu) annotation(
    Line(points = {{68, 170}, {68, 104}}, color = {0, 0, 127}));
  connect(iQMinPu, HVRTCurrentBounds1.iQMinPu) annotation(
    Line(points = {{52, -170}, {52, -104}}, color = {0, 0, 127}));
  connect(iQMaxPu, HVRTCurrentBounds1.iQMaxPu) annotation(
    Line(points = {{68, -170}, {68, -104}}, color = {0, 0, 127}));
  connect(iPMinPu, HVRTCurrentBounds1.iPMinPu) annotation(
    Line(points = {{52, 170}, {52, 130}, {10, 130}, {10, -40}, {52, -40}, {52, -56}}, color = {0, 0, 127}));
  connect(iPMaxPu, HVRTCurrentBounds1.iPMaxPu) annotation(
    Line(points = {{68, 170}, {68, 120}, {20, 120}, {20, -30}, {68, -30}, {68, -56}}, color = {0, 0, 127}));
  connect(iQMaxPu, LVRTCurrentBounds.iQMaxPu) annotation(
    Line(points = {{68, -170}, {68, -130}, {100, -130}, {100, 40}, {68, 40}, {68, 56}}, color = {0, 0, 127}));
  connect(iQMinPu, LVRTCurrentBounds.iQMinPu) annotation(
    Line(points = {{52, -170}, {52, -120}, {90, -120}, {90, 30}, {52, 30}, {52, 56}}, color = {0, 0, 127}));
  annotation(
