...
model CurrentLimitation
  ...
  Modelica.Blocks.Interfaces.RealInput iQcmdPu(start = Q0Pu * SystemBase.SnRef / (SNom * U0Pu)) annotation(
  ...
  //Output variables
  Modelica.Blocks.Interfaces.RealOutput iQMaxPu(start = IQMax0Pu) "Maximum reactive current" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput iQMinPu(start = IQMin0Pu) "Minimum reactive current" annotation(
  ...
  Dynawo.Electrical.Controls.IEC.IEC63406.Controls.BaseControls.AuxiliaryControls.IqLimitation iqLimitation(IMaxPu = IMaxPu, IQMax0Pu = IQMax0Pu, IQMin0Pu = IQMin0Pu, P0Pu = P0Pu, SNom = SNom, U0Pu = U0Pu)  annotation(
  ...
  Modelica.Blocks.Interfaces.BooleanInput FFlag annotation(
...
equation
  ...
  connect(iqLimitation.iQMaxPu, min3.u2) annotation(
    Line(points = {{-49, 100}, {-41, 100}, {-41, 90}, {-23, 90}}, color = {0, 0, 127}));
  connect(realExpression.y, min3.u3) annotation(
    Line(points = {{-49, 116}, {-31, 116}, {-31, 96}, {-23, 96}}, color = {0, 0, 127}));
  ...
  connect(min3.y, freeze.u3) annotation(
    Line(points = {{1, 90}, {19, 90}, {19, 92}, {27, 92}}, color = {0, 0, 127}));
  ...
  connect(division1.y, min3.u1) annotation(
    Line(points = {{-49, 40}, {-31, 40}, {-31, 84}, {-23, 84}}, color = {0, 0, 127}));
