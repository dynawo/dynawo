...
model Control4A2020 "Whole generator control module for type 4A wind turbines (IEC N°61400-27-1:2020)"
  ...
  Dynawo.Electrical.Controls.IEC.IEC61400.BaseControls.WT.QLimiter2020 qLimiter(P0Pu = P0Pu, QMax0Pu = QMax0Pu, QMaxPu = QMaxPu, QMin0Pu = QMin0Pu, QMinPu = QMinPu, QlConst = QlConst, SNom = SNom,TableQMaxPwtcFilt = TableQMaxPwtcFilt, TableQMaxUwtcFilt = TableQMaxUwtcFilt, TableQMinPwtcFilt = TableQMinPwtcFilt, TableQMinUwtcFilt = TableQMinUwtcFilt, U0Pu = U0Pu, tS = tS) annotation(
  ...
  Dynawo.Electrical.Controls.IEC.IEC61400.BaseControls.WT.CurrentLimiter2020 currentLimiter(TableIpMaxUwt = TableIpMaxUwt, TableIqMaxUwt = TableIqMaxUwt, IMaxDipPu = IMaxDipPu, IMaxPu = IMaxPu, IpMax0Pu = IpMax0Pu, IqMax0Pu = IqMax0Pu, IqMin0Pu = IqMin0Pu, Kpqu = Kpqu, MdfsLim = MdfsLim, Mqpri = Mqpri, P0Pu = P0Pu, Q0Pu = Q0Pu, SNom = SNom, U0Pu = U0Pu, UPhase0 = UPhase0, UpquMaxPu = UpquMaxPu, Iq0Pu = Iq0Pu, Ip0Pu = Ip0Pu) annotation(
