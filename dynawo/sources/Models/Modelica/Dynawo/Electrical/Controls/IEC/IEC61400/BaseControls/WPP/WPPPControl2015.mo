...
model WPPPControl2015 "Active power control module for wind power plants (IEC N°61400-27-1:2015)"
  ...
  Dynawo.NonElectrical.Blocks.Continuous.TransferFunction transferFunction(a = {tpfv, 1},b = {tpft, 1}, u_start = -P0Pu*SystemBase.SnRef/SNom, y_start = -P0Pu * SystemBase.SnRef / SNom) annotation(
