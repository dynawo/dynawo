...
model QLimitation "Reactive power limitation (IEC 63406)"
  ...
  //Output variables
  Modelica.Blocks.Interfaces.RealOutput qMaxPu(start = QMaxPu) "Maximum reactive power at converter terminal in pu (base SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput qMinPu(start = QMinPu) "Minimum reactive power at converter terminal in pu (base SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Math.MinMax minMax(nu = 2) annotation(
    Placement(visible = true, transformation(origin = {40, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(QMax.y, switch14.u1) annotation(
    Line(points = {{-32, 20}, {68, 20}, {68, 52}}, color = {0, 0, 127}));
  connect(Zero.y, freeze2.u1) annotation(
    Line(points = {{-36, 60}, {-26, 60}, {-26, 72}, {-12, 72}}, color = {0, 0, 127}));
  connect(Zero.y, freeze3.u1) annotation(
    Line(points = {{-36, 60}, {-26, 60}, {-26, 32}, {-12, 32}}, color = {0, 0, 127}));
  connect(constant1.y, switch13.u1) annotation(
    Line(points = {{-36, -40}, {-26, -40}, {-26, -28}, {-12, -28}}, color = {0, 0, 127}));
  connect(constant1.y, switch12.u1) annotation(
