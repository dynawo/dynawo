...
model QLimitation
  ...
  Dynawo.Electrical.CBGU.Auxiliaries.Min3 min31 annotation(
  ...
  Dynawo.Electrical.CBGU.Auxiliaries.Min3 min32 annotation(
    Placement(visible = true, transformation(origin = {40, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(switch13.y, min32.u3) annotation(
    Line(points = {{11, -20}, {20.4, -20}, {20.4, -34}, {28, -34}}, color = {0, 0, 127}));
  ...
  connect(switch12.y, min32.u2) annotation(
    Line(points = {{12, -60}, {20, -60}, {20, -40}, {28, -40}}, color = {0, 0, 127}));
  connect(realExpression7.y, min32.u1) annotation(
    Line(points = {{-30, -80}, {28, -80}, {28, -46}}, color = {0, 0, 127}));
  connect(min32.y, switch15.u3) annotation(
    Line(points = {{50, -40}, {56, -40}, {56, -32}, {68, -32}}, color = {0, 0, 127}));
  connect(min31.y, switch14.u3) annotation(
    Line(points = {{50.8, 60}, {55.8, 60}, {55.8, 68}, {67.8, 68}}, color = {0, 0, 127}));
  connect(realExpression2.y, min31.u1) annotation(
    Line(points = {{-28, 20}, {28, 20}, {28, 54}}, color = {0, 0, 127}));
  connect(freeze3.y, min31.u2) annotation(
    Line(points = {{12, 40}, {20, 40}, {20, 60}, {28, 60}}, color = {0, 0, 127}));
  connect(freeze2.y, min31.u3) annotation(
    Line(points = {{12, 80}, {20, 80}, {20, 66}, {28, 66}}, color = {0, 0, 127}));
