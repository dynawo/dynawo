...
model GridProtection2015 "Grid protection system for wind turbines (IEC N°61400-27-1:2015)"
  ...
  Dynawo.Electrical.Controls.IEC.BaseControls.Auxiliaries.UfMeasurement ufMeasurement(DfMaxPu = DfMaxPu, U0Pu = U0Pu, UPhase0 = UPhase0, tUFilt = tUFilt, tfFilt = tfFilt, u0Pu = u0Pu)  annotation(
...
equation
  ...
  connect(ufMeasurement.UWTPu, lessEqual.u2) annotation(
    Line(points = {{-116, 80}, {-80, 80}, {-80, 132}, {-62, 132}}, color = {0, 0, 127}));
  connect(ufMeasurement.UWTPu, combiTable1D.u) annotation(
    Line(points = {{-116, 80}, {-20, 80}, {-20, 100}, {-2, 100}}, color = {0, 0, 127}));
  connect(ufMeasurement.UWTPu, combiTable1D1.u) annotation(
    Line(points = {{-116, 80}, {-20, 80}, {-20, 60}, {-2, 60}}, color = {0, 0, 127}));
  connect(ufMeasurement.UWTPu, lessEqual1.u1) annotation(
