...
model PlantCommunication
  ...
  //Input variables
  Modelica.Blocks.Interfaces.RealInput pCmdPu(start = -P0Pu) "Active power command" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput qCmdPu(start = -Q0Pu) "Reactive power command" annotation(
      Placement(visible = true, transformation(origin = {-120, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-110, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput uCmdPu(start = U0Pu) "Voltage command" annotation(
      Placement(visible = true, transformation(origin = {-120, -60}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-110, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));

  //Output variables
  Modelica.Blocks.Interfaces.RealOutput pRefPu(start = -P0Pu) "Active power reference provided by the plant controller" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput qRefPu(start = -Q0Pu) "Reactive power reference provided by the plant controller" annotation(
  ...
  Modelica.Blocks.Continuous.TransferFunction transferFunction(a = {Tlag, 1}, b = {Tlead, 1}, y_start = -P0Pu)  annotation(
      Placement(visible = true, transformation(origin = {-13, 54}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder(T = Tcom, y_start = -P0Pu)  annotation(
  ...
  Modelica.Blocks.Continuous.TransferFunction transferFunction1(a = {Tlag, 1}, b = {Tlead, 1}, y_start = -P0Pu) annotation(
    Placement(visible = true, transformation(origin = {-13, -6}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder1(T = Tcom, y_start = -Q0Pu) annotation(
    Placement(visible = true, transformation(origin = {13, -20}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  Modelica.Blocks.Continuous.TransferFunction transferFunction2(a = {Tlag, 1}, b = {Tlead, 1}, y_start = -P0Pu) annotation(
