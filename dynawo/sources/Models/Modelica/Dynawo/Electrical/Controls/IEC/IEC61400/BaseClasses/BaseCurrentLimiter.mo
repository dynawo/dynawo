...
partial model BaseCurrentLimiter "Current limitation base module for wind turbines (IEC N°61400-27-1)"
  ...
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds1(fileName = CurrentLimitFileName, table = TableIpMaxUwt, tableName = TableIpMaxUwtName, tableOnFile = CurrentLimitTablesOnFile) annotation(
    Placement(visible = true, transformation(origin = {-250, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(fileName = CurrentLimitFileName, table = TableIqMaxUwt, tableName = TableIqMaxUwtName, tableOnFile = CurrentLimitTablesOnFile) annotation(
...
equation
  ...
  connect(max3.y, sqrtNoEvent.u) annotation(
    Line(points = {{2, 120}, {18, 120}}, color = {0, 0, 127}));
  connect(const1.y, max3.u1) annotation(
    Line(points = {{-38, 140}, {-30, 140}, {-30, 126}, {-22, 126}}, color = {0, 0, 127}));
  connect(feedback.y, max3.u2) annotation(
  ...
  connect(combiTable1Ds1.y[1], min2.u2) annotation(
  ...
  connect(division.y, min2.u1) annotation(
