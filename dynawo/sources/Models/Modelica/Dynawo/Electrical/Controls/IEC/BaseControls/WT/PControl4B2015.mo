...
model PControl4B2015 "Active power control module for type 4B wind turbines (IEC N°61400-27-1:2015)"
  extends Dynawo.Electrical.Controls.IEC.BaseClasses.BasePControl4(absLimRateLimFirstOrderAntiWindup.UseLimits = true, absLimRateLimFirstOrderAntiWindup.tI = tPOrdP4B, absLimRateLimFirstOrderAntiWindup.DyMax = DPMaxP4BPu);
