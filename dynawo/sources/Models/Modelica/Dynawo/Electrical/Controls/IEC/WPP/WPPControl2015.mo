...
model WPPControl2015 "Control model for IEC N°61400-27-1:2020 standard WPP"
  extends Dynawo.Electrical.Controls.IEC.BaseClasses.BaseWPPControl;
  ...
  Modelica.Blocks.Interfaces.RealOutput PWTRefPu(start = -P0Pu * SystemBase.SnRef / SNom) annotation(
