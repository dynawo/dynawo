...
model BaseWPPPControl "Base active power control module for wind power plants (IEC N°61400-27-1)"
  ...
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(fileName = PControlTablesFileName, table = TablePwpBiasfwpFiltCom, tableName = TablePwpBiasfwpFiltComName, tableOnFile = PControlTablesOnFile) annotation(
