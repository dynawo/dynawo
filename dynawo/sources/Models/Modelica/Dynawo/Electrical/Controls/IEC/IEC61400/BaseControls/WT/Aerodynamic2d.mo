...
model Aerodynamic2d "Two-dimensional aerodynmaic module for type 3 wind turbines (IEC N°61400-27-1:2020)"
  ...
  Modelica.Blocks.Interfaces.RealInput theta "Wind turbine pitch angle in degrees" annotation(
    Placement(visible = true, transformation(origin = {-120, 60}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-120, 60}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  //outputs
  Modelica.Blocks.Interfaces.RealOutput pAeroPu "Wind turbine aerodynamic power in pu (base SNom)" annotation(
