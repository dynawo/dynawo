...
model Protection
  ...
  Modelica.Blocks.Interfaces.RealInput thetaPLL(start=thetaPLL0) "Phase angle outputted by phase-locked loop" annotation(
  ...
  parameter Types.Angle thetaPLL0 "Initial Phase angle outputted by phase-locked loop" annotation(
      Dialog(group="Operating point"));
