...
model QuadriSwitch
  ...
  //Input variables
  Modelica.Blocks.Interfaces.RealInput e0 annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput e1 annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput e2 annotation(
    Placement(visible = true, transformation(origin = {-120, -22}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-120, -28}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput e3 annotation(
  ...
  Modelica.Blocks.Interfaces.IntegerInput flag annotation(
 ...
 equation
  y = if flag == 0 then e0 else if flag == 1 then e1 else if flag == 2 then e2 else e3;
