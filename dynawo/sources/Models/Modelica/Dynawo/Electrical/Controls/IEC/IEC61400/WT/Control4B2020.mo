...
model Control4B2020 "Whole generator control module for type 4B wind turbines (IEC N°61400-27-1:2020)"
  ...
  Dynawo.Electrical.Controls.IEC.IEC61400.BaseControls.WT.PControl4B2020 pControl4B(DPMaxP4BPu = DPMaxP4BPu, DPRefMax4BPu = DPRefMax4BPu, DPRefMin4BPu = DPRefMin4BPu, IpMax0Pu = IpMax0Pu, Kpaw = Kpaw, MpUScale = MpUScale, P0Pu = P0Pu, SNom = SNom, U0Pu = U0Pu, UpDipPu = UpDipPu, tPAero = tPAero, tPOrdP4B = tPOrdP4B, tS = tS, Ip0Pu = Ip0Pu) annotation(
