...
model Control4B2020 "Whole generator control module for type 4B wind turbines (IEC N°61400-27-1:2020)"
  ...
  Dynawo.Electrical.Controls.IEC.IEC61400.BaseControls.WT.CurrentLimiter2020 currentLimiter(TableIpMaxUwt = TableIpMaxUwt, TableIqMaxUwt = TableIqMaxUwt, IMaxDipPu = IMaxDipPu, IMaxPu = IMaxPu, IpMax0Pu = IpMax0Pu, IqMax0Pu = IqMax0Pu, IqMin0Pu = IqMin0Pu, Kpqu = Kpqu, MdfsLim = MdfsLim, Mqpri = Mqpri, P0Pu = P0Pu, Q0Pu = Q0Pu, SNom = SNom, U0Pu = U0Pu, UPhase0 = UPhase0, UpquMaxPu = UpquMaxPu, Ip0Pu = Ip0Pu, Iq0Pu = Iq0Pu)) annotation(
