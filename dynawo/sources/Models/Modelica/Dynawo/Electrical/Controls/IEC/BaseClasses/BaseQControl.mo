...
partial model BaseQControl "Reactive power control base module for wind turbines (IEC N°61400-27-1)"
  ...
  Dynawo.NonElectrical.Blocks.NonLinear.FiveSwitch fiveSwitch annotation(
...
equation
  ...
  connect(integerConstant.y, fiveSwitch.flag) annotation(
    Line(points = {{280, 280}, {-10, 280}, {-10, 252}}, color = {255, 127, 0}));
  connect(const1.y, add2.u2) annotation(
    Line(points = {{-119, 160}, {-100, 160}, {-100, 174}, {-82, 174}}, color = {0, 0, 127}));
  connect(fiveSwitch.y, limiter.u) annotation(
    Line(points = {{1, 240}, {18, 240}}, color = {0, 0, 127}));
  ...
  connect(add2.y, fiveSwitch.e0) annotation(
    Line(points = {{-58, 180}, {-40, 180}, {-40, 248}, {-22, 248}}, color = {0, 0, 127}));
  connect(add.y, fiveSwitch.e1) annotation(
    Line(points = {{-58, 240}, {-32, 240}, {-32, 244}, {-22, 244}}, color = {0, 0, 127}));
  connect(add.y, fiveSwitch.e3) annotation(
    Line(points = {{-58, 240}, {-32, 240}, {-32, 236}, {-22, 236}}, color = {0, 0, 127}));
  connect(const.y, fiveSwitch.e2) annotation(
    Line(points = {{-58, 280}, {-28, 280}, {-28, 240}, {-22, 240}}, color = {0, 0, 127}));
  connect(const.y, fiveSwitch.e4) annotation(
    Line(points = {{-58, 280}, {-28, 280}, {-28, 232}, {-22, 232}}, color = {0, 0, 127}));
