...
model WPPQControl2020 "Reactive power control module for wind power plants (IEC N°61400-27-1:2020)"
  extends Dynawo.Electrical.Controls.IEC.IEC61400.BaseClasses.BaseWPPQControl(combiTable1Ds2(fileName = QControlTablesFileName, table = TableQwpUErr, tableName = TableQwpUErrName, tableOnFile = QControlTablesOnFile));
  ...
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(fileName = QControlTablesFileName, table = TableQwpMaxPwpFiltCom, tableName = TableQwpMaxPwpFiltComName, tableOnFile = QControlTablesOnFile) annotation(
    Placement(visible = true, transformation(origin = {-190, 140}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds1(fileName = QControlTablesFileName, table = TableQwpMinPwpFiltCom, tableName = TableQwpMinPwpFiltComName, tableOnFile = QControlTablesOnFile) annotation(
