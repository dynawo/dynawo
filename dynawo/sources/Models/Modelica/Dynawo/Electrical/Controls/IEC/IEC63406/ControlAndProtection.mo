...
model ControlAndProtection
  ...
  //Input variables
  Modelica.Blocks.Interfaces.RealInput qRefPu(start = -Q0Pu) "Voltage reference provided by the plant controller" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput pAvailOutPu(start = PAvailOut0Pu) "Maximum output electrical power available to the active power control module" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput pMeasPu(start = -P0Pu) "Measured (and filtered) active power component (generator convention)" annotation(
    Placement(visible = true, transformation(origin = {-200, 60}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-200, 80}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput qMeasPu(start = -Q0Pu) "Measured (and filtered) reactive power component" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput fMeasPu(start = fInitPu) "Measured frequency outputted by the phase-locked loop" annotation(
  ...
  Dynawo.Electrical.Controls.IEC.IEC63406.Protections.Protection protection(U0Pu = U0Pu, fInitPu = fInitPu, UPhase0 = UPhase0) annotation(
...
equation
  ...
  connect(control.iQcmdPu, fRTControl.iQcmdPu) annotation(
    Line(points = {{6, 28}, {30, 28}, {30, 115}, {75, 115}}, color = {0, 0, 127}));
