...
equation
  ...
  connect(zero3.y, greater.u2) annotation(
    Line(points = {{-343.4, -78}, {-304.2, -78}, {-304.2, -64}, {-296.4, -64}}, color = {0, 0, 127}));
  connect(integerToReal.y, greater.u1) annotation(
    Line(points = {{-309, -56}, {-296, -56}}, color = {0, 0, 127}));
  connect(delayFlag.fO, integerToReal.u) annotation(
    Line(points = {{-336.8, -56}, {-331.8, -56}}, color = {255, 127, 0}));
  connect(greater.y, OrReset.u[2]) annotation(
    Line(points = {{-273, -56}, {-263, -56}, {-263, -15}, {-250, -15}}, color = {255, 0, 255}));
