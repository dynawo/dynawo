...
model Control4A2015 "Whole generator control module for type 4A wind turbines (IEC N°61400-27-1:2015)"
  ...
  Dynawo.Electrical.Controls.IEC.BaseControls.WT.PControl4A2015 pControl4A(DPMaxP4APu = DPMaxP4APu, IpMax0Pu = IpMax0Pu, Kpaw = Kpaw, P0Pu = P0Pu, SNom = SNom, U0Pu = U0Pu, tPOrdP4A = tPOrdP4A, tUFiltP4A = tUFiltP4A) annotation(
