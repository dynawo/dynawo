...
model FFR "Fast frequency response (IEC 63406)"
  ...
  Modelica.Blocks.Nonlinear.DeadZone deadZone(deadZoneAtInit = false, uMax = fThresholdPu, uMin = -fThresholdPu) annotation(
    Placement(visible = true, transformation(origin = {-66, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Nonlinear.Limiter limiter(homotopyType = Modelica.Blocks.Types.LimiterHomotopy.NoHomotopy,limitsAtInit = false, uMax = PffrMaxPu, uMin = PffrMinPu) annotation(
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter1(homotopyType = Modelica.Blocks.Types.LimiterHomotopy.NoHomotopy, limitsAtInit = false, uMax = PffrMaxPu, uMin = PffrMinPu) annotation(
  ...
  Modelica.Blocks.Nonlinear.DeadZone deadZone1(deadZoneAtInit = false, uMax = fThresholdPu, uMin = -fThresholdPu) annotation(
    Placement(visible = true, transformation(origin = {-70, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Nonlinear.Limiter limiter2(homotopyType = Modelica.Blocks.Types.LimiterHomotopy.NoHomotopy,limitsAtInit = false, uMax = PffrMaxPu, uMin = PffrMinPu) annotation(
...
equation
  ...
  connect(f0.y, add1.u2) annotation(
