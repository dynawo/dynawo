...
model FFR
  ...
  //Output variables
  Modelica.Blocks.Interfaces.RealOutput pFFRPu(start = PFFR0Pu) annotation(
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter(limitsAtInit = true, uMax = PffrMaxPu, uMin = PffrMinPu) annotation(
  ...
  Modelica.Blocks.Continuous.Derivative derivative(T = Trocof, k = Trocof, y_start = 0)  annotation(
