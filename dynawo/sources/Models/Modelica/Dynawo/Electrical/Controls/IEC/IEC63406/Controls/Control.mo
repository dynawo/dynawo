...
model Control
  ...
  Modelica.Blocks.Interfaces.RealInput qRefPu(start = -Q0Pu * SystemBase.SnRef / SNom) annotation(
    Placement(visible = true, transformation(origin = {-120, -60}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-110, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput fMeasPu(start = fInitPu) annotation(
    Placement(visible = true, transformation(origin = {-120, 90}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-110, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealInput pAvailOutPu(start = PAvailOut0Pu) annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput iQcmdPu(start = Q0Pu * SystemBase.SnRef / (SNom * U0Pu)) annotation(
    Placement(visible = true, transformation(origin = {110, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {115, 21}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealOutput iPMaxPu(start = IPMax0Pu ) annotation(
    Placement(visible = true, transformation(origin = {110, 14}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealOutput iPMinPu(start = IPMin0Pu ) annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput iQMaxPu(start = IQMax0Pu ) annotation(
    Placement(visible = true, transformation(origin = {110, -12}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealOutput iQMinPu(start = IQMin0Pu ) annotation(
    Placement(visible = true, transformation(origin = {110, -26}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));

  //Variables
  Boolean FFlag;

  Dynawo.Electrical.Controls.IEC.IEC63406.Controls.BaseControls.PControl pControl(IPMax0Pu = IPMax0Pu, IPMin0Pu = IPMin0Pu, KIp = KIp, KPp = KPp, P0Pu = P0Pu, PAvailIn0Pu = PAvailIn0Pu, PAvailOut0Pu = PAvailOut0Pu, PFFR0Pu = PFFR0Pu, PFlag = PFlag, SNom = SNom, TpRef = TpRef, U0Pu = U0Pu, fInitPu = fInitPu)  annotation(
  ...
  Dynawo.Electrical.Controls.IEC.IEC63406.Controls.BaseControls.FFR ffr(FFRflag = FFRflag, PFFR0Pu = PFFR0Pu, PffrMaxPu = PffrMaxPu, PffrMinPu = PffrMinPu, Trocof = Trocof, f0Pu = f0Pu, fInitPu = fInitPu, fThresholdPu = fThresholdPu)  annotation(
  ...
  parameter Types.PerUnit IPMax0Pu annotation(
      Dialog(tab = "Operating point"));
  parameter Types.PerUnit PAvailOut0Pu "Initial maximum output electrical power available to the active power control module" annotation(
      Dialog(tab = "Operating point"));
  parameter Types.PerUnit PAvailIn0Pu "Initial minimum output electrical power available to the active power control module" annotation(
      Dialog(tab = "Operating point"));
  parameter Types.PerUnit PFFR0Pu "Initial output power utilized for FFR control" annotation(
      Dialog(tab = "Operating point"));
...
equation
  ...
  connect(currentLimitation.iPMaxPu, iPMaxPu) annotation(
    Line(points = {{42, 14}, {110, 14}}, color = {0, 0, 127}));
  connect(currentLimitation.iPMinPu, iPMinPu) annotation(
    Line(points = {{42, 6}, {80, 6}, {80, 2}, {110, 2}}, color = {0, 0, 127}));
  connect(currentLimitation.iQMaxPu, iQMaxPu) annotation(
    Line(points = {{42, -6}, {80, -6}, {80, -12}, {110, -12}}, color = {0, 0, 127}));
  connect(currentLimitation.iQMinPu, iQMinPu) annotation(
    Line(points = {{42, -14}, {80, -14}, {80, -26}, {110, -26}}, color = {0, 0, 127}));
