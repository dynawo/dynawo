...
or flywheel energy storage systems" annotation(
  ...
  //Input variables
  Modelica.Blocks.Interfaces.RealInput pPrimPu(start = -P0Pu * SystemBase.SnRef / SNom) "Power from the primary energy, which should be specified by model users and can be time-varying to represent the variations of primary energy" annotation(
