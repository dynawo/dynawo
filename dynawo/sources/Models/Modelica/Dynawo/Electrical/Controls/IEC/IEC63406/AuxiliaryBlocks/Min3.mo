...
block Min3 "Pass through the smallest signal"
...
equation
  ...
  annotation(
    Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics = {Text(lineColor = {160, 160, 164}, extent = {{-90, 36}, {90, -36}}, textString = "min()"), Rectangle(extent = {{-100, 100}, {100, -100}})}),
