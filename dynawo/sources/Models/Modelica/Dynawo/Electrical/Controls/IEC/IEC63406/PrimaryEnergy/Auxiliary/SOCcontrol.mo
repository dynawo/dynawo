...
model SOCcontrol "Module to limit output power depending on SOC (IEC 63406)"
  ...
  //Input variables
  Modelica.Blocks.Interfaces.RealInput soc "State of charge of the storage system in %" annotation(
    Placement(visible = true, transformation(origin = {-120, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-120, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));

  //Output variables
  Modelica.Blocks.Interfaces.RealOutput pAvailInPu "Minimum output electrical power available to the active power control module in pu (base SNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput pAvailOutPu "Maximum output electrical power available to the active power control module in pu (base UNom, SNom)" annotation(
