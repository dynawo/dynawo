...
model MeasurementsPQ "Measurement module of P and Q for wind turbine (IEC N°61400-27-1)"
  ...
  Modelica.Blocks.Interfaces.RealOutput QPu(start = -Q0Pu * SystemBase.SnRef / SNom) "Reactive power generated by the converter at grid terminal in pu (base SnRef) (generator convention)" annotation(
