...
model MeasurementsPQ "Measurement module of P and Q for wind turbine (IEC N°61400-27-1)"
  ...
  //Output variables
  Modelica.Blocks.Interfaces.RealOutput PGenNomPu(start = -P0Pu * SystemBase.SnRef / SNom) "Active power generated by the converter at grid terminal in pu (base SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput QGenNomPu(start = -P0Pu * SystemBase.SnRef / SNom) "Active power generated by the converter at grid terminal in pu (base SnRef) (generator convention)" annotation(
