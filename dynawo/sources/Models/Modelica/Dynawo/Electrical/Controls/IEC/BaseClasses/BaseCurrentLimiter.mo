...
equation
  ...
  connect(min4.y, tripleSwitch.e1) annotation(
    Line(points = {{102, -120}, {114, -120}, {114, -104}, {122, -104}}, color = {0, 0, 127}));
  connect(min4.y, tripleSwitch.e2) annotation(
    Line(points = {{102, -120}, {114, -120}, {114, -108}, {122, -108}}, color = {0, 0, 127}));
  connect(tripleSwitch.y, product4.u2) annotation(
    Line(points = {{146, -100}, {180, -100}, {180, -106}, {198, -106}}, color = {0, 0, 127}));
  connect(combiTable1Ds1.y[1], min4.u1) annotation(
    Line(points = {{-239, -100}, {60, -100}, {60, -114}, {78, -114}}, color = {0, 0, 127}));
  connect(combiTable1Ds1.y[1], tripleSwitch.e0) annotation(
    Line(points = {{-238, -100}, {122, -100}}, color = {0, 0, 127}));
  ...
  connect(product1.y, tripleSwitch.flag) annotation(
    Line(points = {{62, 40}, {110, 40}, {110, -94}, {122, -94}}, color = {255, 127, 0}));
