...
model Control4B "Whole generator control module for type 4B wind turbines (IEC N°61400-27-1)"
  ...
  Dynawo.Electrical.Controls.IEC.BaseControls.PControl4B pControl4B(DPMaxP4BPu = DPMaxP4BPu, DPRefMax4BPu = DPRefMax4BPu, DPRefMin4BPu = DPRefMin4BPu,IpMax0Pu = IpMax0Pu, Kpaw = Kpaw, MpUScale = MpUScale, P0Pu = P0Pu, SNom = SNom, U0Pu = U0Pu, UpDipPu = UpDipPu, tPAero = tPAero, tPOrdP4B = tPOrdP4B, tS = tS)  annotation(
