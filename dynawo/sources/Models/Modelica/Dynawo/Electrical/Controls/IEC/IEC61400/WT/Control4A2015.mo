...
model Control4A2015 "Whole generator control module for type 4A wind turbines (IEC N°61400-27-1:2015)"
  ...
  Dynawo.Electrical.Controls.IEC.IEC61400.BaseControls.WT.QLimiter2015 qLimiter(P0Pu = P0Pu, QMax0Pu = QMax0Pu, QMaxPu = QMaxPu, QMin0Pu = QMin0Pu, QMinPu = QMinPu, QlConst = QlConst, SNom = SNom, U0Pu = U0Pu, tPFiltql = tPFiltql, tS = tS, tUFiltql = tUFiltql) annotation(
