...
model Control4A2015 "Whole generator control module for type 4A wind turbines (IEC N°61400-27-1:2015)"
  ...
  Dynawo.Electrical.Controls.IEC.IEC61400.BaseControls.WT.CurrentLimiter2015 currentLimiter(IMaxDipPu = IMaxDipPu, IMaxPu = IMaxPu, IpMax0Pu = IpMax0Pu, IqMax0Pu = IqMax0Pu, IqMin0Pu = IqMin0Pu, Kpqu = Kpqu, MdfsLim = MdfsLim, Mqpri = Mqpri, P0Pu = P0Pu, Q0Pu = Q0Pu, SNom = SNom, TableIpMaxUwt = TableIpMaxUwt, TableIqMaxUwt = TableIqMaxUwt, U0Pu = U0Pu, UPhase0 = UPhase0, UpquMaxPu = UpquMaxPu, tUFiltcl = tUFiltcl) annotation(
