...
model Control4A2015 "Whole generator control module for type 4A wind turbines (IEC N°61400-27-1:2015)"
  ...
  Dynawo.Electrical.Controls.IEC.IEC61400.BaseControls.WT.CurrentLimiter2015 currentLimiter(IMaxDipPu = IMaxDipPu, IMaxPu = IMaxPu, IpMax0Pu = IpMax0Pu, IqMax0Pu = IqMax0Pu, IqMin0Pu = IqMin0Pu, Kpqu = Kpqu, MdfsLim = MdfsLim, Mqpri = Mqpri, P0Pu = P0Pu, Q0Pu = Q0Pu, SNom = SNom, TableIpMaxUwt = TableIpMaxUwt, TableIqMaxUwt = TableIqMaxUwt, U0Pu = U0Pu, UPhase0 = UPhase0, UpquMaxPu = UpquMaxPu, tUFiltcl = tUFiltcl, Ip0Pu = Ip0Pu, Iq0Pu = Iq0Pu) annotation(
  ...
  Dynawo.Electrical.Controls.IEC.IEC61400.BaseControls.WT.QLimiter2015 qLimiter(P0Pu = P0Pu, QMax0Pu = QMax0Pu, QMaxPu = QMaxPu, QMin0Pu = QMin0Pu, QMinPu = QMinPu, QlConst = QlConst, SNom = SNom, TableQMaxPwtcFilt = TableQMaxPwtcFilt, TableQMaxUwtcFilt = TableQMaxUwtcFilt, TableQMinPwtcFilt = TableQMinPwtcFilt, TableQMinUwtcFilt = TableQMinUwtcFilt, U0Pu = U0Pu, tPFiltql = tPFiltql, tS = tS, tUFiltql = tUFiltql) annotation(
