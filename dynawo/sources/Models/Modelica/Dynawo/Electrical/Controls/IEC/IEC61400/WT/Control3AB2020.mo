...
model Control3AB2020 "Whole generator control module for type 4B wind turbines (IEC N°61400-27-1:2020)"
  /*
  ...
  BaseControls.WT.PControl3AB2020 pControl3AB2020(DPMaxPu=DPMaxPu, DPRefMax4abPu=DPRefMax4abPu, DPRefMin4abPu=DPRefMin4abPu, DTauMaxPu=DTauMaxPu, DTauUvrtMaxPu=DTauUvrtMaxPu, IpMax0Pu = IpMax0Pu, KDtd=KDtd, KIp=KIp, KPp=KPp, MOmegaTMax=MOmegaTMax, MOmegaTqpi=MOmegaTqpi, MPUvrt=MPUvrt, MpUScale=MpUScale, OmegaDtdPu=OmegaDtdPu, OmegaOffsetPu=OmegaOffsetPu, P0Pu = P0Pu, PBaseMeasurement=PBaseMeasurement, PDtdMaxPu=PDtdMaxPu, SNom=SNom, TableOmegaPPu=TableOmegaPPu, TauEMinPu=TauEMinPu, TauUscalePu=TauUscalePu, U0Pu=U0Pu, UDvsPu=UDvsPu, UpDipPu=UpDipPu, Zeta=Zeta, tDvs=tDvs, tOmegaRef=tOmegaRef, tOmegafiltp3=tOmegafiltp3, tPord=tPord, tS=tS) annotation(
    Placement(visible = true, transformation(origin = {0, 108}, extent = {{-30, -30}, {30, 30}}, rotation = 0)));

  
  Modelica.Blocks.Interfaces.RealOutput iqCmdPu annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput tanPhi annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput xWTRefPu annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput omegaGenPu annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput ipCmdPu annotation(
