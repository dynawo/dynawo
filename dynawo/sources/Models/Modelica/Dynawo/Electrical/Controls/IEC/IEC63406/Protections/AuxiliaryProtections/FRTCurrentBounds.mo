...
model FRTCurrentBounds "Current limitation during FRT (IEC63406)"
  ...
  //Input variables
  Modelica.Blocks.Interfaces.RealInput ipLVRTPrimPu "Active current calculated by the LVRT module in pu (base UNom, SNom) and before saturation" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput iqLVRTPrimPu "Reactive current calculated by the LVRT module in pu (base UNom, SNom) and before saturation" annotation(
    Placement(visible = true, transformation(origin = {-120, -40}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-120, -40}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));

  //Output variables
  Modelica.Blocks.Interfaces.RealOutput ipMaxPu "Maximum active current calculated in the FRT block in pu (base SNom, UNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput ipMinPu "Minimum active current calculated in the FRT block in pu (base SNom, UNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput iqMaxPu "Maximum reactive current calculated in the FRT block in pu (base SNom, UNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput iqMinPu "Minimum reactive current calculated in the FRT block in pu (base SNom, UNom) (generator convention)" annotation(
