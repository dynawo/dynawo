...
model QControl
  ...
  Modelica.Blocks.Interfaces.RealInput pMeasPu(start=-P0Pu) "Measured (and filtered) active power component" annotation(
  ...
  Dynawo.NonElectrical.Blocks.Continuous.AbsLimRateLimFirstOrderFreeze absLimRateLimFirstOrderFreeze(DyMax = 1000, UseLimits = true, Y0 = -Q0Pu * SystemBase.SnRef / (SNom * U0Pu), tI = Tiq) annotation(
