...
model PLL
  ...
  //Input variables
  Modelica.ComplexBlocks.Interfaces.ComplexInput uPu(re(start = u0Pu.re), im(start = u0Pu.im)) annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput fMeasPu(start=fInitPu) "Measured frequency outputted by the phase-locked loop" annotation(
  ...
  Modelica.Blocks.Sources.RealExpression realExpression1(y = Wref) annotation(
  ...
  Dynawo.Electrical.Controls.IEC.IEC63406.AuxiliaryBlocks.TripleSwitch tripleSwitch1 annotation(
  ...
  Modelica.Blocks.Math.Gain gain2(k = 1 / Wref) annotation(
  ...
  Modelica.Blocks.Math.Gain gain1(k = 1 / Wref) annotation(
  ...
  Dynawo.NonElectrical.Blocks.Continuous.LimitedPI limitedPI(Ki = KIpll * Wref, Kp = KPpll * Wref, YMax = WMaxPu * Wref, YMin = WMinPu * Wref)  annotation(
...
equation
  ...
  connect(tripleSwitch.y, thetaPLL) annotation(
  ...
  connect(complexToPolar1.phi, tripleSwitch.e0) annotation(
    Line(points = {{-38, 86}, {40, 86}, {40, 46}, {68, 46}}, color = {0, 0, 127}));
  connect(complexToPolar1.phi, firstOrder.u) annotation(
    Line(points = {{-38, 86}, {-10, 86}, {-10, 40}, {-2, 40}}, color = {0, 0, 127}));
  connect(firstOrder.y, tripleSwitch.e1) annotation(
    Line(points = {{22, 40}, {68, 40}}, color = {0, 0, 127}));
  connect(integerExpression.y, tripleSwitch.flag) annotation(
    Line(points = {{80, 65}, {80, 52.6}}, color = {255, 127, 0}));
  ...
  connect(integrator.y, tripleSwitch.e2) annotation(
    Line(points = {{55, 6}, {64, 6}, {64, 34}, {68, 34}}, color = {0, 0, 127}));
  ...
  connect(tripleSwitch.y, derivative.u) annotation(
    Line(points = {{92, 40}, {94, 40}, {94, -20}, {90, -20}}, color = {0, 0, 127}));
  ...
  connect(add3.y, tripleSwitch1.e0) annotation(
    Line(points = {{60, -69}, {60, -74}, {68, -74}}, color = {0, 0, 127}));
  connect(add3.y, tripleSwitch1.e1) annotation(
    Line(points = {{60, -68}, {60, -80}, {68, -80}}, color = {0, 0, 127}));
  connect(gain1.y, tripleSwitch1.e2) annotation(
    Line(points = {{36, -80}, {52, -80}, {52, -86}, {68, -86}}, color = {0, 0, 127}));
  connect(tripleSwitch1.y, fMeasPu) annotation(
    Line(points = {{92, -80}, {110, -80}}, color = {0, 0, 127}));
  connect(integrator.y, transformRItoDQ.phi) annotation(
    Line(points = {{55, 6}, {64, 6}, {64, 16}, {-54, 16}, {-54, 6}, {-50, 6}}, color = {0, 0, 127}));
  ...
  connect(integerExpression.y, tripleSwitch1.flag) annotation(
