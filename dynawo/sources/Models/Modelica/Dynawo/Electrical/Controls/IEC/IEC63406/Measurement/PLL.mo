...
model PLL "Phase-Locked-Loop (IEC 63406)"
  ...
  //Output variables
  Modelica.Blocks.Interfaces.RealOutput fMeasPu(start = 1) "Measured frequency outputted by the phase-locked loop in pu (base fNom)" annotation(
...
equation
  ...
  connect(switch12.u1, complexConst.y) annotation(
    Line(points = {{-82, -8}, {-92, -8}, {-92, -30}, {-98, -30}}, color = {85, 170, 255}));
  connect(PLLFLAG.y, multiSwitch.f) annotation(
    Line(points = {{80, 70}, {80, 52}}, color = {255, 127, 0}));
  connect(PLLFLAG.y, multiSwitch1.f) annotation(
    Line(points = {{80, 70}, {80, 60}, {120, 60}, {120, -60}, {80, -60}, {80, -68}}, color = {255, 127, 0}));
  connect(const.y, add3.u1) annotation(
    Line(points = {{73, -40}, {66, -40}, {66, -46}}, color = {0, 0, 127}));
  connect(Zero.y, switch11.u1) annotation(
