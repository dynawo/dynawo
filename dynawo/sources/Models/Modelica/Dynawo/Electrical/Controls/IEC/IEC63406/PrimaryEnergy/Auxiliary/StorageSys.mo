...
model StorageSys "Primary energy source-driven electric conversion module of energy generation systems (IEC TS 63406 ED1)"
  ...
  //Parameters
  parameter Types.Time Tess "Equivalent time constant for the battery, supercapacitor or flywheel energy storage systems" annotation(
  ...
  parameter Types.Percent SOCInit "Initial SOC amount" annotation(
    Dialog(tab = "StorageSys"));
