...
model StorageSys "Primary energy source-driven electric conversion module of energy generation systems (IEC 63406)"
  ...
  Dynawo.Electrical.Controls.IEC.IEC63406.PrimaryEnergy.Auxiliary.SOCcontrol sOCcontrol(PMaxPu = PMaxPu, SOCInit = SOCInit, SOCMax = SOCMax, SOCMin = SOCMin) annotation(
...
equation
  ...
  connect(gain.y, division.u1) annotation(
    Line(points = {{-71, 0}, {-66, 0}, {-66, 20}, {-100, 20}, {-100, 56}, {-88, 56}}, color = {0, 0, 127}));
