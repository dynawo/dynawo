...
model Control4B2015 "Whole generator control module for type 4B wind turbines (IEC N°61400-27-1:2015)"
  ...
  //PControl parameters
  extends Dynawo.Electrical.Controls.IEC.IEC61400.Parameters.ControlSubstructure4b2015;
  ...
  Dynawo.Electrical.Controls.IEC.IEC61400.BaseControls.WT.PControl4B2015 pControl4B(DPMaxP4BPu = DPMaxP4BPu, IpMax0Pu = IpMax0Pu, Kpaw = Kpaw, P0Pu = P0Pu, SNom = SNom, U0Pu = U0Pu, tPAero = tPAero, tPOrdP4B = tPOrdP4B, tUFiltP4B = tUFiltP4B) annotation(
