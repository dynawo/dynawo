...
model Control4B2015 "Whole generator control module for type 4B wind turbines (IEC N°61400-27-1:2015)"
  ...
  //Output variable
  Modelica.Blocks.Interfaces.RealOutput PAeroPu(start = -P0Pu * SystemBase.SnRef / (SNom * U0Pu)) annotation(
...
equation
  ...
  annotation(
    Icon(graphics = {Text(origin = {74, 29}, extent = {{-52, -13}, {67, 27}}, textString = "B")}));
end Control4B2015;
