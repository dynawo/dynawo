...
model QLimiter2015 "Reactive power limitation module for wind turbines (IEC N°61400-27-1:2015)"
  extends Dynawo.Electrical.Controls.IEC.BaseClasses.BaseQLimiter;
...
equation
  ...
  annotation(
    ...
    Icon(graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}), Text(origin = {-3, -29}, extent = {{-57, 27}, {57, -27}}, textString = "2015")}));
end QLimiter2015;
