...
model QControl2015 "Reactive power control module for wind turbines (IEC N°61400-27-1:2020)"
  ...
  Dynawo.NonElectrical.Blocks.NonLinear.MultiSwitch multiSwitch2(f = MqUvrt, nu = 3) annotation(
    Placement(visible = true, transformation(origin = {90, -180}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.NonElectrical.Blocks.NonLinear.MultiSwitch multiSwitch1(f = MqUvrt, nu = 3) annotation(
