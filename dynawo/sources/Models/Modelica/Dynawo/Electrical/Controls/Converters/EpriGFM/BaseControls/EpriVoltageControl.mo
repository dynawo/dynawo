...
model EpriVoltageControl "Voltage controller in EPRI Grid Forming model"
  ...
  Modelica.Blocks.Interfaces.RealOutput iqConvRefPu(start = if OmegaFlag == 0 then - IqConv0Pu else IqConv0Pu) "Q-axis current reference in the converter in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Dynawo.Electrical.Controls.Converters.EpriGFM.BaseControls.CurrentLimitsCalculation currentLimitsCalculation(IMaxPu = IMaxPu, IdConv0Pu = IdConv0Pu, IqConv0Pu = IqConv0Pu, PQFlag = PQFlag)  annotation(
