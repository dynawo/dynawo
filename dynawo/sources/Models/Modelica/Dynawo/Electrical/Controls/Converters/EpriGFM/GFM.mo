...
model GFM
  ...
  Modelica.Blocks.Interfaces.RealInput VrefPu(start = IdPcc0Pu) "d-axis current in the grid in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Continuous.FirstOrder lagQ(T = tr, k = 1) annotation(
  ...
  Modelica.Blocks.Continuous.FirstOrder lagP(T = tr, k = 1) annotation(
    Placement(visible = true, transformation(origin = {-170, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput PauxPu(start = PRef0Pu) annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput QauxPu(start = UFilterRef0Pu) annotation(
  ...
  Modelica.Blocks.Continuous.Integrator integrator1(initType = Modelica.Blocks.Types.Init.InitialState,k = 1 / tv, y(start = 1), y_start = 1) annotation(
    Placement(visible = true, transformation(origin = {85, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Nonlinear.Limiter limiter(limitsAtInit = true, uMax = deltawmax, uMin = deltawmin)  annotation(
    Placement(visible = true, transformation(origin = {168, 135}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.Integrator integrator2(k = 314.15, y_start = 0.143)  annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput wPLLPu(start = PRef0Pu) annotation(
  ...
  Modelica.Blocks.Sources.IntegerConstant constOmegaFlag(k = wflag)  annotation(
 ...
 Modelica.Blocks.Sources.RealExpression VRefPu2(y = VrefPu) annotation(
...
equation
  connect(QFilterPu, lagQ.u) annotation(
    Line(points = {{-210, -10}, {-182, -10}}, color = {0, 0, 127}));
  connect(PFilterPu, lagP.u) annotation(
    Line(points = {{-210, 70}, {-182, 70}}, color = {0, 0, 127}));
  connect(gainK2.y, add2.u1) annotation(
    Line(points = {{-14, 4}, {5, 4}}, color = {0, 0, 127}));
  connect(omegaPu, limiter.y) annotation(
    Line(points = {{260, 141}, {190.5, 141}, {190.5, 135}, {179, 135}}, color = {0, 0, 127}));
 ...
 connect(feedback4.y, product1.u1) annotation(
  ...
  connect(VrefPu, feedback4.u1) annotation(
 ...
 connect(wPLLPu, multiSwitchP.u[1]) annotation(
 ...
 connect(VRefPu2.y, multiSwitchQOutput.u[1]) annotation(
 ...
 connect(integrator1.y, multiSwitchQOutput.u[4]) annotation(
    Line(points = {{96, -2}, {142, -2}, {142, -26}, {165, -26}}, color = {0, 0, 127}));
 connect(wPLLPu, addMinusOmega0.u1) annotation(
 ...
 connect(VrefPu, add5.u2) annotation(
