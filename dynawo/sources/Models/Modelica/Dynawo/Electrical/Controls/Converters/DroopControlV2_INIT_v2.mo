...
model DroopControlV2_INIT_v2 "Initialization model for the grid forming control"
  /*
  ...
  */
  ...
  // parameter Complex u0Pu = Complex(0.99,0)  "Start value of the complex voltage at ACPower PCC connection in pu (base UNom)";
   parameter Real PGen0Pu = 0.63 "start value of the reference active power (SRef, UNom)";
   parameter Real QGen0Pu = 0.12 "start-value of the reactive power reference  input (base UNom, SNom) (generator convention) ";
   parameter Real UFilterRef0Pu = 0.9 "start-value of the module voltage reference to be reached after the RLC filter connection point (base UNom, SNom)";
   parameter Types.VoltageModulePu U0Pu=0.9 "Start value of voltage amplitude at terminal in pu (base UNom)";
   parameter Types.Angle UPhase0=0.2 "Start value of voltage angle at terminal in rad";
   parameter Real PRef0Pu = 0.63 "start value of the reference active power (SRef, UNom)";
   parameter Real QRef0Pu = 0.12 "start-value of the reactive power reference  input (base UNom, SNom) (generator convention) ";
...
equation
  ...
  Complex(-PGen0Pu, -QGen0Pu) = u0Pu * ComplexMath.conj(i0Pu);
...
/* Power Calculation in SnRef convention (generator convention) */
  PMesure0Pu = (udPcc0Pu * idPcc0Pu + uqPcc0Pu * iqPcc0Pu) ;
  QMesure0Pu = (uqPcc0Pu * idPcc0Pu - udPcc0Pu * iqPcc0Pu) ;
//  QMesure0Pu = QGen0Pu;
 // PMesure0Pu = PGen0Pu;
/*Complex voltage*/
...
/*Voltage Reference Loop -- References*/
  udFilterRef0Pu = (QRef0Pu - QMesure0Pu) * Mq + UFilterRef0Pu - DeltaVVId0;
  uqFilterRef0Pu = -DeltaVVIq0;
/*Current Saturation -- References*/
  CurrentModule0 = sqrt(idConv0Pu * idConv0Pu + iqConv0Pu * iqConv0Pu);
  CurrentAngle0 = atan2(iqConv0Pu, idConv0Pu);
  if CurrentModule0 > Imax then
    ...
    if CurrentModule0 < Imin then
      ...
      idConvSatRef0Pu = idConv0Pu;
      iqConvSatRef0Pu = iqConv0Pu;
    end if;
  end if;
/*PLL*/
...
/*DroopControl*/
  ...
  omega0Pu = Mp * (PRef0Pu - PMesure0Pu) + omegaSetSelected0Pu;
