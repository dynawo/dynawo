...
model EpriCurrentCtrl
  extends Parameters.CurrentCtrl;
  extends Parameters.InitialCurrentCtrl;
  extends Parameters.Pref0Pu_;
  

  Modelica.Blocks.Interfaces.RealInput omegaPu(start = 1) "Converter's frequency in pu (base omegaNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput idConvPu(start = 0) "d-axis current in the converter in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput iqConvPu(start = 0) "q-axis current in the converter in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput idConvRefPu(start = 0) "d-axis current reference in the converter in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput iqConvRefPu(start = 0) "q-axis current reference in the converter in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput udFilterPu(start = 1) "d-axis voltage at the converter's capacitor in pu (base UNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput udConvRefPu(start = 1) "d-axis modulation voltage reference in pu (base UNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput uqConvRefPu(start = 0) "q-axis modulation voltage reference in pu (base UNom)" annotation(
  ...
  Modelica.Blocks.Continuous.Integrator integratord(k = Kii, y_start = 0.0) annotation(
  ...
  Modelica.Blocks.Math.Gain gainq(k = Kpi)  annotation(
    Placement(visible = true, transformation(origin = {-60, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.Integrator integratorq(initType = Modelica.Blocks.Types.Init.InitialState,k = Kii, y_start = 0.05) annotation(
    Placement(visible = true, transformation(origin = {-60, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Math.Gain gain(k = RFilter) annotation(
  ...
  Modelica.Blocks.Math.Gain gain1(k = RFilter) annotation(
    Placement(visible = true, transformation(origin = {-46, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder(T = tE, k = 1, y_start = 1) annotation(
    Placement(visible = true, transformation(origin = {158, 65}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder1(T = tE, k = 1, y_start = 0.05) annotation(
