...
model GridFollowingControl "Grid following control"
  ...
  parameter Types.PerUnit RPmaxPu "Maximal primary reserve in pu (base SNom)";
  ...
  parameter Types.PerUnit PRef0Pu "Start value of the active power reference at the converter terminal (filter) in pu (base SNom) (generator convention)";
  ...
  parameter Types.PerUnit IdcSourceRef0Pu "Start value of the DC source current reference in pu (base UNom, SNom)";
  ...
  Modelica.Blocks.Interfaces.RealInput PRefPu(start = PRef0Pu) "Active power reference at the converter terminal (filter) in pu (base SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput QRefPu(start = QRef0Pu) "Rective power reference at the converter terminal (filter) in pu (base SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput idConvPu(start = IdConv0Pu) "d-axis valve current (before filter) in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput iqConvPu(start = IqConv0Pu) "q-axis valve current (before filter) in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput IdcSourceRefPu(start = IdcSourceRef0Pu) "DC source reference current in pu (base UNom, SNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput UdcRefPu(start = Udc0Pu) "DC bus reference voltage in pu (base UNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput omegaPu(start = SystemBase.omegaRef0Pu) "Converter angular frequency in pu (base OmegaNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput IdcSourcePu(start = IdcSource0Pu) "DC source injected current in pu (base UNom, SNom)" annotation(
