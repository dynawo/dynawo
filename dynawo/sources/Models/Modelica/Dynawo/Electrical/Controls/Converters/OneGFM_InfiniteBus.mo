...
//  parameter Real omegaSetSelected0Pu = 1 "start value of the angular frequency selected";
  ...
  Modelica.Blocks.Sources.Step Pref(height = 0.3, offset = 0.5, startTime = 15) annotation(
