...
model IECWT4ACurrentLimitationAux "IEC Wind Turbine type 4A Current Limitation"
  ...
  /*Outputs*/
  Modelica.Blocks.Interfaces.RealOutput ipMaxPu(start = 0) "Maximum active current (Ibase)" annotation(
...
equation
  ...
  connect(booleanToInteger.y, product2.u[1]) annotation(
    Line(points = {{-88, 200}, {-70, 200}}, color = {255, 127, 0}));
  connect(product2.y, switch12.M) annotation(
    Line(points = {{-48.5, 200}, {110, 200}, {110, 114}}, color = {255, 127, 0}));
  connect(Ffrt, product2.u[2]) annotation(
    Line(points = {{-270, 226}, {-80, 226}, {-80, 200}, {-70, 200}}, color = {255, 127, 0}));
  ...
  connect(product2.y, switch14.M) annotation(
    Line(points = {{-48.5, 200}, {89, 200}, {89, -87}}, color = {255, 127, 0}));
...
end IECWT4ACurrentLimitationAux;
