...
model TwoGFM_OneInfiniBus
  ...
  Modelica.Blocks.Sources.Step Pref(height = 0, offset = 0.36, startTime = 0) annotation(
  ...
  Modelica.Blocks.Sources.Step step(height = 0, offset = 0.63, startTime = 0) annotation(
    Placement(visible = true, transformation(origin = {-164, -152}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Step step2(height = 0, offset = 0.12, startTime = 0) annotation(
    Placement(visible = true, transformation(origin = {-186, -52}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Step step3(height = 0, offset = 0.9, startTime = 0) annotation(
    Placement(visible = true, transformation(origin = {-206, -114}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Buses.InfiniteBus infiniteBus(UPhase = 0, UPu = 1)  annotation(
