...
model CurrentLimitation "Current Limitation with active power prioritization"
  ...
  Modelica.Blocks.Interfaces.RealInput idConvRefNLPu(start = IdConv0Pu) "d-axis reference for the valve current before limitation in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput iqConvRefNLPu(start = IqConv0Pu) "q-axis reference for the valve current before limitation in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput idMaxPu(start = PMaxPu/UdFilter0Pu) "d-axis maximal valve current in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput idConvRefPu(start = IdConv0Pu) "d-axis reference for the valve current after limitation in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput iqConvRefPu(start = IqConv0Pu) "q-axis reference for the valve current after limitation in pu (base UNom, SNom) " annotation(
