...
model VirtualImpedance "Virtual Impedance model for the current limitation"
  ...
  Modelica.Blocks.Interfaces.RealOutput DeltaVVId(start = DeltaVVId0) annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput DeltaVVIq(start = DeltaVVIq0) annotation(
...
equation
  ...
  connect(product3.u2, icq) annotation(
  ...
  connect(product4.u2, icq) annotation(
  ...
  connect(product5.u2, icd) annotation(
