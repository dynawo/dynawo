...
model GlobalMatchingControl_INIT "Initialization model for the global matching control"
  ...
  parameter Types.PerUnit idcref0 "Start value of the DC current reference";
  ...
  DeltaVVIq0 = 0;
  DeltaVVId0 = 0;
  idcref0*vdcref0 = Veffref0 * iod0;
  voqref0 = 0;
  vodref0 = Veffref0;
  vdc0 = vdcref0;

end GlobalMatchingControl_INIT;
