...
record Circuit
  parameter Types.PerUnit RPu "Resistance in pu (base SnRef, UNom), example value = 0.0015" annotation(Dialog(tab = "Circuit"));
  parameter Types.PerUnit XPu "Reactance in pu (base SnRef, UNom), example value = 0.15" annotation(Dialog(tab = "Circuit"));
  parameter Types.PerUnit GPu "Half-conductance in pu (base SnRef, UNom), example value = 0" annotation(Dialog(tab = "Circuit"));
  parameter Types.PerUnit BPu "Half-susceptance in pu (base SnRef, UNom), example value = 0" annotation(Dialog(tab = "Circuit"));
end Circuit;
...
record CurrentCtrl
  ...
  parameter Types.PerUnit LFilterPu "Filter inductance in pu (base UNom, SNom), example value = 0.15" annotation(Dialog(tab = "CurrentCtrl"));
  parameter Types.PerUnit RFilterPu "Filter resistance in pu (base UNom, SNom), example value = 0.00015" annotation(Dialog(tab = "CurrentCtrl"));
...
record Pref0Pu_
  parameter Types.ActivePowerPu Pref0Pu "Initial active power in pu (base SNom) (generator convention)" annotation(Dialog(tab = "General"));
end Pref0Pu_;
