...
model IECWT4AMeasuresAux
  ...
  /*Inputs*/
  Modelica.Blocks.Interfaces.RealInput iWtRePu(start = 0) "WTT active current phasor in power system coordinates (Ubase)" annotation(
  ...
  Types.PerUnit IWtPu(start = sqrt(Q0Pu ^ 2) * SystemBase.SnRef / (SNom * U0Pu)) "Module of the current at PCC in pu (base UNom, SNom)";
  ...
  Modelica.Blocks.Continuous.Derivative derivative(T = Tffilt, k = 1 / SystemBase.omegaNom, x_start = UPhase0, y_start = 0) annotation(
    Placement(visible = true, transformation(origin = {10, -79.5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(uWtRePu, rectangularToPolar1.u_re) annotation(
    Line(points = {{-120, 0}, {-60, 0}, {-60, -38}, {-56, -38}}, color = {0, 0, 127}));
  connect(rectangularToPolar1.y_abs, firstOrder3.u) annotation(
    Line(points = {{-33, -38}, {0, -38}, {0, -19.5}, {48, -19.5}}, color = {0, 0, 127}));
  ...
  connect(uWtImPu, rectangularToPolar1.u_im) annotation(
    Line(points = {{-120, -50}, {-56, -50}}, color = {0, 0, 127}));
  ...
  connect(rectangularToPolar1.y_arg, theta) annotation(
    Line(points = {{-33, -50}, {46, -50}, {46, -60}, {120, -60}}, color = {0, 0, 127}));
  connect(omegaRefPu, add.u2) annotation(
    Line(points = {{-120, -100}, {-80, -100}, {-80, -106.5}, {68, -106.5}}, color = {0, 0, 127}));
  connect(rectangularToPolar1.y_arg, derivative.u) annotation(
    Line(points = {{-33, -50}, {-28, -50}, {-28, -80}, {-2, -80}, {-2, -79.5}}, color = {0, 0, 127}));
  connect(rectangularToPolar1.y_abs, uWTCPu) annotation(
    Line(points = {{-33, -38}, {0, -38}, {0, 19.5}, {120, 19.5}}, color = {0, 0, 127}));
  ...
  connect(derivative.y, add.u1) annotation(
    Line(points = {{22, -80}, {40, -80}, {40, -94}, {68, -94}, {68, -94}}, color = {0, 0, 127}));
