...
model GridFormingControlDroopControl "Grid Forming Control with Droop Control"
  ...
  Modelica.Blocks.Interfaces.RealInput UdcRefPu (start = Udc0Pu) "reference DC voltage on the DC side in p.u (base UNom, SNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput UdcPu (start = Udc0Pu) "DC voltage on the DC side in p.u (base UNom, SNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput UdcRefOutPu (start = Udc0Pu) "reference DC voltage on the DC side in p.u (base UNom, SNom)" annotation(
