...
model PControl "Active power control"
  ...
  Modelica.Blocks.Interfaces.RealOutput idConvRefNLPu(start = IdConv0Pu) "d-axis reference for the valve current before limitation in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput idMaxPu(start = PMaxPu/UdFilter0Pu) "d-axis maximal valve current in pu (base UNom, SNom) (generator convention)" annotation(
