...
model CurrentFilterLoopQSEM
  import Modelica.Constants.pi;

  parameter Real EpsilonCurrent "Damping of the close current loop";
  parameter Real Fsw "Switching frequency of the VSC in Hz";
  parameter Real Gffv "Sensitivity to the voltage variation at the RLC filter capacitance";
  ...
  Modelica.Blocks.Interfaces.RealInput idConvSatRefPu(start=idConvSatRef0Pu) "d-axis currrent reference for the inverter bridge output in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput iqConvSatRefPu(start=iqConvSatRef0Pu) "q-axis currrent reference for the inverter bridge output in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Continuous.Integrator integrator(k = Kic, y_start = idConvSatRef0Pu - idConv0Pu) annotation(
    Placement(visible = true, transformation(origin = {12, 36}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Math.Gain gain1(k = LFilter) annotation(
  ...
  Modelica.Blocks.Math.Gain gain3(k = LFilter) annotation(
    Placement(visible = true, transformation(origin = {18, -242}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.Integrator integrator1(k = Kic, y_start = iqConvSatRef0Pu - iqConv0Pu) annotation(
  ...
  Modelica.Blocks.Continuous.FirstOrder firstOrder(T = 0.0000002, k = 1, y_start = 0)  annotation(
    Placement(visible = true, transformation(origin = {-74, -106}, extent = {{-18, -18}, {18, 18}}, rotation = 0)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder1(T = 0.0000002, k = 1, y_start = 0) annotation(
    Placement(visible = true, transformation(origin = {-76, -322}, extent = {{-18, -18}, {18, 18}}, rotation = 0)));

  parameter Types.PerUnit idConvSatRef0Pu "Start value of the d-axis currrent reference for the inverter bridge output in pu (base UNom, SNom) (generator convention)";
  parameter Types.PerUnit iqConvSatRef0Pu "Start value of the q-axis currrent reference for the inverter bridge output in pu (base UNom, SNom) (generator convention)";
...
equation
  ...
  connect(idConvSatRefPu, feedback.u1) annotation(
  ...
  connect(iqConvSatRefPu, feedback2.u1) annotation(
