...
model GlobalDispatchableVirtualOscillatorControl "Global Dispatchable Virtual Oscillator Control"
  ...
  Dynawo.Electrical.Controls.Converters.BaseControls.DispatchableVirtualOscillatorControl dispatchableVirtualOscillatorControl(Alpha = Alpha, Eta = Eta, Pref0 = Pref0, Qref0 = Qref0, KDvoc = KDvoc, Theta0 = Theta0, IPCCd0 = IPCCd0, IPCCq0 = IPCCq0, VFilterd0 = VFilterd0, VFilterq0 = VFilterq0)  annotation(
...
equation
  ...
  connect(iPCCd, dispatchableVirtualOscillatorControl.iPCCd) annotation(
    Line(points = {{-53, -35}, {-13, -35}, {-13, 9}, {-13, 9}}, color = {0, 0, 127}));
  connect(iPCCq, dispatchableVirtualOscillatorControl.iPCCq) annotation(
  ...
  connect(vFilterd, dispatchableVirtualOscillatorControl.vFilterd) annotation(
    Line(points = {{-53, -55}, {-4, -55}, {-4, 9}, {-4, 9}}, color = {0, 0, 127}));
  connect(vFilterq, dispatchableVirtualOscillatorControl.vFilterq) annotation(
    Line(points = {{-53, -50}, {-1, -50}, {-1, 9}, {-1, 9}}, color = {0, 0, 127}));
  connect(dispatchableVirtualOscillatorControl.vFilterqref, voltageLoop.vFilterqref) annotation(
  ...
  connect(dispatchableVirtualOscillatorControl.vFilterdref, voltageLoop.vFilterdref) annotation(
