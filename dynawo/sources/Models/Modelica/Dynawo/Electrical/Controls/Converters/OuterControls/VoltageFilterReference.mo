...
equation
  ...
  connect(add2.y, add.u1) annotation(
    Line(points = {{32, 4}, {62, 4}, {62, 6}}, color = {0, 0, 127}));
  connect(add.u2, feedback.y) annotation(
    Line(points = {{62, -6}, {36, -6}, {36, -70}}, color = {0, 0, 127}));
  connect(add.y, feedback2.u1) annotation(
    Line(points = {{86, 0}, {108, 0}, {108, 2}}, color = {0, 0, 127}));
  connect(feedback2.y, udFilterRefPu) annotation(
