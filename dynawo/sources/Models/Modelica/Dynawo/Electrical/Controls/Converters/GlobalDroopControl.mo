...
model GlobalDroopControl "Global Droop Control"
  ...
  Dynawo.Electrical.Controls.Converters.BasicBlocks.DroopControl droopControl(DeltaVVId0 = DeltaVVId0, DeltaVVIq0 = DeltaVVIq0, Kff = Kff, Mp = Mp, Mq = Mq, Pref0 = Pref0, Qref0 = Qref0, Veffref0 = Veffref0, Wf = Wf, Wff = Wff, deph0 = deph0, iod0 = iod0, ioq0 = ioq0, omega0Pu = omega0Pu, omegaRef0Pu = omegaRef0Pu, vod0 = vod0, vodref0 = vodref0, voq0 = voq0, voqref0 = voqref0, wref0 = wref0)  annotation(
...
equation
  ...
  connect(droopControl.voqref, voltageLoop.voqref) annotation(
    Line(points = {{1, 11}, {9, 11}, {9, 11}, {9, 11}}, color = {0, 0, 127}));
  connect(droopControl.vodref, voltageLoop.vodref) annotation(
  ...
  connect(iod, droopControl.iod) annotation(
    Line(points = {{-53, -35}, {-13, -35}, {-13, 9}, {-13, 9}}, color = {0, 0, 127}));
  connect(ioq, droopControl.ioq) annotation(
  ...
  connect(voq, droopControl.voq) annotation(
    Line(points = {{-53, -50}, {-4, -50}, {-4, 9}, {-4, 9}}, color = {0, 0, 127}));
  connect(vod, droopControl.vod) annotation(
  ...
  connect(droopControl.deph, deph) annotation(
