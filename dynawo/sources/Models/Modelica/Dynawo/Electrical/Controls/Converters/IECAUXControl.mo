...
model IECAUXControl "IEC Wind Turbine type 4A Control"
  ...
  /*Inputs*/
  Modelica.Blocks.Interfaces.RealInput iWtRePu(start = 0) "Real component of the current at the wind turbine terminals in pu (Ubase,SNom) in generator convention" annotation(
    Placement(visible = true, transformation(origin = {-170, 79}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {80, -110}, extent = {{10, -10}, {-10, 10}}, rotation = 270)));
  Modelica.Blocks.Interfaces.RealInput iWtImPu(start = -i0Pu.im * SystemBase.SnRef / SNom) "Imaginary component of the current at the wind turbine terminals n pu (Ubase,SNom) in generator convention" annotation(
    Placement(visible = true, transformation(origin = {-169.5, 39.5}, extent = {{-19.5, -19.5}, {19.5, 19.5}}, rotation = 0), iconTransformation(origin = {40, -110}, extent = {{10, 10}, {-10, -10}}, rotation = 270)));
  ...
  Modelica.Blocks.Interfaces.RealInput QRefPu(start = -Q0Pu * SystemBase.SnRef / SNom ) "Reactive power reference at the wind turbine terminals in pu (SNom) in generator convention" annotation(
    Placement(visible = true, transformation(origin = {-169, -119}, extent = {{-19, -19}, {19, 19}}, rotation = 0), iconTransformation(origin = {110, 50}, extent = {{-10, 10}, {10, -10}}, rotation = 180)));
  Modelica.Blocks.Interfaces.RealInput omegaRefPu(start = SystemBase.omegaRef0Pu) annotation(
    Placement(visible = true, transformation(origin = {-169, -70}, extent = {{-19, -19}, {19, 19}}, rotation = 0), iconTransformation(origin = {110, -50}, extent = {{-10, 10}, {10, -10}}, rotation = 180)));

  /*Outputs*/
  Modelica.Blocks.Interfaces.RealOutput ipCmdPu(start = 0) "d-axis reference current at the generator system module (converter) terminal in pu (Ubase,SNom) in generator convention" annotation(
    Placement(visible = true, transformation(origin = {170, 120}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-110, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  ...
  Modelica.Blocks.Interfaces.RealOutput ipMaxPu(start = 0) "Maximal d-axis reference current at the generator system module (converter) terminal in pu (Ubase,SNom) in generator convention" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput theta(start = UPhase0) "Phase shift between the converter's rotating frame and the grid rotating frame in radians" annotation(
    Placement(visible = true, transformation(origin = {170, -60.5}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {0, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));

  /*Blocks*/
  Dynawo.Electrical.Controls.Converters.BaseControls.IECWT4AMeasuresAux iECWT4AMeasuresAux(P0Pu = P0Pu, Q0Pu = Q0Pu, SNom = SNom, Tffilt = Tffilt, Tpfilt = Tpfilt, Tqfilt = Tqfilt, Tufilt = Tufilt, U0Pu = U0Pu, UPhase0 = UPhase0, i0Pu = i0Pu, u0Pu = u0Pu) annotation(
    Placement(visible = true, transformation(origin = {-99.5, 9.5}, extent = {{-30.5, -30.5}, {30.5, 30.5}}, rotation = 0)));

  Dynawo.Electrical.Controls.Converters.BaseControls.IECWT4ACurrentLimitationAux iECWT4ACurrentLimitationAux( IMax = IMax, IMaxDip = IMaxDip, IMaxHookPu = IMaxHookPu,IpMax0Pu = IpMax0Pu,IqMax0Pu = IqMax0Pu, IqMaxHook = IqMaxHook, IqMin0Pu = IqMin0Pu, Kpqu = Kpqu, Mdfslim = false, Mqpri = Mqpri, P0Pu = P0Pu, Q0Pu = Q0Pu, SNom = SNom, U0Pu = U0Pu, UPhase0 = UPhase0, UpquMax = UpquMax) annotation(
    Placement(visible = true, transformation(origin = {91, 0}, extent = {{-25, -25}, {25, 25}}, rotation = 0)));

  Dynawo.Electrical.Controls.Converters.BaseControls.IECWT4AQControl iECWT4AQControl( IdfHook = IdfHook, IpfHook = IpfHook, IqH1 = IqH1, IqMax = IqMax, IqMin = IqMin, IqPost = IqPost,Kiq = Kiq, Kiu = Kiu, Kpq = Kpq, Kpu = Kpu, Kpufrt = Kpufrt, Kqv = Kqv, MqG = MqG, Mqfrt = Mqfrt, P0Pu = P0Pu, Q0Pu = Q0Pu, QMax0Pu = QMax0Pu, QMin0Pu = QMin0Pu, RWTDrop = RDrop, SNom = SNom, Td = Td, TqOrd = TqOrd, Ts = Ts, Tuss = Tuss, U0Pu = U0Pu, UMax = UMax, UMin = UMin, UdbOne = UdbOne, UdbTwo = UdbTwo, UqDip = UqDip, UqRise = UqRise, XWTDrop = XDrop) annotation(
...
equation
 connect(iECWT4ACurrentLimitationAux.iqMaxPu, iqMaxPu) annotation(
    Line(points = {{119, 0}, {140.5, 0}, {140.5, 20.5}, {169.5, 20.5}}, color = {0, 0, 127}));
 connect(iECWT4ACurrentLimitationAux.iqMinPu, iqMinPu) annotation(
    Line(points = {{119, -17}, {130, -17}, {130, -22}, {170, -22}}, color = {0, 0, 127}));
 connect(iECWT4AMeasuresAux.uWTCfiltPu, iECWT4ACurrentLimitationAux.uWTCfiltPu) annotation(
    Line(points = {{-66, 19}, {0, 19}, {0, 11}, {63, 11}}, color = {0, 0, 127}));
  connect(QRefPu, iECWT4AQControl.xWTRefPu) annotation(
    Line(points = {{-169, -119}, {-130, -119}, {-130, -98}, {-20, -98}}, color = {0, 0, 127}));
  connect(iWtRePu, iECWT4AMeasuresAux.iWtRePu) annotation(
    Line(points = {{-170, 79}, {-144, 79}, {-144, 33}, {-133, 33}}, color = {0, 0, 127}));
  connect(uWtRePu, iECWT4AMeasuresAux.uWtRePu) annotation(
    Line(points = {{-169.5, -0.5}, {-150, -0.5}, {-150, 9.5}, {-133, 9.5}}, color = {0, 0, 127}));
  connect(uWtImPu, iECWT4AMeasuresAux.uWtImPu) annotation(
    Line(points = {{-169.5, -39.5}, {-145, -39.5}, {-145, -3}, {-133, -3}}, color = {0, 0, 127}));
  connect(iECWT4AMeasuresAux.qWTCfiltPu, iECWT4AQControl.qWTCfiltPu) annotation(
    Line(points = {{-66, -18}, {-60, -18}, {-60, -89}, {-20, -89}}, color = {0, 0, 127}));
 connect(iECWT4AQControl.Ffrt, iECWT4ACurrentLimitationAux.Ffrt) annotation(
    Line(points = {{39, -87}, {45, -87}, {45, -11}, {63, -11}}, color = {255, 127, 0}));
  ...
  connect(iECWT4AMeasuresAux.pWTCfiltPu, iECWT4AQLimitation.pWTCfiltPu) annotation(
    Line(points = {{-66, -9}, {-40, -9}, {-40, -80}, {-100, -80}, {-100, -122}, {-82, -122}}, color = {0, 0, 127}));
 connect(iECWT4AMeasuresAux.omegaRefFiltPu, iECWT4ACurrentLimitationAux.OmegaPu) annotation(
    Line(points = {{-66, 9.5}, {-10, 9.5}, {-10, 0}, {63, 0}}, color = {0, 0, 127}));
  connect(iECWT4AMeasuresAux.uWTCfiltPu, iECWT4AQControl.uWTCfiltPu) annotation(
    Line(points = {{-66, 19}, {-50, 19}, {-50, -72}, {-20, -72}}, color = {0, 0, 127}));
  connect(iECWT4AMeasuresAux.pWTCfiltPu, iECWT4AQControl.pWTCfiltPu) annotation(
    Line(points = {{-66, -9}, {-40, -9}, {-40, -80}, {-20, -80}}, color = {0, 0, 127}));
 connect(iECWT4AQControl.iqCmdPu, iECWT4ACurrentLimitationAux.iqCmdPu) annotation(
    Line(points = {{39, -113}, {50, -113}, {50, -22}, {63, -22}}, color = {0, 0, 127}));
  connect(iWtImPu, iECWT4AMeasuresAux.iWtImPu) annotation(
    Line(points = {{-169, 40}, {-150, 40}, {-150, 22}, {-133, 22}}, color = {0, 0, 127}));
  connect(omegaRefPu, iECWT4AMeasuresAux.omegaRefPu) annotation(
  ...
  connect(iECWT4AMeasuresAux.theta, iECWT4APll.theta) annotation(
    Line(points = {{-66, 0}, {-20, 0}, {-20, -46}, {67, -46}}, color = {0, 0, 127}));
  connect(iECWT4AMeasuresAux.uWTCPu, iECWT4APll.uWTCPu) annotation(
    Line(points = {{-66, 37}, {-30, 37}, {-30, -60}, {67, -60}, {67, -60}}, color = {0, 0, 127}));
  connect(iECWT4AMeasuresAux.uWTCfiltPu, iECWT4AQLimitation.uWTCfiltPu) annotation(
    Line(points = {{-66, 19}, {-50, 19}, {-50, -72}, {-90, -72}, {-90, -110}, {-82, -110}, {-82, -110}}, color = {0, 0, 127}));
 connect(const.y, iECWT4ACurrentLimitationAux.ipCmdPu) annotation(
    Line(points = {{-129, 120}, {30, 120}, {30, 22}, {63, 22}}, color = {0, 0, 127}));
  connect(const.y, ipCmdPu) annotation(
    Line(points = {{-129, 120}, {170, 120}}, color = {0, 0, 127}));
  connect(const.y, ipMaxPu) annotation(
    Line(points = {{-129, 120}, {30, 120}, {30, 60}, {170, 60}, {170, 60}}, color = {0, 0, 127}));

annotation(
    Diagram(coordinateSystem(grid = {1, 1}, extent = {{-150, -150}, {150, 150}})),
    preferredView = "diagram",
    Icon(coordinateSystem(grid = {1, 1}, initialScale = 0.1), graphics = {Rectangle(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {0, 30}, extent = {{-90, -30}, {90, 30}}, textString = "AUX"), Text(origin = {0, -30}, extent = {{-90, -30}, {90, 30}}, textString = "control")}));
