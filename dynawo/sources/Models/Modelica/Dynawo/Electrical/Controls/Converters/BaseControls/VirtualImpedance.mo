...
model VirtualImpedance "Virtual Impedance model for the current limitation"
  ...
  Modelica.Blocks.Interfaces.RealOutput DeltaVVId(start = 0) annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput DeltaVVIq(start = 0) annotation(
...
equation
  ...
  connect(product3.u2, iConvq) annotation(
  ...
  connect(product4.u2, iConvq) annotation(
  ...
  connect(product5.u2, iConvd) annotation(
