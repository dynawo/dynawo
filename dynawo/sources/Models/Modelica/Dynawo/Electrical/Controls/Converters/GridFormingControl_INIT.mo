...
model GridFormingControl_INIT "Initialization model for the grid forming control"
  ...
  Dynawo.Connectors.CurrentModulePuConnector IdcSource0Pu "Start value of DC current in pu (base UdcNom, SNom)";
  Dynawo.Connectors.VoltageModulePuConnector UdcSource0Pu "Start value of DC voltage in pu (base UdcNom)";
  Types.VoltageModulePu UdcSourceRef0Pu "Start value of DC voltage reference in pu (base UdcNom)";
  Dynawo.Connectors.VoltageComponentPuConnector UdConv0Pu "Start value of d-axis modulation voltage in pu (base UNom)";
  Dynawo.Connectors.VoltageComponentPuConnector UqConv0Pu "Start value of q-axis modulation voltage in pu (base UNom)";
  Dynawo.Connectors.CurrentComponentPuConnector IdConv0Pu "Start value of d-axis current in the converter in pu (base UNom, SNom) (generator convention)";
  Dynawo.Connectors.CurrentComponentPuConnector IqConv0Pu "Start value of q-axis current in the converter in pu (base UNom, SNom) (generator convention)";
  ...
  Dynawo.Connectors.CurrentComponentPuConnector IdPcc0Pu "Start value of d-axis current in the grid in pu (base UNom, SNom) (generator convention)";
  Dynawo.Connectors.CurrentComponentPuConnector IqPcc0Pu "Start value of q-axis current in the grid in pu (base UNom, SNom) (generator convention)";
  Dynawo.Connectors.VoltageComponentPuConnector UdFilter0Pu "Start value of d-axis voltage at the converter's capacitor in pu (base UNom)";
  Dynawo.Connectors.VoltageComponentPuConnector UqFilter0Pu "Start value of q-axis voltage at the converter's capacitor in pu (base UNom)";
