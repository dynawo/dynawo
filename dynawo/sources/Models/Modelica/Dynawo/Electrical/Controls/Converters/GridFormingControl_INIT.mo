...
model GridFormingControl_INIT "Initialization model for the grid forming control"
  ...
  Dynawo.Connectors.PerUnitInput IdcSource0Pu "Start value of DC current in pu (base UdcNom, SNom)";
  Dynawo.Connectors.PerUnitInput UdcSource0Pu "Start value of DC voltage in pu (base UdcNom)";
  Types.PerUnit UdcSourceRef0Pu "Start value of DC voltage reference in pu (base UdcNom)";
  Dynawo.Connectors.PerUnitInput UdConv0Pu "Start value of d-axis modulation voltage in pu (base UNom)";
  Dynawo.Connectors.PerUnitInput UqConv0Pu "Start value of q-axis modulation voltage in pu (base UNom)";
  Dynawo.Connectors.PerUnitInput IdConv0Pu "Start value of d-axis current in the converter in pu (base UNom, SNom) (generator convention)";
  Dynawo.Connectors.PerUnitInput IqConv0Pu "Start value of q-axis current in the converter in pu (base UNom, SNom) (generator convention)";
  ...
  Dynawo.Connectors.PerUnitOutput IdPcc0Pu "Start value of d-axis current in the grid in pu (base UNom, SNom) (generator convention)";
  Dynawo.Connectors.PerUnitOutput IqPcc0Pu "Start value of q-axis current in the grid in pu (base UNom, SNom) (generator convention)";
  Dynawo.Connectors.PerUnitInput UdFilter0Pu "Start value of d-axis voltage at the converter's capacitor in pu (base UNom)";
  Dynawo.Connectors.PerUnitInput UqFilter0Pu "Start value of q-axis voltage at the converter's capacitor in pu (base UNom)";
  ...
  Dynawo.Connectors.ActivePowerPuInput PFilter0Pu "Start value of active power generated at the converter's capacitor in pu (base SNom) (generator convention)";
  Dynawo.Connectors.ReactivePowerPuInput QFilter0Pu "Start value of reactive power generated at the converter's capacitor in pu (base SNom) (generator convention)";
