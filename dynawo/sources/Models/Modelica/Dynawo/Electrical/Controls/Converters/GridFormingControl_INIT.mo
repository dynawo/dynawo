...
model GridFormingControl_INIT "Initialization model for the grid forming control"
  ...
  Modelica.Blocks.Interfaces.RealOutput UdcSource0Pu "Start value of DC voltage in pu (base UdcNom)";
  Types.PerUnit UdcSourceRef0Pu "Start value of DC voltage reference in pu (base UdcNom)";
  Modelica.Blocks.Interfaces.RealOutput UdConv0Pu "Start value of d-axis modulation voltage in pu (base UNom)";
  Modelica.Blocks.Interfaces.RealOutput UqConv0Pu "Start value of q-axis modulation voltage in pu (base UNom)";
  Modelica.Blocks.Interfaces.RealOutput IdConv0Pu "Start value of d-axis current in the converter in pu (base UNom, SNom) (generator convention)";
  ...
  Modelica.Blocks.Interfaces.RealOutput IqPcc0Pu "Start value of q-axis current in the grid in pu (base UNom, SNom) (generator convention)";
  Modelica.Blocks.Interfaces.RealOutput UdFilter0Pu "Start value of d-axis voltage at the converter's capacitor in pu (base UNom)";
  Modelica.Blocks.Interfaces.RealOutput UqFilter0Pu "Start value of q-axis voltage at the converter's capacitor in pu (base UNom)";
