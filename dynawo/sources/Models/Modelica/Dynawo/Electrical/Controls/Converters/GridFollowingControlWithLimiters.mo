...
model GridFollowingControlWithLimiters
  import Modelica;
  import Dynawo;
  //Model parameters
  ...
  BaseControls.ActivePowerLoopWithLimiters activePowerLoopWithLimiters(Kip = Kip, Kpp = Kpp, PGen0Pu = PGen0Pu, PGenRef0Pu = PGen0Pu, Tlpf = Tlpf, InomPu = InomPu, Trlim = Trlim, didt_min = didt_min, didt_max = didt_max, idConv0Pu = idConv0Pu, iqConv0Pu = iqConv0Pu) annotation(
    Placement(transformation(origin = {-60.5, 42.5}, extent = {{-26.5, -26.5}, {26.5, 26.5}})));
  BaseControls.ReactivePowerLoopWithLimiters reactivePowerLoopWithLimiters(Kiv = Kiv, Kpv = Kpv, Tlpf = Tlpf, UConv0Pu = UConv0Pu, UConvRef0Pu = UConv0Pu, InomPu = InomPu, idConv0Pu = idConv0Pu, iqConv0Pu = iqConv0Pu) annotation(
...
equation
  ...
  connect(PGenRefPu, activePowerLoopWithLimiters.PGenRefPu) annotation(
    Line(points = {{-130, 57}, {-130, 56}, {-90, 56}}, color = {0, 0, 127}));
  connect(PGenPu, activePowerLoopWithLimiters.PGenPu) annotation(
    Line(points = {{-130, 29}, {-90, 29}}, color = {0, 0, 127}));
  connect(activePowerLoopWithLimiters.idRefPu, currentLoopGFL.idConvRefPu) annotation(
    Line(points = {{-31, 42.5}, {-31, 43}, {19, 43}, {19, 42}}, color = {0, 0, 127}));
  connect(iqConvPu, activePowerLoopWithLimiters.iqConvPu) annotation(
    Line(points = {{-130, -110}, {-101, -110}, {-101, 72}, {-60.5, 72}}, color = {0, 0, 127}));
  connect(UConvPu, reactivePowerLoopWithLimiters.UConvPu) annotation(
    Line(points = {{-130, 1}, {-90, 1}}, color = {0, 0, 127}));
  connect(UConvRefPu, reactivePowerLoopWithLimiters.UConvRefPu) annotation(
    Line(points = {{-130, -13}, {-90, -13}}, color = {0, 0, 127}));
  connect(reactivePowerLoopWithLimiters.iqRefPu, currentLoopGFL.iqConvRefPu) annotation(
    Line(points = {{-31, -20}, {1, -20}, {1, -12}, {19, -12}}, color = {0, 0, 127}));
  annotation(
    Diagram(coordinateSystem(grid = {1, 1}, extent = {{-120, -150}, {120, 150}})),
    preferredView = "diagram",
    Icon(coordinateSystem(grid = {1, 1})));
end GridFollowingControlWithLimiters;
