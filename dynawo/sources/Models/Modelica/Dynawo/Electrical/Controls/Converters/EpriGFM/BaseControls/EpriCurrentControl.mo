...
model EpriCurrentControl "Current controller in EPRI Grid Forming model"
  ...
  Modelica.Blocks.Interfaces.RealInput iqConvPu(start = if OmegaFlag == 0 then - IqConv0Pu else IqConv0Pu) "Q-axis current of the converter in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput iqConvRefPu(start = if OmegaFlag == 0 then - IqConv0Pu else IqConv0Pu) "Q-axis current reference of the converter in pu (base UNom, SNom) (generator convention)" annotation(
