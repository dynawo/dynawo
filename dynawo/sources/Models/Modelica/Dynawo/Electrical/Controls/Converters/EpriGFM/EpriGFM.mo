...
model EpriGFM
  ...
  EpriVoltageCtrl epriVoltageCtrl(CFilter = CFilter, IdConv0Pu = IdConv0Pu, IdPcc0Pu = IdPcc0Pu, IqConv0Pu = IqConv0Pu, IqPcc0Pu = IqPcc0Pu, Kip = Kip, Kiv = Kiv, Kpp = Kpp, Kpv = Kpv, QDroop = QDroop, UdFilter0Pu = UdFilter0Pu, UqFilter0Pu = UqFilter0Pu, wDroop = wDroop, wflag = wflag) annotation(
