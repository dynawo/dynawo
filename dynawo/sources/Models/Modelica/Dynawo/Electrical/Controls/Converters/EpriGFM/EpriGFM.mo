...
model EpriGFM "EPRI Grid Forming model"
  ...
  Dynawo.Electrical.Controls.Converters.EpriGFM.BaseControls.Comptodq comptodq(IdConv0Pu = IdConv0Pu, IqConv0Pu = IqConv0Pu,KIPll = KIPll, KPPll = KPPll, OmegaFlag = OmegaFlag, OmegaMaxPu = OmegaMaxPu, OmegaMinPu = OmegaMinPu, Theta0 = Theta0, UdFilter0Pu = UdFilter0Pu, UqFilter0Pu = UqFilter0Pu, i0Pu = i0Pu, u0Pu = u0Pu) annotation(
...
equation
  ...
  connect(comptodq.omegaPLLPu, gfm.omegaPLLPu) annotation(
    Line(points = {{95, -42}, {-287.3, -42}, {-287.3, 15.4}, {-268.3, 15.4}}, color = {23, 156, 125}));
  connect(measurements.iPu, comptodq.iInjPu) annotation(
    Line(points = {{355.2, 9.1}, {355.2, -64}, {148, -64}}, color = {85, 170, 255}));
  connect(measurements.uPu, comptodq.uInjPu) annotation(
    Line(points = {{347.6, 9.1}, {347.6, -74}, {148, -74}}, color = {85, 170, 255}));
  ...
  connect(gfm.omegaPu, epriCurrentCtrl.omegaPu) annotation(
    Line(points = {{-224.7, 16.2}, {-217.7, 16.2}, {-217.7, -3.8}, {12.3, -3.8}, {12.3, 8}, {21, 8}}, color = {0, 0, 127}));
  ...
  connect(gfm.QPu, measurements.QPu) annotation(
    Line(points = {{-276, 30}, {-286, 30}, {-286, 86}, {366, 86}, {366, -6}, {336, -6}, {336, 10}}, color = {0, 170, 127}));
  connect(measurements.PPu, gfm.PPu) annotation(
    Line(points = {{328, 10}, {332, 10}, {332, -10}, {370, -10}, {370, 90}, {-292, 90}, {-292, 34}, {-276, 34}}, color = {0, 170, 127}));
  ...
  connect(PAuxPu, gfm.PAuxPu) annotation(
    Line(points = {{-420, -120}, {-264, -120}, {-264, 4}}, color = {166, 187, 200}));
  ...
  connect(QAuxPu, gfm.QAuxPu) annotation(
    Line(points = {{-420, -160}, {-260, -160}, {-260, 4}}, color = {166, 187, 200}));
  ...
  connect(UdFilterRefPu, gfm.URefPu) annotation(
    Line(points = {{-420, 24}, {-276, 24}}, color = {166, 187, 200}));
  ...
  connect(PRefPu, gfm.PRefPu) annotation(
    Line(points = {{-420, 180}, {-332, 180}, {-332, 46}, {-276, 46}}, color = {166, 187, 200}));
  ...
  connect(QRefPu, gfm.QRefPu) annotation(
    Line(points = {{-420, 140}, {-338, 140}, {-338, 42}, {-276, 42}}, color = {166, 187, 200}));
