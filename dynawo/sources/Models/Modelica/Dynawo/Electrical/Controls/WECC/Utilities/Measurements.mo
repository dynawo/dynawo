...
equation
  ...
  PPuSnRef = ComplexMath.real(terminal1.V * ComplexMath.conj(iPu));
  QPuSnRef = ComplexMath.imag(terminal1.V * ComplexMath.conj(iPu));
  PPu = PPuSnRef * SystemBase.SnRef / SNom;
  QPu = QPuSnRef * SystemBase.SnRef / SNom;
