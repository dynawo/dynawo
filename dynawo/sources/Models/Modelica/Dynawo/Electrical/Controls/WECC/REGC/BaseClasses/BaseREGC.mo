...
partial model BaseREGC "Base class for WECC Generator Converter REGC"
  ...
  Modelica.Blocks.Interfaces.RealInput UPu(start = U0Pu) "Inverter terminal voltage magnitude in pu (base UNom)" annotation(
  ...
  Modelica.Blocks.Continuous.FirstOrder firstOrder(T = tFilterGC, k = 1, y_start = U0Pu) annotation(
