...
partial model BaseREGC "Base class for WECC Generator Converter REGC"
  ...
  Dynawo.NonElectrical.Blocks.Continuous.RateLimFirstOrderFreeze rateLimFirstOrderFreeze2(UseRateLim = true, Y0 = Iq0Pu) annotation(
  ...
  Modelica.Blocks.Continuous.FirstOrder firstOrder(T = tFilterGC, k = 1, y_start = UConv0Pu) annotation(
