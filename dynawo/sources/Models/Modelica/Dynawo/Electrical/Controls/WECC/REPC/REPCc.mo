...
equation
  ...
  connect(rampLimiter2.y, switch5.u1) annotation(
    Line(points = {{174, 50}, {178, 50}, {178, 36}, {172, 36}, {172, 30}}, color = {0, 0, 127}));
  connect(Zero1.y, switch5.u3) annotation(
    Line(points = {{110, 96}, {106, 96}, {106, 66}, {116, 66}, {116, 14}, {172, 14}}, color = {0, 0, 127}));
  connect(QVFlag0.y, switch5.u2) annotation(
    Line(points = {{144, 22}, {172, 22}}, color = {255, 0, 255}));
  connect(switch5.y, QInjRefPu) annotation(
    Line(points = {{196, 22}, {196, 50}, {210, 50}}, color = {0, 0, 127}));
