...
model LowVoltagePowerLogic "Low Voltage Power Limiter block"
  ...
  parameter Types.PerUnit zerox(start=0.0) "LVPL zero crossing in pu (base UNom)";
  parameter Types.PerUnit brkpt(start=1.0) "LVPL breakpoint in pu (base UNom)";
  parameter Types.PerUnit lvpl1(start=1.0) "LVPL gain breakpoint in pu";
