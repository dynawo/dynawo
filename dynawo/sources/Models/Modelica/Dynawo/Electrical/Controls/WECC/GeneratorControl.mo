...
model GeneratorControl "WECC PV Generator Control REGC"
  ...
  Modelica.Blocks.Interfaces.RealInput idCmdPu(start = Id0Pu) "Id setpoint from electrical control in p.u (base SNom, UNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput iqCmdPu(start = Iq0Pu) "Iq setpoint from electrical control in p.u (base SNom, UNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput idRefPu(start = Id0Pu) "Id setpoint to injector in p.u (injector convention) (base SNom, UNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput iqRefPu(start = -Iq0Pu) "Iq setpoint to injector in p.u (injector convention) (base SNom, UNom)" annotation(
