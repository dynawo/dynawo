...
model REGCc "WECC Generator Converter REGC type C"
  extends Dynawo.Electrical.Controls.WECC.REGC.BaseClasses.BaseREGC(rateLimFirstOrderFreeze2(
                                                                    T                          = 1e-6, UseRateLim                          = true,                                                                                                                                Y0                          = Iq0Pu),
      rateLimFirstOrderFreeze1(                                                                                                                    T                          = 1e-6, UseRateLim                          = true, Y0                          = Id0Pu * UConv0Pu));
  ...
  Dynawo.NonElectrical.Blocks.Continuous.PIAntiWindupVariableLimits pIAntiWindupVariableLimits1(
    Ki = Kii,
    Kp = Kip,
    Y0 = Id0Pu) annotation(
