...
record Parameters "Parameters of the PV WECC model"
  ...
  record Params_PlantControl
    ...
    parameter Types.PerUnit QMaxPu "Maximum plant level reactive power command in p.u (base SNom)" annotation(Dialog(tab="Plant Control"));
    ...
    parameter Types.PerUnit PMaxPu "Maximum plant level active power command in p.u (base SNom)" annotation(Dialog(tab="Plant Control"));
    parameter Types.PerUnit PMinPu "Minimum plant level active power command in p.u (base SNom)" annotation(Dialog(tab="Plant Control"));
  ...
  record Params_ElectricalControl
    ...
    parameter Types.PerUnit UMinPu "Low voltage condition trigger voltage for FRT in p.u (base UNom) (typical: 0..0.9)" annotation(Dialog(tab="Electrical Control"));
    parameter Types.PerUnit UMaxPu "High voltage condition trigger voltage for FRT in p.u (base UNom) (typical: 1.1..1.3)" annotation(Dialog(tab="Electrical Control"));
    parameter Types.PerUnit VRef0Pu "Reference voltage for reactive current injection in p.u (base UNom) (typical: 0.95..1.05)" annotation(Dialog(tab="Electrical Control"));
    ...
    parameter Types.PerUnit VMaxPu "Maximum voltage at inverter terminal in p.u (base UNom) (typical: 1.05..1.15)" annotation(Dialog(tab="Electrical Control"));
    parameter Types.PerUnit VMinPu "Minimum voltage at inverter terminal in p.u (base UNom) (typical: 0.85..0.95)" annotation(Dialog(tab="Electrical Control"));
    ...
    parameter Types.PerUnit PMaxPu "Active power upper limit in p.u (base SNom) (typical: 1)" annotation(Dialog(tab="Electrical Control"));
    parameter Types.PerUnit PMinPu "Active power lower limit in p.u (base SNom) (typical: 0)" annotation(Dialog(tab="Electrical Control"));
    ...
    parameter Types.PerUnit IMaxPu "Maximal apparent current magnitude in p.u (base UNom, SNom)" annotation(Dialog(tab="Electrical Control"));
  annotation(preferredView = "text");
  ...
  record Params_GeneratorControl
    ...
    parameter Types.PerUnit IqrMinPu "Minimum rate-of-change of reactive current after fault in p.u (base UNom, SNom) (typical: -999..-1)" annotation(Dialog(tab="Generator Control"));
    parameter Types.PerUnit IqrMaxPu "Maximum rate-of-change of reactive current after fault in p.u (base UNom, SNom) (typical: 1..999)" annotation(Dialog(tab="Generator Control"));
  ...
  record Params_PLL
    ...
    parameter Types.PerUnit OmegaMinPu "Lower frequency limit in p.u" annotation(Dialog(tab="PLL"));
    parameter Types.PerUnit OmegaMaxPu "Upper frequency limit in p.u" annotation(Dialog(tab="PLL"));
  annotation(preferredView = "text");
  end Params_PLL;
