...
model WTGQa "WECC Torque Controller Type A"
  ...
  Modelica.Blocks.Interfaces.RealInput PePu(start = PInj0Pu) "Electrical active power in pu (base SNom)" annotation(
    Placement(transformation(origin = {-140, 28}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-110, 0}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Interfaces.RealInput PRef0Pu(start = PInj0Pu) "Active power Reference from the power plant controller (generator convention) (base SNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput PRefPu(start = PInj0Pu) "Active power Reference for the electrical controller (generator convention) (base SNom)" annotation(
