...
record ParamsREGCc "REGC type C parameters"
  ...
  Dialog(tab="Generator Converter", group = "REGCc"));
  parameter Types.PerUnit KiPLLInj "PLL integrator gain" annotation(
  Dialog(tab="Generator Converter", group = "REGCc"));
  parameter Types.PerUnit KpPLLInj "PLL proportional gain" annotation(
  Dialog(tab="Generator Converter", group = "REGCc"));
  parameter Types.AngularVelocityPu OmegaMaxInjPu "Upper frequency limit in pu (base OmegaNom)" annotation(
  Dialog(tab="Generator Converter", group = "REGCc"));
  parameter Types.AngularVelocityPu OmegaMinInjPu "Lower frequency limit in pu (base OmegaNom)" annotation(
  Dialog(tab="Generator Converter", group = "REGCc"));
