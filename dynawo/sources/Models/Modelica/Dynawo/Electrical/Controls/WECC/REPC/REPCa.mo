...
model REPCa "WECC Plant Control type A"
  ...
  Modelica.Blocks.Nonlinear.Limiter PRefLim(
  ...
  Modelica.Blocks.Continuous.FirstOrder firstOrder2(
    T = tFilterPC,
    y_start = QControl0Pu) annotation(
  ...
  Modelica.Blocks.Continuous.FirstOrder firstOrder3(
    T = tFilterPC,
    y_start = URef0Pu) annotation(
    Placement(visible = true, transformation(origin = {-70, 80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Electrical.Controls.WECC.BaseControls.LineDropCompensation lineDropCompensation1(
    RcPu = RcPu,
    XcPu = XcPu) annotation(
  ...
  Modelica.Blocks.Nonlinear.DeadZone deadZone1(
    uMax = FDbd2Pu,
  ...
  Dynawo.NonElectrical.Blocks.Continuous.LimPIDFreeze limPIDFreeze(
    Ti = Kp / Ki,
    K = Kp,
    Xi0 = QConv0Pu / Kp,
    YMax = QMaxPu,
...
equation
  ...
  connect(OmegaRef.y, wCtrlErr.u1) annotation(
