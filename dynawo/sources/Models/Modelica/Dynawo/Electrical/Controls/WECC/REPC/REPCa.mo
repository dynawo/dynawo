...
model REPCa "WECC Plant Control type A"
  ...
  // Inputs
  Modelica.Blocks.Interfaces.RealInput PRefPu(start = -PPcc0Pu * SystemBase.SnRef / SNom) "Active power setpoint at regulated bus in pu (generator convention) (base SNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput QRefPu(start = -QPcc0Pu * SystemBase.SnRef / SNom) "Reactive power setpoint at regulated bus in pu (generator convention) (base SNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput PRegPu(start = -PPcc0Pu * SystemBase.SnRef / SNom) "Active power at regulated bus in pu (generator convention) (base SNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput QRegPu(start = -QPcc0Pu * SystemBase.SnRef / SNom) "Reactive power at regulated bus in pu (generator convention) (base SNom)" annotation(
  ...
  Modelica.ComplexBlocks.Interfaces.ComplexInput uPu(re(start = uPcc0Pu.re), im(start = uPcc0Pu.im)) "Complex voltage at regulated bus in pu (base UNom)" annotation(
  ...
  Modelica.ComplexBlocks.Interfaces.ComplexInput iPu(re(start = -iPcc0Pu.re), im(start = -iPcc0Pu.im)) "Complex current at PPC regulated bus in pu (generator convention) (base SnRef, UNom)" annotation(
  ...
  // Outputs
  Modelica.Blocks.Interfaces.RealOutput PConvRefPu(start = PConv0Pu) "Active power setpoint at converter terminal in pu (generator convention) (base SNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput QConvRefPu(start = QConv0Pu) "Reactive power setpoint at converter terminal in pu (generator convention) (base SNom)" annotation(
  ...
  Modelica.Blocks.Continuous.FirstOrder firstOrder(T = tLag, y_start = PConv0Pu) annotation(
  ...
  Modelica.Blocks.Continuous.FirstOrder firstOrder1(T = tP, y_start = -PPcc0Pu * SystemBase.SnRef / SNom) annotation(
  ...
  Modelica.Blocks.Nonlinear.DeadZone deadZone(uMax = DbdPu, uMin = -DbdPu) annotation(
    Placement(visible = true, transformation(origin = {50, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder2(T = tFilterPC, y_start = -QPcc0Pu * SystemBase.SnRef / SNom) annotation(
  ...
  Modelica.Blocks.Continuous.FirstOrder firstOrder3(T = tFilterPC, y_start = if VCompFlag == true then UInj0Pu else UPcc0Pu + Kc * (-QPcc0Pu) * SystemBase.SnRef / SNom) annotation(
  ...
  Modelica.Blocks.Sources.Constant const(k = PConv0Pu) annotation(
    Placement(visible = true, transformation(origin = {50, -130}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.NonElectrical.Blocks.Continuous.LimPIDFreeze limPIDFreeze(Ti = Kp / Ki, K = Kp, Xi0 = QConv0Pu / Kp, YMax = QMaxPu, YMin = QMinPu, Y0 = QConv0Pu) annotation(
  ...
  Dynawo.NonElectrical.Blocks.Continuous.TransferFunction leadLag(a = {tFv, 1}, b = {tFt, 1}, x_start = {QConv0Pu}, y_start = QConv0Pu) annotation(
    Placement(visible = true, transformation(origin = {170, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));

  parameter Types.PerUnit PPcc0Pu "Start value of active power at regulated bus in pu (generator convention) (base SNom)";
  parameter Types.PerUnit QPcc0Pu "Start value of reactive power at regulated bus in pu (generator convention) (base SNom)";
  parameter Types.PerUnit UPcc0Pu "Start value of voltage magnitude at regulated bus in pu (base UNom)";

  parameter Types.ComplexPerUnit uPcc0Pu "Start value of complex voltage at regulated bus in pu (base UNom)";
  parameter Types.PerUnit UInj0Pu "Start value of voltage magnitude at injector terminal in pu (base UNom)";
  parameter Types.ComplexPerUnit iPcc0Pu "Start value of complex current at PPC regulated bus in pu (receptor convention) (base SnRef, UNom)";
  parameter Types.PerUnit PConv0Pu "Start value of active power at converter terminal in pu (generator convention) (base SNom)";
  parameter Types.PerUnit QConv0Pu "Start value of reactive power at converter terminal in pu (generator convention) (base SNom)";

  final parameter Types.PerUnit URef0Pu = if VCompFlag == true then UInj0Pu else UPcc0Pu + Kc * (-QPcc0Pu) * SystemBase.SnRef / SNom "Start value of voltage setpoint for plant level control, calculated depending on VcompFlag, in pu (base UNom)";
...
equation
  ...
  connect(switch.y, PConvRefPu) annotation(
  ...
  connect(leadLag.y, QConvRefPu) annotation(
