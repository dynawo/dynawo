...
partial model BaseREEC "WECC Electrical Control REEC common"
  ...
  Modelica.Blocks.Interfaces.RealInput PConvPu(start = PConv0Pu) "Active power at converter terminal in pu (base SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput PConvRefPu(start = PConv0Pu) "Active power setpoint at converter terminal in pu (base SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput QConvPu(start = QConv0Pu) "Reactive power at converter terminal in pu (base SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput QConvRefPu(start = QConv0Pu) "Reactive power setpoint at converter terminal in pu (base SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput UPu(start = UConv0Pu) "Voltage magnitude at converter terminal in pu (base UNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput UFilteredPu(start = UConv0Pu) "Filtered voltage module at converter terminal in pu (base UNom)" annotation(
  ...
  Modelica.Blocks.Continuous.FirstOrder firstOrder(T = tRv, y_start = UConv0Pu) annotation(
  ...
  Modelica.Blocks.Continuous.FirstOrder firstOrder1(T = tpREEC, y_start = PConv0Pu) annotation(
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter2(homotopyType = Modelica.Blocks.Types.LimiterHomotopy.NoHomotopy, uMax = QMaxREECPu, uMin = QMinREECPu) annotation(
  ...
  Dynawo.NonElectrical.Blocks.Continuous.RateLimFirstOrderFreeze rateLimFirstOrderFreeze1(T = tIq, UseFreeze = true, UseRateLim = false, Y0 = Iq0Pu) annotation(
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter3(homotopyType = Modelica.Blocks.Types.LimiterHomotopy.NoHomotopy, uMax = PMaxREECPu, uMin = PMinREECPu) annotation(
...
equation
  ...
  connect(QConvPu, limPIDFreeze.u_m) annotation(
  ...
  connect(rateLimFirstOrderFreeze1.y, switch2.u3) annotation(
    Line(points = {{141, 54}, {260, 54}, {260, 96}, {268, 96}}, color = {0, 0, 127}));
  ...
  connect(QConvRefPu, switch1.u3) annotation(
  ...
  connect(PConvRefPu, slewRateLimiter.u) annotation(
...
<li> Electrical Control WP </li>
    ...
    Icon(graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}), Text(origin = {137, 79}, extent = {{-23, 13}, {35, -21}}, textString = "idCmdPu"), Text(origin = {139, -41}, extent = {{-23, 13}, {35, -21}}, textString = "iqCmdPu"), Text(origin = {141, 13}, extent = {{-23, 13}, {17, -11}}, textString = "frtOn"), Text(origin = {89, -113}, extent = {{-23, 13}, {9, -3}}, textString = "UPu"), Text(origin = {-111, -116}, extent = {{-33, 21}, {9, -3}}, textString = "QConvPu"), Text(origin = {41, -117}, extent = {{-33, 21}, {9, -3}}, textString = "PConvPu"), Text(origin = {-135, 79}, extent = {{-23, 13}, {35, -21}}, textString = "PConvRefPu"), Text(origin = {-135, -41}, extent = {{-23, 13}, {35, -21}}, textString = "QConvRefPu"), Text(origin = {-135, 21}, extent = {{-23, 13}, {35, -21}}, textString = "UFilteredPu"), Text(origin = {7, 130.5}, extent = {{-16, 7}, {24, -10}}, textString = "PFaRef")}, coordinateSystem(extent = {{-100, -100}, {100, 100}}, grid = {1, 1}, initialScale = 0.1)));
end BaseREEC;
