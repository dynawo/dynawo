...
*/
  ...
  Modelica.Blocks.Interfaces.RealInput idRefPu(start = Id0Pu) "d-axis reference current in pu (base UNom, SNom)" annotation(
    Placement(visible = true, transformation(origin = {-110, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {40, 110}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Modelica.Blocks.Interfaces.RealInput iqRefPu(start = Iq0Pu) "q-axis reference current in pu (base UNom, SNom)" annotation(
    Placement(visible = true, transformation(origin = {-110, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-40, 110}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
...
equation
  ...
  annotation(
    preferredView = "text",
    Icon(graphics = {Text(origin = {66.5, 120}, extent = {{-10.5, 7}, {15.5, -10}}, textString = "idRef"), Text(origin = {-71.5, 120}, extent = {{-10.5, 7}, {15.5, -10}}, textString = "iqRef"), Text(origin = {-141.067, 84.2727}, extent = {{1.06667, 1.72727}, {33.0667, -17.2727}}, textString = "udInjPu"), Text(origin = {128.654, 77.8824}, extent = {{-26.6538, 11.1176}, {39.3462, -15.8824}}, textString = "udSourceRef"), Rectangle(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {-10.5, 12}, extent = {{-69.5, 68}, {90.5, -92}}, textString = "UdqRef"), Text(origin = {-141.07, -68.73}, extent = {{1.07, 1.73}, {33.07, -17.27}}, textString = "uqInjPu"), Text(origin = {128.65, -74.12}, extent = {{-26.65, 11.12}, {39.35, -15.88}}, textString = "uqSourceRef")}));
end UdqRef;
