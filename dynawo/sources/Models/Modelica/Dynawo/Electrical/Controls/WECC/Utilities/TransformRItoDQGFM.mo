...
block TransformRItoDQGFM "Transformation from real/imaginary in stationary reference frame to d/q rotating reference frame with rotation angle phi"
  /*
  ...
  */
  ...
  final parameter Types.PerUnit ud0 = u0Pu.re*cos(phi0) + u0Pu.im*sin(phi0) "Initial value of the d-axis component in pu";
  final parameter Types.PerUnit uq0 = -u0Pu.re*sin(phi0) + u0Pu.im*cos(phi0) "Initial value of the q-axis component in pu";
equation
  ud = Modelica.ComplexMath.real(u)*cos(phi) + Modelica.ComplexMath.imag(u)*sin(phi);
  uq = (-Modelica.ComplexMath.real(u)*sin(phi)) + Modelica.ComplexMath.imag(u)*cos(phi);
  annotation(
    preferredView = "text",
