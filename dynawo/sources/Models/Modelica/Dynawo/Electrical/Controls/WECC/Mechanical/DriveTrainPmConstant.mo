...
equation
  ...
  annotation(
    ...
    <p> This block contains the drive train model for generic WECC WTG type 4 model WECC document Second Generation Wind Turbine Models (page 20) : <a href='https://www.wecc.org/Reliability/WECC-Second-Generation-Wind-Turbine-Models-012314.pdf/'>https://www.wecc.org/Reliability/WECC-Second-Generation-Wind-Turbine-Models-012314.pdf </a> </p>
    <img src=\"modelica://Dynawo/Electrical/Controls/WECC/Images/DriveTrainPmConstant.png\" alt=\"Wind turbine generator drive-train model (wtgt_a)\">
