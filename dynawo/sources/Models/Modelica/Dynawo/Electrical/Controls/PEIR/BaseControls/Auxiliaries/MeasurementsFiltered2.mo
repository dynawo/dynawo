...
model MeasurementsFiltered2 "Measurements block for PEIR models"
  ...
  Modelica.Blocks.Interfaces.RealInput udPccPu(start = UdPcc0Pu) "d-axis voltage at the PCC in pu (base UNom)" annotation(
    Placement(visible = true,transformation(origin = {-110, -194}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-110, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealOutput uqFilteredFilterPLLPu(start = UqFilter0Pu) "Filtered q-axis voltage at the RLC filter for PLL in pu (base UNom)" annotation(
    Placement(visible = true,transformation(origin = {110, -160}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {32, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  ...
  final parameter Types.PerUnit UPcc0Pu = sqrt(UdPcc0Pu*UdPcc0Pu+UqPcc0Pu*UqPcc0Pu);
  Modelica.Blocks.Interfaces.RealOutput UFilteredPccPu(start = PFilter0Pu) annotation(
    Placement(visible = true, transformation(origin = {110, -174}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-76, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder11(T = tUFilt, k = 1, y_start = UqFilter0Pu) annotation(
    Placement(visible = true, transformation(origin = {-10, -194}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder12(T = tUFilt, k = 1, y_start = UqFilter0Pu) annotation(
    Placement(visible = true, transformation(origin = {-10, -226}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealOutput udFilteredPccPu(start = UdPcc0Pu) annotation(
    Placement(visible = true, transformation(origin = {110, -194}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {88, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Blocks.Interfaces.RealOutput uqFilteredPccPu(start = UqPcc0Pu) annotation(
    Placement(visible = true, transformation(origin = {110, -226}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {62, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
equation
  ...
  UPccPu = sqrt(uqPccPu^2 + udPccPu^2);
  UFilteredPccPu = sqrt(udFilteredPccPu^2 + uqFilteredPccPu^2);
  ...
  connect(udPccPu, firstOrder11.u) annotation(
    Line(points = {{-110, -194}, {-22, -194}}, color = {0, 0, 127}));
  connect(uqPccPu, firstOrder12.u) annotation(
    Line(points = {{-110, -226}, {-22, -226}}, color = {0, 0, 127}));
  connect(firstOrder11.y, udFilteredPccPu) annotation(
    Line(points = {{1, -194}, {110, -194}}, color = {0, 0, 127}));
  connect(firstOrder12.y, uqFilteredPccPu) annotation(
