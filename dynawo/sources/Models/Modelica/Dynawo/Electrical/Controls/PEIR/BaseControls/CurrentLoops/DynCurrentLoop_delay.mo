...
model DynCurrentLoop_delay "Current loop control for grid forming and grid following converters"
  /*
  ...
  */
  ...
  Modelica.Blocks.Interfaces.RealOutput DeltaUidConvRefPu annotation(
    Placement(transformation(origin = {112, 191}, extent = {{-10, -10}, {10, 10}}, rotation = 90), iconTransformation(origin = {-81, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Blocks.Interfaces.RealOutput DeltaUiqConvRefPu annotation(
    Placement(transformation(origin = {110, -191}, extent = {{-10, -10}, {10, 10}}, rotation = -90), iconTransformation(origin = {-83, -110}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Modelica.Blocks.Interfaces.RealOutput iConvPu = sqrt(idConvPu^2 + iqConvPu^2) annotation(
    Placement(transformation(origin = {-138, -184}, extent = {{-10, -10}, {10, 10}}, rotation = 90), iconTransformation(origin = {-39, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  ...
  Modelica.Blocks.Continuous.Integrator integratord(k = Kic, y_start = UdConv0Pu - Kfd*UdFilter0Pu + LFilter*Omega0Pu*IqConv0Pu, use_reset = false, initType = Modelica.Blocks.Types.Init.InitialOutput) annotation(
    Placement(transformation(origin = {-61, 109}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Math.Gain gainq(k = Kpc) annotation(
    Placement(visible = true, transformation(origin = {-60, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.Integrator integratorq(k = Kic, y_start = UqConv0Pu - Kfq*UqFilter0Pu - LFilter*Omega0Pu*IdConv0Pu, use_reset = false, use_set = false, initType = Modelica.Blocks.Types.Init.InitialOutput) annotation(
    Placement(visible = true, transformation(origin = {-60, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Math.Product product annotation(
    Placement(transformation(origin = {-90, 17}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Math.Product product1 annotation(
    Placement(transformation(origin = {-89, -18}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Nonlinear.FixedDelay fixedDelayd(delayTime = Ts) annotation(
    Placement(transformation(origin = {80, 158}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Nonlinear.FixedDelay fixedDelayq(delayTime = Ts) annotation(
    Placement(transformation(origin = {62, -150}, extent = {{-10, -10}, {10, 10}})));
equation
  ...
  connect(GainLfd.u, product.y) annotation(
    Line(points = {{-22, 25}, {-50.5, 25}, {-50.5, 17}, {-79, 17}}, color = {0, 0, 127}));
  connect(GainLfq.u, product1.y) annotation(
    Line(points = {{-22, -25}, {-50.5, -25}, {-50.5, -18}, {-78, -18}}, color = {0, 0, 127}));
  ...
  connect(idConvPu, product.u1) annotation(
    Line(points = {{-150, 50}, {-120, 50}, {-120, 23}, {-102, 23}}, color = {0, 0, 127}));
  connect(omegaPu, product.u2) annotation(
    Line(points = {{-150, 0}, {-120, 0}, {-120, 11}, {-102, 11}}, color = {0, 0, 127}));
  connect(omegaPu, product1.u1) annotation(
    Line(points = {{-150, 0}, {-120, 0}, {-120, -12}, {-101, -12}}, color = {0, 0, 127}));
  connect(iqConvPu, product1.u2) annotation(
    Line(points = {{-150, -50}, {-120, -50}, {-120, -24}, {-101, -24}}, color = {0, 0, 127}));
  connect(feedbackd.y, integratord.u) annotation(
    Line(points = {{-111, 80}, {-90, 80}, {-90, 109}, {-73, 109}}, color = {0, 0, 127}));
  connect(integratord.y, addd1.u1) annotation(
    Line(points = {{-50, 109}, {-40, 109}, {-40, 92}, {-32, 92}}, color = {0, 0, 127}));
  ...
  connect(fixedDelayd.y, DeltaUidConvRefPu) annotation(
    Line(points = {{91, 158}, {112, 158}, {112, 191}}, color = {0, 0, 127}));
  connect(integratord.y, fixedDelayd.u) annotation(
    Line(points = {{-50, 109}, {-21, 109}, {-21, 158}, {68, 158}}, color = {0, 0, 127}));
  connect(fixedDelayq.y, DeltaUiqConvRefPu) annotation(
    Line(points = {{73, -150}, {110, -150}, {110, -191}}, color = {0, 0, 127}));
  connect(integratorq.y, fixedDelayq.u) annotation(
    Line(points = {{-49, -110}, {-38, -110}, {-38, -169}, {20, -169}, {20, -150}, {50, -150}}, color = {0, 0, 127}));
  annotation(
