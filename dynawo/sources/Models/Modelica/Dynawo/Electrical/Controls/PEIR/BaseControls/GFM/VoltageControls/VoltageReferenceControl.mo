...
equation
  ...
  connect(gain1.y, firstOrder2.u) annotation(
    Line(points = {{-37, 4}, {-14, 4}}, color = {0, 0, 127}));
  ...
  connect(gain2.y, firstOrder3.u) annotation(
    Line(points = {{-37, -36}, {-20, -36}}, color = {0, 0, 127}));
  ...
  connect(firstOrder2.y, feedback.u1) annotation(
    Line(points = {{10, 4}, {26, 4}}, color = {0, 0, 127}));
  connect(feedback.y, feedback4.u2) annotation(
    Line(points = {{44, 4}, {52, 4}, {52, 70}}, color = {0, 0, 127}));
  connect(feedback.u2, gain1.y) annotation(
    Line(points = {{34, -4}, {34, -12}, {-28, -12}, {-28, 4}, {-36, 4}}, color = {0, 0, 127}));
  ...
  connect(feedback1.y, feedback7.u1) annotation(
    Line(points = {{48, -36}, {74, -36}}, color = {0, 0, 127}));
  connect(feedback1.u2, gain2.y) annotation(
    Line(points = {{38, -44}, {38, -52}, {-34, -52}, {-34, -36}, {-36, -36}}, color = {0, 0, 127}));
  annotation(
