...
model GridFormingControlVSM
  ...
  Dynawo.Electrical.Controls.PEIR.BaseControls.GFM.VoltageControls.VoltageReferenceControl voltageReferenceControl(DeltaVVId0 = VI.DeltaVVId0, DeltaVVIq0 = VI.DeltaVVIq0,IdPcc0Pu = IdPcc0Pu, IqPcc0Pu = IqPcc0Pu,Kff = Kff, Mq = Mq, QFilter0Pu = QFilter0Pu, URef0Pu = UFilterRef0Pu, UdRef0Pu = UdFilter0Pu, UqRef0Pu = UqFilter0Pu, Wf = Wf, Wff = Wff)  annotation(
    Placement(visible = true, transformation(origin = {-38, 24}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
  Dynawo.Electrical.Controls.PEIR.BaseControls.GFM.VoltageControls.QSEM QSEM(IdConv0Pu = IdConv0Pu, IqConv0Pu = IqConv0Pu, RFilter = RTransformerPu, UdFilter0Pu = UdFilter0Pu, UdPcc0Pu = UdPcc0Pu, UqFilter0Pu = UqFilter0Pu, UqPcc0Pu = UqPcc0Pu, XFilter = XTransformerPu, XVI = XVI)  annotation(
    Placement(visible = true, transformation(origin = {16, 24}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
  Dynawo.Electrical.Controls.PEIR.BaseControls.CurrentLoops.CurrentLoop currentLoop(IdConv0Pu = IdConv0Pu, IqConv0Pu = IqConv0Pu,Kfd = Kfd, Kfq = Kfq, Kic = Kic, Kpc = Kpc, RFilter = RFilterPu, UdConv0Pu = UdConv0Pu, UdFilter0Pu = UdFilter0Pu, UqConv0Pu = UqConv0Pu, UqFilter0Pu = UqFilter0Pu, XFilter = XFilterPu)  annotation(
...
Dynawo.Electrical.Controls.PEIR.BaseControls.VirtualImpedance2 VI(IMaxVI = IMaxVI, IdConv0Pu = IdConv0Pu, IqConv0Pu = IqConv0Pu, KpVI = KpVI, XRratio = XRratio)  annotation(
  ...
  final parameter Types.VoltageModulePu UFilterRef0Pu = sqrt(UdFilter0Pu*UdFilter0Pu + UqFilter0Pu*UqFilter0Pu) "Start value of voltage module reference in pu (base UNom)";
