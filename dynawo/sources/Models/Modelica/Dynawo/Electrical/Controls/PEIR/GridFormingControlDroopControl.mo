within Dynawo.Electrical.Controls.PEIR;
...
model GridFormingControlDroopControl "Grid forming control with droop control"
  ...
  Dynawo.Electrical.Controls.Converters.BaseControls.CurrentLoopControls.CurrentLoop currentLoop(IdConv0Pu = IdConv0Pu, IqConv0Pu = IqConv0Pu, Kic = Kic, Kpc = Kpc, LFilter = LFilter, RFilter = RFilter, UdConv0Pu = UdConv0Pu, UdFilter0Pu = UdFilter0Pu, UqConv0Pu = UqConv0Pu, UqFilter0Pu = UqFilter0Pu) annotation(
    Placement(visible = true, transformation(origin = {80, 80}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Dynawo.Electrical.Controls.Converters.BaseControls.VoltageLoopControls.VoltageLoopPI voltageLoop(CFilter = CFilter, IdConv0Pu = IdConv0Pu, IdPcc0Pu = IdPcc0Pu, IqConv0Pu = IqConv0Pu, IqPcc0Pu = IqPcc0Pu, Kiv = Kiv, Kpv = Kpv, UdFilter0Pu = UdFilter0Pu, UqFilter0Pu = UqFilter0Pu) annotation(
  ...
  Dynawo.Electrical.Controls.Converters.BaseControls.GFMControls.Migrate.DroopControl droopControl(DeltaVVId0 = DeltaVVId0, DeltaVVIq0 = DeltaVVIq0, IdPcc0Pu = IdPcc0Pu, IqPcc0Pu = IqPcc0Pu, Kff = Kff, Mp = Mp, Mq = Mq, PFilter0Pu = PFilter0Pu, PRef0Pu = PRef0Pu, QFilter0Pu = QFilter0Pu, QRef0Pu = QRef0Pu, Theta0 = Theta0, UFilterRef0Pu = UFilterRef0Pu, UdFilter0Pu = UdFilter0Pu, UqFilter0Pu = UqFilter0Pu, Wf = Wf, Wff = Wff) annotation(
...
equation
  connect(voltageLoop.idConvRefPu, currentLoop.idConvRefPu) annotation(
    Line(points = {{42, 100}, {50, 100}, {50, 92}, {58, 92}}, color = {0, 0, 127}));
  connect(voltageLoop.iqConvRefPu, currentLoop.iqConvRefPu) annotation(
    Line(points = {{42, 60}, {50, 60}, {50, 70}, {58, 70}}, color = {0, 0, 127}));
  ...
  connect(droopControl.omegaPu, currentLoop.omegaPu) annotation(
    Line(points = {{-18, 79.8}, {20, 79.8}, {20, 80}, {58, 80}}, color = {0, 0, 127}));
  ...
  connect(currentLoop.udConvRefPu, udConvRefPu) annotation(
    Line(points = {{102, 90}, {110, 90}, {110, 120}, {130, 120}}, color = {0, 0, 127}));
  connect(currentLoop.uqConvRefPu, uqConvRefPu) annotation(
    Line(points = {{102, 70}, {110, 70}, {110, 40}, {130, 40}}, color = {0, 0, 127}));
