...
model DynDroopPlantControl "GFM with VSM control and a generic Plant Controller"
  /*
 ...
 // Virtual impedance parameters
  ...
  Electrical.PEIR.Converters.General.Average.GridForming.DynGFMDroop dynGFMDroop(CFilterPu = CFilterPu, IMaxVI = IMaxVI, Kfd = Kfd, Kff = Kff, Kfq = Kfq, KpVI = KpVI, LFilterPu = LFilterPu, LTransformerPu = LTransformerPu, Mq = Mq, P0Pu = P0Pu, Q0Pu = Q0Pu, RFilterPu = RFilterPu, RTransformerPu = RTransformerPu, SNom = SNom, U0Pu = U0Pu, UPhase0 = UPhase0, Wf = Wf, Wff = Wff, XRratio = XRratio, XVI = XVI, tVSC = tVSC, Mp = Mp, omegaC = omegaC, omegaNPLL = omegaNPLL, ZetaPLL = ZetaPLL)annotation(
    Placement(transformation(origin = {36, -2}, extent = {{-26, -26}, {26, 26}})));
equation
  ...
  connect(dynGFMDroop.terminal, terminal) annotation(
    Line(points = {{65, -2}, {96, -2}}, color = {0, 0, 255}));
  connect(omegaRefPu, dynGFMDroop.omegaRefPu) annotation(
    Line(points = {{-12, 114}, {-12, 8}, {8, 8}}, color = {0, 0, 127}));
  connect(plantControl.PInjRefPu, dynGFMDroop.PFilterRefPu) annotation(
    Line(points = {{-50, 4}, {-20, 4}, {-20, 18}, {8, 18}}, color = {0, 0, 127}));
  connect(plantControl.QInjRefPu, dynGFMDroop.QFilterRefPu) annotation(
    Line(points = {{-50, -8}, {-20, -8}, {-20, -12}, {8, -12}}, color = {0, 0, 127}));
  connect(UFilterRefPu, dynGFMDroop.UFilterRefPu) annotation(
    Line(points = {{-52, -60}, {-12, -60}, {-12, -22}, {8, -22}}, color = {0, 0, 127}));
  connect(dynGFMDroop.omegaDroopPu, plantControl.omegaPu) annotation(
    Line(points = {{52, 26}, {52, 22}, {-86, 22}, {-86, 0}, {-74, 0}}, color = {0, 0, 127}));
  annotation(
    experiment(StartTime = 0, StopTime = 25, Tolerance = 1e-06, Interval = 0.0244379),
    Diagram);
end DynDroopPlantControl;
