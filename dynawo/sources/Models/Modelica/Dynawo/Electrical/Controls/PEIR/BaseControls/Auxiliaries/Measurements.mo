...
model Measurements "Measurements block for PEIR models"
  ...
  Modelica.Blocks.Interfaces.RealInput udPccPu(start = UdPcc0Pu) "d-axis voltage at the PCC in pu (base UNom) (generator convention)"annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput uqPccPu(start = UqPcc0Pu) "q-axis voltage at the PCC in pu (base UNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput udFilterPu(start = UdFilter0Pu) "d-axis voltage at the filter in pu (base UNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput uqFilterPu(start = UqFilter0Pu) "q-axis voltage at the filter in pu (base UNom) (generator convention)" annotation(
  ...
  // Outputs
  Modelica.Blocks.Interfaces.RealOutput PFilterPu(start = PFilter0Pu) "Active power at the filter in pu (base SNom) (generator convention)" annotation(
    Placement(visible = true, transformation(origin = {110, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealOutput QFilterPu(start = QFilter0Pu) "Reactive power at the filter in pu (base SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput udFilteredPccPu(start = UdPcc0Pu) "Filtered d-axis voltage at PCC in pu (base UNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput uqFilteredPccPu(start = UqPcc0Pu) "Filtered q-axis voltage at PCC in pu (base UNom) (generator convention)" annotation(
  ...
  parameter Types.PerUnit UdPcc0Pu "Start value of d-axis voltage at PCC in pu (base UNom) (generator convention)";
  parameter Types.PerUnit UqPcc0Pu "Start value of q-axis voltage at PCC in pu (base UNom) (generator convention)";
  parameter Types.PerUnit UdFilter0Pu "Start value of d-axis voltage at the filter in pu (base UNom) (generator convention)";
  parameter Types.PerUnit UqFilter0Pu "Start value of q-axis voltage at the filter in pu (base UNom) (generator convention)";

  final parameter Types.PerUnit PFilter0Pu = UdFilter0Pu * IdPcc0Pu + UqFilter0Pu * IqPcc0Pu "Start value of active power at the filter in pu (base SNom) (generator convention)";
  final parameter Types.PerUnit QFilter0Pu = UqFilter0Pu * IdPcc0Pu - UdFilter0Pu * IqPcc0Pu "Start value of reactive power at the filter in pu (base SNom) (generator convention)";
