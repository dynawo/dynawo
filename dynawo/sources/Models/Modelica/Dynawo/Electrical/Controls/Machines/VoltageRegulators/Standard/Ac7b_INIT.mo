...
model Ac7b_INIT "IEEE excitation system type AC7B initialization model"
  ...
  //Input parameters
  Dynawo.Connectors.ComplexCurrentPuInput it0Pu "Initial complex stator current in pu (base SNom, UNom)";
  Dynawo.Connectors.ComplexVoltagePuInput ut0Pu "Initial complex voltage in pu (base UNom)";
