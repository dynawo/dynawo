...
model SclReferenceCurrent
  ...
  parameter Types.PerUnit IInst "SCL instantaneous field current limit";
  parameter Types.PerUnit ILim "SCL thermal field current limit";
  parameter Types.PerUnit ITfPu "SCL reference for inverse time calculations";
  ...
  //Input variable
  Modelica.Blocks.Interfaces.RealInput IPu(start = I0Pu) "Input current" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput IPRefPu(start = I0Pu) "Input reference current" annotation(
  ...
  //Output variables
  Modelica.Blocks.Interfaces.RealOutput IRefPu(start = 0) "Reference current" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput tErr(start = tErr0) annotation(
  ...
  Modelica.Blocks.Continuous.LimIntegrator limIntegrator1(outMax = IInst, outMin = ILim, y_start = IRef0Pu) annotation(
  ...
  Modelica.Blocks.Continuous.LimIntegrator limIntegrator(outMax = tMax, outMin = tMin, y_start = tScl - tErr0) annotation(
  ...
  //Initial parameters
  parameter Types.CurrentModulePu I0Pu "Initial input current";
  parameter Types.CurrentModulePu IRef0Pu "Initial reference current";
...
equation
  ...
  connect(limIntegrator.y, gain3.u) annotation(
    Line(points = {{41, -60}, {60, -60}, {60, -100}, {42, -100}}, color = {0, 0, 127}));
  ...
  connect(feedback3.y, greaterEqualThreshold.u) annotation(
    Line(points = {{69, -20}, {118, -20}}, color = {0, 0, 127}));
  connect(limIntegrator.y, feedback3.u2) annotation(
    Line(points = {{41, -60}, {60, -60}, {60, -28}}, color = {0, 0, 127}));
  ...
  connect(const3.y, feedback3.u1) annotation(
    Line(points = {{1, -20}, {52, -20}}, color = {0, 0, 127}));
  ...
  connect(feedback3.y, tErr) annotation(
    Line(points = {{69, -20}, {100, -20}, {100, 60}, {370, 60}}, color = {0, 0, 127}));
  connect(lessEqualThreshold1.y, and1.u1) annotation(
