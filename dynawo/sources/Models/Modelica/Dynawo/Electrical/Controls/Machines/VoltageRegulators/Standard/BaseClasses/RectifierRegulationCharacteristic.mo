...
block RectifierRegulationCharacteristic "Characteristic function of rectifier regulation"
  ...
  final parameter Real UHigh = 0.75 "Upper limit of non-linear mode";
