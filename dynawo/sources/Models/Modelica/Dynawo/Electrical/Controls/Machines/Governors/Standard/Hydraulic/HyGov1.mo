...
model HyGov1
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter1(uMax = VelMaxPu) annotation(
...
equation
  ...
  connect(PmRefPu, add3.u2) annotation(
    Line(points = {{-380, 100}, {-322, 100}}, color = {0, 0, 127}));
  connect(add1.y, add3.u3) annotation(
    Line(points = {{-299, -20}, {-280, -20}, {-280, 40}, {-340, 40}, {-340, 92}, {-322, 92}}, color = {0, 0, 127}));
  connect(add3.y, firstOrder1.u) annotation(
    Line(points = {{-299, 100}, {-282, 100}}, color = {0, 0, 127}));
  ...
  connect(limiter.y, add3.u1) annotation(
    Line(points = {{-99, 100}, {-80, 100}, {-80, 160}, {-340, 160}, {-340, 108}, {-322, 108}}, color = {0, 0, 127}));
  connect(firstOrder1.y, limiter1.u) annotation(
    Line(points = {{-258, 100}, {-242, 100}}, color = {0, 0, 127}));
  connect(limiter1.y, gain2.u) annotation(
    Line(points = {{-218, 100}, {-202, 100}}, color = {0, 0, 127}));
  connect(gain2.y, limitedPI.u) annotation(
    Line(points = {{-178, 100}, {-162, 100}}, color = {0, 0, 127}));
  connect(limitedPI.y, limiter.u) annotation(
    Line(points = {{-138, 100}, {-122, 100}}, color = {0, 0, 127}));
