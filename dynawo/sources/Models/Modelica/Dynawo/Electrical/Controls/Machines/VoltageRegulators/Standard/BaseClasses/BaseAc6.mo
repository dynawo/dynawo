...
partial model BaseAc6 "IEEE excitation system type AC6 base model"
  ...
  Dynawo.NonElectrical.Blocks.Continuous.TransferFunction transferFunction(a = {tA, 1}, b = {tK, 1}, u_start = Va0Pu) annotation(
  ...
  Dynawo.NonElectrical.Blocks.Continuous.TransferFunction transferFunction1(a = {tH, 1}, b = {tJ, 1}, u_start = Vh0Pu) annotation(
