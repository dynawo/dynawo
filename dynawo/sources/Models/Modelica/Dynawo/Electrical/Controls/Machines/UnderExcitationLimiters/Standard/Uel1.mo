...
model Uel1 "IEEE underexcitation limiter type UEL1 model"
  ...
  parameter Types.VoltageModulePu VUcMaxPu "UEL maximum voltage magnitude";
  parameter Types.VoltageModulePu VUiMaxPu "UEL maximum output";
  parameter Types.VoltageModulePu VUiMinPu "UEL minimum output";
  parameter Types.VoltageModulePu VUrMaxPu "UEL maximum radius";
