...
model IEEE_PSS2A "Power System Stabilizer"
  ...
  parameter Types.ActivePowerPu PGen0Pu "Initial power input in p.u (base PNom)";
  parameter Types.VoltageModulePu Upss0Pu "Initial voltage output in p.u (base PNom)";
