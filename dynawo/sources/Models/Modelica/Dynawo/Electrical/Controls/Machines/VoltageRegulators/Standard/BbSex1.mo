...
model BbSex1 "Model of exciter BBSEX1"
  ...
  Dynawo.Electrical.Controls.Utilities.TransferFunction transferFunction(a = {t4 , 1}, b = {t3 , 1}, x_scaled(start = {Efd0Pu / K}), x_start = {Efd0Pu / K}, y(start = Efd0Pu / K)) annotation(
