...
model Pss3b "IEEE power system stabilizer type 3B"
  ...
  Dynawo.NonElectrical.Blocks.Continuous.Washout washout(tW = tW2, U0 = KOmega * SystemBase.omega0Pu + KOmegaRef * SystemBase.omegaRef0Pu) annotation(
    Placement(visible = true, transformation(origin = {-70, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder(T = t2, k = Ks2, y_start = KOmega * SystemBase.omega0Pu + KOmegaRef * SystemBase.omegaRef0Pu) annotation(
    Placement(visible = true, transformation(origin = {-110, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder1(T = t1, k = Ks1, y_start = PGen0Pu * SystemBase.SnRef / SNom) annotation(
    Placement(visible = true, transformation(origin = {-110, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
