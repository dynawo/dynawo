...
partial model BaseSt1 "IEEE excitation system type ST1 base model"
  ...
  Dynawo.NonElectrical.Blocks.Continuous.TransferFunction transferFunction1(a = {tB, 1}, b = {tC, 1}, u_start = Va0Pu / Ka) annotation(
  ...
  Dynawo.NonElectrical.Blocks.Continuous.TransferFunction transferFunction(a = {tB1, 1}, b = {tC1, 1}, u_start = Va0Pu / Ka) annotation(
