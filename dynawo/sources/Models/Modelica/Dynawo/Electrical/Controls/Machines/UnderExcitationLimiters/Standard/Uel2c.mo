...
model Uel2c "IEEE overexcitation limiter type UEL2C model"
  ...
  parameter Types.VoltageModulePu VUel1MaxPu "UEL maximum output";
  parameter Types.VoltageModulePu VUel1MinPu "UEL minimum output";
  parameter Types.VoltageModulePu VUel2MaxPu "UEL maximum output";
  parameter Types.VoltageModulePu VUel2MinPu "UEL minimum output";
  parameter Types.VoltageModulePu VUiMaxPu "UEL PI control maximum output";
  parameter Types.VoltageModulePu VUiMinPu "UEL PI control minimum output";
  parameter Modelica.SIunits.Reactance Xq "UEL characteristic reactance in ohms";
  ...
  Modelica.Blocks.Math.MultiSwitch multiSwitch1(expr = firstOrder.y * {1, 1 / VBias}, nu = 2, y_default = 1) annotation(
  ...
  Modelica.Blocks.Logical.LessEqualThreshold lessEqualThreshold(threshold = VBias) annotation(
  ...
  parameter Types.VoltageModulePu VBias0Pu "Initial calculated voltage bias";

  final parameter Types.PerUnit KAdj0 = ((U0Pu ^ 2) / Xq + QGen0Pu) / sqrt(((U0Pu ^ 2) / Xq + QGen0Pu) ^ 2 + PGen0Pu ^ 2) "Initial UEL adjustable gain";

equation
  kAdj = ((UPu ^ 2) / Xq + QGenPu) / sqrt(((UPu ^ 2) / Xq + QGenPu) ^ 2 + PGenPu ^ 2);
