...
model ReactivePowerControlLoop_INIT "Initialisation model for the Reactive Power Control Loop (RPCL)"
  ...
  Dynawo.Connectors.VoltageModulePuInput UStatorRef0Pu "Start value of the generator stator voltage reference in pu (base UNom)";
  Dynawo.Connectors.ReactivePowerPuInput QStator0Pu "Start value of the generator stator reactive power in pu (base QNomAlt) (generator convention)";
