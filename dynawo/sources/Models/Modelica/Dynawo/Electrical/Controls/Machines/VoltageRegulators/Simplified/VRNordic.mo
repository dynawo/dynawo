...
model VRNordic "Voltage regulator model for the Nordic 32 test system used for voltage stability studies"
  ...
  Dynawo.Electrical.Controls.Utilities.TransferFunction leadLag(a = {tLagTgr, 1}, b = {tLeadTgr, 1}, x_scaled(start = {Efd0Pu}), x_start = {Efd0Pu}, y(start = Efd0Pu), y_start = Efd0Pu) annotation(
