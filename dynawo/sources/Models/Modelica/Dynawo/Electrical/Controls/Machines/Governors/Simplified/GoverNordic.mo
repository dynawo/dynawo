...
model GoverNordic "Governor model for the Nordic 32 test system used for voltage stability studies"
  ...
  Modelica.Blocks.Sources.Constant const(k = PGen0Pu * SystemBase.SnRef / PNom) annotation(
    Placement(visible = true, transformation(origin = {-250, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder1(T = 2, y_start = PGen0Pu * SystemBase.SnRef / PNom) annotation(
  ...
  Modelica.Blocks.Math.Gain perUnitP(k = SystemBase.SnRef / PNom) annotation(
    Placement(visible = true, transformation(origin = {-250, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.NonElectrical.Blocks.NonLinear.LimRateLimFirstOrder limRateLimFirstOrder(DuMax = 0.1, Y0 = Pm0Pu, YMax = 1.002, YMin = 0, tS = 0.2) annotation(
