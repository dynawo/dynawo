...
model Ac7c "IEEE exciter type AC7C model"
  ...
  Dynawo.NonElectrical.Blocks.Continuous.LimitedPI limitedPI(Ki = Kia, Kp = Kpa, Y0 = Efe0Pu / (if Sw2 then Vb0Pu else Kr * Efd0Pu), YMax = VaMaxPu, YMin = VaMinPu) annotation(
...
equation
  ...
  elseif PositionOel == 2 then
    sum1.u[3] = 0;
    min1.u[2] = if PositionScl == 2 then min(UOelPu, USclOelPu) else min1.u[1];
    min2.u[2] = if PositionScl == 3 then USclOelPu else min2.u[1];
    min3.u1 = min3.u2;
  elseif PositionOel == 3 then
    sum1.u[3] = 0;
    min1.u[2] = if PositionScl == 2 then USclOelPu else min1.u[1];
    min2.u[2] = if PositionScl == 3 then min(UOelPu, USclOelPu) else min2.u[1];
    min3.u1 = min3.u2;
  ...
  elseif PositionUel == 2 then
    sum1.u[4] = 0;
    max1.u[2] = if PositionScl == 2 then max(UUelPu, USclUelPu) else max1.u[1];
    max2.u[2] = if PositionScl == 3 then USclUelPu else max2.u[1];
  elseif PositionUel == 3 then
    sum1.u[4] = 0;
    max1.u[2] = if PositionScl == 2 then USclUelPu else max1.u[1];
    max2.u[2] = if PositionScl == 3 then max(UUelPu, USclUelPu) else max2.u[1];
  else
    sum1.u[4] = 0;
    max1.u[2] = if PositionScl == 2 then USclUelPu else max1.u[1];
    max2.u[2] = if PositionScl == 3 then USclUelPu else max2.u[1];
