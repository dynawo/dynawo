...
model Dc1c "IEEE excitation system type DC1C model"
  ...
  Dynawo.Electrical.Controls.Utilities.TransferFunction transferFunction(a = {tB, 1}, b = {tC, 1}, x_scaled(start = {Va0Pu / Ka}), x_start = {Va0Pu / Ka}, y(start = Va0Pu / Ka)) annotation(
