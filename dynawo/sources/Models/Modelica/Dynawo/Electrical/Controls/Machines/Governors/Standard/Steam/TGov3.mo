...
model TGov3 "IEEE governor type TGOV3"
  ...
  parameter Types.PerUnit K2 "Fraction of IP shaft power after first boiler pass";
  ...
  Modelica.Blocks.Interfaces.RealOutput PmPu(start = Pm0Pu) "Mechanical power in pu (base PNomTurb)" annotation(
    Placement(visible = true, transformation(origin = {390, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Math.Add3 add3(k1 = K1, k2 = K3, k3 = K2) annotation(
...
equation
  ...
  connect(combiTable1Ds.y[1], firstOrder1.u) annotation(
    Line(points = {{241, 40}, {278, 40}}, color = {0, 0, 127}));
  connect(firstOrder1.y, add3.u2) annotation(
    Line(points = {{301, 40}, {337, 40}}, color = {0, 0, 127}));
  connect(add3.y, PmPu) annotation(
    Line(points = {{361, 40}, {390, 40}, {390, 39}}, color = {0, 0, 127}));
  connect(combiTable1Ds.y[1], add3.u3) annotation(
    Line(points = {{241, 40}, {260, 40}, {260, -40}, {320, -40}, {320, 32}, {338, 32}}, color = {0, 0, 127}));
  connect(firstOrder.y, add3.u1) annotation(
    Line(points = {{41, 0}, {60, 0}, {60, 80}, {320, 80}, {320, 48}, {338, 48}}, color = {0, 0, 127}));
