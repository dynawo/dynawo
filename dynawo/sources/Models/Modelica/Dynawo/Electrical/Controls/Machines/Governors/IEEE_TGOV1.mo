...
model IEEE_TGOV1 "Keep the mechanical power as a constant modulated by the difference between omega and a reference"
  ...
  Modelica.Blocks.Sources.Constant refPower(k = Pm0Pu) annotation(
...
equation
  ...
  connect(refPower.y, feedback.u1) annotation(
    Line(points = {{-99, 0}, {-78, 0}}, color = {0, 0, 127}));
