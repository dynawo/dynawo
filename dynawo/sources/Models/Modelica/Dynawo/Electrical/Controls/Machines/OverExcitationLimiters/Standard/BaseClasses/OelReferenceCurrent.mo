...
model OelReferenceCurrent
  ...
  Modelica.Blocks.Continuous.LimIntegrator limIntegrator1(outMax = IInst, outMin = ILim, IRef0Pu) annotation(
  ...
  Modelica.Blocks.Continuous.LimIntegrator limIntegrator(outMax = tMax, outMin = tMin, y_start = tFcl - tErr0) annotation(
...
equation
  ...
  connect(feedback3.y, lessEqualThreshold1.u) annotation(
    Line(points = {{109, -20}, {140, -20}, {140, -100}, {158, -100}}, color = {0, 0, 127}));
  ...
  connect(limIntegrator.y, gain3.u) annotation(
    Line(points = {{81, -60}, {100, -60}, {100, -100}, {81, -100}}, color = {0, 0, 127}));
  ...
  connect(feedback3.y, greaterEqualThreshold.u) annotation(
    Line(points = {{109, -20}, {158, -20}}, color = {0, 0, 127}));
  connect(limIntegrator.y, feedback3.u2) annotation(
    Line(points = {{81, -60}, {100, -60}, {100, -28}}, color = {0, 0, 127}));
  ...
  connect(const3.y, feedback3.u1) annotation(
    Line(points = {{41, -20}, {91, -20}}, color = {0, 0, 127}));
  ...
  connect(feedback3.y, tErr) annotation(
    Line(points = {{110, -20}, {140, -20}, {140, 60}, {330, 60}}, color = {0, 0, 127}));
