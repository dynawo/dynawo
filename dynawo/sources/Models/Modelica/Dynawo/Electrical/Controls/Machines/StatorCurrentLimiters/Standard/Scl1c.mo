...
model Scl1c "IEEE stator current limiter type SCL1C model"
  ...
  parameter Types.VoltageModulePu VSclDb "Dead-band for reactive power or power factor in pu (base SnRef)";
