...
model St7c "IEEE excitation system type ST7C model"
  ...
  Modelica.Blocks.Interfaces.RealOutput VFbPu(start = UsRef0Pu) "Reference voltage for UEL2C in pu (base UNom)" annotation(
...
equation
  ...
  connect(UsPu, firstOrder.u) annotation(
    Line(points = {{-400, -140}, {-360, -140}, {-360, -100}, {-322, -100}}, color = {0, 0, 127}));
  connect(firstOrder.y, transferFunction.u) annotation(
    Line(points = {{-299, -100}, {-202, -100}}, color = {0, 0, 127}));
  ...
  connect(min1.yMin, VFbPu) annotation(
    Line(points = {{-238, 0}, {-220, 0}, {-220, 60}, {-190, 60}}, color = {0, 0, 127}));
