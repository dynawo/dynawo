...
equation
  connect(gain1Init.y, rectifierRegulationCharacteristicInit.u1) annotation(
    Line(points = {{-39, 60}, {-20, 60}, {-20, 6}, {-2, 6}}, color = {0, 0, 127}));
  ...
  connect(realExpressionInit.y, gain1Init.u) annotation(
    Line(points = {{-99, 60}, {-62, 60}}, color = {0, 0, 127}));
  ...
  connect(booleanConstantInit.y, switchInit.u2) annotation(
    Line(points = {{-99, -40}, {-63, -40}}, color = {255, 0, 255}));
  connect(const1Init.y, switchInit.u3) annotation(
    Line(points = {{-99, -80}, {-80, -80}, {-80, -48}, {-63, -48}}, color = {0, 0, 127}));
