...
model GovSteamEu "Governor type GovSteamEU"
  ...
  Modelica.Blocks.Tables.CombiTable1Dv combiTableEmergency(table=[0,1; OmegaMax1Pu,1; OmegaMax2Pu,0;
        OmegaMax2Pu + 0.01,0], tableOnFile=false) annotation (Placement(visible=true,
        transformation(
        origin={240,-88},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  ...
  Dynawo.NonElectrical.Blocks.NonLinear.Min2 minEmergencyBoiler annotation(
    Placement(visible = true, transformation(origin = {14, -164}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.NonElectrical.Blocks.NonLinear.Min2 minEmergencyCv annotation(
