...
partial model BaseSt7 "IEEE excitation system type ST7 base model"
  ...
  Dynawo.NonElectrical.Blocks.Continuous.TransferFunction transferFunction1(a = {tB, 1}, b = {tC, 1}, u_start = (1 + Kia) * Efd0Pu, y_start = (1 + Kia) * Efd0Pu) annotation(
  ...
  Dynawo.NonElectrical.Blocks.Continuous.TransferFunction transferFunction(a = {tF, 1}, b = {tG, 1}, u_start = Us0Pu, y_start = Us0Pu) annotation(
...
equation
  ...
  connect(max1.y, min1.u[1]) annotation(
    Line(points = {{-279, 0}, {-261, 0}}, color = {0, 0, 127}));
  connect(max2.y, min2.u[1]) annotation(
    Line(points = {{181, 0}, {200, 0}}, color = {0, 0, 127}));
