...
partial model BaseSt7 "IEEE excitation system type ST7 base model"
  ...
  Dynawo.NonElectrical.Blocks.Continuous.TransferFunction transferFunction1(a = {tB, 1}, b = {tC, 1}, u_start = (1 + Kia) * Efd0Pu) annotation(
  ...
  Dynawo.NonElectrical.Blocks.Continuous.TransferFunction transferFunction(a = {tF, 1}, b = {tG, 1}, u_start = Us0Pu) annotation(
