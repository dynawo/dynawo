...
model BaseIEEEX "IEEE excitation system base model"
  ...
  Dynawo.Electrical.Controls.Utilities.TransferFunction transferFunction(a = {tB, 1}, b = {tC, 1}, x_scaled(start = {Va0Pu / Ka}), x_start = {Va0Pu / Ka}, y_start = Va0Pu / Ka) annotation(
