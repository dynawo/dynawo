...
model BaseIEEEX "IEEE excitation system base model"
  ...
  Modelica.Blocks.Continuous.TransferFunction transferFunction(a = {max(tB, 1e-5), 1}, b = {tC, 1}, x_scaled(start = {Va0Pu / Ka}), x_start = {Va0Pu / Ka}, y(start = Va0Pu / Ka)) annotation(
