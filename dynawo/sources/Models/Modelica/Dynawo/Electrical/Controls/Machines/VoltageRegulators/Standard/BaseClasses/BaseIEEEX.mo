...
partial model BaseIEEEX "IEEE excitation system base model"
  ...
  Dynawo.NonElectrical.Blocks.Continuous.TransferFunction transferFunction(a = {tB, 1}, b = {tC, 1}, u_start = Va0Pu / Ka, y_start = Va0Pu / Ka) annotation(
