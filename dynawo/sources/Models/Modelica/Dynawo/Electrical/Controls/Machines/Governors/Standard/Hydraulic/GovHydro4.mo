...
model GovHydro4 "Governor type GovHydro4"
  ...
  Modelica.Blocks.Sources.Constant constant1(k = QNl) annotation(
    Placement(visible = true, transformation(origin = {8, -128}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(constant1.y, addQnl.u2) annotation(
    Line(points = {{19, -128}, {29, -128}, {29, -66}, {38, -66}}, color = {0, 0, 127}));
  ...
  connect(intTw.y, division.u1) annotation(
    Line(points = {{1, -40}, {8, -40}, {8, -98}, {-170, -98}, {-170, -34}, {-162, -34}}, color = {0, 0, 127}));
