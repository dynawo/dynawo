...
model GovCT2 "Governor type GovCT2"
  ...
  // Parameters
  parameter Types.PerUnit aSetPu = 10 "Acceleration limiter setpoint in pu/s (base omegaNom), typical: 10" annotation( Dialog(tab = "Acceleration limiter"));
  parameter Types.AngularVelocityPu DeltaOmegaDbPu = 0 "Speed governor deadband in pu (base omegaNom), typical: 0" annotation( Dialog(tab = "Main control path"));
  parameter Types.AngularVelocityPu DeltaOmegaMaxPu = 1 "Maximum value for speed error signal in pu (base omegaNom), typical: 1" annotation( Dialog(tab = "Main control path"));
  parameter Types.AngularVelocityPu DeltaOmegaMinPu = -1 "Minimum value for speed error signal in pu (base omegaNom), typical: -1" annotation( Dialog(tab = "Main control path"));
  parameter Types.Time DeltaT = 1 "Correction factor in s (to adapt the unit of the acceleration limiter gain from pu/s to pu), typical: 1" annotation( Dialog(tab = "Acceleration limiter"));
  parameter Types.PerUnit Dm = 0 "Speed sensitivity coefficient (damping), typical: 0 (deactivated)" annotation( Dialog(tab = "Turbine/engine"));
  parameter Types.Frequency fLim10Hz = 0 "Frequency threshold 10 in Hz, typical: 0" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.Frequency fLim1Hz = 49 "Frequency threshold 1 in Hz, typical: 49" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.Frequency fLim2Hz = 8 "Frequency threshold 2 in Hz, typical: 8" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.Frequency fLim3Hz = 7 "Frequency threshold 3 in Hz, typical: 7" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.Frequency fLim4Hz = 6 "Frequency threshold 4 in Hz, typical: 6" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.Frequency fLim5Hz = 5 "Frequency threshold 5 in Hz, typical: 5" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.Frequency fLim6Hz = 4 "Frequency threshold 6 in Hz, typical: 4" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.Frequency fLim7Hz = 3 "Frequency threshold 7 in Hz, typical: 3" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.Frequency fLim8Hz = 2 "Frequency threshold 8 in Hz, typical: 2" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.Frequency fLim9Hz = 1 "Frequency threshold 9 in Hz, typical: 1" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.PerUnit KA = 10 "Acceleration limiter gain, typical: 10" annotation( Dialog(tab = "Acceleration limiter"));
  parameter Types.PerUnit KDGov = 0 "Governor derivative gain, typical: 0" annotation( Dialog(tab = "Main control path"));
  parameter Types.PerUnit KIGov = 0.45 "Governor integral gain, typical: 0.45" annotation( Dialog(tab = "Main control path"));
  parameter Types.PerUnit KILoad = 1 "Load limiter integral gain for PI controller, typical: 1" annotation( Dialog(tab = "Load limit controller"));
  parameter Types.PerUnit KIMw = 0 "Power controller gain, typical: 0 (deactivated)" annotation( Dialog(tab = "Supervisory load controller"));
  parameter Types.PerUnit KPGov = 4 "Governor proportional gain, typical: 4" annotation( Dialog(tab = "Main control path"));
  parameter Types.PerUnit KPLoad = 1 "Load limiter proportional gain for PI controller, typical: 1" annotation( Dialog(tab = "Load limit controller"));
  parameter Types.PerUnit KTurb = 1.9168 "Turbine gain, typical: 1.9168" annotation( Dialog(tab = "Turbine/engine"));
  parameter Types.ActivePowerPu PBaseMw "Base power in [MW, MVA]" annotation( Dialog(tab = "General"));
  parameter Types.ActivePowerPu PGenBaseMw = SystemBase.SnRef "Base power for measured electrical power in [MW, MVA]" annotation( Dialog(tab = "General"));
  parameter Types.ActivePowerPu PLdRefPu = 1 "Load limiter reference value in pu (base PNomTurb), typical: 1" annotation( Dialog(tab = "Load limit controller"));
  parameter Types.ActivePowerPu PLim10Pu = 0.8325 "Power limit 10 in pu (base PNomTurb), typical: 0.8325" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.ActivePowerPu PLim1Pu = 0.8325 "Power limit 1 in pu (base PNomTurb), typical: 0.8325" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.ActivePowerPu PLim2Pu = 0.8325 "Power limit 2 in pu (base PNomTurb), typical: 0.8325" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.ActivePowerPu PLim3Pu = 0.8325 "Power limit 3 in pu (base PNomTurb), typical: 0.8325" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.ActivePowerPu PLim4Pu = 0.8325 "Power limit 4 in pu (base PNomTurb), typical: 0.8325" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.ActivePowerPu PLim5Pu = 0.8325 "Power limit 5 in pu (base PNomTurb), typical: 0.8325" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.ActivePowerPu PLim6Pu = 0.8325 "Power limit 6 in pu (base PNomTurb), typical: 0.8325" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.ActivePowerPu PLim7Pu = 0.8325 "Power limit 7 in pu (base PNomTurb), typical: 0.8325" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.ActivePowerPu PLim8Pu = 0.8325 "Power limit 8 in pu (base PNomTurb), typical: 0.8325" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.ActivePowerPu PLim9Pu = 0.8325 "Power Limit 9 in pu (base PNomTurb), typical: 0.8325" annotation( Dialog(tab = "Frequency dependent valve limit"));
  ...
  parameter Types.PerUnit PRatePu = 0.017 "Ramp rate for frequency-dependent power limit in pu/s (base PNomTurb*KTurb), typical: 0.017" annotation( Dialog(tab = "Frequency dependent valve limit"));
  parameter Types.PerUnit RClosePu = -99 "Minimum valve closing rate in pu/s (base PNomTurb*KTurb), typical: -99" annotation( Dialog(tab = "Turbine/engine"));
  parameter Types.PerUnit RDownPu = -99 "Maximum rate of load limit decrease in pu/s (base PNomTurb*KTurb), typical: -99" annotation( Dialog(tab = "Load limit controller"));
  parameter Types.PerUnit ROpenPu = 99 "Maximum valve opening rate in pu/s (base PNomTurb*KTurb), typical: 99" annotation( Dialog(tab = "Turbine/engine"));
  parameter Types.PerUnit RDroop = 0.05 "Permanent droop, typical: 0.05" annotation( Dialog(tab = "Main control path"));
  parameter Integer RSelectInt "Feedback signal for droop" annotation( Dialog(tab = "Main control path"));
  parameter Types.PerUnit RUpPu = 99 "Maximum rate of load limit increase in pu/s (base PNomTurb*KTurb), typical: 99" annotation( Dialog(tab = "Load limit controller"));
  parameter Types.Time tActuator = 0.4 "Actuator time constant in s, typical: 0.4" annotation( Dialog(tab = "Turbine/engine"));
  parameter Types.Time tA = 1 "Acceleration limiter time constant in s, typical: 1" annotation( Dialog(tab = "Acceleration limiter"));
  parameter Types.Time tB = 0.1 "Turbine lag time constant in s, typical: 0.1" annotation( Dialog(tab = "Turbine/engine"));
  parameter Types.Time tC = 0 "Turbine lead time constant in s, typical: 0" annotation( Dialog(tab = "Turbine/engine"));
  parameter Types.Time tDGov = 1 "Governor derivative controller time constant in s, typical: 1" annotation( Dialog(tab = "Main control path"));
  parameter Types.Time tDRatelim = 0.001 "Ramp rate limter derivative time constant in s, typical: 0.001";
  parameter Types.Time tEngine = 0 "Transport time delay for diesel engine in s, typical: 0" annotation( Dialog(tab = "Turbine/engine"));
  parameter Types.Time tFLoad = 3 "Load limiter time constant in s, typical: 3" annotation( Dialog(tab = "Load limit controller"));
  parameter Types.Time tLastValue = 1e-9 "Fast delay block time constant in s, typical: 1e-9" annotation( Dialog(tab = "Main control path"));
  parameter Types.Time tPElec = 2.5 "Electrical power transducer time constant in s, typical: 2.5" annotation( Dialog(tab = "Main control path"));
  parameter Types.Time tSA = 1e-6 "Temperature detection lead time constant in s, typical: 1e-6" annotation( Dialog(tab = "Load limit controller"));
  parameter Types.Time tSB = 50 "Temperature detection lag time constant in s, typical: 50" annotation( Dialog(tab = "Load limit controller"));
  parameter Types.PerUnit ValveMaxPu = 1 "Maximum valve position limit in pu (base PNomTurb*KTurb), typical: 1" annotation( Dialog(tab = "Turbine/engine"));
  parameter Types.PerUnit ValveMinPu = 0.175 "Minimum valve position limit in pu (base PNomTurb*KTurb), typical: 0.175" annotation( Dialog(tab = "Turbine/engine"));
  parameter Types.PerUnit WFnlPu = 0.187 "No load fuel flow in pu (base PNomTurb*KTurb), typical: 0.187" annotation( Dialog(tab = "Turbine/engine"));
  parameter Boolean WFSpdBool = false "Switch for fuel source characteristic, typical: false" annotation( Dialog(tab = "Turbine/engine")); 
...
protected
    ...
    final parameter Types.PerUnit initCfePu = WFnlPu + (if KTurb > 0 then initPMechNoLossPu/KTurb else 0);
    final parameter Types.PerUnit initFsrtPu = (PLdRefPu/KTurb + WFnlPu - initTexPu)*KPLoad + initIntegratorKILoadPu;
    final parameter Types.PerUnit initIntegratorKILoadPu = 1;
    final parameter Types.PerUnit initPMechNoLossPu = if Dm>0.0 then Pm0Pu + omega0Pu*Dm else Pm0Pu;
    final parameter Types.PerUnit initTexPu = initCfePu * (if Dm<0 then omega0Pu^Dm else 1);
    final parameter Types.PerUnit initValvePu = if WFSpdBool then initCfePu/omega0Pu else initCfePu;
equation
  ...
  connect(PGenPu, gainChangeBaseIn.u) annotation(
    Line(points = {{-334, -182}, {-308, -182}}, color = {0, 0, 127}));
