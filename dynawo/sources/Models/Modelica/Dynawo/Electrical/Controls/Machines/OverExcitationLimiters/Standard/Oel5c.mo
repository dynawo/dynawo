...
model Oel5c "IEEE (2016) overexcitation limiter type OEL5C model"
  ...
  Dynawo.NonElectrical.Blocks.Continuous.TransferFunctionBypass transferFunction(a = {tBOel, 1}, b = {tCOel, 1}, u_start = KScale1 * Input0Pu, y_start = KScale1 * Input0Pu) annotation(
