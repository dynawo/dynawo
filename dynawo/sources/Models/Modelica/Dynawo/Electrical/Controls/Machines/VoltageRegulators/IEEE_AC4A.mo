...
model IEEE_AC4A
  ...
  LeadLag leadLag(T1 = Tc, T2 = Tb, K = 1, y0 = 1 / Ka, u0 = 1/Ka)  annotation(
    Placement(visible = true, transformation(origin = {-30, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FirstOrderWithNonWindUpLimiter firstOrderLim(T = Ta, K = Ka, YMax = VrMax, YMin = VrMin, y0 = 1, u0 = 1/Ka)  annotation(
