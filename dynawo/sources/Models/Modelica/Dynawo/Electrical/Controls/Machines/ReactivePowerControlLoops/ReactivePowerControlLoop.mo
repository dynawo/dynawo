...
model ReactivePowerControlLoop "Simplified Reactive Power Control Loop model"
  ...
  */
  ...
  parameter Types.ReactivePowerPu QDeadBand "Reactive power dead band in pu (base QNomAlt)";
  ...
  Modelica.Blocks.Nonlinear.DeadZone deadBand(uMax = QDeadBand, uMin = -QDeadBand) annotation(
...
equation
  ...
  connect(rampLim.u, gainIntegrator.y) annotation(
    Line(points = {{-22, 0}, {-31, 0}}, color = {0, 0, 127}));
  ...
  connect(errQ.y, deadBand.u) annotation(
    Line(points = {{-90, 0}, {-84, 0}}, color = {0, 0, 127}));
  connect(deadBand.y, gainIntegrator.u) annotation(
