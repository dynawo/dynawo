...
model ReactivePowerControlLoop "Simplified Reactive Power Control Loop model"
  ...
  Dynawo.NonElectrical.Blocks.NonLinear.DeadZone deadZone(uMax = QDeadBandPu, uMin = -QDeadBandPu) annotation(
    Placement(transformation(origin = {-73, 0}, extent = {{-10, -10}, {10, 10}})));
...
equation
  ...
  connect(rampLim.u, gainIntegrator.y) annotation(
    Line(points = {{-16, 0}, {-33, 0}}, color = {0, 0, 127}));
  connect(errQ.u2, QStatorPu) annotation(
    Line(points = {{-106, -8}, {-106, -40}, {-172, -40}}, color = {0, 0, 127}));
  connect(errQ.u1, participation.y) annotation(
    Line(points = {{-114, 0}, {-119, 0}}, color = {0, 0, 127}));
  ...
  connect(swLimUp.y, rampLim.limit1) annotation(
    Line(points = {{-99, 80}, {-40, 80}, {-40, 8}, {-16, 8}}, color = {0, 0, 127}));
  connect(swLimDown.y, rampLim.limit2) annotation(
    Line(points = {{-76, -120}, {-40, -120}, {-40, -8}, {-16, -8}}, color = {0, 0, 127}));
  ...
  connect(errQ.y, deadZone.u) annotation(
    Line(points = {{-96, 0}, {-84, 0}}, color = {0, 0, 127}));
  connect(deadZone.y, gainIntegrator.u) annotation(
    Line(points = {{-62, 0}, {-56, 0}}, color = {0, 0, 127}));
