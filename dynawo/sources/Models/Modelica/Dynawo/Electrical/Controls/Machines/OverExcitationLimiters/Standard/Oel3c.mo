...
model Oel3c "IEEE overexcitation limiter type OEL3C model"

  //Regulation parameters
  parameter Types.PerUnit ITfPu "OEL timed field current limiter pick up level";
  ...
  parameter Types.VoltageModulePu VOel1MaxPu "OEL integrator maximum output";
  parameter Types.VoltageModulePu VOel1MinPu "OEL integrator minimum output";
  parameter Types.VoltageModulePu VOel2MaxPu "OEL maximum output";
  parameter Types.VoltageModulePu VOel2MinPu "OEL minimum output";

  final parameter Types.PerUnit KScale = ITfPu / Input0Pu "OEL input signal scaling factor";
  ...
  Modelica.Blocks.Math.Add add annotation(
    Placement(visible = true, transformation(origin = {130, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.LimIntegrator limIntegrator(outMax = VOel1MaxPu, outMin = VOel1MinPu) annotation(
    Placement(visible = true, transformation(origin = {30, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
