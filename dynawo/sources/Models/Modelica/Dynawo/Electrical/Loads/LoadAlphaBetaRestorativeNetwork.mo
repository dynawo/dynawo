...
equation
  if (running.value) then
    Tp * der(zPRaw) = (complexToPolar.len / ComplexMath.'abs'(u0Pu)) ^ alphaLong - zPRaw * (complexToPolar.len / ComplexMath.'abs'(u0Pu)) ^ alpha;
    Tq * der(zQRaw) = (complexToPolar.len / ComplexMath.'abs'(u0Pu)) ^ betaLong - zQRaw * (complexToPolar.len / ComplexMath.'abs'(u0Pu)) ^ beta;
    ...
    PPu = zP * PRefPu * (1. + deltaP) * ((complexToPolar.len / ComplexMath.'abs'(u0Pu)) ^ alpha);
    QPu = zQ * QRefPu * (1. + deltaQ) * ((complexToPolar.len / ComplexMath.'abs'(u0Pu)) ^ beta);
  else
    Tp * der(zPRaw) = 0.;
    Tq * der(zQRaw) = 0.;
    zP = 0.;
