...
model LoadAuxiliaries_INIT "Initialization for auxiliaries where u0Pu and i0Pu need to be connected"
  ...
  parameter Dynawo.Connectors.ActivePowerPuConnector P0Pu "Start value of active power in pu (base SnRef) (receptor convention)";
  parameter Dynawo.Connectors.ReactivePowerPuConnector Q0Pu "Start value of reactive power in pu (base SnRef) (receptor convention)";
