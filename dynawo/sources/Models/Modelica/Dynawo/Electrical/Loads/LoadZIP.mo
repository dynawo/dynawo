...
equation
  if (running.value) then
    PPu = PRefPu * (1 + deltaP) * (Zp * (complexToPolar.len / ComplexMath.'abs'(u0Pu)) ^ 2 + Ip * (complexToPolar.len / ComplexMath.'abs'(u0Pu)) + Pp);
    QPu = QRefPu * (1 + deltaQ) * (Zq * (complexToPolar.len / ComplexMath.'abs'(u0Pu)) ^ 2 + Iq * (complexToPolar.len / ComplexMath.'abs'(u0Pu)) + Pq);
  else
