...
partial model BaseBESScbCurrentSource "Partial base model for WECC BESS with electrical control model type C, generator/converter model type B"
  ...
  Dynawo.Electrical.Controls.WECC.REGC.REGCbCS regcBCS(Id0Pu = Id0Pu, Iq0Pu = Iq0Pu, DerIqrMaxPu = DerIqrMaxPu, DerIqrMinPu = DerIqrMinPu, RateFlag = RateFlag, RrpwrPu = RrpwrPu, UInj0Pu = UInj0Pu, tFilterGC = tFilterGC, tG = tG) annotation(
