...
model BESSCurrentSourceNoPlantControl3 "WECC BESS with electrical control model type E, generator/converter model type B (without plant control)"
...
equation
  ...
  connect(PInjRefPu, reecE.PInjRefPu) annotation(
    Line(points = {{-190, 20}, {-160, 20}, {-160, 6}, {-91, 6}}, color = {0, 0, 127}));
  connect(QInjRefPu, reecE.QInjRefPu) annotation(
    Line(points = {{-190, -20}, {-160, -20}, {-160, -6}, {-91, -6}}, color = {0, 0, 127}));
...
end BESSCurrentSourceNoPlantControl3;
