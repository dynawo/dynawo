...
model BESSda_INIT "Initialization model for WECC Wind model with a current source as interface with the grid"
  ...
  parameter Types.VoltageModulePu U0Pu "Start value of voltage module at regulated bus in pu (bae UNom)";
  ...
  Types.ComplexCurrentPu iInj0Pu "Start value of complex current at injector in pu (base SNom, UNom) (generator convention)";
