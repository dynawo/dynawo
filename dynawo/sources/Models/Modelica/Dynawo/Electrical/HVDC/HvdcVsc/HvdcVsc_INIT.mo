...
model HvdcVsc_INIT "Initialisation model for the HVDC VSC model"
  ...
  Dynawo.Connectors.ReactivePowerPuOutput PRef0Pu "Start value of reactive power reference in pu (base SNom) (DC to AC)";
  ...
  Dynawo.Connectors.VoltageModulePuOutput URef10Pu "Start value of the voltage reference for the side 1 of the HVDC link in pu (base UNom)";
