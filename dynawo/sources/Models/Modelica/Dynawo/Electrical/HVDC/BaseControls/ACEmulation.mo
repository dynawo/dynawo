...
equation
  connect(firstOrder1.y, feedback.u2) annotation(
    Line(points = {{-69, 0}, {-40, 0}, {-40, 32}}, color = {0, 0, 127}));
  connect(feedback.y, gain.u) annotation(
    Line(points = {{-31, 40}, {-22, 40}}, color = {0, 0, 127}));
  ...
  connect(Theta2, firstOrder1.u) annotation(
    Line(points = {{-110, 0}, {-92, 0}}, color = {0, 0, 127}));
  connect(firstOrder.y, feedback.u1) annotation(
    Line(points = {{-69, 40}, {-48, 40}}, color = {0, 0, 127}));
