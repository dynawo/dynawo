...
partial model BasePV_INIT "Base initialization model for PV HVDC"
  ...
  Dynawo.Connectors.ReactivePowerPuOutput QInj10PuQNom "Reactive power at terminal 1 in pu (base Q1Nom) (generator convention)";
  Dynawo.Connectors.VoltageModulePuOutput U1Ref0Pu "Start value of the voltage regulation set point in pu (base UNom) at terminal 1";
