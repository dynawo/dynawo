...
partial model BaseQStatusDangling_INIT "Base initialization model for QStatus at terminal 1"
  ...
  Modelica.Blocks.Interfaces.BooleanInput limUQDown10 "Whether the minimum reactive power limits are reached or not at terminal 1, start value";
  Modelica.Blocks.Interfaces.BooleanInput limUQUp10 "Whether the maximum reactive power limits are reached or not at terminal 1, start value";
