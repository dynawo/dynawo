...
model DCVoltageControlSideDangling "DC Voltage Control Side for the HVDC VSC model that connects two different synchronous areas (Udc control on the side of the main one)"
