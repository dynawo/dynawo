...
model HvdcVSCDanglingUdc "HVDC VSC model that connects two different synchronous areas (Udc control on the side of the main one)"
  ...
  extends HVDC.HvdcVSC.BaseControls.Parameters.Params_DCVoltageControlDangling;
  ...
  Modelica.Blocks.Interfaces.RealInput UdcRefPu(start = Udc10Pu) "DC voltage reference of the HVDC link in p.u (base UNom)" annotation(
