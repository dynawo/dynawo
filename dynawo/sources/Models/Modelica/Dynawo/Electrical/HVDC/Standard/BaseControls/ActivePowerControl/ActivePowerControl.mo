within Dynawo.Electrical.HVDC.Standard.BaseControls.ActivePowerControl;
...
model ActivePowerControl "Active power control for HVDC link"
  ...
  HVDC.Standard.BaseControls.ActivePowerControl.RPFaultFunction RPFault(SlopeRPFault = SlopeRPFault) "rpfault function for HVDC" annotation(
