...
model DCVoltageControl "DC Voltage Control for HVDC"
  ...
  parameter Types.VoltageModulePu VdcRefMaxPu;
  parameter Types.VoltageModulePu VdcRefMinPu;
  parameter Types.PerUnit Kpdc;
  parameter Types.PerUnit Kidc;
  parameter Types.PerUnit IpMaxcstPu;

  Modelica.Blocks.Interfaces.RealInput vdcRefPu(start = Vdc0Pu) annotation(
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter(limitsAtInit = true, uMax = VdcRefMaxPu, uMin = VdcRefMinPu)  annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput ipRefVdcPu(start = Ip0Pu) annotation(
...
equation
  connect(vdcRefPu, limiter.u) annotation(
  ...
  connect(gain1.y, ipRefVdcPu) annotation(
