within Dynawo.Electrical.HVDC.Standard.BaseControls.DCVoltageControl;
...
model DCVoltageControl "DC Voltage Control for HVDC"
  ...
  HVDC.Standard.BaseControls.DCVoltageControl.ActivateDeltaP activateDeltaPfunction(DUDC = DUDC, Ip0Pu = Ip0Pu, IpMaxCstPu = IpMaxCstPu)  "Function that activates the DeltaP when necessary" annotation(
