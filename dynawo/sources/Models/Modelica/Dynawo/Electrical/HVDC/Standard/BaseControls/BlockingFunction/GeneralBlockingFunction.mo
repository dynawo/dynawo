...
model GeneralBlockingFunction "Undervoltage blocking function for the two sides of an HVDC Link"
  ...
  HVDC.Standard.BaseControls.BlockingFunction.BlockingFunction blockingFunction1(TBlock = TBlock, TBlockUV = TBlockUV, TDeblockU = TDeblockU, UBlockUVPu = UBlockUVPu, UMaxdbPu = UMaxdbPu, UMindbPu = UMindbPu, U0Pu = U10Pu) "Undervoltage blocking function for one side of an HVDC Link"  annotation(
    Placement(visible = true, transformation(origin = {-40, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HVDC.Standard.BaseControls.BlockingFunction.BlockingFunction blockingFunction2(TBlock = TBlock, TBlockUV = TBlockUV, TDeblockU = TDeblockU, UBlockUVPu = UBlockUVPu, UMaxdbPu = UMaxdbPu, UMindbPu = UMindbPu, U0Pu = U20Pu) "Undervoltage blocking function for one side of an HVDC Link"  annotation(
    Placement(visible = true, transformation(origin = {-40, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
