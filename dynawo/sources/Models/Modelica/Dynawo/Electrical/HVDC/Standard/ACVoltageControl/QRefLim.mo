...
model QRefLim
  ...
  extends Parameters.Params_QRefLim;
  ...
  Modelica.Blocks.Tables.CombiTable1D QMaxPPu(extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint, table = tableQMaxPPu) annotation(
    Placement(visible = true, transformation(origin = {-66, 95}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Tables.CombiTable1D QMinPPu(extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint, table = tableQMinPPu) annotation(
    Placement(visible = true, transformation(origin = {-66, 55}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Tables.CombiTable1D QMinUPu(extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint, table = tableQMinUPu) annotation(
    Placement(visible = true, transformation(origin = {-66, -55}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Tables.CombiTable1D QMaxUPu(extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint, table = tableQMaxUPu) annotation(
    Placement(visible = true, transformation(origin = {-66, -95}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
