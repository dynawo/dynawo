...
model DeltaPCalc
  ...
  Modelica.Blocks.Interfaces.RealInput ipRefUdcPu(start = Ip0Pu) "Active current reference of the DC voltage control side of the HVDC link in p.u (base UNom, SNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput DeltaPPu(start = 0) "Corrective signal to adjust the active power in the case where the DC voltage control side of the HVDC link cannot control the DC voltage anymore" annotation(
...
equation
  ...
  connect(switch1.y, DeltaPPu) annotation(
