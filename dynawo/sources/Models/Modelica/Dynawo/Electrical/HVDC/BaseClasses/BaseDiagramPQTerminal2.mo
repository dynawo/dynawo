...
partial model BaseDiagramPQTerminal2 "Base dynamic model for a PQ diagram at terminal 2"
  ...
  Modelica.Blocks.Tables.CombiTable1Dv tableQInj2Max(
    tableOnFile=true,
    tableName=QInj2MaxTableName,
    fileName=QInj2MaxTableFile) "Table to get QInj2MaxPu from PInj2Pu (generator convention)";
  Modelica.Blocks.Tables.CombiTable1Dv tableQInj2Min(
    tableOnFile=true,
    tableName=QInj2MinTableName,
    fileName=QInj2MinTableFile) "Table to get QInj2MinPu from PInj2Pu (generator convention)";
