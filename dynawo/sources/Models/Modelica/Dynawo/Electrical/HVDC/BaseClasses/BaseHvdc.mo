...
*/
  ...
  input Dynawo.Connectors.ActivePowerPuConnector P1RefPu(start = P1Ref0Pu) "Active power regulation set point in pu (base SnRef) at terminal 1 (receptor convention)";
