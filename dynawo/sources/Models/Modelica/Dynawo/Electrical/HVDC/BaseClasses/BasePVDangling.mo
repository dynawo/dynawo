...
partial model BasePVDangling "Base dynamic model for PV control at terminal 1"
  ...
  Dynawo.Connectors.VoltageModulePuInput U1RefPu(start = U1Ref0Pu) "Voltage regulation set point in pu (base UNom) at terminal 1";

  Dynawo.Connectors.ReactivePowerPuInput QInj1PuQNom "Reactive power at terminal 1 in pu (base Q1Nom) (generator convention)";
