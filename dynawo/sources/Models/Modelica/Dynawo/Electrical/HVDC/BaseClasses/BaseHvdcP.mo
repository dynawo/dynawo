...
*/
  ...
  Modelica.Blocks.Interfaces.RealInput Theta1(start = UPhase10) "Angle of the voltage at terminal 1 in rad";
  Modelica.Blocks.Interfaces.RealInput Theta2(start = UPhase20) "Angle of the voltage at terminal 2 in rad";
