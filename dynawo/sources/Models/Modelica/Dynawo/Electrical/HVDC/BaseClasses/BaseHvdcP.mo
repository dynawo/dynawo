...
*/
  ...
  Dynawo.Connectors.AngleOutput Theta1(start = UPhase10) "Angle of the voltage at terminal 1 in rad";
  Dynawo.Connectors.AngleOutput Theta2(start = UPhase20) "Angle of the voltage at terminal 2 in rad";
...
equation
  ...
  if terminal1.V.re > Modelica.Constants.eps or terminal1.V.re < -Modelica.Constants.eps or terminal1.V.im > Modelica.Constants.eps or terminal1.V.im < -Modelica.Constants.eps then
  ...
  if terminal2.V.re > Modelica.Constants.eps or terminal2.V.re < -Modelica.Constants.eps or terminal2.V.im > Modelica.Constants.eps or terminal2.V.im < -Modelica.Constants.eps then
