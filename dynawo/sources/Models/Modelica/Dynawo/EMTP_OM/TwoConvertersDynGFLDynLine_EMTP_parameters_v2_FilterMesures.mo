...
model TwoConvertersDynGFLDynLine_EMTP_parameters_v2_FilterMesures
  ...
  Dynawo.Electrical.Lines.DynLine dynLine2(LPu = 0.005, P01Pu = 0.09, P02Pu = -0.09, Q01Pu = 0.9892, Q02Pu = -0.9892, RPu = 0.0005, U01Pu = 1.099, U02Pu = 1.1, UPhase01 = -0.04, UPhase02 = -0.04) annotation(
...
parameter Real modif1 = 1;
  ...
  Dynawo.Electrical.PEIR.Converters.General.Average.GridFollowing.DynGFLMeasurementFiltered GFL2(CFilterPu = 1e-5, Kfd = 1, Kfq = 1, Ki = 10, Kic = 1.87, Kid = 25, Kiq = 25, Kp = 2, Kpc = 0.18, Kpd = 0.1, Kpq = 0.1, LFilterPu = 0.1, LTransformerPu = 0.05, OmegaMaxPu = 1.1, OmegaMinPu = 0.9, P0Pu = -5, Q0Pu = 0.28, RFilterPu = 0.003, RTransformerPu = 0.002, SNom = 1000, U0Pu = 1.1072, UPhase0 = 0.098, tPFilt = 1 / 111, tQFilt = 1 / 111, tVSC = 0.00004) annotation(
...
// OmegaRef = 1
  ...
  connect(GFL1.terminal, dynLine.terminal1) annotation(
    Line(points = {{-55, 4}, {-55.5, 4}, {-55.5, 0}, {-42, 0}}, color = {0, 0, 255}));
  ...
  connect(step.y, GFL1.PFilterRefPu) annotation(
    Line(points = {{-109, 16}, {-92, 16}, {-92, 12}, {-77, 12}}, color = {0, 0, 127}));
  connect(step1.y, GFL2.PFilterRefPu) annotation(
    Line(points = {{127, 34}, {113.5, 34}, {113.5, 8}, {96, 8}}, color = {0, 0, 127}));
  connect(step2.y, GFL1.QFilterRefPu) annotation(
    Line(points = {{-108, -20}, {-77, -20}, {-77, 0}}, color = {0, 0, 127}));
  connect(GFL2.QFilterRefPu, step3.y) annotation(
    Line(points = {{96, -4}, {122.5, -4}, {122.5, -14}, {153, -14}}, color = {0, 0, 127}));
