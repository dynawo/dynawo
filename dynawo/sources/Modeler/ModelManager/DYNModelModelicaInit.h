...
/**
 * @file  DYNModelModelicaInit.h
 *
 * @brief Class for native Modelica models used for init model
 *
 */


#ifndef MODELER_MODELMANAGER_DYNMODELMODELICAINIT_H_
#define MODELER_MODELMANAGER_DYNMODELMODELICAINIT_H_
 ...
 *
 * Class for native Modelica models used for init model
 */
class ModelModelicaInit : public ModelModelica {
 public:
  /**
   * @brief default destructor
   */
  virtual ~ModelModelicaInit() { }
