...
/**
 * @file  DYNTwoWTransformerInterfaceIIDM.h
 *
 * @brief Two windings transformer data interface : header file for IIDM implementation
 *
 */
#ifndef MODELER_DATAINTERFACE_DYNTWOWTRANSFORMERINTERFACEIIDM_H_
#define MODELER_DATAINTERFACE_DYNTWOWTRANSFORMERINTERFACEIIDM_H_
...
#endif  // MODELER_DATAINTERFACE_DYNTWOWTRANSFORMERINTERFACEIIDM_H_
