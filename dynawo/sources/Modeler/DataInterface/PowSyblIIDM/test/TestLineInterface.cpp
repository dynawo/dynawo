...
TEST(DataInterfaceTest, Line) {
  ...
  ASSERT_FALSE(li.getCurrentLimitPermanent(season, LineInterface::CURRENT_LIMIT_SIDE_1));
  ASSERT_FALSE(li.getCurrentLimitNbTemporary(season, LineInterface::CURRENT_LIMIT_SIDE_1));
  ASSERT_FALSE(li.getCurrentLimitTemporaryName(season, LineInterface::CURRENT_LIMIT_SIDE_1, 0));
  ASSERT_FALSE(li.getCurrentLimitTemporaryAcceptableDuration(season, LineInterface::CURRENT_LIMIT_SIDE_1, 0));
  ASSERT_FALSE(li.getCurrentLimitTemporaryValue(season, LineInterface::CURRENT_LIMIT_SIDE_1, 0));
  ASSERT_FALSE(li.getCurrentLimitTemporaryFictitious(season, LineInterface::CURRENT_LIMIT_SIDE_1, 0));
