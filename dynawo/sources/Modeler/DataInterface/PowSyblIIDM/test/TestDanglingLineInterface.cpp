...
TEST(DataInterfaceTest, DanglingLine_1) {
  ...
  std::unique_ptr<CurrentLimitInterface> currentLimitIfce(new CurrentLimitInterfaceIIDM(1.0, 99, false));
  ...
  std::unique_ptr<CurrentLimitInterface> currentLimitIfceFictitious(new CurrentLimitInterfaceIIDM(1.0,
