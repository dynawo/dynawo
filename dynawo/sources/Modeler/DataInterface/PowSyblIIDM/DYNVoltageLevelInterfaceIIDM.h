...
class VoltageLevelInterfaceIIDM : public VoltageLevelInterface {
 public:
   ...
   */
  void addSwitch(const boost::shared_ptr<SwitchInterface>& sw) override;

  /**
   * @copydoc VoltageLevelInterface::addBus()
   */
  void addBus(const boost::shared_ptr<BusInterface>& bus) override;

  /**
   * @copydoc VoltageLevelInterface::addGenerator()
   */
  void addGenerator(const boost::shared_ptr<GeneratorInterface>& generator) override;

  /**
   * @copydoc VoltageLevelInterface::addLoad()
   */
  void addLoad(const boost::shared_ptr<LoadInterface>& load) override;

  /**
   * @copydoc VoltageLevelInterface::addShuntCompensator()
   */
  void addShuntCompensator(const boost::shared_ptr<ShuntCompensatorInterface>& shunt) override;

  /**
   * @copydoc VoltageLevelInterface::addDanglingLine()
   */
  void addDanglingLine(const boost::shared_ptr<DanglingLineInterface>& danglingLine) override;

  /**
   * @copydoc VoltageLevelInterface::addStaticVarCompensator()
   */
  void addStaticVarCompensator(const boost::shared_ptr<StaticVarCompensatorInterface>& svc) override;

  /**
   * @copydoc VoltageLevelInterface::addVscConverter()
   */
  void addVscConverter(const boost::shared_ptr<VscConverterInterface>& vsc) override;

  /**
   * @copydoc VoltageLevelInterface::addLccConverter()
   */
  void addLccConverter(const boost::shared_ptr<LccConverterInterface>& lcc) override;

  /**
   * @copydoc VoltageLevelInterface::getBuses()
   */
  const std::vector< boost::shared_ptr<BusInterface> >& getBuses() const override;

  /**
   * @copydoc VoltageLevelInterface::getSwitches()
   */
  const std::vector< boost::shared_ptr<SwitchInterface> >& getSwitches() const override;

  /**
   * @copydoc VoltageLevelInterface::getLoads()
   */
  const std::vector< boost::shared_ptr<LoadInterface> >& getLoads() const override;

  /**
   * @copydoc VoltageLevelInterface::getShuntCompensators()
   */
  const std::vector< boost::shared_ptr<ShuntCompensatorInterface> >& getShuntCompensators() const override;

  /**
   * @copydoc VoltageLevelInterface::getStaticVarCompensators()
   */
  const std::vector< boost::shared_ptr<StaticVarCompensatorInterface> >& getStaticVarCompensators() const override;

  /**
   * @copydoc VoltageLevelInterface::getGenerators()
   */
  const std::vector< boost::shared_ptr<GeneratorInterface> >& getGenerators() const override;

  /**
   * @copydoc VoltageLevelInterface::getDanglingLines()
   */
  const std::vector< boost::shared_ptr<DanglingLineInterface> >& getDanglingLines() const override;

  /**
   * @copydoc VoltageLevelInterface::getVscConverters()
   */
  const std::vector< boost::shared_ptr<VscConverterInterface> >& getVscConverters() const override;

  /**
   * @copydoc VoltageLevelInterface::getLccConverters()
   */
  const std::vector< boost::shared_ptr<LccConverterInterface> >& getLccConverters() const override;
