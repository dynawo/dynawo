...
class LineInterfaceIIDM : public LineInterface, public boost::noncopyable {
  ...
  */
   ...
   */
  boost::optional<double> getCurrentLimitPermanent(const std::string& season, unsigned int number) const final;

  /**
   * @copydoc LineInterface::getCurrentLimitNbTemporary(const std::string& season, unsigned int number) const
   */
  boost::optional<unsigned int> getCurrentLimitNbTemporary(const std::string& season, unsigned int number) const final;
   ...
   */
  boost::optional<std::string> getCurrentLimitTemporaryName(const std::string& season, unsigned int number, unsigned int indexTemporary) const final;
   ...
   */
  boost::optional<unsigned long> getCurrentLimitTemporaryAcceptableDuration(const std::string& season, unsigned int number,
   ...
   */
  boost::optional<double> getCurrentLimitTemporaryValue(const std::string& season, unsigned int number, unsigned int indexTemporary) const final;
   ...
   */
  boost::optional<bool> getCurrentLimitTemporaryFictitious(const std::string& season, unsigned int number, unsigned int indexTemporary) const final;
