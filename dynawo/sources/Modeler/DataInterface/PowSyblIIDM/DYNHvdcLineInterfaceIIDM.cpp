...
void HvdcLineInterfaceIIDM::importStaticParameters() {
  ...
  double p0ACEmulation = !isACEmulationEnabled ? 0 : hvdcActivePowerControl_->getP0().get();
  double p0ACEmulationPu = (hvdcLineIIDM_.getConvertersMode() == powsybl::iidm::HvdcLine::ConvertersMode::SIDE_1_RECTIFIER_SIDE_2_INVERTER) ?
                           p0ACEmulation / SNREF : - p0ACEmulation / SNREF;
