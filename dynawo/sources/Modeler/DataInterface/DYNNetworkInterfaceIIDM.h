...
/**
 * @file  DYNNetworkInterfaceIIDM.h
 *
 * @brief Network data interface : header file for IIDM implementation
 *
 */
#ifndef MODELER_DATAINTERFACE_DYNNETWORKINTERFACEIIDM_H_
#define MODELER_DATAINTERFACE_DYNNETWORKINTERFACEIIDM_H_
...
#endif  // MODELER_DATAINTERFACE_DYNNETWORKINTERFACEIIDM_H_
