...
void ModelMulti::printToFile(const std::string& suffix, bool printY, bool printYp, bool printZ) {
  const std::vector<propertyContinuousVar_t>& modelYType = getYType();
  ...
  std::string folderBaseY = "tmpY";
  std::string folderBaseYp = "tmpYp";
  std::string folderBaseZ = "tmpZ";
  if (!suffix.empty()) {
    folderBaseY += "-" + suffix;
    folderBaseYp += "-" + suffix;
    folderBaseZ += "-" + suffix;
