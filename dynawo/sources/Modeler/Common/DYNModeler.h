...
class Modeler {
 ...
 private:
   ...
   */
  void initStaticRefs(const boost::shared_ptr<SubModel>& model, const boost::shared_ptr<ModelDescription>& modelDescription) const;
   ...
   */
  void collectAllInternalConnections(const boost::shared_ptr<dynamicdata::ModelicaModel>& model,
 ...
 private:
   ...
   * @param modelDescription dynamic model
   */
  void initParamDescription(const boost::shared_ptr<ModelDescription>& modelDescription) const;
