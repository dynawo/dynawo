...
class ModelMulti : public Model, private boost::noncopyable {
  ...
  */
  void updateCalculatedVarForCurves(const boost::shared_ptr<curves::CurvesCollection>& curvesCollection) const override;
   ...
   */
  void setConstraints(const boost::shared_ptr<constraints::ConstraintsCollection>& constraints) override;

  /**
   * @copydoc Model::initCurves(const boost::shared_ptr<curves::Curve>& curve)
   */
  bool initCurves(const boost::shared_ptr<curves::Curve>& curve) override;
  ...
  */
   ...
   */
  void setLocalInitParameters(const boost::shared_ptr<parameters::ParametersSet>& localInitParameters) override;
