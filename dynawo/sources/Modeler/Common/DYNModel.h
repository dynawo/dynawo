...
class Model {
 public:
   ...
   */
  virtual void updateCalculatedVarForCurves(const boost::shared_ptr<curves::CurvesCollection>& curvesCollection) const = 0;
   ...
   */
  virtual bool initCurves(const boost::shared_ptr<curves::Curve>& curve) = 0;
  ...
  */
   ...
   */
  virtual void setLocalInitParameters(const boost::shared_ptr<parameters::ParametersSet>& localInitParameters) = 0;
