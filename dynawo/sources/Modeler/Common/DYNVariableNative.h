...
class VariableNative : public Variable {
 public:
   ...
   * @param external @b whether the variable is external
   */
  ...
  /**
   * @copydoc Variable::isExternal() const
   */
 ...
 private:
  ...
  const bool isExternal_;  ///< @b whether the variable is external in the model
