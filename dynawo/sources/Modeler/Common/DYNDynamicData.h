...
class DynamicData : public boost::noncopyable {
  ...
  */
   ...
   */
  inline const boost::shared_ptr<parameters::ParametersSet>& getNetworkParameters() const {
   ...
   */
  boost::shared_ptr<parameters::ParametersSet> getParametersSet(const std::string& modelId, const std::string& parFile, const std::string& parId);
 ...
 private:
   ...
   */
  void resolveParReferences(const boost::shared_ptr<dynamicdata::Model>& model,
                            const boost::shared_ptr<parameters::ParametersSet>& modelSet);
   ...
   */
  void mergeParameters(const boost::shared_ptr<parameters::ParametersSet>& concatParams, const std::string& udmName,
