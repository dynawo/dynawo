...
static const char UPDATABLE_INPUT_NAME[] = "input_value";  ///< updatable model parameter/variable name
 ...
 */
inline bool is_closed_side_1(State state) {
 ...
 */
inline bool is_closed_side_2(State state) {
