...
class Compiler {
 ...
 private:
   ...
   */
  std::string connectVariableName(const boost::shared_ptr<ModelDescription>& model, const std::string& rawVariableName) const;
  ...
  std::string modelicaModelVariableName(const std::string& rawVariableName, const std::string& modelId,
                                        const std::map<std::string, boost::shared_ptr<dynamicdata::UnitDynamicModel> >& unitDynamicModels) const;
  ...
  */
   ...
   */
  std::string writeConcatModelicaFile(const std::string& modelID, const boost::shared_ptr<ModelDescription>& modelicaModelDescription,
   ...
   */
  std::string writeInitFile(const boost::shared_ptr<ModelDescription>& modelicaModelDescription,
      const std::map<std::string, boost::shared_ptr<dynamicdata::UnitDynamicModel> >& unitDynamicModels,
