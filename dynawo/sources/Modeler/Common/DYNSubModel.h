...
class SubModel {
 ...
 public:
   ...
   */
  void initSub(double t0, const boost::shared_ptr<parameters::ParametersSet>& localInitParameters);
  ...
  */
   ...
   */
  void addCurve(const boost::shared_ptr<curves::Curve>& curve);
   ...
   */
  void updateCalculatedVarForCurve(const boost::shared_ptr<curves::Curve>& curve);
   ...
   * @param curve curve to store
   */
  static void addParameterCurve(const boost::shared_ptr<curves::Curve>& curve);
   ...
   */
  static void setParameterFromSet(const boost::shared_ptr<parameters::ParametersSet>& parametersSet, const parameterOrigin_t& origin,
