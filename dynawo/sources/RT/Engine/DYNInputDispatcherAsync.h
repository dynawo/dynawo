 ...
 *
 */
#ifndef RT_ENGINE_DYNINPUTDISPATCHER_H
#define RT_ENGINE_DYNINPUTDISPATCHER_H
...
class InputDispatcherAsync {
 public:
  InputDispatcherAsync(std::shared_ptr<ActionBuffer> &actionBuffer, std::shared_ptr<TimeManager>& timeManager);
...
# endif  // RT_ENGINE_DYNINPUTDISPATCHER_H