...
TEST(Models, TestBuildCheckSum) {
  ...
  ssDiff.str(std::string());
  executeCommand("diff dic/allInOne/AIOMyTimeline_keys.cpp dic/allInOne/AIOMyTimeline_keys.cpp", ssDiff);
  std::cout << ssDiff.str() << std::endl;
  ASSERT_EQ(ssDiff.str(), "Executing command : diff dic/allInOne/AIOMyTimeline_keys.cpp dic/allInOne/AIOMyTimeline_keys.cpp\n");
  ssDiff.str(std::string());
  executeCommand("diff dic/allInOne/AIOMyTimeline_keys.h dic/allInOne/AIOMyTimeline_keys.h", ssDiff);
  std::cout << ssDiff.str() << std::endl;
  ASSERT_EQ(ssDiff.str(), "Executing command : diff dic/allInOne/AIOMyTimeline_keys.h dic/allInOne/AIOMyTimeline_keys.h\n");
  ssDiff.str(std::string());
