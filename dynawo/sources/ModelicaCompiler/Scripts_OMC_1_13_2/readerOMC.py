...
class ReaderOMC:
    ...
    def add_delay_func(self):
        ...
        func = RawOmcFunctions()
        func.set_name("delayGetLastPointX")
        func.set_signature("modelica_real delayGetLastPointX(DATA* data, int exprNumber, modelica_real exprValue, modelica_real time, modelica_real delayTime, modelica_real delayMax)")
        func.set_return_type("modelica_real")
        func.add_params(OmcFunctionParameter("data", "DATA*", 0, True))
        func.add_params(OmcFunctionParameter("exprNumber", "int", 1, True))
        func.add_params(OmcFunctionParameter("exprValue", "modelica_real", 2, True))
        ...
        func = RawOmcFunctions()
        func.set_name("delayGetLastPointY")
        func.set_signature("modelica_real delayGetLastPointY(DATA* data, int exprNumber, modelica_real exprValue, modelica_real time, modelica_real delayTime, modelica_real delayMax)")
        func.set_return_type("modelica_real")
        func.add_params(OmcFunctionParameter("data", "DATA*", 0, True))
        func.add_params(OmcFunctionParameter("exprNumber", "int", 1, True))
        func.add_params(OmcFunctionParameter("exprValue", "modelica_real", 2, True))
