...
void MACHINE_PQ_INIT_callExternalObjectConstructors(DATA *data, threadData_t *threadData)
{
...
void MACHINE_PQ_INIT_callExternalObjectDestructors(DATA *data, threadData_t *threadData)
{
