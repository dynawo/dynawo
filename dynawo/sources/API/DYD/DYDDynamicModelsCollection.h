...
class DynamicModelsCollection {
  ...
  * @return models
  */
  const std::map<std::string, boost::shared_ptr<Model> >& getModels() const {
    return models_;
  }
  ...
  * @return connectors
  */
  const std::vector<boost::shared_ptr<Connector> >& getConnectors() const {
    return connectors_;
  }
  ...
  */
  const std::map<std::string, boost::shared_ptr<MacroConnector> >& getMacroConnectors() const {
  ...
  */
  const std::vector<boost::shared_ptr<MacroConnect> >& getMacroConnects() const {
  ...
  */
  const std::map<std::string, boost::shared_ptr<MacroStaticReference> >& getMacroStaticReferences() const {
