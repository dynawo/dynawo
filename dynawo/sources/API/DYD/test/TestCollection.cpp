...
TEST(APIDYDTest, CollectionCreate) {
  ...
  const unsigned int nbModels = collection->getModels().size();
...
TEST(APIDYDTest, CollectionCopy) {
  ...
  const unsigned int nbModels = collection1->getModels().size();
  ASSERT_EQ(nbModels, 2);
}
...
TEST(APIDYDTest, CollectionAddConnect) {
  ...
  const unsigned int nbConnect = collection->getConnectors().size();
...
TEST(APIDYDTest, CollectionAddMacroConnector) {
  ...
  const unsigned int nbMacroConnectors = collection->getMacroConnectors().size();
...
TEST(APIDYDTest, CollectionAddMacroConnect) {
  ...
  const unsigned int nbMacroConnects = collection->getMacroConnects().size();
...
TEST(APIDYDTest, CollectionMacroStaticReference) {
  ...
  const unsigned int nbMacroStaticReferences = collection->getMacroStaticReferences().size();
...
TEST(APIDYDTest, StaticRefIterators) {
  ...
  const unsigned int nbStaticReferences = model->getStaticRefs().size();
...
TEST(APIDYDTest, MacroStaticRefIterators) {
  ...
  const unsigned int nbMacroStaticReferences = model->getMacroStaticRefs().size();
