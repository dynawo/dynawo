...
class Model {
  ...
  * @return static refs
  */
  const std::map<std::string, boost::shared_ptr<StaticRef>>& getStaticRefs() const {
    return staticRefs_;
  }
  ...
  */
  const std::map<std::string, boost::shared_ptr<MacroStaticRef>>& getMacroStaticRefs() const {
