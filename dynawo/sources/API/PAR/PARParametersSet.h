...
class ParametersSet : public boost::enable_shared_from_this<ParametersSet> {
 public:
   ...
   * @returns Shared pointer to current ParametersSet instance
   */
  boost::shared_ptr<ParametersSet> createParameter(const std::string& name, bool value);
   ...
   * @returns Shared pointer to current ParametersSet instance
   */
  boost::shared_ptr<ParametersSet> createParameter(const std::string& name, int value);
   ...
   * @returns Shared pointer to current ParametersSet instance
   */
  boost::shared_ptr<ParametersSet> createParameter(const std::string& name, double value);
   ...
   * @returns Shared pointer to current ParametersSet instance
   */
  boost::shared_ptr<ParametersSet> createParameter(const std::string& name, bool value, const std::string& row, const std::string& column);
   ...
   * @returns Shared pointer to current ParametersSet instance
   */
  boost::shared_ptr<ParametersSet> createParameter(const std::string& name, int value, const std::string& row, const std::string& column);
   ...
   * @returns Shared pointer to current ParametersSet instance
   */
  boost::shared_ptr<ParametersSet> createParameter(const std::string& name, double value, const std::string& row, const std::string& column);
   ...
   * @returns Reference to current ParametersSet instance
   */
  boost::shared_ptr<ParametersSet> addReference(const boost::shared_ptr<Reference>& ref);
   ...
   */
  void extend(const boost::shared_ptr<ParametersSet>& parametersSet);
   ...
   */
  const std::map<std::string, boost::shared_ptr<Parameter> >& getParameters();
   ...
   */
  const std::unordered_map<std::string, boost::shared_ptr<Reference> >& getReferences();
  ...
  */
  const std::map<std::string, boost::shared_ptr<MacroParSet> >& getMacroParSets();
