...
void
ParametersSetCollection::addParametersSet(const shared_ptr<ParametersSet>& paramSet, const bool force) {
...
void
ParametersSetCollection::addMacroParameterSet(const shared_ptr<MacroParameterSet>& macroParamSet) {
