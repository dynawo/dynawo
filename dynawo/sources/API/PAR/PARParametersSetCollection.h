...
class ParametersSetCollection {
 public:
   ...
   * ID already exists.
   */
  void addParametersSet(const boost::shared_ptr<ParametersSet>& paramSet, bool force = false);
   ...
   * ID already exists.
   */
  void addMacroParameterSet(const boost::shared_ptr<MacroParameterSet>& macroParamSet);
  ...
  */
  const std::map<std::string, boost::shared_ptr<ParametersSet> >& getParametersSets() const {
  ...
  */
  const std::map<std::string, boost::shared_ptr<MacroParameterSet> >& getMacroParametersSets() const {
