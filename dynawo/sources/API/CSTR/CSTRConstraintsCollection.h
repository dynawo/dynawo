...
class ConstraintsCollection {
  ...
  */
  const std::map<std::string, std::vector<boost::shared_ptr<Constraint> > >& getConstraintsByModel() const {
  ...
  */
  const std::map<std::string, boost::shared_ptr<Constraint> >& getConstraintsById() const {
