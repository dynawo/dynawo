...
class JobEntry {
 public:
  ...
  /**
   * @brief Interactive settings entries container setter
   * @param interactiveSettingsEntry : Interactive settings entries container for the job
   */
  void setInteractiveSettingsEntry(const std::shared_ptr<InteractiveSettingsEntry> & interactiveSettingsEntry);

  /**
   * @brief Interactive settings entries container getter
   * @return Interactive settings entries container for the job
   */
 ...
 private:
  ...
  std::shared_ptr<InteractiveSettingsEntry> interactiveSettingsEntry_;  ///< Local init entries container
