...
class CriteriaCollection {
  ...
  * @return bus criteria
  */
  const std::vector<boost::shared_ptr<Criteria> >& getBusCriteria() const {
    return busCriteria_;
  }
  ...
  */
  const std::vector<boost::shared_ptr<Criteria> >& getLoadCriteria() const {
  ...
  */
  const std::vector<boost::shared_ptr<Criteria> >& getGeneratorCriteria() const {
