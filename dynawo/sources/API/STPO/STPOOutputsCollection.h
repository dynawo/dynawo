...
/**
 * @file  STPOOutputsCollection.h
 *
 * @brief Outputs collection description : interface file
 *
 */

#ifndef API_STPO_STPOOUTPUTSCOLLECTSTPON_H_
#define API_STPO_STPOOUTPUTSCOLLECTSTPON_H_
...
class OutputsCollection {
 public:
   ...
   * @brief constructor
   *
   * @param id outputsCollection's id
   */
  explicit OutputsCollection(const std::string& id);

  /**
   * @brief add a output to the collection
   *
  ...
  // /**
  //  * @brief add a new point for each output
  //  *
  //  * @param time time of the new point
  //  */
  // void updateOutputs(const double& time);
 ...
 private:
  std::vector<std::shared_ptr<Output> > outputs_;  ///< Vector of the outputs object
  std::string id_;                                 ///< Outputs collections id
};

}  // namespace stepOutputs

#endif  // API_STPO_STPOOUTPUTSCOLLECTSTPON_H_
