 ...
 */
static bool copySparseToKINSOL(SparseMatrix& smj, SUNMatrix& JJ, const std::vector<sunindextype>& lastRowVals);
 ...
 */
static void propagateMatrixStructureChangeToKINSOL(SparseMatrix& smj, SUNMatrix& JJ,
    std::vector<sunindextype>& lastRowVals, SUNLinearSolver& LS, const std::string& linearSolverName, bool log);
