...
__LA_SSIZE_T bos_write(struct archive* /*archive*/, void* client_data, const void* buffer, size_t n) {
...
void ZipOutputStream::write(const std::string& filename, const boost::shared_ptr<ZipFile>& zip) {
...
void ZipOutputStream::write(std::ostream& stream, const boost::shared_ptr<ZipFile>& zip) {
