...
/**
 * @file StandbyAutomaton1.cpp
 * @brief sample program creating a network with the StandbyAutomaton extension
 */
...
using namespace IIDM::extensions::standbyautomaton;
using namespace IIDM::extensions::standbyautomaton::xml;
...
int main(int argc, char** argv) {
  ...
  load.setExtension(
    StandbyAutomatonBuilder()
      .standBy( false )
      .b0( 0 )
      .lowVoltageSetPoint( 0 )
      .highVoltageSetPoint( 20 )
      .lowVoltageThreshold( 0 )
      .highVoltageThreshold( 10 )
    .build()
  );
