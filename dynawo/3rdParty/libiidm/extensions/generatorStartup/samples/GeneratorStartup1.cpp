...
/**
 * @file GeneratorStartup1.cpp
 * @brief sample program creating a network with the GeneratorStartup extension
 */
...
using namespace IIDM::extensions::generator_startup;
...
int main(int argc, char** argv) {
  ...
  gen.setExtension(GeneratorStartupBuilder().predefinedActivePowerSetpoint(5)
                                            .marginalCost(10)
                                            .plannedOutageRate(0.8)
                                            .forcedOutageRate(0.7)
                                            .build());
