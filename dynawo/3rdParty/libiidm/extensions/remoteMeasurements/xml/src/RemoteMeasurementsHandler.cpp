...
const std::string& RemoteMeasurementsHandler::xsd_path() {
  static const std::string xsdPath = getMandatoryEnvVar("IIDM_XML_XSD_PATH") + std::string("remoteMeasurements.xsd");
  return xsdPath;
}
