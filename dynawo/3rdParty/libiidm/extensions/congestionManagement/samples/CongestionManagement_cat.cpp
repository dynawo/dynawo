...
/**
 * @file CongestionManagement_cat.cpp
 * @brief sample program replicating an iidm xml file using only CongestionManagement extension
 */
...
int main(int argc, char** argv) {
  ...
  parser.register_extension<CongestionManagementHandler>();
