...
/**
 * @file VoltageLevelShortCircuits1.cpp
 * @brief sample program creating a network with the VoltageLevelShortCircuits extension
 */
...
using namespace IIDM::extensions::voltagelevelshortcircuits;
