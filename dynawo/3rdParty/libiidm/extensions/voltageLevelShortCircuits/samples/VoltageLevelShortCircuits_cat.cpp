...
/**
 * @file VoltageLevelShortCircuits_cat.cpp
 * @brief sample program replicating an iidm xml file using only VoltageLevelShortCircuits extension
 */

#include <IIDM/extensions/voltageLevelShortCircuits/xml.h>
...
using namespace IIDM::extensions::voltagelevelshortcircuits::xml;
...
int main(int argc, char** argv) {
  ...
  parser.register_extension<VoltageLevelShortCircuitsHandler>();
