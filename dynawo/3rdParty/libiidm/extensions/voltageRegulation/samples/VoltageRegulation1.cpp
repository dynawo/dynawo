...
/**
 * @file VoltageRegulation1.cpp
 * @brief sample program creating a network with the VoltageRegulation extension
 */
...
using namespace IIDM::extensions::voltageregulation;
...
int main(int argc, char** argv) {
  ...
  battery.setExtension(VoltageRegulationBuilder().voltageRegulatorOn(true)
                                       .targetV(20)
                                       .regulatingTerminal(TerminalReference("battery1"))
                                       .build());
