...
const std::string& ActivePowerControlHandler::xsd_path() {
  static const std::string xsdPath = getMandatoryEnvVar("IIDM_XML_XSD_PATH") + std::string("activePowerControl.xsd");
  return xsdPath;
}
