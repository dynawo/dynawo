...
/**
 * @file GeneratorActivePowerControl1.cpp
 * @brief sample program creating a network with the GeneratorActivePowerControl extension
 */
...
using namespace IIDM::extensions::generatoractivepowercontrol;
