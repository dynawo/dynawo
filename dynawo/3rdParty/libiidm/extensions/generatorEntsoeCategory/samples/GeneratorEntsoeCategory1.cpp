...
/**
 * @file GeneratorEntsoeCategory1.cpp
 * @brief sample program creating a network with the GeneratorEntsoeCategory extension
 */
...
using namespace IIDM::extensions::generator_entsoe_category;
