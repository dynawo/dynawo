...
install_libiidm() {
  ...
  cmake $SOURCE_DIR -DIIDM_BUILD_SHARED=$IIDM_BUILD_SHARED -DBUILD_XML=ON -DCMAKE_INSTALL_PREFIX=$INSTALL_DIR -DCMAKE_PREFIX_PATH=$LIBXML_INSTALL_DIR -DCMAKE_BUILD_TYPE=$BUILD_TYPE -DCMAKE_C_COMPILER=$C_COMPILER -DCMAKE_CXX_COMPILER=$CXX_COMPILER -DCXX11_ENABLED=$CXX11_ENABLED $CMAKE_OPTIONNAL
