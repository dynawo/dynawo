...
\textbf{Warning}, if you execute directly the command in the folder containing
your .mo file it will be deleted so be sure to make a copy of it and execute all the following commands.

\begin{lstlisting}[language=bash,deletekeywords={jobs,help}]
$> cd /path/to/Test.mo
$> mkdir -p compilation
$> cp Test.mo compilation
$> $MY_ENV_DYNAWO compileModelicaOMC --model Test --output-dir compilation --lib Test.so
\end{lstlisting}
...
\begin{lstlisting}[language=bash,deletekeywords={jobs,help}]
$> cp Test.mo compilation
$> $MY_ENV_DYNAWO compileModelicaOMC --model Test --output-dir compilation
\end{lstlisting}
...
\lstinputlisting[language=XML,title=Test.xml]{../resources/exampleExecutables/TestCompile/ExternalVariables/Test.xml}
...
\lstinputlisting[language=Modelica,title=Model1.mo]{../resources/exampleExecutables/TestDydLibNoExternal/Model1.mo}

And the second:
\lstinputlisting[language=Modelica,title=Model2.mo]{../resources/exampleExecutables/TestDydLibNoExternal/Model2.mo}
...
\lstinputlisting[language=XML,title=Test.xml]{../resources/exampleExecutables/TestDydLibNoExternal/Test.xml}
...
\lstinputlisting[language=XML,title=Test.jobs]{../resources/exampleExecutables/TestDydLibNoExternal/SimulationCompiledLib/Test.jobs}
\lstinputlisting[language=XML,title=Test.dyd]{../resources/exampleExecutables/TestDydLibNoExternal/SimulationCompiledLib/Test.dyd}
\lstinputlisting[language=XML,title=Test.crv]{../resources/exampleExecutables/TestDydLibNoExternal/SimulationCompiledLib/Test.crv}
And the same solvers.par file as previously. 
...
\lstinputlisting[language=XML,title=Test.par]{../resources/exampleExecutables/TestDydLibNoExternal/SimulationCompiledLib/Test.par}
...
\lstinputlisting[language=XML,title=Test.jobs]{../resources/exampleExecutables/TestDydLibNoExternal/Simulation/Test.jobs}
\lstinputlisting[language=XML,title=Test.dyd]{../resources/exampleExecutables/TestDydLibNoExternal/Simulation/Test.dyd}
\lstinputlisting[language=XML,title=Test.par]{../resources/exampleExecutables/TestDydLibNoExternal/Simulation/Test.par}
\lstinputlisting[language=XML,title=Test.crv]{../resources/exampleExecutables/TestDydLibNoExternal/Simulation/Test.crv}
And the same solvers.par file as previously.
...
\lstinputlisting[language=Modelica,title=Model2.mo]{../resources/exampleExecutables/TestDydLib/Model2.mo}
\lstinputlisting[language=XML,title=Model2.xml]{../resources/exampleExecutables/TestDydLib/Model2.xml}

The same xml file is used as in the first example to connect those models:
\lstinputlisting[language=XML,title=Test.xml]{../resources/exampleExecutables/TestDydLib/Test.xml}
...
\lstinputlisting[language=XML,title=Test.xml]{../resources/exampleExecutables/TestDydLib/compilation/Test.xml}
...
\lstinputlisting[language=XML,title=FrequencyLoad.xml]{../resources/exampleLibrary/FrequencyLoad.xml}
