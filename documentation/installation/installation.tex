...
\begin{itemize}
\item
  \href{https://github.com/dynawo/dynawo/releases/download/v1.2.0/Dynawo_Linux_v1.2.0.zip}{Linux}
\item
  \href{#}{MacOS} (Soon)
\item
  \href{https://github.com/dynawo/dynawo/releases/download/v1.2.0/Dynawo_Windows_v1.2.0.zip}{Windows}
\end{itemize}
