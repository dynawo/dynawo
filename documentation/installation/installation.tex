...
\begin{itemize}
\item
  \href{https://github.com/dynawo/dynawo/releases/download/v1.4.1/Dynawo_Linux_v1.4.1.zip}{Linux}
\item
  \href{https://github.com/dynawo/dynawo/releases/download/v1.4.1/Dynawo_Windows_v1.4.1.zip}{Windows}
\end{itemize}
...
\item \href{https://www.powsybl.org/pages/documentation/developer/repositories/powsybl-iidm4cpp.html}{\underline{PowSyBl - iidm4cpp}} a C++ implementation of the IIDM grid model and distributed under the MPL License, Version 2.0. The current version used is 1.5.0.
