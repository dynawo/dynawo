...
\begin{itemize}
\item
  \href{https://github.com/dynawo/dynawo/releases/download/v1.1.0/Dynawo_Linux_v1.1.0.zip}{Linux}
\item
  \href{https://github.com/dynawo/dynawo/releases/download/v1.1.0/Dynawo_MacOS_v1.1.0.zip}{MacOS}
\item
  Windows (Soon)
\end{itemize}
...
\item Libraries: \href{http://www.netlib.org/blas/index.html}{BLAS}, \href{http://www.netlib.org/lapack/index.html}{LAPACK}
...
\item \href{https://cmake.org/}{CMake}: minimum version 3.9.6
\item \href{https://www.python.org/ftp/python/2.7.17/python-2.7.17.amd64.msi}{Python2}
\end{itemize}
...
\item
  \href{https://cmake.org}{CMake}
\item
  \href{https://www.python.org/ftp/python/2.7.17/python-2.7.17.amd64.msi}{Python2}
\end{itemize}
