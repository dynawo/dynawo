...
\Dynawo is available on two platforms: \textbf{Linux} and \textbf{Windows}. You
can either build it from sources on each platform or use binaries distributed on
Github. If you are on \textbf{MacOS} you ca use a \hyperref[sec:docker]{Docker}
solution.
...
\begin{itemize}
\item
  \href{https://github.com/dynawo/dynawo/releases/download/v1.2.1/Dynawo_Linux_v1.2.1.zip}{Linux}
\item
  \href{https://github.com/dynawo/dynawo/releases/download/v1.2.1/Dynawo_Windows_v1.2.1.zip}{Windows}
\end{itemize}
...
\Dynawo has be tested on Linux platforms (Centos and Debian based) and provided that you can install system packages there should be no problem on other Linux distribution.
