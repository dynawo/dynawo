...
One model is implemented for computing various aggregations of voltage levels: \verb VoltageMeasurementUtilities  model.

\paragraph{Voltage measurement utilities model}
~~\\

The ``VoltageMeasurementUtilities'' model allows a dynamic number of voltage levels to be monitored and outputs various aggregations of their values.
...
These aggregations are computed only on a subset of the input voltage levels for which the associated \verb running  variables are \verb True .
