...
\item \textbf{Final values}: the user can have access to the values of the variables and the parameters of the models at the end of the simulation by adding the item ``dumpFinalValues'' in the jobs file.
