...
<modelicaModel id="MyGenerator" staticId="MyGeneratorIIDMId">
  ...
  <staticRef var="P" staticVar="p"/>
  <staticRef var="Q" staticVar="q"/>
...
<macroConnector id="M1S_OMEGAREF_CONNECTOR">
  <connect var1="omega_grp_@INDEX@_" var2="M1S_omega"/>
  <connect var1="running_grp_@INDEX@_" var2="M1S_running"/>
  <connect var1="omegaRef_grp_@INDEX@_" var2="M1S_omegaRef"/>
</macroConnector>
\end{lstlisting}
