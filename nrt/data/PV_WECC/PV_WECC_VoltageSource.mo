model PV_WECC_VoltageSource
  ...
  Dynawo.Electrical.Transformers.TransformerFixedRatio transformerFixedRatio1(
    ...
    rTfoPu = 1, state(start = Dynawo.Electrical.Constants.state.Closed)) annotation(
  ...
  Dynawo.Electrical.Photovoltaics.WECC.PVVoltageSource WECC_PV_Model1(
    ...
    Rlne = 0, Rsource = 0, Rtfo = 0.0000999999902,
    SNom = 100, UReg0Pu = 1.01463461,
    URegPhase0 (displayUnit = "rad") = 0.0690452,
    Xlne = 0.000025, Xsource = 0.1, Xtfo = 0.049999899999) annotation(
  ...
  // Inner variables:
  SIunits.PerUnit PRegPu_SnRef;
  SIunits.PerUnit QRegPu_SnRef;
