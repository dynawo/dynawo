...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 2in]
        ...
        table[x=time, y expr=\thisrow{NETWORK__BUS____3_TN_Upu}]
...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 2.5in, yticklabel style={text width={width("$-0.6$")},align=right}]
        \addplot[color=red!50]
        table[x=time, y expr=\thisrow{NETWORK__BUS____5_TN_Upu}]
        {../IEEE14_TapChangerCpp/reference/outputs/curves/curves.csv};
        \addplot[color=blue!50]
        table[x=time, y expr=\thisrow{NETWORK__BUS____6_TN_Upu}]
        {../IEEE14_TapChangerCpp/reference/outputs/curves/curves.csv};
...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 2.3in]
        \addplot[color=blue!50]
        table[x=time, y expr=\thisrow{NETWORK__BUS____2_TN_Upu}]
        {../IEEE14_TapChangerBlocking/reference/outputs/curves/curves.csv};
        \addplot[color=green!50]
        table[x=time, y expr=\thisrow{NETWORK__BUS____3_TN_Upu}]
        {../IEEE14_TapChangerBlocking/reference/outputs/curves/curves.csv};
...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 2.7in]
        \addplot[color=blue!50]
        table[x=time, y expr=\thisrow{NETWORK__BUS____3_TN_U}]
        {../IEEE14_TapChangerBlocking/reference/outputs/curves/curves.csv};
        \addplot[color=red!50]
