...
\subsection{Scenario}
At $t=3s$, a 500ms three-phase fault is triggered at bus 8.
...
\subsection{Scenario}
At $t=3s$, a 1500ms three-phase fault is triggered at generator 1. This very high duration fault causes the generator to lose synchronism.
...
\subsection{Scenario}
At $t=3s$, a 1000ms three-phase fault is triggered at generator 1. This very high duration fault causes the generator to lose synchronism, and thus to accelerate.
