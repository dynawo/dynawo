...
At $t=1s$, a three-phase fault is applied at the Generator 2 terminal. The fault is cleared at $t=1.1s$. \\
...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 2in]
        \addplot[color=blue!50]
        table[x=time,y expr=\thisrow{NETWORK__BUS____2_TN_Upu_value}*69]
        {../IEEE14_Fault/reference/outputs/curves/curves.csv};
    \end{axis}
  \end{tikzpicture}
}
\subfigure[Active power of generator 2(MW)]
{%
  \begin{tikzpicture}
    \begin{axis}[height = 2in]
        \addplot[color=blue!50]
