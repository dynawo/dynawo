...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 1.5in, xmax=40]
        \addplot[color=blue!50]
...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 1.5in, xmax=40, yticklabel style={/pgf/number format/.cd,fixed zerofill,precision=3}]
        \addplot[color=blue!50]
...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 1.3in, xmax=40, yticklabel style={/pgf/number format/.cd,fixed zerofill,precision=3}]
        \addplot[color=blue!50]
...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 1.3in, xmax=40]
        \addplot[color=blue!50]
        table[x=time, y expr=\thisrow{GEN____8_SM_generator_UStatorPu}*20]
        {../IEEE57_3_DisconnectLine/reference/outputs/curves/curves.csv};
    \end{axis}
  \end{tikzpicture}
}
...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 2.5in, xmax=40]
        \addplot[color=blue!50]
