...
############################################################################
#               IEEE57 - Node fault on node 45                           #
############################################################################

case_name = "IEEE57 - DisconnectBus"
case_description = "IEEE57 - Node fault on node 45"
job_file = os.path.join(os.path.dirname(__file__), "IEEE57_BasicTestCases", "IEEE57_4_DisconnectBus", "IEEE57.jobs")
