...
#################################################
#       NORDIC dump-load sequence with GFL      #
#################################################

case_name = "NORDIC dump-load sequence with GFL"
case_description = "NORDIC dump-load from dump sequence while tap changers are moving."
job_file = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), "nrt", "data", "DynaWaltz", "Nordic_PlantController", "Nordic_seq.jobs")
