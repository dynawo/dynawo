...
load.
There are three different embedded tests  :
\begin{itemize}
...
N.B : when using PVariation, we increase the power in percentage, when using deltaPRefPu we add the value to the active power existing.
...
The third simulation has the following characteristics:
\begin{itemize}
\item The frequency and load of the network are constants;
\item The active power of the generator increases at t = 2 s until t = 3 s;
\item The simulation lasts for 10s.
\end{itemize}
