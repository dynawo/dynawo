...
\subfigure[Generator active power (p.u)]
{%
  \begin{tikzpicture}
    \begin{axis}[height = 2.4in]
        \addplot[color=blue!50]
...
\subfigure[Generator reactive power (p.u)]
{%
  \begin{tikzpicture}
    \begin{axis}[height = 2.4in]
        \addplot[color=blue!50]
...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 2.4in]
        \addplot[color=blue!50]
        table[x=time, y expr=\thisrow{generator_generator_UPu}*24]
...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 2.4in]
        \addplot[color=blue!50]
        table[x=time, y expr=\thisrow{generator_generator_QGenPu}*100/2220]
        {../SMIB_3_LoadVarQ/reference/outputs/curves/curves.csv};
    \end{axis}
  \end{tikzpicture}
}
...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 1.7in]
        \addplot[color=blue!50]
        table[x=time, y expr=\thisrow{generator_generator_PGenPu}*100/2220]
        {../SMIB_4_DisconnectLine/reference/outputs/curves/curves.csv};
    \end{axis}
  \end{tikzpicture}
}
