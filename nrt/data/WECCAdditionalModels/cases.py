...
################################################
#           WECC WPP4B test case with HVRT     #
################################################

case_name = "WECC WPP4B HVRT"
case_description = "WECC WPP4B with HVRT test on a SMIB network"
job_file = os.path.join(os.path.dirname(__file__),  "Wind", "LHVRT", "WECCWPP4BCurrentSourceHVRT", "WECCWPP4B.jobs")

test_cases.append((case_name, case_description, job_file, 2, standardReturnCodeType, standardReturnCode))

################################################
#           WECC WPP4B test case with LVRT     #
################################################

case_name = "WECC WPP4B LVRT"
case_description = "WECC WPP4B with LVRT test on a SMIB network"
job_file = os.path.join(os.path.dirname(__file__),  "Wind", "LHVRT", "WECCWPP4BCurrentSourceLVRT", "WECCWPP4B.jobs")
