...
This chapter presents 8 test cases simulating five models of renewable energies generators :
\begin{itemize}
...
\section{PV and Wind}
The implementation of the models WECCPVCurrentSource, WECCPVvoltageSource, WECCWTG4ACurrentSource1 and WECCWTG4BCurrentSource in Modelica has lead to the following publication in the 14th Modelica conference:\\
...
\par The same scenario is simulated in the four cases. First the infinite bus voltage is reduced from 1 pu to 0.5 pu from t=1 s to t=2 s. Then its frequency is increased to 1.01 pu (from 1 pu) from t=6 s to t=6.5 s.
