...
The implementation of the models WECCPVCurrentSource, WECCWTG4ACurrentSource and WECCWTG4BCurrentSource in Modelica has lead to the following publication in the 14th Modelica conference:\\
...
\begin{tikzpicture}
    \begin{axis}[height = 2.5in]
        ...
        {../WECC/PV/WECCPVVoltageSource2/reference/outputs/curves/curves.csv};
        \addplot[color=red!50]
        table[x=time, y expr=\thisrow{WECCPVVSource_photovoltaics_injector_PInjPu}]
        {../WECC/PV/WECCPVVoltageSource4/reference/outputs/curves/curves.csv};
        \legend{$WECCPVVoltageSource2$, $WECCPVVoltageSource4$}
    \end{axis}
  \end{tikzpicture}
}
...
\subsection{WECCPVVoltageSource1 and WECCPVVoltageSource3}
Here we are going to compare results from WECCPVVoltageSource1 (REPC-A + REEC-A + REGC-B) against WECCPVVoltageSource3 (REPC-A + REEC-A + REGC-C) :
...
\begin{tikzpicture}
    \begin{axis}[height = 2.5in]
        ...
        {../WECC/PV/WECCPVVoltageSource1/reference/outputs/curves/curves.csv};
        \addplot[color=red!50]
        table[x=time, y expr=\thisrow{WECCPVVSource_photovoltaics_HvMeasurements_PPu}]
        {../WECC/PV/WECCPVVoltageSource3/reference/outputs/curves/curves.csv};
        \legend{$WECCPVVoltageSource1$, $WECCPVVoltageSource3$}
    \end{axis}
  \end{tikzpicture}
}
\subfigure[Reactive power injected in pu (base SNom)]
...
\section{Type 3 Wind}
\subsection{Test case description}
The WTG3 is connected to an infinite bus through a line in both test cases.

\begin{figure}[H]
\center
  \includegraphics[width=0.55\textwidth]{WTG3.png}
  \caption{Test case diagram}
\end{figure}
...
\begin{tikzpicture}
    \begin{axis}[height = 1.5in]
        \addplot[color=blue!50]
        table[x=time, y expr=\thisrow{WTG3_WTG3_injector_PInjPu}]
        {../WECC/Wind/WECCWTG3CurrentSource1/reference/outputs/curves/curves.csv};
        \addplot[color=red!50]
        table[x=time, y expr=\thisrow{WTG3_WTG3_injector_PInjPu}]
        {../WECC/Wind/WECCWTG3CurrentSource2/reference/outputs/curves/curves.csv};
        \legend{$WECCWTG3CurrentSource1$, $WECCWTG3CurrentSource2$}
    \end{axis}
  \end{tikzpicture}
}
\subfigure[Reactive power injected in pu (base SNom)]
...
\begin{tikzpicture}
    \begin{axis}[height = 1.5in]
        \addplot[color=blue!50]
        table[x=time, y expr=\thisrow{WTG3_WTG3_injector_QInjPu}]
        {../WECC/Wind/WECCWTG3CurrentSource1/reference/outputs/curves/curves.csv};
        \addplot[color=red!50]
        table[x=time, y expr=\thisrow{WTG3_WTG3_injector_QInjPu}]
        {../WECC/Wind/WECCWTG3CurrentSource2/reference/outputs/curves/curves.csv};
...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 1.5in, yticklabel style={/pgf/number format/.cd,fixed,precision=3}]
        ...
        {../WECC/BESS/WECCBESSCurrentSource/reference/outputs/curves/curves.csv};
    \end{axis}
  \end{tikzpicture}
  }
\subfigure[Active power injected in pu (base SNom)]
...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 2in]
        \addplot[color=blue!50]
        table[x=time,y expr=\thisrow{NETWORK__BUS____2_TN_Upu}*69]
...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 2in]
        \addplot[color=blue!50]
        table[x=time,y expr=\thisrow{NETWORK__GLEN__12_TN_Upu}*69]
...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 2in]
        \addplot[color=blue!50]
        table[x=time,y expr=\thisrow{NETWORK__SALT___9_TN_Upu}*69]
        {../IEEE57/IEEE57_Fault/reference/outputs/curves/curves.csv};
    \end{axis}
  \end{tikzpicture}
}
...
{%
  \begin{tikzpicture}
    \begin{axis}[height = 2in]
        \addplot[color=blue!50]
        table[x=time,y=NETWORK_NLOAD_Upu]
