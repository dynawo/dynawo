...
\par At t=0, the power plant is injecting 0.7pu of active power and 0.2pu of reactive power into the grid. The voltage module at its terminal is 1pu and the voltage angle is equal to 0rad.
...
This chapter presents a test case that simulates a 5-machine all-converter-interfaced power system. Two converters are grid following and use the WECC WTG4A model presented above and three converters are grid forming converters using a droop control.
...
\par First, an active power double step is played at WP2 at t=1s and t=2s. Then a line is disconnected at t=3s. Then an active power double step is played at HVDC1 at t=4s and t=5s. Finally, a fault is played at t=7s and cleared at t=7.1s.

\section{Results}

\par As an example, the injected active and reactive powers of WP2 and HVDC1 are shown in the following:
