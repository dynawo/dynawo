...
\item A PV plant with the injector represented as a voltage source. Two REGC models enables the voltage source connection REGC-B : WECCPVVoltageSource2 and REGC-C : WECCPVVoltageSource4.
