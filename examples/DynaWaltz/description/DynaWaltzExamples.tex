...
\begin{figure}[H]
\subfigure[Generator 1 $Efd$ and $Efd_{Max} \ (p.u.)$]
{%
  \begin{tikzpicture}
...
\subfigure[Generator 3 $Efd$ and $Efd_{Max} \ (p.u.)$]
{%
  \begin{tikzpicture}
    \begin{axis}[height = 2in]
        \addplot[color=blue!50]
  ...
  \subfigure[Voltage behavior for load 9 transformer]
{
  ...
  \subfigure[Active power variations for load 9 (p.u.)]
  {
  \begin{tikzpicture}
    \begin{axis}[height = 2 in]
        \addplot[color=blue!50]
  ...
  \subfigure[Reactive power variations for load 9 (p.u.)]
  {
  \begin{tikzpicture}
    \begin{axis}[height = 2 in]
        \addplot[color=blue!50]
