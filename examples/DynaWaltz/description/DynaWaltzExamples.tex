  ...
  \subfigure[Voltage behavior for load 2 transmission transformer]
{
  \begin{tikzpicture}
    \begin{axis}[height = 2 in]
        \addplot[color=blue!50]
            table[x=time,y=_LOAD___2_EC_transformerT_tapChanger_UMonitored]
        {../IEEE14/IEEE14_GeneratorDisconnections/reference/outputs/curves/curves.csv};
        \addplot[dashed, color=red!50]
  ...
  \begin{tikzpicture}
    \begin{axis}[height = 2 in]
        \addplot[color=blue!50]
            table[x=time,y=_LOAD___2_EC_transformerT_tapChanger_tap]
        {../IEEE14/IEEE14_GeneratorDisconnections/reference/outputs/curves/curves.csv};
        \addplot[dashed, color=red!50]
  ...
  \subfigure[Voltage behavior for load 9 transformer]
{
  \begin{tikzpicture}
    \begin{axis}[height = 2 in]
        \addplot[color=blue!50]
            table[x=time,y=_LOAD___9_EC_transformer_tapChanger_UMonitored]
        {../IEEE14/IEEE14_GeneratorDisconnections/reference/outputs/curves/curves.csv};
        \addplot[dashed, color=red!50]
  ...
  \begin{tikzpicture}
    \begin{axis}[height = 2 in]
        \addplot[color=blue!50]
            table[x=time,y=_LOAD___9_EC_transformer_tapChanger_tap]
        {../IEEE14/IEEE14_GeneratorDisconnections/reference/outputs/curves/curves.csv};
        \addplot[dashed, color=red!50]
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[height = 2 in]
        \addplot[color=blue!50]
            table[x=time,y=NETWORK__BUS____1_TN_U]
        {../IEEE14/IEEE14_GeneratorDisconnections/reference/outputs/curves/curves.csv};
    \end{axis}
  \end{tikzpicture}
}
  ...
  \begin{tikzpicture}
    \begin{axis}[height = 2 in]
        \addplot[color=blue!50]
            table[x=time,y=NETWORK__BUS____5_TN_U]
        {../IEEE14/IEEE14_GeneratorDisconnections/reference/outputs/curves/curves.csv};
    \end{axis}
  \end{tikzpicture}
}
  ...
  \begin{tikzpicture}
    \begin{axis}[height = 2 in]
        \addplot[color=blue!50]
            table[x=time,y=NETWORK__BUS____6_TN_U]
        {../IEEE14/IEEE14_GeneratorDisconnections/reference/outputs/curves/curves.csv};
    \end{axis}
  \end{tikzpicture}
}
  ...
  \subfigure[Voltage behavior for load 1 transmission transformer]
{
  \begin{tikzpicture}
    \begin{axis}[height = 2 in]
        \addplot[color=blue!50]
            table[x=time,y=_LOAD___1_EC_transformerT_tapChanger_UMonitored]
  ...
  \begin{tikzpicture}
    \begin{axis}[height = 2 in]
        \addplot[color=blue!50]
            table[x=time,y=_LOAD___1_EC_transformerT_tapChanger_tap]
        {../IEEE57/IEEE57_GeneratorDisconnection/reference/outputs/curves/curves.csv};
        \addplot[dashed, color=red!50]
  ...
  \subfigure[Voltage behavior for load 38 transformer]
{
  \begin{tikzpicture}
    \begin{axis}[height = 2 in]
        \addplot[color=blue!50]
            table[x=time,y=_LOAD__38_EC_transformer_tapChanger_UMonitored]
        {../IEEE57/IEEE57_GeneratorDisconnection/reference/outputs/curves/curves.csv};
        \addplot[dashed, color=red!50]
  ...
  \begin{tikzpicture}
    \begin{axis}[height = 2 in]
        \addplot[color=blue!50]
            table[x=time,y=_LOAD__38_EC_transformer_tapChanger_tap]
        {../IEEE57/IEEE57_GeneratorDisconnection/reference/outputs/curves/curves.csv};
        \addplot[dashed, color=red!50]
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[height = 2 in, xmax = 300]
        \addplot[color=blue!50]
            table[x=time,y=NETWORK__KANA___1_TN_U]
        {../IEEE57/IEEE57_GeneratorDisconnection/reference/outputs/curves/curves.csv};
    \end{axis}
  \end{tikzpicture}
}
  ...
  \begin{tikzpicture}
    \begin{axis}[height = 2 in, xmax = 300]
        \addplot[color=blue!50]
            table[x=time,y=NETWORK__SALT___9_TN_U]
        {../IEEE57/IEEE57_GeneratorDisconnection/reference/outputs/curves/curves.csv};
    \end{axis}
  \end{tikzpicture}
}
  ...
  \begin{tikzpicture}
    \begin{axis}[height = 2 in, xmax = 300]
        \addplot[color=blue!50]
            table[x=time,y=NETWORK__GLEN__12_TN_U]
        {../IEEE57/IEEE57_GeneratorDisconnection/reference/outputs/curves/curves.csv};
    \end{axis}
  \end{tikzpicture}
}
...
\begin{figure}[H]
  \begin{tikzpicture}
    \begin{axis}[height = 2 in]
        \addplot[color=blue!50]
            table[x=time,y=NETWORK_1041_131_Upu]
        {../Nordic/reference/outputs/curves/curves.csv};
        \addplot[dashed, color=red!50]
        table[x=time,y=NETWORK_1042_131_Upu]
        {../Nordic/reference/outputs/curves/curves.csv};
